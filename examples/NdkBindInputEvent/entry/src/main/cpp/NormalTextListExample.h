 ...
 */
// [Start Cpp_InputEventListExample]
...
private:
    ...
    // [End get_base_event_info]

    // [Start get_pointer_position]
    // 获取事件位置信息
    ...
    // [End handle_hover_event]

    // [Start handle_axis_event]
    // 处理轴事件
    ...
    // [End handle_axis_event]

    // [Start handle_key_event]
    // 处理按键事件
