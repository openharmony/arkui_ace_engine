...
// [StartExclude long_press_and_swipe_gesture]
ArkUI_NodeHandle CreateSequentialGestureColumn()
{
...
void CreateLongPressGesture(ArkUI_NativeGestureAPI_1 *gestureApi, ArkUI_GestureRecognizerHandle groupGesture,
...
void CreateSwipeGesture(ArkUI_NativeGestureAPI_1 *gestureApi, ArkUI_GestureRecognizerHandle groupGesture,
    ArkUI_NodeHandle column)
{
    // 创建快滑手势 swipe
...
{
    auto column = CreateSequentialGestureColumn();
    ...
    CreateLongPressGesture(gestureApi, groupGesture, column);
    CreateSwipeGesture(gestureApi, groupGesture, column);
