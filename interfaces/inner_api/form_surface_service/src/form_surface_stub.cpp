    ...
    uint32_t code, MessageParcel& data, MessageParcel& reply, MessageOption& option)
{
    ...
    switch (msgId) {
        ...
        case FormSurfaceServiceMessage::ON_ACTION_EVENT: {
            HandleOnActionEvent(data, reply);
            break;
        }
...
int32_t FormSurfaceServiceStub::HandleOnActionEvent(MessageParcel &data, MessageParcel &reply)
{
