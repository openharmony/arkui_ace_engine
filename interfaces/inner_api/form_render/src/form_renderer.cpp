...
void FormRenderer::SetUIContentProperty(const OHOS::AAFwk::Want &want)
{
    ...
    if (enableBlurBackground_ || removeBackgroundImage_) {
...
void FormRenderer::ParseWant(const OHOS::AAFwk::Want &want)
{
    ...
    removeBackgroundImage_ = want.GetBoolParam(OHOS::AppExecFwk::Constants::PARAM_DELETE_BACKGROUND_IMAGE, false);
}
