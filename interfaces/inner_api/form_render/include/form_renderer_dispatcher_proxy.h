...
public:
    ...
    void DispatchSurfaceChangeEvent(float width, float height, uint32_t reason,
        const std::shared_ptr<Rosen::RSTransaction>& rsTransaction, float borderWidth = 0.0) override;
