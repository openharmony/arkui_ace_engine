...
#ifndef FOUNDATION_ACE_INTERFACE_INNERAPI_DRAWABLE_LOG_H
#define FOUNDATION_ACE_INTERFACE_INNERAPI_DRAWABLE_LOG_H
...
#define PRINT_HILOG(level, fmt, ...)                                                                                  \
    HILOG_IMPL(LOG_CORE, LOG_##level, 0xD00391F, "AceDrawableDescriptor", "[%{public}s:%{public}d]" fmt, DD_FILENAME, \
...
#endif // FOUNDATION_ACE_INTERFACE_INNERAPI_DRAWABLE_LOG_H
