...
typedef struct {
    ...
    *
    * @param handler Indicates the pointer to the custom dialog box controller.
    */
    ...
    * @note This method must be called before the <b>show</b> method.
    * @param handler Indicates the pointer to the custom dialog box controller.
    * @param useModalMode Specifies whether the custom dialog box is a modal, which has a mask applied.
    * The value <b>true</b> means that the custom dialog box is a modal, and <b>false</b> means the opposite.
    ...
    * @param rect Indicates the pointer to the mask area. Events outside the mask area are transparently transmitted,
    ...
    * @note This method must be called before the <b>show</b> method.
    * @param handler Indicates the pointer to the custom dialog box controller.
    * @param customStyle Specifies whether to use a custom style for the dialog box.
    ...
    * @note This method must be called before the <b>show</b> method.
    * @param handler Indicates the pointer to the custom dialog box controller.
    * @param useCustomAnimation Specifies whether to use a custom animation.
    * The value <b>true</b> means to use a custom animation, and <b>false</b> means to use the default animation.
    * @return Returns <b>0</b> if the operation is successful; returns <b>401</b> if a parameter error occurs.
    */
    ...
    * @return Returns <b>0</b> if the operation is successful; returns <b>401</b> if a parameter error occurs.
    */
    int32_t (*registerOnWillDismiss)(ArkUI_NativeDialogHandler handler, OnWillDismissEvent eventHandler);
    /**
