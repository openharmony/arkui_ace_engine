...
/**
 * @brief Enumerates the text encoding types supported by ArkUI text layout query APIs.
 *
 * @since 26
 */
typedef enum {
    /**
     * @brief UTF-8 encoding. Character positions and character ranges are calculated by UTF-8 byte offsets.
     *
     * @since 26
     */
    ...
    /**
     * @brief UTF-16 encoding. Character positions and character ranges are calculated by UTF-16 code unit offsets.
     *
     * @since 26
     */
...
/**
 * @brief Gets the character position at coordinate with text encoding.
 *
 * @param layoutManager Indicates the pointer to an <b>ArkUI_TextLayoutManager</b> object.
 * @param dx Indicates the positionX of typography to set.
 * @param dy Indicates the positionY of typography to set.
 * @param encoding Indicates the text encoding type, which can be
 * <b>ARKUI_TEXT_ENCODING_UTF8</b> or <b>ARKUI_TEXT_ENCODING_UTF16</b>.
 * @param outPos Returns the character position at coordinate.
 * @return Returns the result code.
 *         Returns {@link ARKUI_ERROR_CODE_NO_ERROR} if the operation is successful.
 *         Returns {@link ARKUI_ERROR_CODE_PARAM_INVALID} if a parameter exception occurs.
...
/**
 * @brief Get the glyph range produced by the specified range of characters with text encoding.
 *
 * @param layoutManager Indicates the pointer to an <b>ArkUI_TextLayoutManager</b> object.
 * @param charRange The character range.
 * @param encoding Indicates the text encoding type, which can be
...
/**
 * @brief Gets the character range that maps to the glyphs in the given glyph range with text encoding.
 *
 * @param layoutManager Indicates the pointer to an <b>ArkUI_TextLayoutManager</b> object.
 * @param glyphRange glyphRange the glyph range.
 * @param encoding Indicates the text encoding type, which can be
