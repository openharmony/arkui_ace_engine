    ...
    ArkUI_NodeHandle node, void* userData, void (*onDrawCompleted)(void* userData))
{
    ...
    const auto* impl = OHOS::Ace::NodeModel::GetFullImpl();
    impl->getNodeModifiers()->getFrameNodeModifier()->setDrawCompleteCallback(
...
int32_t OH_ArkUI_UnregisterDrawCallbackOnNodeHandle(ArkUI_NodeHandle node) {
    ...
    const auto* impl = OHOS::Ace::NodeModel::GetFullImpl();
    impl->getNodeModifiers()->getFrameNodeModifier()->resetDrawCompleteCallback(node->uiNodeHandle);
    return OHOS::Ace::ERROR_CODE_NO_ERROR;
}
    ...
    ArkUI_NodeHandle node, void* userData, void (*onLayoutCompleted)(void* userData))
{
    ...
    const auto* impl = OHOS::Ace::NodeModel::GetFullImpl();
    impl->getNodeModifiers()->getFrameNodeModifier()->setLayoutCallback(
...
int32_t OH_ArkUI_UnregisterLayoutCallbackOnNodeHandle(ArkUI_NodeHandle node)
{
    ...
    const auto* impl = OHOS::Ace::NodeModel::GetFullImpl();
    impl->getNodeModifiers()->getFrameNodeModifier()->resetLayoutCallback(node->uiNodeHandle);
    return OHOS::Ace::ERROR_CODE_NO_ERROR;
}
