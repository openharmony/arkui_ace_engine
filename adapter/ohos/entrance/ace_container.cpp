...
void AceContainer::AttachView(std::shared_ptr<Window> window, AceView* view, double density, double width,
    double height, uint32_t windowId, UIEnvCallback callback)
{
    aceView_ = view;
