...
constexpr int32_t DEFAULT_APP_RPE_COUNT = 3;
...
int32_t GetAppPreCountProp()
{
    int32_t appPreCount =
        system::GetIntParameter("persist.sys.graphic.dvsync.app_pre_count", DEFAULT_APP_RPE_COUNT);
    return appPreCount > 0 ? appPreCount : 0;
}
...
int32_t SystemProperties::appPreCount_ = GetAppPreCountProp();
