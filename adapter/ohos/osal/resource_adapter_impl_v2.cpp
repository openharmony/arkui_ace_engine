...
const std::unordered_set<std::string> PATTERN_NOT_SYNC_LOAD_SET = { THEME_PATTERN_CHECKBOX, THEME_PATTERN_DATA_PANEL,
    ...
    THEME_BLUR_STYLE_COMMON, THEME_PATTERN_SHADOW, THEME_PATTERN_SCROLLABLE, THEME_PATTERN_SELECTABLE,
    THEME_PATTERN_APP, THEME_PATTERN_CONTAINER_PICKER, THEME_PATTERN_CORNER_MARK };
