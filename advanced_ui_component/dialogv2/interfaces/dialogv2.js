                  ...
                  this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (index === this.imageIndex) {
                      ...
                      this.ifElseBranchUpdateFunction(1, () => {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                          Column.create();
                          Column.padding({ top: { 'id': -1, 'type': 10002, params: ['sys.float.padding_level8'],
...
class CustomDialogContentComponent extends ViewV2 {
  ...
  initialRender() {
    this.observeComponentCreation2((elmtId, isInitialRender) => {
      Scroll.create();
      Scroll.borderRadius({ 'id': -1, 'type': 10002, params: ['sys.float.alert_container_shape'], 'bundleName': '__harDefaultBundleName__', 'moduleName': '__harDefaultModuleName__' });
      ...
      this.observeComponentCreation2((elmtId, isInitialRender) => {
        if (isInitialRender) {
          let componentCall = new CustomDialogContentComponent(this, {
            ...
            minContentHeight: this.minContentHeight,
            $minContentHeight: value => { this.minContentHeight = value; }
          }, undefined, elmtId, () => { }, { page: 'library/src/main/ets/components/dialog.ets', line: 1700, col: 7 });
          ViewV2.create(componentCall);
          let paramsLambda = () => {
            return {
              contentBuilder: () => {
