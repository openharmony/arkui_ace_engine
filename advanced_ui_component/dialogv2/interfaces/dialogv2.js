      ...
      if (this.buttons) {
        this.ifElseBranchUpdateFunction(0, () => {
          ...
          this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            this.forEachUpdateFunction(elmtId, this.buttons.slice(0, VERTICAL_BUTTON_MAX_COUNT), forEachItemGenFunction, (item) => item.content?.toString() ?? JSON.stringify(item), true, false);
          }, ForEach);
          ForEach.pop();
          Column.pop();
        });
