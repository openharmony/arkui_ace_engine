...
class Util {
    static isSymbolResource(q2) {
        if (!Util.isResourceType(q2)) {
            return false;
        }
        let r2 = q2;
        return r2.type === RESOURCE_TYPE_SYMBOL;
    }
    static isResourceType(p2) {
        if (!p2) {
            return false;
        }
        if (typeof p2 === 'string' || typeof p2 === 'undefined') {
            return false;
        }
        return true;
    }
...
class ContentItemStruct extends ViewPU {
    constructor(s16, t16, u16, v16 = -1, w16 = undefined, x16) {
        ...
        this.__symbolStyle = new SynchedPropertyObjectOneWayPU(t16.symbolStyle, this, "symbolStyle");
    ...
    updateStateVars(q16) {
        ...
        this.__symbolStyle.reset(q16.symbolStyle);
    ...
    purgeVariableDependenciesOnElmtId(p16) {
        ...
        this.__symbolStyle.purgeDependencyOnElmtId(p16);
...
class OperateItemStruct extends ViewPU {
    constructor(x14, y14, z14, a15 = -1, b15 = undefined, c15) {
        ...
        this.__symbolStyle = new SynchedPropertyObjectOneWayPU(y14.symbolStyle, this, "symbolStyle");
    ...
    updateStateVars(v14) {
        ...
        this.__symbolStyle.reset(v14.symbolStyle);
    ...
    purgeVariableDependenciesOnElmtId(u14) {
        ...
        this.__symbolStyle.purgeDependencyOnElmtId(u14);
    ...
    createIcon(g13, h13 = null) {
        this.observeComponentCreation2((k13, l13) => {
            ...
            Button.accessibilityLevel(g13.icon?.accessibilityLevel ?? ACCESSIBILITY_LEVEL_AUTO);
        ...
        this.observeComponentCreation2((i13, j13) => {
            If.create();
            if (g13.icon?.symbolStyle) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((d2, e2) => {
                        SymbolGlyph.create();
                        SymbolGlyph.attributeModifier.bind(this)(g13.icon?.symbolStyle);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((x1, y1) => {
                        If.create();
                        if (Util.isSymbolResource(g13.icon?.value)) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((b2, c2) => {
                                    SymbolGlyph.create(g13.icon?.value);
                                    SymbolGlyph.fontSize(OPERATEITEM_ICONLIKE_SIZE);
                                    SymbolGlyph.effectStrategy(SymbolEffectStrategy.NONE);
                                    SymbolGlyph.focusable(true);
                                    SymbolGlyph.draggable(false);
...
function getAccessibilityText(j) {
    try {
        let p = '';
        if (typeof j === 'string') {
            p = j;
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((o9, p9) => {
                            if (p9) {
                                let q9 = new ContentItemStruct(this, {}, undefined, o9, () => { }, { page: "librarys/composelistitem/src/main/ets/components/composelistitem.ets", line: 1118, col: 11 });
                                ViewPU.create(q9);
                                let c = () => {
                                    return {};
                                };
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((i9, j9) => {
                            if (j9) {
                                ...
                                }, undefined, i9, () => { }, { page: "librarys/composelistitem/src/main/ets/components/composelistitem.ets", line: 1121, col: 11 });
                                ViewPU.create(k9);
                                let b = () => {
                                    return {
                                        icon: this.contentItem?.icon,
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((a9, b9) => {
                            if (b9) {
                                ...
                                }, undefined, a9, () => { }, { page: "librarys/composelistitem/src/main/ets/components/composelistitem.ets", line: 1134, col: 11 });
                                ViewPU.create(c9);
                                let a = () => {
                                    return {
                                        icon: this.operateItem?.icon,
