...
var u;
(function (p1) {
    p1[p1["LEVEL1"] = 1.75] = "LEVEL1";
    p1[p1["LEVEL2"] = 2] = "LEVEL2";
    p1[p1["LEVEL3"] = 3.2] = "LEVEL3";
})(u || (u = {}));
var a1;
(function (k1) {
    k1[k1["FIRST_HEIGHT"] = 48] = "FIRST_HEIGHT";
    k1[k1["SECOND_HEIGHT"] = 56] = "SECOND_HEIGHT";
    k1[k1["THIRD_HEIGHT"] = 64] = "THIRD_HEIGHT";
    k1[k1["FOURTH_HEIGHT"] = 72] = "FOURTH_HEIGHT";
    k1[k1["FIFTH_HEIGHT"] = 96] = "FIFTH_HEIGHT";
})(a1 || (a1 = {}));
const c1 = 1;
const d1 = 2;
const e1 = 4;
...
class b3 extends ViewPU {
    ...
    createButton(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.accessibilityLevel(this.button?.accessibilityLevel ?? o5);
            Button.accessibilityText(n5(this.button?.accessibilityText ?? ''));
            Button.accessibilityDescription(n5(this.button?.accessibilityDescription ?? ''));
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.padding({
    ...
    createIcon(param, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.accessibilityLevel(param.icon?.accessibilityLevel ?? o5);
            Button.accessibilityText(n5(param.icon?.accessibilityText ?? ''));
            Button.accessibilityDescription(n5(param.icon?.accessibilityDescription ?? ''));
            Button.flexShrink(0);
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
    ...
    createArrow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.accessibilityLevel(this.arrow?.accessibilityLevel ?? o5);
            Button.accessibilityText(n5(this.arrow?.accessibilityText ?? ''));
            Button.accessibilityDescription(n5(this.arrow?.accessibilityDescription ?? ''));
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
    ...
    createRadio(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Radio.accessibilityLevel(this.radio?.accessibilityLevel ?? o5);
            Radio.accessibilityText(n5(this.radio?.accessibilityText ?? '', this.radio?.isCheck));
            Radio.accessibilityDescription(n5(this.radio?.accessibilityDescription ?? '', this.radio?.isCheck));
        }, Radio);
    }
    createCheckBox(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Checkbox.accessibilityLevel(this.checkBox?.accessibilityLevel ?? o5);
            Checkbox.accessibilityText(n5(this.checkBox?.accessibilityText ?? '', this.checkBox?.isCheck));
            Checkbox.accessibilityDescription(n5(this.checkBox?.accessibilityDescription ?? '', this.checkBox?.isCheck));
        }, Checkbox);
        Checkbox.pop();
    }
    createSwitch(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.accessibilityLevel(this.switch?.accessibilityLevel ?? o5);
            Toggle.accessibilityText(n5(this.switch?.accessibilityText ?? '', this.switch?.isCheck));
            Toggle.accessibilityDescription(n5(this.switch?.accessibilityDescription ?? '', this.switch?.isCheck));
        }, Toggle);
        Toggle.pop();
        Row.pop();
    }
    createTextArrow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.onClick(this.arrow?.action);
            Button.accessibilityLevel(this.arrow?.accessibilityLevel ?? o5);
            Button.accessibilityText(`${this.text} ${n5(this.arrow?.accessibilityText ?? '')}`);
            Button.accessibilityDescription(n5(this.arrow?.accessibilityDescription ?? ''));
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
...
function n5(resource, selected) {
    try {
        let p5 = getContext().resourceManager.getStringSync(125833934);
        let q5 = '';
        if (typeof resource === 'string') {
            q5 = resource;
        }
        else {
            q5 = getContext().resourceManager.getStringSync(resource);
        }
        return selected ? `${p5},${q5}` : q5;
    }
    catch (error) {
        let code = error.code;
...
export class ComposeListItem extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.p5 = new ObservedPropertySimplePU('', this, "accessibilityTextBuilder");
        this.envCallback = {
    ...
    onPropChange() {
        ...
        ${n5(this.contentItem?.primaryText ?? '')}
        ${n5(this.contentItem?.secondaryText ?? '')}
        ${n5(this.contentItem?.description ?? '')}
      `;
        }
        else {
            this.accessibilityTextBuilder = `
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new z2(this, {}, undefined, elmtId, () => { }, { page: "library/src/main/ets/components/MainPage.ets", line: 1121, d3: 11 });
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "library/src/main/ets/components/MainPage.ets", line: 1124, d3: 11 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        icon: this.contentItem?.icon,
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "library/src/main/ets/components/MainPage.ets", line: 1137, d3: 11 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        icon: this.operateItem?.icon,
