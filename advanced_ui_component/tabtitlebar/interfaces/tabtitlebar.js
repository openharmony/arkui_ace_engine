...
class d1 extends ViewPU {
  constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
    ...
    this.g2 = new ObservedPropertyObjectPU(new ButtonGestureModifier(this.dialogController), this, "buttonGestureModifier");
    this.setInitiallyProvidedValue(params);
...
class c2 extends ViewPU {
  ...
  initialRender() {
    ...
    this.observeComponentCreation2((elmtId, isInitialRender) => {
      ...
      Button.borderRadius(c2.buttonBorderRadius);
      Button.backgroundColor(this.getBgColor());
      Button.onAreaChange((j2, newValue) => {
    ...
    this.dialogController = new CustomDialogController({
      builder: () => {
        let jsDialog = new d2(this, {
          ...
          tabTitleBarDialog: this.item.label ? this.item.label : '',
          fontSize: this.fontSize,
        }, undefined, -1, () => { }, { page: "library/src/main/ets/components/mainpage/TabTitleBar.ets", line: 720, j1: 14 });
        jsDialog.setController(this.dialogController);
        ViewPU.create(jsDialog);
        let paramsLambda = () => {
          return {
