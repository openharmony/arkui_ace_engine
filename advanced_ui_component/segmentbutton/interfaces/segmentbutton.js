...
var __decorate =
  ...
  function (f25, g25, h25, i25) {
    var j25 = arguments.length,
      k25 =
        j25 < 3
          ? g25
          : i25 === null
          ? (i25 = Object.getOwnPropertyDescriptor(g25, h25))
          : i25,
      l25;
  ...
  (SegmentButtonItemOptionsArray_1 = class SegmentButtonItemOptionsArray extends (
    ...
    unshift(...w24) {
      ...
      return super.unshift(
        ...w24.map((x24) => new SegmentButtonItemOptions(x24))
      );
    }
  ...
  (SegmentButtonOptions_1 = class SegmentButtonOptions {
    ...
    constructor(o24) {
      ...
      this.selectedFontColor =
        o24.selectedFontColor ?? segmentButtonTheme.TAB_SELECTED_FONT_COLOR;
      this.fontSize = o24.fontSize ?? segmentButtonTheme.FONT_SIZE;
      this.selectedFontSize =
        o24.selectedFontSize ?? segmentButtonTheme.SELECTED_FONT_SIZE;
      this.fontWeight = o24.fontWeight ?? FontWeight.Regular;
      this.selectedFontWeight = o24.selectedFontWeight ?? FontWeight.Medium;
      this.backgroundColor =
        o24.backgroundColor ?? segmentButtonTheme.BACKGROUND_COLOR;
      this.selectedBackgroundColor =
        o24.selectedBackgroundColor ??
          ...
          this.observeComponentCreation2((y22, z22) => {
            ...
            Stack.shadow(
              resourceToNumber(
                ...
                segmentButtonTheme.SEGMENT_BUTTON_SHADOW,
                0
              )
            );
          }, Stack);
...
class MultiSelectItemArray extends ViewPU {
  constructor(o22, p22, q22, r22 = -1, s22 = undefined, t22) {
    ...
    this.__multiColor = new ObservedPropertyObjectPU(
      Array.from({ length: MAX_ITEM_COUNT }, (u22, v22) => Color.Transparent),
      this,
      'multiColor'
    );
  ...
  onOptionsChange() {
    for (let f22 = 0; f22 < this.selectedIndexes.length; f22++) {
      this.multiColor[this.selectedIndexes[f22]] =
        this.options.selectedBackgroundColor ??
        segmentButtonTheme.CAPSULE_SELECTED_BACKGROUND_COLOR;
    }
  }
  ...
  onSelectedChange() {
    ...
    for (let d22 = 0; d22 < this.selectedIndexes.length; d22++) {
      this.multiColor[this.selectedIndexes[d22]] =
        this.options.selectedBackgroundColor ??
        segmentButtonTheme.CAPSULE_SELECTED_BACKGROUND_COLOR;
    }
  }
  ...
  aboutToAppear() {
    for (let c22 = 0; c22 < this.selectedIndexes.length; c22++) {
      this.multiColor[this.selectedIndexes[c22]] =
        this.options.selectedBackgroundColor ??
        segmentButtonTheme.CAPSULE_SELECTED_BACKGROUND_COLOR;
    }
  }
...
class SegmentButtonItem extends ViewPU {
  ...
  updateStateVars(i21) {
    ...
    this.__isSegmentFocusStyleCustomized.reset(
      i21.isSegmentFocusStyleCustomized
    );
      ...
      if (this.options.showText) {
        this.ifElseBranchUpdateFunction(0, () => {
          this.observeComponentCreation2((p20, q20) => {
            ...
            Text.minFontSize(
              this.isSegmentFocusStyleCustomized ? this.property.fontSize : 9
            );
            ...
            this.ifElseBranchUpdateFunction(0, () => {
              ...
              }, Stack);
              {
                this.observeComponentCreation2(
                  (d19, e19) => {
                    if (e19) {
                      let f19 = new PressAndHoverEffect(
                        this,
                        {
                          pressIndex: z18,
...
class SegmentButtonItemArrayComponent extends ViewPU {
  constructor(j18, k18, l18, m18 = -1, n18 = undefined, o18) {
    ...
    this.__buttonWidth = new ObservedPropertyObjectPU(
      Array.from({ length: MAX_ITEM_COUNT }, (t18, u18) => 0),
      this,
      'buttonWidth'
    );
    this.__buttonHeight = new ObservedPropertyObjectPU(
      Array.from({ length: MAX_ITEM_COUNT }, (r18, s18) => 0),
      this,
      'buttonHeight'
    );
    ...
    this.__isSegmentFocusStyleCustomized = new SynchedPropertySimpleOneWayPU(
      k18.isSegmentFocusStyleCustomized,
      this,
      'isSegmentFocusStyleCustomized'
    );
  ...
  updateStateVars(h18) {
    ...
    this.__isSegmentFocusStyleCustomized.reset(
      h18.isSegmentFocusStyleCustomized
    );
  }
    ...
    if (!(this.options.multiply ?? false)) {
      ...
      for (let j17 = 0; j17 < this.optionsArray.deleteCount; j17++) {
        ...
        let l17 = f17.map((m17) =>
          ...
          m17 > this.optionsArray.changeStartIndex
            ? m17 - 1
            : m17
        );
        if (k17 !== -1) {
      ...
      for (let g17 = 0; g17 < this.optionsArray.addLength; g17++) {
        let h17 = f17.map((i17) =>
          this.optionsArray.changeStartIndex &&
          i17 >= this.optionsArray.changeStartIndex
            ? i17 + 1
            : i17
        );
        f17 = h17;
    ...
    this.observeComponentCreation2((v16, w16) => {
      ...
      Stack.size({
        width:
          this.options.type === 'capsule' &&
          this.buttonItemsSelected[this.focusIndex]
            ? this.buttonWidth[t16] + 8
            : this.buttonWidth[t16],
        height:
          this.options.type === 'capsule' &&
          this.buttonItemsSelected[this.focusIndex]
            ? this.buttonHeight[t16] + 8
            : this.buttonHeight[t16],
      });
  ...
  calculateBorderRadius() {
    ...
    for (let p16 = 0; p16 < this.buttonBorderRadius.length; p16++) {
      ...
      if (this.options.type === 'tab' || !(this.options.multiply ?? false)) {
        o16[p16].topStart = LengthMetrics.vp(
          this.options.iconTextRadius ?? q16
        );
        o16[p16].topEnd = LengthMetrics.vp(this.options.iconTextRadius ?? q16);
        o16[p16].bottomStart = LengthMetrics.vp(
          this.options.iconTextRadius ?? q16
        );
        o16[p16].bottomEnd = LengthMetrics.vp(
          this.options.iconTextRadius ?? q16
        );
      } else {
        if (p16 === 0) {
          ...
          o16[p16].topEnd = LengthMetrics.vp(
            this.options.iconTextRadius ?? q16
          );
                  ...
                  this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((c16, d16) => {
                      ...
                      Button.onSizeChange((h16, i16) => {
                        this.buttonItemsSize[o15] = {
                          width: i16.width,
                          height: this.buttonItemsSize[o15].height,
                        };
                        if (i16.width) {
                          this.buttonItemsPosition[o15] = {
                            start: LengthMetrics.vp(
                              Number.parseFloat(
                                ...
                                (Number.parseFloat(i16.width.toString()) + 1) *
                                  o15
                            ),
                        ...
                        if (
                          ...
                          if (this.selectedIndexes.indexOf(o15) === -1) {
                            ...
                            this.selectedIndexes.splice(
                              this.selectedIndexes.indexOf(o15),
                              1
                            );
                          }
                        } else {
                      ...
                      Button.onTouch((g16) => {
                        ...
                        if (g16.type === TouchType.Down) {
                          ...
                          g16.type === TouchType.Up ||
                          g16.type === TouchType.Cancel
                        ) {
                          Context.animateTo(
                            {
                              curve: curves.interpolatingSpring(10, 1, 410, 38),
                    ...
                    this.observeComponentCreation2((w15, x15) => {
                      ...
                      __Common__.onSizeChange((y15, z15) => {
                        ...
                        for (
                          let b16 = 0;
                          b16 < this.buttonItemsSize.length;
                          b16++
                        ) {
                          this.buttonItemsSize[b16] = {
                            width: this.buttonItemsSize[b16].width,
                            height: a16,
                          };
                        }
                        this.calculateBorderRadius();
...
export class SegmentButton extends ViewPU {
  constructor(j14, k14, l14, m14 = -1, n14 = undefined, o14) {
    ...
    this.__buttonItemsSize = new ObservedPropertyObjectPU(
      Array.from({ length: MAX_ITEM_COUNT }, (d15, e15) => {
        return {};
      }),
      this,
      'buttonItemsSize'
    ...
    this.__buttonItemsSelected = new ObservedPropertyObjectPU(
      Array.from({ length: MAX_ITEM_COUNT }, (z14, a15) => false),
      this,
      'buttonItemsSelected'
    );
    this.addProvidedVar(
    ...
    this.__hoverColorArray = new ObservedPropertyObjectPU(
      Array.from(
        ...
        (p14, q14) => new HoverColorProperty()
      ),
      this,
      'hoverColorArray'
    );
  ...
  setItemsSelected() {
    ...
    if (this.options.type === 'capsule' && (this.options.multiply ?? false)) {
      this.selectedIndexes.forEach(
        (o13) => (this.buttonItemsSelected[o13] = true)
      );
    } else {
  ...
  updateSelectedIndexes() {
    ...
    let m13 = this.selectedIndexes.some((n13) => {
      return (
        n13 === void 0 ||
        n13 < 0 ||
        (this.options.buttons && n13 >= this.options.buttons.length)
      );
    });
    if (m13) {
      if (this.options.type === 'tab') {
  ...
  isMovedFromPanGestureStartPoint(j13, k13) {
    return (
      !nearEqual(j13, this.panGestureStartPoint.x) ||
      !nearEqual(k13, this.panGestureStartPoint.y)
    );
  }
  ...
  isShouldMirror() {
    ...
    try {
      ...
      console.error(
        `Ace SegmentButton getSystemLanguage, error: ${h13.toString()}`
      );
    }
    return false;
  }
    ...
    this.observeComponentCreation2((j12, k12) => {
      ...
      Stack.onKeyEvent((g13) => {
        ...
        if (g13.type === KeyType.Down) {
          if (
            g13.keyCode === KeyCode.KEYCODE_SPACE ||
            g13.keyCode === KeyCode.KEYCODE_ENTER ||
        ...
        for (
          ...
          if (w12 < 0) {
            this.isCurrentPositionSelected =
              x12 === this.selectedIndexes[0] ? true : false;
            break;
          }
        }
      });
      PanGesture.onActionUpdate((o12) => {
        ...
        if (
          ...
          this.isMovedFromPanGestureStartPoint(p12.globalX, p12.globalY)
        ) {
      ...
      PanGesture.onActionEnd((l12) => {
        ...
        if (
          !this.isPanGestureMoved &&
          this.isMovedFromPanGestureStartPoint(m12.globalX, m12.globalY)
        ) {
          this.isPanGestureMoved = true;
        }
        ...
        this.ifElseBranchUpdateFunction(0, () => {
              ...
              this.ifElseBranchUpdateFunction(0, () => {
                {
                  this.observeComponentCreation2(
                    (f12, g12) => {
                      if (g12) {
                        let h12 = new MultiSelectBackground(
                          this,
                          {
                    ...
                    this.ifElseBranchUpdateFunction(0, () => {
                      {
                        this.observeComponentCreation2(
                          (z11, a12) => {
                            if (a12) {
                              let b12 = new PressAndHoverEffectArray(
                                this,
                                {
                                  options: this.options,
              ...
              this.ifElseBranchUpdateFunction(0, () => {
                {
                  this.observeComponentCreation2(
                    (p11, q11) => {
                      if (q11) {
                        let r11 = new MultiSelectItemArray(
                          this,
                          {
                            optionsArray: this.options.buttons,
                            options: this.options,
          ...
          Stack.pop();
          {
            this.observeComponentCreation2(
              (f11, g11) => {
                if (g11) {
                  let h11 = new SegmentButtonItemArrayComponent(
                    this,
                    {
                      pressArray: this.__pressArray,
                      hoverArray: this.__hoverArray,
  ...
  getMaxFontSize() {
    ...
    try {
      ...
      console.error(
        `Ace SegmentButton getMaxFontSize, error: ${c11.toString()}`
      );
      return DEFAULT_MAX_FONT_SCALE;
    }
  }
  ...
  switch (r10.type) {
    ...
    case RESOURCE_TYPE_INTEGER:
      try {
        ...
        console.error(
          `[SegmentButton] get resource error, return defaultValue`
        );
        return s10;
      }
    default:
