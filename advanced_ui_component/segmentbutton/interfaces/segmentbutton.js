...
var j = (this && this.j) || function (x8, target, key, desc) {
...
let SegmentButtonItemOptionsArray = m = class SegmentButtonItemOptionsArray extends Array {
    constructor(u8) {
        ...
        if (typeof u8 !== 'number' && u8 !== void 0) {
            super.push(...u8.map((element) => new SegmentButtonItemOptions(element)));
        }
    }
...
class c1 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.o2 = new SynchedPropertyNesedObjectPU(params.optionsArray, this, "optionsArray");
        this.q2 = new SynchedPropertyNesedObjectPU(params.options, this, "options");
        this.s2 = this.initializeConsume("buttonBorderRadius", "buttonBorderRadius");
        this.t2 = this.initializeConsume("buttonItemsSize", "buttonItemsSize");
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }

    setInitiallyProvidedValue(params) {
        this.o2.set(params.optionsArray);
        this.q2.set(params.options);
    }
                    ...
                    if (index < a1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Stack.backgroundColor(this.options.backgroundColor ?? b1.BACKGROUND_COLOR);
...
class d1 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.o2 = new SynchedPropertyNesedObjectPU(params.optionsArray, this, "optionsArray");
        this.q2 = new SynchedPropertyNesedObjectPU(params.options, this, "options");
        this.u2 = new SynchedPropertyObjectTwoWayPU(params.selectedIndexes, this, "selectedIndexes");
        this.t2 = this.initializeConsume("buttonItemsSize", "buttonItemsSize");
        this.v2 = this.initializeConsume("selectedItemPosition", "selectedItemPosition");
        this.w2 = this.initializeConsume("zoomScaleArray", "zoomScaleArray");
        this.s2 = this.initializeConsume("buttonBorderRadius", "buttonBorderRadius");
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
...
class e1 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.w2 = this.initializeConsume("zoomScaleArray", "zoomScaleArray");
        this.s2 = this.initializeConsume("buttonBorderRadius", "buttonBorderRadius");
        this.z2 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (e8, index) => Color.Transparent), this,
            "multiColor");
        this.setInitiallyProvidedValue(params);
    ...
    onOptionsChange() {
        for (let c8 = 0; c8 < this.selectedIndexes.length; c8++) {
            this.multiColor[this.selectedIndexes[c8]] = this.options.selectedBackgroundColor ??
            b1.u1;
        }
    }
    ...
    onSelectedChange() {
        ...
        for (let a8 = 0; a8 < this.selectedIndexes.length; a8++) {
            this.multiColor[this.selectedIndexes[a8]] = this.options.selectedBackgroundColor ??
            b1.u1;
        }
    }
    ...
    aboutToAppear() {
        for (let z7 = 0; z7 < this.selectedIndexes.length; z7++) {
            this.multiColor[this.selectedIndexes[z7]] = this.options.selectedBackgroundColor ??
            b1.u1;
        }
    }
...
class f1 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.u2 = new SynchedPropertyObjectTwoWayPU(params.selectedIndexes, this, "selectedIndexes");
        this.a3 = new SynchedPropertySimpleTwoWayPU(params.focusIndex, this, "focusIndex");
    ...
    getButtonPadding() {
        ...
        if (this.options.type === 'capsule' && this.options.j2 && this.options.showIcon) {
            return {
...
class i1 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.a3 = this.initializeConsume("focusIndex", "focusIndex");
        this.w2 = this.initializeConsume("zoomScaleArray", "zoomScaleArray");
        ...
        this.s3 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (g7, index) => 0), this, "buttonWidth");
        this.t3 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (f7, index) => 0), this, "buttonHeight");
        this.buttonItemsRealHeight = Array.from({ length: a1 }, (e7, index) => 0);
    ...
    changeSelectedIndexes(t6) {
        if (this.optionsArray.f2 === void 0 || this.optionsArray.deleteCount === void 0 ||
            this.optionsArray.g2 === void 0) {
            return;
        }
        if (!(this.options.multiply ?? false)) {
            ...
            if (this.selectedIndexes[0] < this.optionsArray.f2) {
                return;
            }
            if (this.optionsArray.f2 + this.optionsArray.deleteCount > this.selectedIndexes[0]) {
                ...
                this.selectedIndexes[0] =
                    this.selectedIndexes[0] - this.optionsArray.deleteCount + this.optionsArray.g2;
            }
        } else {
            let u6 = this.selectedIndexes;
            for (let x6 = 0; x6 < this.optionsArray.deleteCount; x6++) {
                let y6 = u6.indexOf(this.optionsArray.f2);
                let indexes = u6.map(value => this.optionsArray.f2 &&
                    (value > this.optionsArray.f2) ? value - 1 : value);
                if (y6 !== -1) {
                    indexes.splice(y6, 1);
                }
                u6 = indexes;
            }
            for (let v6 = 0; v6 < this.optionsArray.g2; v6++) {
                let indexes = u6.map(value => this.optionsArray.f2 &&
                    (value >= this.optionsArray.f2) ? value + 1 : value);
                u6 = indexes;
            }
            this.selectedIndexes = u6;
        }
    }
    ...
    changeFocusIndex(s6) {
        ...
        if (this.focusIndex < this.optionsArray.f2) {
            return;
        }
        if (this.optionsArray.f2 + this.optionsArray.deleteCount > this.focusIndex) {
            this.focusIndex = 0;
        } else {
            this.focusIndex = this.focusIndex - this.optionsArray.deleteCount + this.optionsArray.g2;
        }
    }
    ...
    onOptionsArrayChange() {
        ...
        let r6 = Math.min(this.options.buttons.length, this.buttonItemsSize.length);
        if (this.optionsArray.f2 !== void 0 && this.optionsArray.deleteCount !== void 0 &&
            this.optionsArray.g2 !== void 0) {
            this.changeSelectedIndexes(r6);
            this.changeFocusIndex(r6);
    ...
    calculateBorderRadius() {
        ...
        for (let index = 0; index < this.buttonBorderRadius.length; index++) {
            let n6 = this.buttonItemsSize[index].height / 2;
            if (this.options.type === 'tab' || !(this.options.multiply ?? false)) {
                l6[index].topStart = LengthMetrics.vp(this.options.l2 ?? n6);
                l6[index].topEnd = LengthMetrics.vp(this.options.l2 ?? n6);
                l6[index].bottomStart = LengthMetrics.vp(this.options.l2 ?? n6);
                l6[index].bottomEnd = LengthMetrics.vp(this.options.l2 ?? n6);
            } else {
                if (index === 0) {
                    l6[index].topStart = LengthMetrics.vp(this.options.l2 ?? n6);
                    l6[index].topEnd = LengthMetrics.vp(0);
                    l6[index].bottomStart = LengthMetrics.vp(this.options.l2 ?? n6);
                    l6[index].bottomEnd = LengthMetrics.vp(0);
                } else if (this.options.buttons &&
                    index === Math.min(this.options.buttons.length, this.buttonItemsSize.length) - 1) {
                    l6[index].topStart = LengthMetrics.vp(0);
                    l6[index].topEnd = LengthMetrics.vp(this.options.l2 ?? n6);
                    l6[index].bottomStart = LengthMetrics.vp(0);
                    l6[index].bottomEnd = LengthMetrics.vp(this.options.l2 ?? n6);
                } else {
                    l6[index].topStart = LengthMetrics.vp(0);
                    l6[index].topEnd = LengthMetrics.vp(0);
                                ...
                                if (index < a1) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            Button.onSizeChange((i6, newValue) => {
                                                ...
                                                if (newValue.width) {
                                                    this.buttonItemsPosition[index] = {
                                                        start: LengthMetrics.vp(Number.parseFloat(this.options.n2.toString()) +
                                                            (Number.parseFloat(newValue.width.toString()) + 1) * index),
                                                        top: LengthMetrics.px(Math.floor(this.getUIContext()
                                                            .vp2px(Number.parseFloat(this.options.n2.toString()))))
                                                    };
                                                }
                                            });
                                            ...
                                            Button.onHover((isHover) => {
                                                ...
                                                if (isHover) {
                                                    Context.animateTo({ duration: 250, curve: Curve.Friction }, () => {
                                                        this.hoverColorArray[index].e3 = (b1.w1);
                                                    });
                                                } else {
                                                    Context.animateTo({ duration: 250, curve: Curve.Friction }, () => {
...
export class SegmentButton extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.s2 = new ObservedPropertyObjectPU(Array.from({
            length: a1
        }, (d5, index) => {
            return {
                topStart: LengthMetrics.vp(0),
        ...
        this.addProvidedVar("buttonBorderRadius", this.s2, false);
        this.t2 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (c5, index) => {
            return {};
        }), this, "buttonItemsSize");
        this.addProvidedVar("buttonItemsSize", this.t2, false);
        ...
        this.m3 =
            new ObservedPropertyObjectPU(Array.from({ length: a1 }, (a5, index) => false), this, "buttonItemsSelected");
        this.addProvidedVar("buttonItemsSelected", this.m3, false);
        this.l3 = new ObservedPropertyObjectPU(Array.from({
            length: a1
        }, (z4, index) => new j1()), this, "buttonItemProperty");
        this.addProvidedVar("buttonItemProperty", this.l3, false);
        this.a3 = new ObservedPropertySimplePU(-1, this, "focusIndex");
        this.addProvidedVar("focusIndex", this.a3, false);
        this.v2 = new ObservedPropertyObjectPU({}, this, "selectedItemPosition");
        this.addProvidedVar("selectedItemPosition", this.v2, false);
        this.w2 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (y4, index) => 1.0), this, "zoomScaleArray");
        this.addProvidedVar("zoomScaleArray", this.w2, false);
        this.n3 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (x4, index) => false), this, "pressArray");
        this.q3 = new ObservedPropertyObjectPU(Array.from({ length: a1 }, (w4, index) => false), this, "hoverArray");
        this.r3 = new ObservedPropertyObjectPU(Array.from({
            length: a1
        }, (v4, index) => new g1()), this, "hoverColorArray");
    ...
    isShouldMirror() {
        ...
        try {
            let f4 = t.System.getSystemLanguage();
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TapGesture.onAction((event) => {
                ...
                let b4 = a4.localX;
                let c4 = Math.min(this.options.buttons.length, this.buttonItemsSize.length);
            ...
            PanGesture.onActionStart((event) => {
                ...
                this.isPanGestureMoved = false;
                for (let z3 = 0; z3 < Math.min(this.options.buttons.length, this.buttonItemsSize.length); z3++) {
                    y3 = y3 - this.buttonItemsSize[z3].width;
                    if (y3 < 0) {
                        this.isCurrentPositionSelected = z3 === this.selectedIndexes[0] ? true : false;
                        break;
                    }
                }
            });
            PanGesture.onActionUpdate((event) => {
                ...
                let r3 = q3.localX;
                if (!this.isPanGestureMoved && this.isMovedFromPanGestureStartPoint(q3.globalX, q3.globalY)) {
                    this.isPanGestureMoved = true;
                }
                for (let w3 = 0; w3 < Math.min(this.options.buttons.length, this.buttonItemsSize.length); w3++) {
            ...
            PanGesture.onActionEnd((event) => {
                ...
                if (!this.isPanGestureMoved && this.isMovedFromPanGestureStartPoint(n3.globalX, n3.globalY)) {
                    this.isPanGestureMoved = true;
                }
            ...
            if (this.options !== void 0 && this.options.buttons != void 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                        ...
                        if (this.options.type === 'capsule' && (this.options.multiply ?? false)) {
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Stack.backgroundColor(this.options.backgroundColor ?? b1.BACKGROUND_COLOR);
                                    Stack.borderRadius(this.options.m2 ?? this.componentSize.height / 2);
                                    Stack.backgroundBlurStyle(this.options.backgroundBlurStyle);
                                }, Stack);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    If.create();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        this.options.l2 : this.options.m2) ??
    ...
    updateAnimatedProperty(curve) {
        ...
        this.buttonItemsSelected.forEach((selected, index) => {
            ...
            b1.s1 : this.options.fontSize ?? b1.q1;
