...
extern const char _binary_breadcrumb_abc_start[];
extern const char _binary_breadcrumb_abc_end[];
...
void NAPI_arkui_advanced_Breadcrumb_GetABCCode(const char** buf, int* buflen)
{
    ...
    if (buflen != nullptr) {
        *buflen = _binary_breadcrumb_abc_end - _binary_breadcrumb_abc_start;
    }
}
