...
!function(e){
  const t = "#00000000";
  const o = "#FFFFFF";
  const i = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGAAAABgCAYAAADimHc4AAAAIGNIUk0AAHomAACAhAAA+gAAAIDoAAB1M" +
    "AAA6mAAADqYAAAXcJy6UTwAAAAEZ0FNQQAAsY58+1GTAAAAAXNSR0IArs4c6QAAAAZiS0dEAP8A/wD/oL2nkwAAAAlwSFlzAAAOxAAADsQBlSsO" +
    "GwAAAq9JREFUeNrt2j9rFEEYx/FJziIECwsLCwsJIVhYiISgaIhiioiIlpaCjZ1/qhNUIkHE0negpZggEnwHFgoWFiJicVyRQsQXIHKIvyGzIJK" +
    "bmTW7M7P6/cCvyR3c7fPsPLO7F2MAAAAAAAAAAAAAAAAAAAAAAAAAAF01keAz9ihrymVln/JEua18L7w2V5TrykHltXJTGTb9Ib0EB/JYueWKP6" +
    "Ucd3mh/Ci0+Hfc9z6gTCuHlUvK06ZPnMkEB3Nth78tK89dQ0os/toOfz+kHG36w1I0YNwZs6JsFtaEccVvTYoGrHteW3ajaKoDxbfz/10X94BXy" +
    "oIyO+b1Wbcn2JE0ylT8VeW+5/UtZUn52sUG/FQ23PycG/OeGWXevW+U4cwPFf+MMmjjw3uJDnLkRo2vCTlWQl954Hn9i3Je+djWF+glPNNimlCt" +
    "hJcJLlH7buZPemb+ovKpzS/RS7zcqybMB/aEhZZXwmqg+NXMH7ZdkNQNqJrwLLAxz7Q4jkIzf5iq+LkaUGdjbroJoUvNb674g1SFyNWAOntCU48" +
    "tYq7zzyqfUxYhZwPqNOHYLi9RQ8XfylH8EhpQZ2P+23EUU/zFlGOntAbU2Zjr3qyF7nCrsTPIdeClNCB2Y66zEvoRG26WsVNqA+rerPlWwg3lYe" +
    "Amayl38UtsQBOPLezMfxRxkzUo4WBLbEDsxmxXwinlrRsn+5W7yr1SbrJiTJiy2d+T7Y82K4H32QbsNf7fFeyDtRMlFb/kFVBnY7amXbN8l5oXT" +
    "YtPNf/VBsTuCSZQfPs8/0OJB9eFBuymCXbsnCxlw+1yA2I35j+Lf860/Dz/f2rA73fMdhUc8bzvjXKhxJnftasgH3sJelU5bbb/Z8ee8e/N9j9P" +
    "rZt8P/ADAAAAAAAAAAAAAAAAAAAAAAAgpV9KuZwVm6MIDQAAAABJRU5ErkJggg==";
  const s = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGAAAABgCAYAAADimHc4AAAAIGNIUk0AAHomAACAhAAA+gAAAIDoAAB1M" +
    "AAA6mAAADqYAAAXcJy6UTwAAAAEZ0FNQQAAsY58+1GTAAAAAXNSR0IArs4c6QAAAAZiS0dEAP8A/wD/oL2nkwAAAAlwSFlzAAAOxAAADsQBlSsO" +
    "GwAAAjVJREFUeNrtnCtvG1EQRq+9BlVUEBAYYFBgYGBYaBBoFUVVfkCtyqDAIL8jtI8EBruVIgU4UvMD0iKDPmirtlJglJZUyqzsSFXlxwZsPPP" +
    "tOdJHbDKac+/cXXvtlAAAAAAAAAAAAAAAAAAAAAAUyZzW1bMMLbuWv5YvqgJqTps/sjT+eW1geckOuB+OLdtzpHy3fFQTUHdY06MFr7+xPGMHlE" +
    "93iYQnajvBo4APlj3LRhUkeBRwaRnProDkJXi9DP1ZFQmZ49oqISFzXl9RCb8sFwhYn4Sw9wlZkDplx1EWqFZJCVmwHSsnIZoAuYM5ogCpgzmqA" +
    "JlxFFmAxDiKLiD8OFIQEHocqQgIK0FJwF0kfLZMELA+CTuWI8s1AtYj4YHlt+UcAeVK+JqmX2/OY9Pyat1F1pM2J2n6Fec8mh4KVBdwO27m8RAB" +
    "5dNb0uhPCCiXTpo+zLWItwgoj/bsKmhrwft/PBzAOQ3RlT9a0vycF5ZvHoqtCTZ/vKL5fcuhl4KVRlA7WvOVBOQP875f0fyBt+arnAH52DmNtvJ" +
    "VzoBwM19pBBVp/r7n5kceQa0CYyfE78pqoiu/733lRxUg1fxoZ0BbrfmRzoAiHy+Ea36UEdRRXPlRRlCR5g+iNt/7CGoqr3zvAuRXvucR1CrQ/G" +
    "ES+fMOjzvgQH3seN8B3ao036uASVWan+Pxybgflqf/LY78wH2dBPF6I/bY8txyZXlnOUsAAAAAAAAAAAAAAAAAAAAAEIgb8WKMjSFbuAQAAAAAS" +
    "UVORK5CYII=";
  ...
  }(d = e.TreeListenType || (e.TreeListenType = {}));

  class r {
    constructor() {
      this.appEventBus = new a
    }

    static getInstance() {
      null == AppStorage.Get(this.APP_KEY_EVENT_BUS) && AppStorage.SetOrCreate(this.APP_KEY_EVENT_BUS, new r);
  ...
  r.APP_KEY_EVENT_BUS = "app_key_event_bus";
  e.TreeListenerManager = r;
  ...
  class I {
    constructor(e) {
      ...
      this.menu = e.menu;
      e.icon && (this.nodeItem.imageNode = new A(e.icon, e.selectedIcon, e.editIcon, {
        id: -1,
        type: 10002,
      ...
      e.primaryTitle && (this.nodeItem.mainTitleNode = new S(e.primaryTitle));
      this.children = []
    }

    addImageCollapse(e) {
      if (e) {
        this.nodeItem.imageCollapse = new A(s, null, null, {
          id: -1,
          type: 10002,
  ...
  }(m = e.InteractionStatus || (e.InteractionStatus = {}));

  class A extends u {
    constructor(e, t, o, a, d, r) {
      super();
      this.rightMargin = {
        id: -1,
        type: 10002,
      ...
      this.imageCollapseDownSource = i;
      this.imageCollapseRightSource = s;
    ...
    setImageCollapseSource(e, t) {
      ...
      } else if (e === m.FinishEdit || e === m.FinishDragInsert) {
        this.imageCollapseDownSource = i;
        this.imageCollapseRightSource = s;
        this.isImageCollapse = !0
      }
      this.imageCollapseSource = t == p.Collapse ? this.imageCollapseRightSource : this.imageCollapseDownSource
    }
    ...
    setImageSource(e) {
      switch (e) {
        case m.Normal:
          ...
          break;
        case m.Selected:
          if (this.currentInteractionStatus !== m.Edit) {
  ...
  class C {
    ...
    setNodeItemMainTitle(e) {
      this.nodeItem.mainTitleNode.title = "树视图"
    }
    ...
    handleImageCollapseAfterAddNode(e) {
      if (e) {
        this.nodeItem.imageCollapse = new A(i, null, null, {
          id: -1,
          type: 10002,
          params: ["sys.float.ohos_id_alpha_content_tertiary"],
          bundleName: "",
  ...
  class L extends n {
    constructor() {
      ...
      this.isTouchDown = !1;
      this.appEventBus = r.getInstance().getTreeListener();
      this.isInnerDrag = !1;
      this.isDrag = !1;
    ...
    setImageSource(e, t) {
      ...
      o.setIsSelected(t === m.Selected || t === m.Edit || t === m.FinishEdit);
      null != o.getNodeItem().mainTitleNode && t != m.DragInsert && t != m.FinishDragInsert && o.getNodeItem()
        .mainTitleNode
        .setMainTitleSelected(t === m.Selected || t === m.FinishEdit);
    ...
    clearLastIndexStatus() {
      if (!(-1 == this.lastIndex || this.lastIndex >= this.listNode.length)) {
        this.setImageSource(this.lastIndex, m.Normal);
    ...
    changeNodeStatus(e) {
      ...
      if (this.expandAndCollapseInfo.get(i) == p.Expand) {
        this.expandAndCollapseInfo.set(i, p.Collapse);
        o[t].getNodeItem().imageCollapse.changeImageCollapseSource(p.Collapse)
      } else if (this.expandAndCollapseInfo.get(i) == p.Collapse) {
        this.expandAndCollapseInfo.set(i, p.Expand);
        o[t].getNodeItem().imageCollapse.changeImageCollapseSource(p.Expand)
      }
    }
    ...
    handleExpandAndCollapse(e) {
      ...
      if (o[t].getChildNodeInfo().isHasChildNode && s == p.Collapse) {
      ...
      if (s == p.Expand) for (a = 0; a < d.length; a++) {
        o[d[a]].setNodeIsShow(!0);
        o[d[a]].setListItemHeight(48);
        let e = o[d[a]].getCurrentNodeId();
        this.expandAndCollapseInfo.get(e) == p.Expand && this.handleExpandAndCollapse(d[a])
      }
      d = null;
      this.notifyDataReload()
    }
    ...
    init(e) {
      ...
      this.listNodeUtils.traverseNodeDF((e => {
        if (e.currentNodeId >= 0) {
          ...
          o.getChildNodeInfo().isHasChildNode && this.expandAndCollapseInfo.set(o.getCurrentNodeId(), p.Collapse);
    ...
    refreshRemoveNodeData(e, t) {
      ...
      this.appEventBus.emit(d.NODE_DELETE, [i])
    }
    ...
    refreshAddNodeData(e) {
      ...
      for (let e = 0;e < this.listNode.length; e++) if (this.listNode[e].getNodeCurrentNodeId() == t.getNodeParentNodeId()) {
        ...
        } else this.expandAndCollapseInfo.get(this.listNode[e].getNodeCurrentNodeId()) == p.Collapse && this.changeNodeStatus(o);
        ...
        this.setImageSource(e + 1, m.Edit);
        this.currentOperation = h.ADD_NODE;
        this.notifyDataAdd(e + 1);
        this.notificationNodeInfo(e + 1, this.currentOperation);
        break
      }
      this.modifyNodeIndex = o + 1;
      this.expandAndCollapseInfo.set(t.getNodeParentNodeId(), p.Expand);
    ...
    handleEventDrag(e) {
      this.setImageSource(e, m.Normal);
    ...
    handleEvent(e, t) {
      ...
      e !== l.TOUCH_DOWN && e !== l.TOUCH_UP && e !== l.MOUSE_BUTTON_RIGHT || t != this.lastIndex && this.clearLastIndexStatus();
      ...
      switch (e) {
        ...
        case l.TOUCH_UP: {
          ...
          this.setImageSource(t, m.Selected);
          this.lastIndex = t;
    ...
    notificationNodeInfo(e, t) {
      if (t === h.MODIFY_NODE) {
        ...
        this.appEventBus.emit(d.NODE_MODIFY, [t])
      } else if (t === h.ADD_NODE) {
        ...
        this.appEventBus.emit(d.NODE_ADD, [o])
      }
    }

    finishEditing() {
      if (-1 != this.modifyNodeIndex) {
        this.setImageSource(this.modifyNodeIndex, m.FinishEdit);
        this.setImageCollapseSource(this.modifyNodeIndex, m.FinishEdit);
    ...
    setItemVisibilityOnEdit(e, t) {
      ...
      if (-1 != e) {
        if (t === h.MODIFY_NODE) {
          ...
          this.currentOperation = h.MODIFY_NODE;
          t.setTitleAndInputTextStatus(!0);
          this.setImageSource(o, m.Edit);
          this.setImageCollapseSource(o, m.Edit);
        ...
        if (t === h.COMMIT_NODE) {
          ...
          e.setIsModify(!1);
          this.setImageSource(o, m.FinishEdit);
          this.setImageCollapseSource(o, m.FinishEdit);
          this.notificationNodeInfo(this.modifyNodeIndex, this.currentOperation);
    ...
    setPopUpInfo(e, t, o, i) {
      ...
      if (o) {
        ...
        } else if (e === g.WARNINGS && null != s.getNodeItem().inputText) {
          t === c.INVALID_ERROR ? s.setPopUpText("invalid error") : t === c.LENGTH_ERROR && s.setPopUpText("length error");
    ...
    clearHighLight(e) {
      ...
      this.setImageSource(e, m.FinishDragInsert);
      this.setImageCollapseSource(e, m.FinishDragInsert);
    ...
    setVisibility(e, t, o) {
      ...
      if ((i || o) && this.isInnerDrag) {
        ...
        let i = this.expandAndCollapseInfo.get(o) == p.Expand && this.flag == N.DOWN_FLAG ? this.getData(t)
        ...
        if (this.flag == N.DOWN_FLAG && t < this.totalCount() - 1) {
        ...
        } else if (this.flag == N.UP_FLAG && t < this.totalCount() - 1) {
    ...
    delayHighLightAndExpandNode(e, t, o) {
      ...
      if (s || i) {
        let i = this;
        if (!s && (!this.isInnerDrag || this.expandAndCollapseInfo.get(t) == p.Collapse && this.isInnerDrag || !this.expandAndCollapseInfo.has(t) && this.listNode[e].getIsFolder())) {
        ...
        this.lastTimeoutHighLightId = this.timeoutHighLightId;
        this.lastDelayHighLightIndex = e;
        if (!s && this.expandAndCollapseInfo.get(t) == p.Collapse) {
    ...
    delayHighLight(e) {
      ...
      this.setImageSource(e, m.DragInsert);
      this.setImageCollapseSource(e, m.DragInsert);
      this.notifyDataReload()
    }
    ...
    alterDragNode(e, t, o, i, s, a) {
      let r = [];
      let n = e;
      let l = s;
      let h = a.getNodeInfoData();
      let g = null;
      let c = a.getNodeInfoNode();
      let I = !1;
      let u = this.INITIAL_INVALID_VALUE;
      let m = this.INITIAL_INVALID_VALUE;
      let A = this.flag == N.DOWN_FLAG;
      m = this.getChildIndex(i, s);
      u = this.getChildIndex(e, t);
      u = e != i ? A ? u + 1 : u : u > m ? A ? u : u - 1 : A ? u + 1 : u;
      for (let e = 0;e < this.listNode.length; e++) if (this.listNode[e].getCurrentNodeId() == t) {
        I = this.listNode[e].getIsHighLight();
        if (this.flag == N.DOWN_FLAG && this.expandAndCollapseInfo.get(t) == p.Expand) {
          n = t;
          u = 0
        } else if (this.flag == N.UP_FLAG && this.expandAndCollapseInfo.get(t) == p.Expand && 0 == this.listNode[e].getCanShowFlagLine()) {
          n = t;
          u = 0
        } else if (I) {
          n = t;
      ...
      let S = { currentNodeId: l, parentNodeId: n, childIndex: u };
      this.appEventBus.emit(d.NODE_MOVE, [S]);
      ...
      this.listNodeUtils.removeNode(s, i, this.listNodeUtils.traverseNodeBF);
      let C = t;
      let D = A;
      if (this.expandAndCollapseInfo.get(t) == p.Expand) {
        D = !1;
        this.listNode.forEach((e => {
          e.getCurrentNodeId() == t && 0 == e.getCanShowFlagLine() && (C = e.getNodeInfoNode()
                                                                             .children
                                                                             .length ? e.getNodeInfoNode()
                                                                                         .children[0]
                                                                                         .currentNodeId : this.INITIAL_INVALID_VALUE)
        }))
      } else !this.expandAndCollapseInfo.get(t) && I && this.expandAndCollapseInfo.set(t, p.Expand);
      this.listNodeUtils.addDragNode(r[0].parentId, r[0].currentId, C, D, r[0].data);
      ...
      let L = [...this.listNode];
      this.reloadListNode(this.listNodeUtils, L)
    }
    ...
    reloadListNode(e, t) {
      ...
      this.listNodeUtils.traverseNodeDF((e => {
        if (e.currentNodeId >= 0) {
          ...
          this.expandAndCollapseInfo.get(e.currentNodeId) == p.Expand ? i.getNodeItem()
                                                                          .imageCollapse
                                                                          .changeImageCollapseSource(p.Expand) : this.expandAndCollapseInfo.get(e.currentNodeId) == p.Collapse && i.getNodeItem()
            .imageCollapse
            .changeImageCollapseSource(p.Collapse);
    ...
    initialRender() {
      this.observeComponentCreation(((e, t) => {
        ...
        List.onDragMove((e => {
          ...
          let t = Math.floor(e.getY() / 24) % 2 ? N.DOWN_FLAG : N.UP_FLAG;
          ...
          if (o != this.listNodeDataSource.getLastPassIndex() && this.listNodeDataSource.getIsInnerDrag()) {
            if (this.listNodeDataSource.getIsParentOfInsertNode(s)) {
              ...
              let e = this;
              this.listNodeDataSource.clearTimeOutAboutDelayHighLightAndExpand(T.call(e, s));
              this.listNodeDataSource.setFlag(N.NONE);
              return
            }
          }
          ...
          if (s != this.listNodeDataSource.getDraggingCurrentNodeId()) {
            let e = this;
            this.listNodeDataSource.delayHighLightAndExpandNode(T.call(e, s), s, o)
          }
        }));
        ...
        List.onDrop(((e, t) => {
          ...
          -1 !== this.viewLastIndex && i != this.viewLastIndex && this.listNodeDataSource.handleEventDrag(this.viewLastIndex);
          ...
          if (this.listNodeDataSource.getIsParentOfInsertNode(a)) {
            ...
            this.listNodeDataSource.handleEvent(l.DRAG, t);
            return
          }
          if (this.listNodeDataSource.getExpandAndCollapseInfo(n) == p.Expand) {
            let e = this;
            this.listNodeDataSource.expandAndCollapseNode(T.call(e, n))
          }
          if (this.listNodeDataSource.getExpandAndCollapseInfo(a) == p.Collapse) {
            let e = this;
            let t = T.call(e, a);
          ...
          if (n != a) {
            this.listNodeDataSource.alterDragNode(r, a, s, h, n, d);
            this.listNodeDataSource.hideLastLine()
          } else {
            this.listNodeDataSource.hideLastLine();
          ...
          let g = T.call(this, this.listNodeDataSource.getLastDelayHighLightId());
          ...
          this.listNodeDataSource.handleEvent(l.DRAG, c);
          this.listNodeDataSource.setIsInnerDrag(!1);
          this.listNodeDataSource.notifyDataReload()
        }));
        t || List.pop();
        ...
        const e = e => {
          const i = e;
          {
            ...
            const s = (t, o) => {
              ...
              ListItem.create(r, e);
              ListItem.onFocus((() => {
                this.listNodeDataSource.handleEvent(l.FOCUS, T.call(this, i.getNodeCurrentNodeId()))
              }));
              ListItem.onBlur((() => {
                this.listNodeDataSource.handleEvent(l.BLUR, T.call(this, i.getNodeCurrentNodeId()))
              }));
              ListItem.width("100%");
            ...
            const a = () => {
              this.observeComponentCreation(s);
              this.observeComponentCreation(((e, s) => {
                ...
                i.getNodeIsShow() ? this.ifElseBranchUpdateFunction(0, (() => {
                  this.observeComponentCreation(((e, t) => {
                    ...
                    Column.onMouse((e => {
                      let t = this;
                      let o = T.call(t, i.getNodeCurrentNodeId());
                      if (e.button == MouseButton.Right) {
                        t.listNodeDataSource.handleEvent(l.MOUSE_BUTTON_RIGHT, T.call(t, i.getNodeCurrentNodeId()));
                        this.listTreeViewMenu = i.getMenu();
                        t.listNodeDataSource.setClickIndex(o);
                        t.listNodeDataSource.setPopUpInfo(g.HINTS, c.NONE,!1, o);
                  ...
                  this.observeComponentCreation(((e, t) => {
                    ...
                    Row.onTouch((e => {
                      let t = this;
                      let o = T.call(t, i.getNodeCurrentNodeId());
                      let s = i.getNodeCurrentNodeId();
                      t.listNodeDataSource.setClickIndex(o);
                      if (e.type === TouchType.Down) {
                        this.viewLastIndex = t.listNodeDataSource.getLastIndex();
                        this.touchDownCount++;
                        this.isMultiPress = this.touchDownCount > this.MAX_TOUCH_DOWN_COUNT;
                        this.listNodeDataSource.getIsTouchDown() || t.listNodeDataSource.handleEvent(l.TOUCH_DOWN, o)
                      }
                      if (e.type === TouchType.Up) {
                        this.touchDownCount--;
                        this.touchDownCount < this.MAX_TOUCH_DOWN_COUNT && (this.isMultiPress = !1);
                        let e = { currentNodeId: s };
                        this.appEventBus.emit(d.NODE_CLICK, [e]);
                        t.listNodeDataSource.handleEvent(l.TOUCH_UP, o)
                      }
                      if (-1 !== t.listNodeDataSource.getLastIndex() && o !== t.listNodeDataSource.getLastIndex()) {
                        t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.NONE,!1, t.listNodeDataSource.getLastIndex());
                        t.listNodeDataSource.setItemVisibilityOnEdit(t.listNodeDataSource.getLastIndex(), h.COMMIT_NODE)
                      }
                    }));
                    Row.onHover((e => {
                      let t = this;
                      let o = T.call(t, i.getNodeCurrentNodeId());
                      e ? t.listNodeDataSource.handleEvent(l.HOVER, o) : t.listNodeDataSource.handleEvent(l.HOVER_OVER, o)
                    }));
                    Gesture.create(GesturePriority.Low);
                    TapGesture.create({ count: 2 });
                    TapGesture.onAction((e => {
                      this.listNodeDataSource.expandAndCollapseNode(T.call(this, i.getNodeCurrentNodeId()))
                    }));
                    TapGesture.pop();
                    Gesture.pop();
                    ...
                    i.getNodeItem().mainTitleNode && i.getNodeItem()
                      ...
                      this.observeComponentCreation(((e, t) => {
                        ...
                        TextInput.onChange((e => {
                          let t = this;
                          var o = T.call(t, i.getNodeCurrentNodeId());
                          let s = "";
                          let a = !1;
                          let d = !1;
                          if (t.checkInvalidPattern(e)) {
                            ...
                            a = !0;
                            t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.INVALID_ERROR,!0, o)
                          } else {
                            s = e;
                            a = !1;
                            t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.INVALID_ERROR,!1, o)
                          }
                          if (t.checkIsAllCN(s) && s.length > this.MAX_CN_LENGTH || !t.checkIsAllCN(s) && s.length > this.MAX_EN_LENGTH) {
                            ...
                            d = !0;
                            t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.LENGTH_ERROR,!0, o)
                          } else d = !1;
                          if (!d && !a) {
                            t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.LENGTH_ERROR,!1, o);
                        ...
                        TextInput.onSubmit((e => {
                          let t = this;
                          var o = T.call(t, i.getNodeCurrentNodeId());
                          t.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.NONE,!1, o);
                          t.listNodeDataSource.setItemVisibilityOnEdit(o, h.COMMIT_NODE)
                        }));
                        t || TextInput.pop();
                        ViewStackProcessor.StopGetAccessRecording()
                      }));
            ...
            const r = (e, a) => {
              s(e, a);
              this.updateFuncByElmtId.set(e, s);
              this.observeComponentCreation(((e, s) => {
                ViewStackProcessor.StartGetAccessRecordingFor(e);
                If.create();
                i.getNodeIsShow() ? this.ifElseBranchUpdateFunction(0, (() => {
  ...
  __decorate([], _.prototype, "popupForShowTitle", null);
  __decorate([], _.prototype, "builder", null);
  __decorate([], _.prototype, "draggingPopup", null);
  e.TreeView = _;
  e.TreeController = class {
    ...
    removeNode() {
      ...
      this.listNodeDataSource.refreshData(this.listNodeUtils, h.REMOVE_NODE, t, o);
      this.nodeIdList.splice(this.nodeIdList.indexOf(e), 1)
    }

    modifyNode() {
      let e = this.listNodeDataSource.getClickNodeId();
      this.listNodeDataSource.setItemVisibilityOnEdit(e, h.MODIFY_NODE)
    }
    ...
    add() {
      ...
      this.listNodeDataSource.refreshData(this.listNodeUtils, h.ADD_NODE, e, [o]);
      this.listNodeDataSource.setPopUpInfo(g.WARNINGS, c.NONE,!1, this.listNodeDataSource.getLastIndex());
      this.listNodeDataSource.setItemVisibilityOnEdit(this.listNodeDataSource.getLastIndex(), h.COMMIT_NODE);
      let i = T.call(this, o);
      this.listNodeDataSource.setClickIndex(i);
      this.listNodeDataSource.handleEvent(l.TOUCH_UP, i)
    }
