...
export class ExceptionPrompt extends ViewPU {
    constructor(s1, t1, u1, v1 = -1, w1 = undefined, x1) {
        ...
        this.callbacks = {
            onConfigurationUpdated: (h2) => {
                this.fontSizeScale = Math.min(this.updateFontScale(), 2);
                this.fontSizeScale = Math.max(this.fontSizeScale, 1);
            },
            onMemoryLevel() {
            }
        };
            ...
            if (this.options?.symbolStyle !== undefined) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((e1, f1) => {
                        ...
                        SymbolGlyph.fontSize(`${(this.fontSizeScale ?? 1) * SYMBOL_SIZE}vp`);
                    }, SymbolGlyph);
                });
            } else {
