...
RefPtr<DividerTheme> GetDividerTheme()
{
    ...
    auto dividerTheme =
        node ? themeManager->GetTheme<DividerTheme>(node->GetThemeScopeId()) : themeManager->GetTheme<DividerTheme>();
    return dividerTheme;
}
