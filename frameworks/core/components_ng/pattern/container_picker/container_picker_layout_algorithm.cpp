    ...
    const LayoutConstraintF& layoutConstraint, int32_t startIndex, float startPos, bool cachedLayout)
{
    ...
    do {
        ...
        LOGE("lslsls currentIndex %{public}d currentStartPos %{public}f", currentIndex, currentStartPos);
    ...
    const LayoutConstraintF& layoutConstraint, int32_t endIndex, float endPos, bool cachedLayout)
{
    ...
    do {
        ...
        LOGE("lslsls currentIndex %{public}d currentEndPos %{public}f", currentIndex, currentEndPos);
...
void ContainerPickerLayoutAlgorithm::Layout(LayoutWrapper* layoutWrapper)
{
    ...
    for (auto& pos : itemPosition_) {
        LOGE("lslsls pos %{public}d pos.second.startPos %{public}f", pos.first, pos.second.startPos);
