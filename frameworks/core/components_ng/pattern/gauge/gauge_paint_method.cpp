    ...
    RSCanvas& canvas, RenderRingInfo data, const RefPtr<GaugePaintProperty>& paintProperty) const
{
    ...
    Color color = paintProperty->GetColorsValue().at(0).at(0).first;
    ...
    RSCanvas& canvas, RenderRingInfo data, const RefPtr<GaugePaintProperty>& paintProperty) const
{
    ...
    auto colorsArray = paintProperty->GetColorsValue().at(0);
...
void GaugePaintMethod::DrawIndicator(RSCanvas& canvas, const RenderRingInfo& data) const
{
    RSPath path;
