...
public:
    static void RegisterTextInputAttributes(Local<panda::ObjectRef> object, EcmaVM* vm);
    static bool ParseCreateEditText(EcmaVM* vm, const Local<ObjectRef>& paramObject,
        std::optional<std::u16string>& stringValueOption, Local<JSValueRef>& changeEventVal,
        RefPtr<ResourceObject>& textObject);
    static void ParseTextFieldTextObject(EcmaVM* vm, const Local<JSValueRef>& changeEventVal);
    static ArkUINativeModuleValue CreateTextInput(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static ArkUINativeModuleValue SetShowUnit(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static ArkUINativeModuleValue SetCancelButtonJs(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static ArkUINativeModuleValue SetInputFilterJs(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue ResetInputFilter(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue CreateJsTextFieldCommonEvent(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue SetOnSubmitJs(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static ArkUINativeModuleValue SetPunctuationOverflow(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue ResetPunctuationOverflow(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static bool ParseLayoutPolicy(EcmaVM* vm, ArkUINodeHandle& nativeNode, const Local<JSValueRef> value, bool isWidth);
    ...
    static Local<JSValueRef> JsSetIMEExtraInfo(ArkUIRuntimeCallInfo* info);
    ...
    static ArkUINativeModuleValue SetStrokeJoinStyle(ArkUIRuntimeCallInfo *runtimeCallInfo);
    static ArkUINativeModuleValue ResetStrokeJoinStyle(ArkUIRuntimeCallInfo *runtimeCallInfo);
...
private:
    ...
    static void SetCancelButtonIconJs(EcmaVM* vm, ArkUINodeHandle& nativeNode, Local<ObjectRef>& paramObject);
};
}
