...
void SetTextInputOnChangeEvent(void* callback)
{
    ...
    TextFieldModelNG::SetOnChangeEvent(frameNode, std::move(*onChangeEvent));
}
...
void SetTextInputTextAlignJs(ArkUINodeHandle node, ArkUI_Int32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
...
void ResetTextInputSelectedBackgroundColorJs(ArkUINodeHandle node, void* resRawPtr)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    if (SystemProperties::ConfigChangePerform()) {
    ...
    if (frameNode->GreatOrEqualAPITargetVersion(PlatformVersion::VERSION_TWENTY_SIX)) {
        ...
        if (SystemProperties::ConfigChangePerform() && resRawPtr) {
            auto resourceObject = AceType::Claim(reinterpret_cast<ResourceObject*>(resRawPtr));
            auto pattern = frameNode->GetPattern();
            CHECK_NULL_VOID(pattern);
            pattern->RegisterResource<Color>("selectedBackgroundColor", resourceObject, selectedColor);
        }
        if (selectedColor.GetAlpha() == DEFAULT_ALPHA) {
            // Default setting of 20% opacity
            selectedColor = selectedColor.ChangeOpacity(DEFAULT_OPACITY);
...
void SetTextInputShowUnit(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto unitFunc = reinterpret_cast<std::function<void()>*>(callback);
        TextFieldModelNG::SetShowUnit(frameNode, std::move(*unitFunc));
    } else {
        TextFieldModelNG::SetShowUnit(frameNode, nullptr);
    }
}
...
void SetOnSecurityStateChange(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onSecurityState = reinterpret_cast<std::function<void(bool)>*>(callback);
        TextFieldModelNG::SetOnSecurityStateChange(frameNode, std::move(*onSecurityState));
    } else {
...
void SetTextInputCustomKeyboardFunc(ArkUINodeHandle node, void* callback, bool supportAvoidance)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        ...
        TextFieldModelNG::SetCustomKeyboard(frameNode, std::move(buildFunc), supportAvoidance);
    } else {
        TextFieldModelNG::SetCustomKeyboard(frameNode, nullptr, supportAvoidance);
    }
}
...
void SetTextInputMarginJS(ArkUINodeHandle node)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    TextFieldModelNG::SetMargin(frameNode);
}
    ...
    void* onPrepareMenuCallback, bool isJsView)
{
    ...
    if (isJsView) {
        ...
        TextFieldModelNG::SetSelectionMenuOptions(
            frameNode, std::move(*onCreateMenu), std::move(*onMenuItemClick), std::move(*onPrepareMenu));
        return;
    }
...
void SetLayoutPolicyProperty(ArkUINodeHandle node, ArkUI_Uint32 policy, bool isWidth)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    ViewAbstract::UpdateOnlyLayoutPolicyProperty(frameNode, static_cast<LayoutCalPolicy>(policy), isWidth);
}
...
void SetTextInputTypeImpl(ArkUINodeHandle node, ArkUI_Int32 type)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetType(CastToTextInputType(type));
}

void SetTextInputPlaceholderColorImpl(ArkUINodeHandle node, ArkUI_Uint32 color, void* resRawPtr)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    Color result = Color(color);
    GetTextFieldModelImpl()->SetPlaceholderColor(result);
}

void SetTextInputPlaceholderFontImpl(ArkUINodeHandle node, const struct ArkUIPlaceholderFontType* placeholderFont,
    void* fontSizeRawPtr, void* fontfamilyRawPtr)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    ...
    GetTextFieldModelImpl()->SetPlaceholderFont(font);
}

void SetTextInputEnterKeyTypeImpl(ArkUINodeHandle node, ArkUI_Int32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetEnterKeyType(CastToTextInputAction(value));
}

void SetTextInputTextAlignImpl(ArkUINodeHandle node, ArkUI_Int32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    TextAlign value_textAlign = static_cast<TextAlign>(value);
    GetTextFieldModelImpl()->SetTextAlign(value_textAlign);
}

void SetTextInputStyleImpl(ArkUINodeHandle node, ArkUI_Int32 style)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetInputStyle(static_cast<InputStyle>(style));
}

void SetTextInputCaretColorImpl(ArkUINodeHandle node, ArkUI_Uint32 color, void* colorRawPtr)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    Color result = Color(color);
    GetTextFieldModelImpl()->SetCaretColor(result);
}

void SetTextInputMaxLengthImpl(ArkUINodeHandle node, ArkUI_Uint32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetMaxLength(value);
}

void SetTextInputFontSizeImpl(ArkUINodeHandle node, const struct ArkUILengthType *value, void* resRawPtr)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    CalcDimension fontSize;
    ...
    fontSize.SetUnit(static_cast<DimensionUnit>(value->unit));
    GetTextFieldModelImpl()->SetFontSize(fontSize);
}

void SetTextInputFontWeightStrImpl(ArkUINodeHandle node, ArkUI_CharPtr fontWeight, void* fontWeightRawPtr)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetFontWeight(Framework::ConvertStrToFontWeight(fontWeight));
}

void SetTextInputFontColorImpl(ArkUINodeHandle node, ArkUI_Uint32 color, void* resRawPtr, bool isCapi)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    Color result = Color(color);
    GetTextFieldModelImpl()->SetTextColor(result);
}

void SetTextInputFontStyleImpl(ArkUINodeHandle node, ArkUI_Uint32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetFontStyle(static_cast<Ace::FontStyle>(value));
}

void SetTextInputFontFamilyImpl(ArkUINodeHandle node, ArkUI_CharPtr* fontFamilies, ArkUI_Uint32 length, void* resRawPtr)
{
    CHECK_NULL_VOID(fontFamilies);
    if (length <= 0) {
        return;
    ...
    GetTextFieldModelImpl()->SetFontFamily(families);
}

void SetTextInputOnEditChangeImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onEditChange = reinterpret_cast<std::function<void(bool)>*>(callback);
        GetTextFieldModelImpl()->SetOnEditChanged(std::move(*onEditChange));
    } else {
        GetTextFieldModelImpl()->SetOnEditChanged(nullptr);
    }
}

void SetTextInputOnSubmitWithEventImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onSubmit = reinterpret_cast<std::function<void(int32_t, NG::TextFieldCommonEvent&)>*>(callback);
        GetTextFieldModelImpl()->SetOnSubmit(std::move(*onSubmit));
    } else {
        GetTextFieldModelImpl()->SetOnSubmit(std::function<void(int32_t, NG::TextFieldCommonEvent&)>());
    }
}

void SetTextInputOnChangeImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onChange = reinterpret_cast<std::function<void(const ChangeValueInfo&)>*>(callback);
        GetTextFieldModelImpl()->SetOnChange(std::move(*onChange));
    } else {
        GetTextFieldModelImpl()->SetOnChange(nullptr);
    }
}

void SetTextInputOnCopyImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onCopy = reinterpret_cast<std::function<void(const std::u16string&)>*>(callback);
        GetTextFieldModelImpl()->SetOnCopy(std::move(*onCopy));
    } else {
        GetTextFieldModelImpl()->SetOnCopy(nullptr);
    }
}

void SetTextInputOnCutImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onCut = reinterpret_cast<std::function<void(const std::u16string&)>*>(callback);
        GetTextFieldModelImpl()->SetOnCut(std::move(*onCut));
    } else {
        GetTextFieldModelImpl()->SetOnCut(nullptr);
    }
}

void SetTextInputOnPasteImpl(ArkUINodeHandle node, void* callback)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    if (callback) {
        auto onPasteWithEvent = reinterpret_cast<std::function<void(
                const std::u16string&, NG::TextCommonEvent&)>*>(callback);
        GetTextFieldModelImpl()->SetOnPasteWithEvent(std::move(*onPasteWithEvent));
    } else {
        GetTextFieldModelImpl()->SetOnPasteWithEvent(nullptr);
    }
}

void SetTextInputCopyOptionImpl(ArkUINodeHandle node, ArkUI_Int32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetCopyOption(static_cast<CopyOptions>(value));
}

void SetTextInputBackgroundColorWithColorSpaceImpl(ArkUINodeHandle node, ArkUI_Uint32 color,
    ArkUI_Int32 colorSpace, void* resRawPtr)
{
    auto* frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetTextInputShowPasswordIconImpl(ArkUINodeHandle node, ArkUI_Uint32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetShowPasswordIcon(static_cast<bool>(value));
}

void SetTextInputMaxLinesImpl(ArkUINodeHandle node, ArkUI_Int32 value)
{
    auto *frameNode = reinterpret_cast<FrameNode *>(node);
    CHECK_NULL_VOID(frameNode);
    GetTextFieldModelImpl()->SetMaxLines(static_cast<uint32_t>(value));
}
void SetTextInputOnChangeEventImpl(void* callback)
{
    return;
}
...
CHECK_INITIALIZED_FIELDS_BEGIN(); // don't move this line
        static const ArkUITextInputModifier modifier = {
            .createTextInput = CreateTextInputImpl,
            .setTextInputOnChangeEvent = SetTextInputOnChangeEventImpl,
            .setTextInputFocusableAndFocusNode = SetTextInputFocusableAndFocusNodeImpl,
            ...
            .setTextInputMaxLines = SetTextInputMaxLinesImpl,
            .resetTextInputMaxLines = nullptr,
            .setTextInputPlaceholderColor = SetTextInputPlaceholderColorImpl,
            .resetTextInputPlaceholderColor = nullptr,
            .setTextInputCaretPosition = nullptr,
            .resetTextInputCaretPosition = nullptr,
            .setTextInputCopyOption = SetTextInputCopyOptionImpl,
            .resetTextInputCopyOption = nullptr,
            .setTextInputShowPasswordIcon = SetTextInputShowPasswordIconImpl,
            .resetTextInputShowPasswordIcon = nullptr,
            .setTextInputPasswordIcon = nullptr,
            .resetTextInputPasswordIcon = nullptr,
            .setTextInputTextAlign = SetTextInputTextAlignImpl,
            .setTextInputTextAlignJs = nullptr,
            .resetTextInputTextAlign = nullptr,
            .setTextInputStyle = SetTextInputStyleImpl,
            .resetTextInputStyle = nullptr,
            .setTextInputSelectionMenuHidden = nullptr,
            .resetTextInputSelectionMenuHidden = nullptr,
            .setTextInputShowUnderline = nullptr,
            .resetTextInputShowUnderline = nullptr,
            .setTextInputCaretStyle = nullptr,
            .resetTextInputCaretStyle = nullptr,
            .setTextInputEnableKeyboardOnFocus = nullptr,
            .resetTextInputEnableKeyboardOnFocus = nullptr,
            .setTextInputBarState = nullptr,
            .resetTextInputBarState = nullptr,
            .setTextInputEnterKeyType = SetTextInputEnterKeyTypeImpl,
            .resetTextInputEnterKeyType = nullptr,
            .setTextInputFontWeight = nullptr,
            .resetTextInputFontWeight = nullptr,
            .setTextInputFontSize = SetTextInputFontSizeImpl,
            .resetTextInputFontSize = nullptr,
            .setTextInputMaxLength = SetTextInputMaxLengthImpl,
            .resetTextInputMaxLength = nullptr,
            .setTextInputSelectedBackgroundColor = nullptr,
            .resetTextInputSelectedBackgroundColor = nullptr,
            .resetTextInputSelectedBackgroundColorJs = nullptr,
            .setTextInputShowError = nullptr,
            .resetTextInputShowError = nullptr,
            .setTextInputShowUnit = nullptr,
            .setTextInputPlaceholderFont = SetTextInputPlaceholderFontImpl,
            .resetTextInputPlaceholderFont = nullptr,
            .setTextInputFontColor = SetTextInputFontColorImpl,
            .resetTextInputFontColor = nullptr,
            .setTextInputFontStyle = SetTextInputFontStyleImpl,
            .resetTextInputFontStyle = nullptr,
            .setTextInputFontFamily = SetTextInputFontFamilyImpl,
            .resetTextInputFontFamily = nullptr,
            .setTextInputPlaceholderString = nullptr,
            .setTextInputTextString = nullptr,
            .setTextInputFontWeightStr = SetTextInputFontWeightStrImpl,
            .stopTextInputTextEditing = nullptr,
            .setTextInputCancelButton = nullptr,
            .resetTextInputCancelButton = nullptr,
            .getTextInputPlaceholder = nullptr,
            .getTextInputText = nullptr,
            .getTextInputCaretColor = nullptr,
            .getTextInputCaretStyle = nullptr,
            .getTextInputShowUnderline = nullptr,
            .getTextInputMaxLength = nullptr,
            .getTextInputEnterKeyType = nullptr,
            .getTextInputPlaceholderColor = nullptr,
            .getTextInputPlaceholderFont = nullptr,
            .getTextInputRequestKeyboardOnFocus = nullptr,
            .getTextInputType = nullptr,
            .getTextInputSelectedBackgroundColor = nullptr,
            .getTextInputShowPasswordIcon = nullptr,
            .getTextInputEditing = nullptr,
            .getTextInputShowCancelButton = nullptr,
            .getTextInputCancelIconSize = nullptr,
            .getTextInputTextCancelIconSrc = nullptr,
            .getTextInputTextCancelIconColor = nullptr,
            .getTextInputTextAlign = nullptr,
            .getTextInputFontColor = nullptr,
            .getTextInputFontStyle = nullptr,
            .getTextInputFontWeight = nullptr,
            .getTextInputFontSize = nullptr,
            ...
            .setTextInputHalfLeading = nullptr,
            .resetTextInputHalfLeading = nullptr,
            .setTextInputPasswordRules = nullptr,
            .resetTextInputPasswordRules = nullptr,
            .setTextInputEnableAutoFill = nullptr,
            .resetTextInputEnableAutoFill = nullptr,
            .setTextInputPadding = nullptr,
            .resetTextInputPadding = nullptr,
            .setTextInputFontFeature = nullptr,
            .resetTextInputFontFeature = nullptr,
            .setTextInputDecoration = nullptr,
            .resetTextInputDecoration = nullptr,
            .getTextInputDecoration = nullptr,
            .setTextInputLetterSpacing = nullptr,
            .resetTextInputLetterSpacing = nullptr,
            .setTextInputLineHeight = nullptr,
            .resetTextInputLineHeight = nullptr,
            .setTextInputNormalUnderlineColor = nullptr,
            .setTextInputUserUnderlineColor = nullptr,
            .resetTextInputUserUnderlineColor = nullptr,
            .setTextInputWordBreak = nullptr,
            .resetTextInputWordBreak = nullptr,
            .setTextInputPlaceholderFontEnum = nullptr,
            .setTextInputAdaptMinFontSize = nullptr,
            .resetTextInputAdaptMinFontSize = nullptr,
            .setTextInputAdaptMaxFontSize = nullptr,
            .resetTextInputAdaptMaxFontSize = nullptr,
            .setTextInputHeightAdaptivePolicy = nullptr,
            .resetTextInputHeightAdaptivePolicy = nullptr,
            .setTextInputTextOverflow = nullptr,
            .resetTextInputTextOverflow = nullptr,
            .getTextInputTextOverflow = nullptr,
            .setTextInputTextIndent = nullptr,
            .resetTextInputTextIndent = nullptr,
            .setTextInputOnWillChange = nullptr,
            .resetTextInputOnWillChange = nullptr,
            .getTextInputSelectionMenuHidden = nullptr,
            .getTextInputWordBreak = nullptr,
            .getTextInputEnableAutoFill = nullptr,
            .setTextInputContentType = nullptr,
            .resetTextInputContentType = nullptr,
            .getTextInputContentType = nullptr,
            .getTextInputUserUnderlineColor = nullptr,
            .getTextInputPasswordRules = nullptr,
            .getTextInputSelectAll = nullptr,
            .setTextInputInputFilter = nullptr,
            .getTextInputInputFilter = nullptr,
            .resetTextInputInputFilter = nullptr,
            .getTextInputCaretIndex = nullptr,
            .getTextInputCaretOffset = nullptr,
            .getTextInputStyle = nullptr,
            .getTextInputContentRect = nullptr,
            .getTextInputContentLinesNum = nullptr,
            .setBlurOnSubmit = nullptr,
            .getBlurOnSubmit = nullptr,
            .getTextInputAdaptMinFontSize = nullptr,
            .getTextInputAdaptMaxFontSize = nullptr,
            .getTextInputLineHeight = nullptr,
            .getTextInputHalfLeading = nullptr,
            .getTextInputMaxLines = nullptr,
            .getTextInputFontFeature = nullptr,
            .setTextInputCustomKeyboardFunc = nullptr,
            .setTextInputCustomKeyboard = nullptr,
            .getTextInputCustomKeyboard = nullptr,
            .getTextInputCustomKeyboardOption = nullptr,
            .resetTextInputCustomKeyboard = nullptr,
            .setTextInputSelectAll = nullptr,
            .resetTextInputSelectAll = nullptr,
            .setTextInputShowCounter = nullptr,
            .resetTextInputShowCounter = nullptr,
            .setTextInputOnEditChange = SetTextInputOnEditChangeImpl,
            .resetTextInputOnEditChange = nullptr,
            .setOnSecurityStateChange = nullptr,
            .setTextInputFilter = nullptr,
            .resetTextInputFilter = nullptr,
            .setTextInputOnSubmitWithEvent = SetTextInputOnSubmitWithEventImpl,
            .resetTextInputOnSubmitWithEvent = nullptr,
            .setTextInputOnChange = SetTextInputOnChangeImpl,
            .resetTextInputOnChange = nullptr,
            .setTextInputOnTextSelectionChange = nullptr,
            .resetTextInputOnTextSelectionChange = nullptr,
            .setTextInputOnContentScroll = nullptr,
            .resetTextInputOnContentScroll = nullptr,
            .setTextInputOnWillCopy = nullptr,
            .resetTextInputOnWillCopy = nullptr,
            .setTextInputOnCopy = SetTextInputOnCopyImpl,
            .resetTextInputOnCopy = nullptr,
            .setTextInputOnWillCut = nullptr,
            .resetTextInputOnWillCut = nullptr,
            .setTextInputOnCut = SetTextInputOnCutImpl,
            ...
            .setTextInputNumberOfLines = nullptr,
            .getTextInputNumberOfLines = nullptr,
            .resetTextInputNumberOfLines = nullptr,
            .setTextInputShowPassword = nullptr,
            .resetTextInputShowPassword = nullptr,
            .getTextInputShowPassword = nullptr,
            .setTextInputLineBreakStrategy = nullptr,
            .resetTextInputLineBreakStrategy = nullptr,
            .setTextInputMargin = nullptr,
            .setTextInputMarginJS = nullptr,
            .resetTextInputMargin = nullptr,
            ...
            .setLayoutPolicyProperty = nullptr,
            .setTextInputWidth = nullptr,
            .resetTextInputWidth = nullptr,
            .setTextInputCancelSymbolIcon = nullptr,
            .resetTextInputCancelSymbolIcon = nullptr,
            .setTextInputEnableHapticFeedback = nullptr,
            .resetTextInputEnableHapticFeedback = nullptr,
            .setTextInputAutoCapitalizationMode = nullptr,
            .resetTextInputAutoCapitalizationMode = nullptr,
            .getTextInputLetterSpacing = nullptr,
            .getTextInputEnablePreviewText = nullptr,
            .setEllipsisMode = nullptr,
            .resetEllipsisMode = nullptr,
            .getEllipsisMode = nullptr,
            .setTextInputMinFontScale = nullptr,
            .resetTextInputMinFontScale = nullptr,
            .setTextInputMaxFontScale = nullptr,
            .resetTextInputMaxFontScale = nullptr,
            .setStopBackPress = nullptr,
            .resetStopBackPress = nullptr,
            .setTextInputKeyboardAppearance = nullptr,
            .getTextInputKeyboardAppearance = nullptr,
            .resetTextInputKeyboardAppearance = nullptr,
            .setTextInputStrokeWidth = nullptr,
            .resetTextInputStrokeWidth = nullptr,
            .getTextInputStrokeWidth = nullptr,
            .setTextInputStrokeColor = nullptr,
            .resetTextInputStrokeColor = nullptr,
            .getTextInputStrokeColor = nullptr,
            .setTextInputEnableAutoFillAnimation = nullptr,
            .getTextInputEnableAutoFillAnimation = nullptr,
            .resetTextInputEnableAutoFillAnimation = nullptr,
            .setEnableAutoSpacing = nullptr,
            .resetEnableAutoSpacing = nullptr,
            .resetTextInputOnSecurityStateChange = nullptr,
            .getTextInputShowCounterOptions = nullptr,
            .scrollToVisible = nullptr,
            .setTextInputOnWillAttachIME = nullptr,
            .resetTextInputOnWillAttachIME = nullptr,
            .textInputDeleteBackward = nullptr,
            .setTextInputOrphanCharOptimization = nullptr,
            .getTextInputOrphanCharOptimization = nullptr,
            .resetTextInputOrphanCharOptimization = nullptr,
            .setTextInputCompressLeadingPunctuation = nullptr,
            .resetTextInputCompressLeadingPunctuation = nullptr,
            .getTextInputCompressLeadingPunctuation = nullptr,
            .setTextInputPunctuationOverflow = nullptr,
            .resetTextInputPunctuationOverflow = nullptr,
            .getTextInputPunctuationOverflow = nullptr,
            .setTextInputDirection = nullptr,
            .getTextInputDirection = nullptr,
            .resetTextInputDirection = nullptr,
            .setIncludeFontPadding = nullptr,
            .resetIncludeFontPadding = nullptr,
            .getIncludeFontPadding = nullptr,
            .setFallbackLineSpacing = nullptr,
            .resetFallbackLineSpacing = nullptr,
            .getFallbackLineSpacing = nullptr,
            .setTextInputSelectedDragPreviewStyle = nullptr,
            .resetTextInputSelectedDragPreviewStyle = nullptr,
            .getTextInputSelectedDragPreviewStyle = nullptr,
            .setTextInputStrokeJoinStyle = nullptr,
            .resetTextInputStrokeJoinStyle = nullptr,
            .setTextInputLinearGradient = nullptr,
            .getTextInputLinearGradient = nullptr,
            .setTextInputRadialGradient = nullptr,
            .getTextInputRadialGradient = nullptr,
            .resetTextInputGradient = nullptr,
    ...
    static const ArkUITextInputModifier modifier = {
        ...
        .setTextInputOnChangeEvent = SetTextInputOnChangeEvent,
        .setTextInputFocusableAndFocusNode = SetTextInputFocusableAndFocusNode,
        ...
        .setTextInputTextAlignJs = SetTextInputTextAlignJs,
        ...
        .resetTextInputSelectedBackgroundColorJs = ResetTextInputSelectedBackgroundColorJs,
        .setTextInputShowError = SetTextInputShowError,
        .resetTextInputShowError = ResetTextInputShowError,
        .setTextInputShowUnit = SetTextInputShowUnit,
        ...
        .setTextInputCustomKeyboardFunc = SetTextInputCustomKeyboardFunc,
        ...
        .setOnSecurityStateChange = SetOnSecurityStateChange,
        ...
        .setTextInputMarginJS = SetTextInputMarginJS,
        ...
        .setLayoutPolicyProperty = SetLayoutPolicyProperty,
