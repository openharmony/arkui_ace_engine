...
bool PickerColumnPattern::CanMove(bool isDown) const
{
    ...
    CHECK_NULL_RETURN(host, false);
    auto pattern = host->GetPattern<PickerColumnPattern>();
    int totalOptionCount = pattern->GetOptionCount();
    int currentIndex = static_cast<int>(pattern->GetCurrentIndex());
...
const Color& PickerColumnPattern::GetButtonHoverColor() const
{
