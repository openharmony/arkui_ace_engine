...
struct TextSpanOptions : NG::SpanOptionBase {
    std::optional<int32_t> offset;
    std::string value;
    std::optional<TextStyle> style;
    std::optional<UpdateParagraphStyle> paraStyle;
    NG::UserGestureOptions userGestureOption;
    bool hasResourceFontColor = false;
    bool hasResourceDecorationColor = false;
...
struct SymbolSpanOptions : NG::SpanOptionBase {
    std::optional<int32_t> offset;
    uint32_t symbolId;
    std::optional<TextStyle> style;
...
public:
    virtual int32_t AddImageSpan(const NG::ImageSpanOptions& options) = 0;
    ...
    virtual int32_t AddPlaceholderSpan(const RefPtr<NG::UINode>& customNode, const NG::SpanOptionBase& options) = 0;
    ...
    virtual void UpdateSpanStyle(int32_t start, int32_t end, TextStyle textStyle, NG::ImageSpanAttribute imageStyle) = 0;
