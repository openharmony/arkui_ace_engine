...
RefPtr<LayoutWrapper> MeasureLayoutChild::GetChildByIndex() const
{
    return parent_->GetChildByIndex(index_);
}
RefPtr<LayoutWrapper> MeasureLayoutChild::GetOrCreateChildByIndex() const
{
...
void MeasureLayoutChild::MarkLayouted()
{
    parent_->AddLayouted(index_);
}
