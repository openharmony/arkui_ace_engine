...
std::optional<Converter::PickerValueType> ProcessBindableValue(
    FrameNode* frameNode, const Opt_Union_BindableResourceStr_BindableResourceStrArray& value)
{
    ...
    Converter::VisitUnion(
        ...
        [&result, frameNode](const Ark_BindableResourceStr& src) {
            Converter::VisitUnion(
                src,
                [&result](
                    const Ark_ResourceStr& src) { result = Converter::OptConvert<Converter::PickerValueType>(src); },
        ...
        [&result, frameNode](const Ark_BindableResourceStrArray& src) {
            Converter::VisitUnion(
                src,
                [&result](
                    const Array_ResourceStr& src) { result = Converter::OptConvert<Converter::PickerValueType>(src); },
...
std::optional<Converter::PickerSelectedType> ProcessBindableSelected(
    FrameNode* frameNode, const Opt_Union_I32_Array_I32_Bindable_I32_Bindable_Array_I32& value)
{
...
void ValidateSelectedValues(std::vector<uint32_t>& selectedValues, std::vector<std::string>& values, uint32_t index,
    bool isHasSelectAttr, std::vector<std::string>& resultStr)
{
...
void ValidateSingleTextPickerOptions(TextPickerOptions& options)
{
    ...
    if (!options.hasSelected) {
        ...
        auto valueIterator = std::find_if(options.range.begin(), options.range.end(),
            [value](const NG::RangeContent& rangeContrent) -> bool { return rangeContrent.text_.compare(value) == 0; });
...
void ProcessCascadeSelected(const std::vector<OHOS::Ace::NG::TextCascadePickerOptions>& options, uint32_t index,
...
void SetMultiRange(FrameNode* frameNode, const Opt_Union_I32_Array_I32* value)
{
    ...
    auto count =
        TextPickerModelStatic::IsCascade(frameNode) ? TextPickerModelStatic::GetMaxCount(frameNode) : options.size();
...
void SetTextPickerOptionsImpl(Ark_NativePointer node, const Opt_TextPickerOptions* options)
{
...
void SetDefaultPickerItemHeightImpl(Ark_NativePointer node, const Opt_Union_F64_String* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetCanLoopImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetDisappearTextStyleImpl(Ark_NativePointer node, const Opt_Union_PickerTextStyle_TextPickerTextStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetTextStyleImpl(Ark_NativePointer node, const Opt_Union_PickerTextStyle_TextPickerTextStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto context = frameNode->GetContext();
...
void SetSelectedTextStyleImpl(Ark_NativePointer node, const Opt_Union_PickerTextStyle_TextPickerTextStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto context = frameNode->GetContext();
...
void SetDisableTextStyleAnimationImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<bool>(value);
...
void SetDefaultTextStyleImpl(Ark_NativePointer node, const Opt_TextPickerTextStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<PickerTextStyle>(value);
...
void SetOnChangeImpl(Ark_NativePointer node, const Opt_OnTextPickerChangeCallback* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    ...
    auto onChange = [arkCallback = CallbackHelper(*optValue)](
                        const std::vector<std::string>& values, const std::vector<double>& selecteds) {
...
void SetOnScrollStopImpl(Ark_NativePointer node, const Opt_TextPickerScrollStopCallback* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
...
void SetOnEnterSelectedAreaImpl(Ark_NativePointer node, const Opt_TextPickerEnterSelectedAreaCallback* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
    ...
    auto onEnterSelectedArea = [arkCallback = CallbackHelper(*optValue)](
                                   const std::vector<std::string>& values, const std::vector<double>& selecteds) {
        Array_String stringArrayValues = Converter::ArkValue<Array_String>(values, Converter::FC);
        auto value = Converter::ArkUnion<Ark_Union_String_Array_String, Array_String>(stringArrayValues);
...
void SetSelectedIndexImpl(Ark_NativePointer node, const Opt_Union_I32_Array_I32* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetDividerImpl(Ark_NativePointer node, const Opt_DividerOptions* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto context = frameNode->GetContext();
...
void SetGradientHeightImpl(Ark_NativePointer node, const Opt_Dimension* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
