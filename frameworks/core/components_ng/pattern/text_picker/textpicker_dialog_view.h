...
private:
    ...
    static void SetFirstDividerNodeActive(RefPtr<UINode>& contentRow);
    static void SetSecondDividerNodeActive(RefPtr<UINode>& contentRow);
    static void SetThirdDividerNodeActive(RefPtr<UINode>& contentRow);
