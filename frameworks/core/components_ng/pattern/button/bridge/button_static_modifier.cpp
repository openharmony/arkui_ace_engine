...
{
    static const GENERATED_ArkUIButtonContentModifier modifier = {
        .contentModifierButtonImpl = ContentModifierButtonImpl,
        .resetContentModifierButtonImpl = ResetContentModifierButtonImpl,
    };
    return &modifier;
}
