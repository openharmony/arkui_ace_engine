...
constexpr int32_t SHEET_MAIN_TITLE_MAX_LINES = 2;
constexpr int32_t SHEET_SUB_TITLE_MAX_LINES = 1;
constexpr Dimension MIN_MAIN_TITLE_FONT_SIZE = 14.0_fp;
constexpr Dimension MIN_SUB_TITLE_FONT_SIZE = 10.0_vp;
} // namespace
