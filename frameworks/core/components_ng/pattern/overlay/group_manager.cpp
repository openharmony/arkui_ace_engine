...
void GroupManager::AddCheckBoxToGroup(const std::string& group, int32_t checkboxId)
{
    checkBoxGroupNotify_[group].push_back(checkboxId);
}

void GroupManager::AddCheckBoxGroupToGroup(const std::string& group, int32_t checkBoxId)
{
...
std::unordered_map<std::string, std::list<WeakPtr<FrameNode>>> GroupManager::GetCheckBoxGroupMap()
{
