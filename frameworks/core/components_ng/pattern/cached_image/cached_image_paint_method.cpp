...
void CachedImagePaintMethod::UpdateBorderRadius(PaintWrapper* paintWrapper)
{
    ...
    BorderRadiusArray radiusXY = {
        PointF(borderRadius->radiusTopLeft.value_or(Dimension()).ConvertToPx(),
            borderRadius->radiusTopLeft.value_or(Dimension()).ConvertToPx()),
        PointF(borderRadius->radiusTopRight.value_or(Dimension()).ConvertToPx(),
            borderRadius->radiusTopRight.value_or(Dimension()).ConvertToPx()),
        PointF(borderRadius->radiusBottomLeft.value_or(Dimension()).ConvertToPx(),
            borderRadius->radiusBottomLeft.value_or(Dimension()).ConvertToPx()),
        PointF(borderRadius->radiusBottomRight.value_or(Dimension()).ConvertToPx(),
            borderRadius->radiusBottomRight.value_or(Dimension()).ConvertToPx())
    };
...
void CachedImagePaintMethod::UpdatePaintConfig(
    const RefPtr<ImageRenderProperty>& renderProps, PaintWrapper* paintWrapper)
{
    auto&& config = canvasImage_->GetPaintConfig();
...
CanvasDrawFunction CachedImagePaintMethod::GetContentDrawFunction(PaintWrapper* paintWrapper)
{
    ...
    return [imagePainter, contentSize](RSCanvas& canvas) {
