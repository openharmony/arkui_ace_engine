...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_BUBBLE_BRIDGE_BUBBLE_DYNAMIC_MODULE_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_BUBBLE_BRIDGE_BUBBLE_DYNAMIC_MODULE_H

#include "core/common/dynamic_module.h"

namespace OHOS::Ace {

class BubbleDynamicModule : public DynamicModule {
public:
    BubbleDynamicModule() = default;
    ~BubbleDynamicModule() = default;
...
#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_BUBBLE_BRIDGE_BUBBLE_DYNAMIC_MODULE_H
