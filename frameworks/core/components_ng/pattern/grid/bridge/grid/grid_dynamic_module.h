...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_GRID_BRIDGE_GRID_GRID_DYNAMIC_MODULE_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_GRID_BRIDGE_GRID_GRID_DYNAMIC_MODULE_H

#include "core/common/dynamic_module.h"

namespace OHOS::Ace {

class GridDynamicModule : public DynamicModule {
public:
    GridDynamicModule() = default;
    ~GridDynamicModule() = default;
...
#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_GRID_BRIDGE_GRID_GRID_DYNAMIC_MODULE_H
