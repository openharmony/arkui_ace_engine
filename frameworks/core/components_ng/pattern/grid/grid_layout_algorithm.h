...
class ACE_EXPORT GridLayoutAlgorithm : public BoxLayoutAlgorithm {
    DECLARE_ACE_TYPE(GridLayoutAlgorithm, BoxLayoutAlgorithm);

public:
    explicit GridLayoutAlgorithm(const RefPtr<GridLayoutController>& layoutController)
