...
public:
    ...
    {
        return MakeRefPtr<GridLayoutAlgorithm>(layoutController_);
    }

private:
    void OnModifyDone() override;
    void AddScrollEvent();
    bool HandleScrollEvent(float offset, int32_t source);

    RefPtr<GridLayoutController> layoutController_;
