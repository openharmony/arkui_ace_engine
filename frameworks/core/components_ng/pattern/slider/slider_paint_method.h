...
public:
    ...
    explicit SliderPaintMethod(const RefPtr<SliderContentModifier>& sliderContentModifier,
        const SliderContentModifier::Parameters& parameters, const RefPtr<SliderTipModifier>& sliderTipModifier,
    ...
    void UpdateContentModifier(PaintWrapper* paintWrapper) override
    {
        ...
        sliderContentModifier_->UpdateData(
            paintProperty, paintWrapper->GetContentSize(), paintWrapper->GetContentOffset(), sliderTheme);
        sliderContentModifier_->SetTrackThickness(parameters_.trackThickness);
        sliderContentModifier_->GetBackgroundPen(parameters_, paintWrapper->GetContentOffset(), sliderTheme);
        if (paintProperty->GetShowStepsValue(false)) {
            sliderContentModifier_->GetMarkerPen(parameters_, paintWrapper->GetContentOffset(), sliderTheme);
        }
        sliderContentModifier_->GetSelectPen(parameters_, paintWrapper->GetContentOffset(), sliderTheme);
        sliderContentModifier_->GetCirclePen(parameters_, paintWrapper->GetContentOffset(), sliderTheme);
    }
