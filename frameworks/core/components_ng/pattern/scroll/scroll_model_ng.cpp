...
void ScrollModelNG::CreateWithResourceObjScrollBarWidth(const RefPtr<ResourceObject>& resObj)
{
...
void ScrollModelNG::CreateWithResourceObjScrollBarWidth(FrameNode* frameNode, const RefPtr<ResourceObject>& resObj)
{
