...
void TimePickerColumnPattern::HandleCrownMoveEvent(const CrownEvent& event)
{
    ...
    LOGD("TimePickerColumnPattern::HandleCrownMoveEvent offsetY=%{public}lf,yLast_=%{public}lf", offsetY, yLast_);
...
void TimePickerColumnPattern::ToUpdateSelectedTextProperties(const RefPtr<PickerTheme>& pickerTheme)
{
    auto pipeline = PipelineBase::GetCurrentContext();
    CHECK_NULL_VOID(pipeline);
    auto pickerTheme1 = pipeline->GetTheme<PickerTheme>();
    CHECK_NULL_VOID(pickerTheme1);
    ...
    auto textLayoutProperty = textPattern->GetLayoutProperty<TextLayoutProperty>();
    CHECK_NULL_VOID(textLayoutProperty);
    UpdateSelectedTextProperties(pickerTheme1, textLayoutProperty, timePickerLayoutProperty);
