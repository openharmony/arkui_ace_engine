...
void ArcScrollPaintMethod::UpdateOverlayModifier(PaintWrapper* paintWrapper)
{
    CHECK_NULL_VOID(paintWrapper);
    auto scrollBarOverlayModifier =
        AceType::DynamicCast<ArcScrollBarOverlayModifier>(GetOverlayModifier(paintWrapper));
    CHECK_NULL_VOID(scrollBarOverlayModifier);
    auto scrollBar = AceType::DynamicCast<ArcScrollBar> (GetScrollBar());
