...
void MenuWrapperPaintMethod::GetTopPath(float arrowX, float arrowY, RSPath& path)
{
...
void MenuWrapperPaintMethod::GetBottomPath(float arrowX, float arrowY, RSPath& path)
{
    path.MoveTo(arrowX - horizonOffsetForth_, arrowY + verticalOffsetThird_);
    path.QuadTo(arrowX - horizonOffsetThird_, arrowY + verticalOffsetThird_, arrowX - horizonOffsetSecond_,
        arrowY + verticalOffsetSecond_);
...
void MenuWrapperPaintMethod::GetRightPath(float arrowX, float arrowY, RSPath& path)
{
...
void MenuWrapperPaintMethod::GetLeftPath(float arrowX, float arrowY, RSPath& path)
{
    path.MoveTo(arrowX - verticalOffsetThird_, arrowY - horizonOffsetForth_);
    path.QuadTo(arrowX - verticalOffsetThird_, arrowY - horizonOffsetThird_, arrowX - verticalOffsetSecond_,
        arrowY - horizonOffsetSecond_);
...
void MenuWrapperPaintMethod::UpdateArrowPath(Placement placement, float arrowX, float arrowY, RSPath& path)
{
...
CanvasDrawFunction MenuWrapperPaintMethod::GetOverlayDrawFunction(PaintWrapper* paintWrapper)
{
    return [weak = WeakClaim(this), paintWrapper](RSCanvas& canvas) {
        ...
        if (menu) {
            auto props = DynamicCast<MenuWrapperPaintProperty>(paintWrapper->GetPaintProperty());
