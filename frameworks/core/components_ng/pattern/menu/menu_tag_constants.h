...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_MENU_TAG_CONSTANTS_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_MENU_TAG_CONSTANTS_H

namespace OHOS::Ace::NG {

// Menu related ETS tags
...
// Overlay related tags
const char SELECT_OVERLAY_ETS_TAG[] = "SelectOverlay";

} // namespace OHOS::Ace::NG

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_MENU_TAG_CONSTANTS_H