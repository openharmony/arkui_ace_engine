...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_DATE_PICKER_BRIDGE_ARKTS_NATIVE_DATE_PICKER_BRIDGE_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_DATE_PICKER_BRIDGE_ARKTS_NATIVE_DATE_PICKER_BRIDGE_H
...
public:
    ...
    static ArkUINativeModuleValue CreateDatePicker(ArkUIRuntimeCallInfo* runtimeCallInfo);
    ...
    static ArkUINativeModuleValue SetUseMilitaryTime(ArkUIRuntimeCallInfo* runtimeCallInfo);
};
} // namespace OHOS::Ace::NG

#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_DATE_PICKER_BRIDGE_ARKTS_NATIVE_DATE_PICKER_BRIDGE_H
