...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_DATE_PICKER_PICKER_DATE_TIME_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_DATE_PICKER_PICKER_DATE_TIME_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_DATE_PICKER_PICKER_DATE_TIME_H
