...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_COLUMN_LAYOUT_LAZY_COLUMN_LAYOUT_INFO_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_COLUMN_LAYOUT_LAZY_COLUMN_LAYOUT_INFO_H
...
class LazyColumnLayoutAlgorithm;
class LazyColumnLayoutPattern;

struct ColumnItemMainPos {
    float startPos = 0.0f;
    float endPos = 0.0f;
};
...
private:
    ...
    friend class LazyColumnLayoutAlgorithm;
    friend class LazyColumnLayoutPattern;
};
} // namespace OHOS::Ace::NG
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_COLUMN_LAYOUT_LAZY_COLUMN_LAYOUT_INFO_H
