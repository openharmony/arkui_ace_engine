...
private:
    ...
    ArcIndexerCollapsingMode lastCollapsingMode_ = ArcIndexerCollapsingMode::INVALID;
    ArcIndexerCollapsingMode currectCollapsingMode_ = ArcIndexerCollapsingMode::INVALID;
