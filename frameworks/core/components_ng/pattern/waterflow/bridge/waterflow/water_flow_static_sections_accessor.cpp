...
WaterFlowSections::Section Convert(const Ark_SectionOptions& src)
{
    ...
    if (onGetItemMainSizeByIndex) {
        auto modelCallback = [callback = CallbackHelper(*onGetItemMainSizeByIndex)](int32_t value) -> float {
...
Ark_Boolean SpliceImpl(
    Ark_WaterFlowSections peer, Ark_Int32 start, const Opt_Int32* deleteCount, const Opt_Array_SectionOptions* sections)
{
...
Ark_Boolean PushImpl(Ark_WaterFlowSections peer, const Ark_SectionOptions* section)
{
    CHECK_NULL_RETURN(peer, false);
    CHECK_NULL_RETURN(peer->GetController(), false);
...
Ark_Boolean UpdateImpl(Ark_WaterFlowSections peer, Ark_Int32 sectionIndex, const Ark_SectionOptions* section)
{
    CHECK_NULL_RETURN(peer, false);
    CHECK_NULL_RETURN(peer->GetController(), false);
    std::vector<WaterFlowSections::Section> sections;
