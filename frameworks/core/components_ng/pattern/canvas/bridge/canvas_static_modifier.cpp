...
void SetOnReadyImpl(Ark_NativePointer node, const Opt_Callback_Opt_DrawingRenderingContext_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
{
    static const GENERATED_ArkUICanvasModifier modifier {
