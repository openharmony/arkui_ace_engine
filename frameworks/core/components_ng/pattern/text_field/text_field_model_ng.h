...
public:
    ...
    static void SetBorderStyle(FrameNode* frameNode, const NG::BorderStyleProperty& borderStyles);
    static void SetMargin(FrameNode* frameNode, const NG::PaddingProperty& margin);
