...
constexpr int32_t AUTO_FILL_ICON_HIDE_DELAY_DURATION_SHORT = 700;
constexpr int32_t AUTO_FILL_ICON_HIDE_DELAY_DURATION_MEDIUM = 750;
constexpr int32_t AUTO_FILL_ICON_HIDE_DELAY_DURATION_LONG = 850;
constexpr int32_t AUTO_FILL_ICON_HIDE_DELAY_DURATION_EXTRA_LONG = 1000;
} // namespace
