...
class CustomDialogControllerMdoel {
public:
    static CustomDialogControllerMdoel* GetInstance();
    virtual ~CustomDialogControllerMdoel() = default;
    
    virtual void SetOpenDialog() = 0;
    virtual void SetCloseDialog() = 0;

private:
    static std::unique_ptr<CustomDialogControllerMdoel> instance_;
};
} // namespace OHOS::Ace
