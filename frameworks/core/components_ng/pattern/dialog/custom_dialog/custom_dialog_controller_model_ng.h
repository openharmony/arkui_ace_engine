...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_DIALOG_CUSTOM_DIALOG_CUSTOM_DIALOG_CONTROLLER_MODEL_NG_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_DIALOG_CUSTOM_DIALOG_CUSTOM_DIALOG_CONTROLLER_MODEL_NG_H
...
public:
    ...
    static RefPtr<UINode> SetOpenDialogWithNode(DialogProperties& dialogProperties, const RefPtr<UINode>& customNode);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_DIALOG_CUSTOM_DIALOG_CUSTOM_DIALOG_CONTROLLER_MODEL_NG_H
