...
private:
    ...
    static void SetOffsetWithResourceObj(const RefPtr<FrameNode>& node);
    static void SetShadowWithResourceObj(const RefPtr<FrameNode>& node);
    static void SetEffectWithResourceObj(const RefPtr<FrameNode>& node);
    static void SetBlurStyleWithResourceObj(const RefPtr<FrameNode>& node);
    static void SetMaskRectWithResouceObj(const RefPtr<FrameNode>& node);
};
} // namespace OHOS::Ace::NG
