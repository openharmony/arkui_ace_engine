...
void PolylineBridge::RegisterPolylineAttributes(Local<panda::ObjectRef> object, EcmaVM* vm)
{
    const char* functionNames[] = { "create", "setPoints", "resetPoints" };

    Local<JSValueRef> funcValues[] = {
        panda::FunctionRef::New(const_cast<panda::EcmaVM*>(vm), PolylineBridge::CreatePolyline),
    ...
    auto polyline = panda::ObjectRef::NewWithNamedProperties(vm,
...
ArkUINativeModuleValue PolylineBridge::CreatePolyline(ArkUIRuntimeCallInfo* runtimeCallInfo)
{
    EcmaVM* vm = runtimeCallInfo->GetVM();
    CHECK_NULL_RETURN(vm, panda::NativePointerRef::New(vm, nullptr));
    Local<JSValueRef> firstArg = runtimeCallInfo->GetCallArgRef(NUM_0);
    GetArkUINodeModifiers()->getPolylineModifier()->createPolyline();
