...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_SHAPE_BRIDGE_RECT_MODEL_IMPL_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_SHAPE_BRIDGE_RECT_MODEL_IMPL_H
...
#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_SHAPE_BRIDGE_RECT_MODEL_IMPL_H
