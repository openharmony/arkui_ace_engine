...
constexpr double STROKE_MITER_LIMIT_MIN_VALUE = 1.0;
...
void SetShapeOptionsImpl(Ark_NativePointer node, const Opt_image_PixelMap* value)
{
...
void SetViewPortImpl(Ark_NativePointer node, const Opt_ViewportRect* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetStrokeImpl(Ark_NativePointer node, const Opt_ResourceColor* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetFillImpl(Ark_NativePointer node, const Opt_ResourceColor* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetStrokeDashOffsetImpl(Ark_NativePointer node, const Opt_Length* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetStrokeDashArrayImpl(Ark_NativePointer node, const Opt_Array_Length* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetStrokeLineCapImpl(Ark_NativePointer node, const Opt_LineCapStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto enumLineCapStyle = Converter::OptConvertPtr<LineCapStyle>(value);
    ShapeModelStatic::SetStrokeLineCap(frameNode, EnumToInt(enumLineCapStyle));
}

void SetStrokeLineJoinImpl(Ark_NativePointer node, const Opt_LineJoinStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto enumLineJoinStyle = Converter::OptConvertPtr<LineJoinStyle>(value);
    ShapeModelStatic::SetStrokeLineJoin(frameNode, EnumToInt(enumLineJoinStyle));
}

void SetStrokeMiterLimitImpl(Ark_NativePointer node, const Opt_Length* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetStrokeOpacityImpl(Ark_NativePointer node, const Opt_Union_F64_String_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetFillOpacityImpl(Ark_NativePointer node, const Opt_Union_F64_String_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto fillOpacity = Converter::OptConvertPtr<float>(value);
    Validator::ValidateOpacity(fillOpacity);
...
void SetAntiAliasImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<bool>(value);
    ShapeModelNG::SetAntiAlias(frameNode, convValue.value_or(true));
}

void SetMeshImpl(Ark_NativePointer node, const Opt_Array_F64* value, const Opt_Int32* column, const Opt_Int32* row)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    ...
    auto expectedMeshSize = (columnValue + 1) * (rowValue + 1) * 2;
    if (static_cast<size_t>(expectedMeshSize) != mesh.size()) {
