...
Framework::PolygonModelImpl* GetPolylineModelImpl()
{
...
#ifndef CROSS_PLATFORM
void CreatePolylineImpl()
{
    GetPolylineModelImpl()->Create(false);
}
#endif
} // namespace
...
#ifndef CROSS_PLATFORM
void SetPointsImpl(ArkUINodeHandle node, const ArkUI_Float32* pointX, const ArkUI_Float32* pointY,
    int32_t length, void* xResObjArray, void* yResObjArray)
{
    auto* model = GetPolylineModelImpl();
    ...
    model->SetPoints(shapePoints);
}

void ResetPointsImpl(ArkUINodeHandle node)
{
    auto* model = GetPolylineModelImpl();
    CHECK_NULL_VOID(model);
    ShapePoints points;
...
const ArkUIPolylineModifier* GetPolylineDynamicModifier()
{
    ...
    if (!isCurrentUseNewPipeline) {
        ...
        static const ArkUIPolylineModifier modifier = {
            .createPolyline = CreatePolylineImpl,
            .setPoints = SetPointsImpl,
            .resetPoints = ResetPointsImpl,
        };
