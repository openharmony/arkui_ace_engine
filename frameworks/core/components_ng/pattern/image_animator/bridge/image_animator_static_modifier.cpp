...
{
    switch (src) {
        case Ark_AnimationStatus::ARK_ANIMATION_STATUS_INITIAL:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_AnimationStatus::ARK_ANIMATION_STATUS_RUNNING:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_AnimationStatus::ARK_ANIMATION_STATUS_PAUSED:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_AnimationStatus::ARK_ANIMATION_STATUS_STOPPED:
            dst = static_cast<int32_t>(src);
            break;
        default:
            LOGE("Unexpected enum value in Ark_AnimationStatus: %{public}d", src);
    }
}
template<>
...
{
    switch (src) {
        case Ark_FillMode::ARK_FILL_MODE_NONE:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_FillMode::ARK_FILL_MODE_FORWARDS:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_FillMode::ARK_FILL_MODE_BACKWARDS:
            dst = static_cast<int32_t>(src);
            break;
        case Ark_FillMode::ARK_FILL_MODE_BOTH:
            dst = static_cast<int32_t>(src);
            break;
        default:
...
void SetImagesImpl(Ark_NativePointer node, const Opt_Array_ImageFrameInfo* value)
{
...
void SetStateImpl(Ark_NativePointer node, const Opt_AnimationStatus* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetDurationImpl(Ark_NativePointer node, const Opt_Int32* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetReverseImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetFixedSizeImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<bool>(value);
...
void SetFillModeImpl(Ark_NativePointer node, const Opt_FillMode* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetIterationsImpl(Ark_NativePointer node, const Opt_Int32* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetMonitorInvisibleAreaImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<bool>(value);
...
void SetOnPauseImpl(Ark_NativePointer node, const Opt_synthetic_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
...
void SetOnRepeatImpl(Ark_NativePointer node, const Opt_synthetic_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
...
void SetOnCancelImpl(Ark_NativePointer node, const Opt_synthetic_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
...
void SetOnFinishImpl(Ark_NativePointer node, const Opt_synthetic_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto optValue = Converter::GetOptPtr(value);
