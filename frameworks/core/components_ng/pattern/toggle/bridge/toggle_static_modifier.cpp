...
void ReplaceContentBoxNodeChild(const RefPtr<FrameNode>& boxNode, const RefPtr<UINode>& uiNode)
{
...
{
    return { .pointRadius = Converter::OptConvert<Dimension>(src.pointRadius),
...
void SetSelectedColorImpl(Ark_NativePointer node, const Opt_ResourceColor* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void SetSwitchPointColorImpl(Ark_NativePointer node, const Opt_ResourceColor* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    auto convValue = Converter::OptConvertPtr<Color>(value);
...
void SetSwitchStyleImpl(Ark_NativePointer node, const Opt_SwitchStyle* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    ...
    Ark_NativePointer node, const Ark_Object* contentModifier, const ToggleModifierBuilder* builder)
{
    ...
    auto builderFunc = [arkBuilder = CallbackHelper(*builder), node, frameNode, objectKeeper](
        ...
        arkBuilder.BuildAsync(
            [boxNode](const RefPtr<UINode>& uiNode) mutable { ReplaceContentBoxNodeChild(boxNode, uiNode); }, node,
            arkConfig);
        return boxNode;
    };
...
{
    static const GENERATED_ArkUIToggleModifier ArkUIToggleStaticModifierImpl {
    ...
    return &ArkUIToggleStaticModifierImpl;
}

const ArkUIToggleStaticContentModifier* GetToggleStaticContentModifier()
{
    static const ArkUIToggleStaticContentModifier ArkUIToggleStaticContentModifierImpl {
        ToggleAttributeModifier::ContentModifierToggleImpl,
        ToggleAttributeModifier::ResetContentModifierToggleImpl,
    };
    return &ArkUIToggleStaticContentModifierImpl;
}
