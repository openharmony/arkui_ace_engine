...
public:
    static void Create(Ace::NG::ToggleType toggleType, bool isOn);
    static void SetSelectedColor(const Ace::Color& selectedColor);
    static void SetSwitchPointColor(const Ace::Color& switchPointColor);
