...
namespace Converter {
template<>
inline TabBarOptions Convert(const Ark_TabBarOptions& src)
{
...
template<>
inline IconStyle Convert(const Ark_TabBarIconStyle& src)
{
    IconStyle iconStyle;
...
template<>
inline void AssignCast(std::optional<SelectedMode>& dst, const Ark_SelectedMode& src)
{
    switch (src) {
...
template<>
inline void AssignCast(std::optional<BoardStyle>& dst, const Ark_BoardStyle& src)
{
...
template<>
inline void AssignCast(std::optional<LayoutMode>& dst, const Ark_LayoutMode& src)
{
    switch (src) {
...
template<>
inline void AssignCast(std::optional<IndicatorStyle>& dst, const Ark_SubTabBarIndicatorStyle& src)
{
    dst = IndicatorStyle();
...
template<>
inline void AssignCast(std::optional<LabelStyle>& dst, const Ark_TabBarLabelStyle& src)
{
    dst = LabelStyle();
...
void SetTabBarImpl(Ark_NativePointer node,
    const Opt_Union_ComponentContentBase_SubTabBarStyle_BottomTabBarStyle_String_Resource_CustomNodeBuilder_TabBarOptions*
        value)
{
