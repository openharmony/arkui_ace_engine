...
#ifndef ARC_LIST_DYNAMIC_MODIFIER_H
#define ARC_LIST_DYNAMIC_MODIFIER_H

#include "core/components_ng/pattern/arc_list/bridge/arc_list_custom_modifier.h"
#include "core/interfaces/arkoala/arkoala_api.h"

namespace OHOS::Ace::NG::NodeModifier {
// Table builders, defined in arc_list_dynamic_modifier.cpp.
// In cross builds the node-modifier layer fetches these via dlopen; in non-cross
// builds it calls them directly to bypass dlopen (single, in-process definition).
...
#endif // ARC_LIST_DYNAMIC_MODIFIER_H
