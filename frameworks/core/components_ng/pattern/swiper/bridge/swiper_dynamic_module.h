...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_SWIPER_BRIDGE_SWIPER_DYNAMIC_MODULE_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_SWIPER_BRIDGE_SWIPER_DYNAMIC_MODULE_H

#include "core/common/dynamic_module.h"

namespace OHOS::Ace {

class SwiperDynamicModule : public DynamicModule {
public:
    SwiperDynamicModule() = default;
    ~SwiperDynamicModule() override = default;
