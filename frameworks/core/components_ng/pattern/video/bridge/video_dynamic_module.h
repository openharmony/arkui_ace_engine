...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_VIDEO_BRIDGE_VIDEO_DYNAMIC_MODULE_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_VIDEO_BRIDGE_VIDEO_DYNAMIC_MODULE_H

#include "core/common/dynamic_module.h"

namespace OHOS::Ace {

class VideoDynamicModule : public DynamicModule {
public:
...
#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_VIDEO_BRIDGE_VIDEO_DYNAMIC_MODULE_H
