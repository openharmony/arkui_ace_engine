...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_VIDEO_VIDEO_STATE_MACHINE_FULL_SCREEN_PATTERN_H
...
class VideoStateMachineFullScreenPattern : public VideoStateMachinePattern, public FocusView {
    DECLARE_ACE_TYPE(VideoStateMachineFullScreenPattern, VideoStateMachinePattern);
...
public:
    ...
    const RefPtr<VideoStateMachinePattern> GetVideoPattern()
    {
...
private:
    WeakPtr<VideoStateMachinePattern> videoPattern_;
    RefPtr<EventHub> eventHub_;
    RefPtr<GestureEventHub> originGestureEventHub_;
};
} // namespace OHOS::Ace::NG
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_VIDEO_VIDEO_STATE_MACHINE_FULL_SCREEN_PATTERN_H