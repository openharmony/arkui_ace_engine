...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_GRID_LAYOUT_LAYOUT_MODEL_STATIC_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_GRID_LAYOUT_LAYOUT_MODEL_STATIC_H
...
public:
    ...
    // Set the breakpoint-adaptive column policy; nullopt resets it (last-set-wins over ColumnsTemplate, same as Grid).
    static void SetItemFillPolicy(FrameNode* frameNode, const std::optional<PresetFillType>& policy);
};

} // namespace OHOS::Ace::NG
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_LAZY_GRID_LAYOUT_LAYOUT_MODEL_STATIC_H
