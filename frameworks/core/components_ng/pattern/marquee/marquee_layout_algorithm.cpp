    ...
    LayoutCalPolicy policy, float childDimensionSize, MeasureCalculationContext& context)
{
    ...
    switch (policy) {
        ...
        case LayoutCalPolicy::FIX_AT_IDEAL_SIZE: {
            ...
            UpdateOptionSizeByCalcLayoutConstraint(frameIdealSize, context.layoutProperty->GetCalcLayoutConstraint(),
                context.layoutConstraint.percentReference);
    ...
    switch (policy) {
        ...
        case LayoutCalPolicy::FIX_AT_IDEAL_SIZE: {
            ...
            if (frameIdealSize.Height().has_value()) {
                context.layoutConstraint.maxSize.SetWidth(frameIdealSize.Height().value());
            }
            break;
        }
        case LayoutCalPolicy::MATCH_PARENT:
