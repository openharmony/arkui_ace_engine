...
void ScrollBarPattern::OnModifyDone()
{
    ...
    auto offsetTask = [weak = WeakClaim(this)](double offset, int32_t source) {
        if (source != SCROLL_FROM_START) {
            ...
            if (pattern) {
                LOGE("hhh scroll event, offset:%{public}lf", offset);
...
// void ScrollBarPattern::RegisterScrollEventTask()
// {
...
{
    bool atBottom = GreatOrEqual(currentOffset_, scrollableDistance_);
    // TODO: ignore ReachMaxCount
    return atBottom;
}

// bool ScrollBarPattern::ScrollPageCheck(float delta, int32_t source)
// {
//     return true;
// }

// void ScrollBarPattern::HandleScrollEffect() {}

// void ScrollBarPattern::HandleScrollBarOutBoundary() {}

// void ScrollBarPattern::AdjustOffset(float& delta, int32_t source)
// {
//     if (!isScrollContent_) {
...
void ScrollBarPattern::ValidateOffset(int32_t source)
{
    ...
    LOGE("hhh 1 currentOffset_:%{public}lf, scrollableDistance_:%{public}lf", currentOffset_, scrollableDistance_);
    ...
    // }
    // }
    LOGE("hhh 2 currentOffset_:%{public}lf, scrollableDistance_:%{public}lf", currentOffset_, scrollableDistance_);
}

// void ScrollBarPattern::HandleScrollPosition(float scroll, int32_t scrollState)
// {
//     if (!scrollableEvent_) {
//         return;
//     }
...
// bool ScrollBarPattern::IsCrashTop() const
// {
...
// bool ScrollBarPattern::IsCrashBottom() const
// {
...
// void ScrollBarPattern::HandleCrashTop() const
// {
...
// void ScrollBarPattern::HandleCrashBottom() const
// {
//     auto frameNode = GetHost();
//     CHECK_NULL_VOID(frameNode);
//     auto eventHub = frameNode->GetEventHub<ScrollEventHub>();
...
//     // TODO: ignore handle refresh
    LOGE("hhh IsAtBottom():%{public}d, IsAtTop():%{public}d, delta:%{public}lf", IsAtBottom(), IsAtTop(), delta);
...
// void ScrollBarPattern::CreateOrStopAnimator()
// {
//     if (!animator_) {
...
// void ScrollBarPattern::AnimateTo(float position, float duration, const RefPtr<Curve>& curve, bool limitDuration,
...
// void ScrollBarPattern::ScrollToEdge(ScrollEdgeType scrollEdgeType, bool smooth)
// {
...
// void ScrollBarPattern::ScrollBy(float pixelX, float pixelY, bool smooth, const std::function<void()>& onFinish)
// {
...
// bool ScrollBarPattern::ScrollPage(bool reverse, bool smooth, const std::function<void()>& onFinish)
// {
...
// void ScrollBarPattern::JumpToPosition(float position, int32_t source)
// {
...
// void ScrollBarPattern::DoJump(float position, int32_t source)
// {
...
// void ScrollBarPattern::SetEdgeEffectCallback(const RefPtr<ScrollEdgeEffect>& scrollEffect)
// {
...
// void ScrollBarPattern::RemoveScrollEdgeEffect()
// {
//     if (!scrollEffect_) {
//         return;
//     }
...
// void ScrollBarPattern::SetScrollEdgeEffect(const RefPtr<ScrollEdgeEffect>& scrollEffect)
// {
...
// bool ScrollBarPattern::IsOutOfBoundary() const
// {
