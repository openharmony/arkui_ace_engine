...
public:
    ...
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(SearchIconColor, Color, PROPERTY_UPDATE_MEASURE);
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(CancelIconColor, Color, PROPERTY_UPDATE_MEASURE);
