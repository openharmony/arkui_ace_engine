...
bool CheckHasMeasured(PropertyChangeFlag propertyChangeFlag)
{
    return ((propertyChangeFlag & PROPERTY_UPDATE_LAYOUT_BY_MEASURE) == PROPERTY_UPDATE_LAYOUT_BY_MEASURE);
}
