...
/**
 * @tc.name: FocusHubHandleKeyEventTest007
 * @tc.desc: Create FocusHub and invoke DumpFocusTree.
 * @tc.type: FUNC
 */
HWTEST_F(FocusHubTestNg, FocusHubHandleKeyEventTest007, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create frameNode.
     */
    ...
    /**
     * @tc.steps: step3. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::NODE;
    ...
    /**
     * @tc.steps: step5. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::NODE;
    ...
    /**
     * @tc.steps: step6. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::NODE;
    focusHub->currentFocus_ = false;
    ...
    /**
     * @tc.steps: step7. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::SCOPE;
    focusHub->currentFocus_ = false;
    ...
    /**
     * @tc.steps: step8. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::SCOPE;
    focusHub->currentFocus_ = true;
    ...
    /**
     * @tc.steps: step9. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->focusType_ = FocusType::SCOPE;
    focusHub->currentFocus_ = true;
...
/**
 * @tc.name: FocusHubHandleKeyEventTest008
 * @tc.desc: Create FocusHub and invoke RequestFocusImmediately.
 * @tc.type: FUNC
 */
HWTEST_F(FocusHubTestNg, FocusHubHandleKeyEventTest008, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create frameNode.
     */
     ...
     */
    focusHub->focusType_ = FocusType::SCOPE;
    focusHub->focusNodes_.empty();
    focusHub->currentFocus_ = true;
    focusHub->focusable_ = false;
    focusHub->RequestFocusImmediately();
}
/**
 * @tc.name: FocusHubHandleKeyEventTest009
 * @tc.desc: Create FocusHub and invoke LostFocus and LostSelfFocus.
 * @tc.type: FUNC
 */
HWTEST_F(FocusHubTestNg, FocusHubHandleKeyEventTest009, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create frameNode.
     */
...
/**
 * @tc.name: FocusHubHandleKeyEventTest0011
 * @tc.desc: Create FocusHub and invoke LostFocus and LostSelfFocus.
 * @tc.type: FUNC
 */
HWTEST_F(FocusHubTestNg, FocusHubHandleKeyEventTest0011, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create frameNode.
     */
    ...
    eventHub->AttachHost(frameNode);
    auto focusHub = AceType::MakeRefPtr<FocusHub>(AceType::WeakClaim(AceType::RawPtr(eventHub)));
    FocusHub* focusNode = new FocusHub(AceType::WeakClaim(AceType::RawPtr(eventHub)));
    /**
     * @tc.steps: step3. Focus hub is currently focused, FocusType is DISABLE and key code is TV_CONTROL_UP.
     * @tc.expected: OnKeyEventScope -> RequestNextFocus.
     */
    focusHub->RemoveChild(nullptr);
     ...
     */
    focusHub->currentFocus_ = true;
    focusHub->RemoveChild(focusNode);
