...
/**
 * @tc.name: ViewAbstractTest0271
 * @tc.desc: Test the operation of View_Abstract.
 * @tc.type: FUNC
 */
HWTEST_F(ViewAbstractTest, ViewAbstractTest0271, TestSize.Level1)
{
    /**
    ...
    /**
     * @tc.steps: step2. callback SetClickEffectLevel.push FrameNode is null.
     * @tc.expected: step2. Return expected results..
     */
    viewAbstract.SetClickEffectLevel(ClickEffectLevel::LIGHT, 1.0);
    auto frameNode = AceType::DynamicCast<FrameNode>(ViewStackProcessor::GetInstance()->Finish());
...
/**
 * @tc.name: ViewAbstractTest0272
 * @tc.desc: Test the operation of View_Abstract.
 * @tc.type: FUNC
 */
HWTEST_F(ViewAbstractTest, ViewAbstractTest0272, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Build a object viewAbstract.
     */
...
/**
 * @tc.name: ViewAbstractTest0273
 * @tc.desc: Test the operation of View_Abstract
 * @tc.type: FUNC
 */
HWTEST_F(ViewAbstractTest, ViewAbstractTest0273, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Build a object viewAbstract.
     */
