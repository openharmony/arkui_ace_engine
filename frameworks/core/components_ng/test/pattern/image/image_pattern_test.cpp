...
const ImageFit IMAGE_FIT_DEFAULT = ImageFit::COVER;
const bool SYNCMODE_DEFAULT = false;
const CopyOptions COPYOPTIONS_DEFAULT = CopyOptions::None;
const bool AUTORESIZE_DEFAULT = true;
const bool FITORIGINALSIZE_DEFAULT = true;
const ImageRepeat IMAGE_NO_REPEAT = ImageRepeat::NOREPEAT;
const ImageInterpolation IMAGE_NO_INTERPOLATION = ImageInterpolation::NONE;
const ImageRenderMode IMAGE_NO_RENDERMODE = ImageRenderMode::ORIGINAL;
const bool MATCHTEXTDIRECTION_DEFAULT = false;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ImagePatternTest, ImageCreator001, TestSize.Level1)
{
    ImageModelNG image;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ImagePatternTest, ImageCreator002, TestSize.Level1)
{
    ImageModelNG image;
    RefPtr<PixelMap> pixMap = nullptr;
    image.Create("", false, pixMap);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ImagePatternTest, ImageCreator003, TestSize.Level1)
{
    ImageModelNG image;
    RefPtr<PixelMap> pixMap = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ImagePatternTest, ImageEventTest001, TestSize.Level1)
{
    ImageModelNG image;
    RefPtr<PixelMap> pixMap = nullptr;
    image.Create(IMAGE_SRC_URL, false, pixMap);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ImagePatternTest, ImageEventTest002, TestSize.Level1)
{
    ImageModelNG image;
    RefPtr<PixelMap> pixMap = nullptr;
    image.Create(IMAGE_SRC_URL, false, pixMap);
