...
public:
    ...
    virtual void SetActiveChildRange(const std::set<int32_t>& activeIndexes, const std::set<int32_t>& cachedIndexes) = 0;
    virtual void RecycleItemsByIndex(const std::set<int32_t>& indexes) = 0;
