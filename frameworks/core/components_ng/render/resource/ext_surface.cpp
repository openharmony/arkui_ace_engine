...
#ifdef RENDER_EXTRACT_SUPPORTED
bool ExtSurface::SurfaceCapture(uintptr_t pointerVal, int32_t width, int32_t height)
{
    return CaptureToNativeBuffer(SURFACE_WIDTH, SURFACE_HEIGHT, pointerVal, width, height);
}
