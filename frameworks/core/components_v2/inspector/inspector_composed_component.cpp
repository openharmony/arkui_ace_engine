...
const std::unordered_map<std::string, CreateElementFunc> CREATE_ELEMENT_MAP {
    ...
    { NAVIGATION_TITLE_COMPONENT_TAG, [](const std::string& id) { return AceType::MakeRefPtr<V2::NavigationTitleComposedElement>(id); } },
    { NAVIGATION_MENUS_COMPONENT_TAG, [](const std::string& id) { return AceType::MakeRefPtr<V2::NavigationMenusComposedElement>(id); } },
};
