...
{
    static const ArkUIIndicatorComponentModifier* cachedModifier = nullptr;
    if (cachedModifier == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("IndicatorComponent");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const ArkUIIndicatorComponentModifier*>(module->GetDynamicModifier());
    }
...
{
    static const ArkUIIndicatorControllerModifier* cachedModifier = nullptr;
    if (cachedModifier == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("IndicatorComponent");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const ArkUIIndicatorControllerModifier*>(
