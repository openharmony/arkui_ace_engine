...
const ArkUIWaterFlowModifier* GetWaterFlowModifier()
{
    static const ArkUIWaterFlowModifier modifier = { ResetColumnsTemplate, SetColumnsTemplate, ResetRowsTemplate,
        ...
        SetWaterFlowScroller, GetWaterFlowLayoutMode, SetWaterFlowLayoutMode, ResetWaterFlowLayoutMode,
        ResetWaterFlowSections, SetWaterFlowFadingEdge, ResetWaterFlowFadingEdge };
    return &modifier;
}
