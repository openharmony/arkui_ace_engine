...
{
    static const ArkUIArcSwiperModifier* cachedModifier = nullptr;
    if (cachedModifier == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("Swiper");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const ArkUIArcSwiperModifier*>(
            module->GetCustomModifier("swiperArcModifier"));
    }
