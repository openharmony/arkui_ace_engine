...
ACE_FORCE_EXPORT ActionSheetModel* GetActionSheetModel();
ACE_FORCE_EXPORT AlertDialogModel* GetAlertDialogModel();
ACE_FORCE_EXPORT CustomDialogControllerModel* GetCustomDialogControllerModel();
} // namespace OHOS::Ace::NG::NodeModifier
