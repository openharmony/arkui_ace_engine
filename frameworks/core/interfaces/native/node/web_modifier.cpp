...
constexpr int32_t DEFAULT_TEXT_ZOOM_RATIO = 0;
constexpr float DEFAULT_INITIAL_SCALE = 0.0f;
...
constexpr bool MEDIA_PLAY_GESTURE_ACCESS_ENABLED = false;
constexpr bool DEFAULT_MEDIA_OPTIONS_ENABLED = false;
