...
ani_long ConstructCustomNode(ani_int id, ArkUICustomNodeInfo&& customNodeInfo)
{
    ...
    customNode->SetClearParentReusePoolFunc(std::move(customNodeInfo.clearParentReusePoolFunc));
    customNode->SetMemOptGetter(std::move(customNodeInfo.getMemOptFunc));
