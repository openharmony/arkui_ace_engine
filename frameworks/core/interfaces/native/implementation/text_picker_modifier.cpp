...
{
    static const GENERATED_ArkUITextPickerModifier* cachedModifier = nullptr;

    if (cachedModifier == nullptr) {
#ifdef ARKUI_CAPI_UNITTEST
        cachedModifier = GeneratedModifier::GetTextPickerStaticModifier();
#else
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("TextPicker");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const GENERATED_ArkUITextPickerModifier*>(module->GetStaticModifier());
#endif
    }
