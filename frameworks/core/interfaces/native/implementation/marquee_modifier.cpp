...
{
    switch (src) {
        case ARK_MARQUEE_UPDATE_STRATEGY_DEFAULT:
            dst = MarqueeUpdateStrategy::DEFAULT;
            break;
        case ARK_MARQUEE_UPDATE_STRATEGY_PRESERVE_POSITION:
            dst = MarqueeUpdateStrategy::PRESERVE_POSITION;
            break;
        default:
            LOGE("Unexpected enum value in Ark_MarqueeUpdateStrategy: %{public}d", src);
    }
}
...
void SetMarqueeOptionsImpl(Ark_NativePointer node, const Ark_MarqueeOptions* options)
{
...
void AllowScaleImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    auto convValue = Converter::OptConvert<bool>(*value);
    MarqueeModelNG::SetAllowScale(frameNode, convValue.value_or(true));
}
void FontWeightImpl(Ark_NativePointer node, const Opt_Union_Number_FontWeight_String* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void MarqueeUpdateStrategyImpl(Ark_NativePointer node, const Opt_MarqueeUpdateStrategy* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void OnStartImpl(Ark_NativePointer node, const Opt_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onStart = [arkCallback = CallbackHelper(value->value)]() -> void { arkCallback.Invoke(); };
    MarqueeModelNG::SetOnStart(frameNode, std::move(onStart));
}
void OnBounceImpl(Ark_NativePointer node, const Opt_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onBounce = [arkCallback = CallbackHelper(value->value)]() -> void { arkCallback.Invoke(); };
    MarqueeModelNG::SetOnBounce(frameNode, onBounce);
}
void OnFinishImpl(Ark_NativePointer node, const Opt_Callback_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onFinish = [arkCallback = CallbackHelper(value->value)]() -> void { arkCallback.Invoke(); };
