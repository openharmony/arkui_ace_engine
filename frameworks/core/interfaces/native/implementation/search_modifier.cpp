                   ...
                   const Callback_String_Void* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    auto onSubmit = [arkCallback = CallbackHelper(*value)](const std::string& value,
                  ...
                  const EditableTextOnChangeCallback* value)
{
    ...
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    auto onChange = [arkCallback = CallbackHelper(*value)](const std::string& text,
                     ...
                     const Opt_Callback_String_Void* error)
{
    ...
    if (arkErrorEvent) {
        errorEvent = [callback = CallbackHelper(*arkErrorEvent)](const std::string& val) {
