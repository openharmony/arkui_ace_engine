...
{
    auto peerImpl = Referenced::MakeRefPtr<UIExtensionProxyPeerImpl>();
    peerImpl->IncRefCount();
    return reinterpret_cast<UIExtensionProxyPeer *>(Referenced::RawPtr(peerImpl));
}
...
void SendImpl(
    Ark_UIExtensionProxy peer, const Map_String_CustomObject* data)
{
    LOGE("UIExtensionProxyAccessor::SendImpl - is not supported");
}
Map_String_CustomObject SendSyncImpl(
    Ark_VMContext vmContext, Ark_UIExtensionProxy peer, const Map_String_CustomObject* data)
{
    LOGE("UIExtensionProxyAccessor::SendSyncImpl - is not supported");
    return {};
}
void OnAsyncReceiverRegisterImpl(
...
void OnSyncReceiverRegisterImpl(
    Ark_UIExtensionProxy peer, const Callback_UIExtensionProxy_Void* callback_)
{
#ifdef WINDOW_SCENE_SUPPORTED
    CHECK_NULL_VOID(peer);
...
void OffAsyncReceiverRegisterImpl(
    Ark_UIExtensionProxy peer, const Opt_Callback_UIExtensionProxy_Void* callback_)
{
#ifdef WINDOW_SCENE_SUPPORTED
    CHECK_NULL_VOID(peer);
    CHECK_NULL_VOID(callback_);
...
void OffSyncReceiverRegisterImpl(
    Ark_UIExtensionProxy peer, const Opt_Callback_UIExtensionProxy_Void* callback_)
{
#ifdef WINDOW_SCENE_SUPPORTED
    CHECK_NULL_VOID(peer);
