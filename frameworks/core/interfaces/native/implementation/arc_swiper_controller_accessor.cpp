...
namespace ArcSwiperControllerAccessor {
...
} // ArcSwiperControllerAccessor
const GENERATED_ArkUIArcSwiperControllerHelperAccessor* GetArcSwiperControllerHelperAccessor()
{
    static const GENERATED_ArkUIArcSwiperControllerHelperAccessor ArcSwiperControllerAccessorImpl {
        ArcSwiperControllerAccessor::DestroyPeerImpl,
        ArcSwiperControllerAccessor::ConstructImpl,
        ArcSwiperControllerAccessor::GetFinalizerImpl,
        ArcSwiperControllerAccessor::ShowNextImpl,
        ArcSwiperControllerAccessor::ShowPreviousImpl,
        ArcSwiperControllerAccessor::FinishAnimationImpl,
    };
    return &ArcSwiperControllerAccessorImpl;
}

struct ArcSwiperControllerPeer {
    virtual ~ArcSwiperControllerPeer() = default;
};
}
