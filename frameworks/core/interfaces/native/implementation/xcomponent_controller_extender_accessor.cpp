...
{
    static const GENERATED_ArkUIXComponentControllerExtenderAccessor* cachedAccessor = nullptr;
    if (cachedAccessor == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("XComponent");
        CHECK_NULL_RETURN(module, nullptr);
        cachedAccessor = reinterpret_cast<const GENERATED_ArkUIXComponentControllerExtenderAccessor*>(
            module->GetCustomModifier(XCOMPONENT_CONTROLLER_EXTENDER_ACCESSOR));
    }
