...
{
    static const GENERATED_ArkUILazyWaterFlowLayoutExtenderAccessor* cachedModifier = nullptr;

    if (cachedModifier == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("LazyVWaterFlowLayout");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const GENERATED_ArkUILazyWaterFlowLayoutExtenderAccessor*>(
