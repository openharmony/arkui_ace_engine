 ...
 */
 ...
 namespace StateStyleOpsAccessor {
 void OnStateStyleChangeImpl(Ark_NativePointer node, const Callback_StateStylesChange* stateStyleChange)
 {
 ...
 const GENERATED_ArkUIStateStylesOpsAccessor* GetStateStylesOpsAccessor()
 {
     static const GENERATED_ArkUIStateStylesOpsAccessor StateStylesOpsAccessorImpl {
         StateStyleOpsAccessor::OnStateStyleChangeImpl,
     };
     return &StateStylesOpsAccessorImpl;
 }
 
 struct StateStylesOpsPeer {
     virtual ~StateStylesOpsPeer() = default;
 };
 }