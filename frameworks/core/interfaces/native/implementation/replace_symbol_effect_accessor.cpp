...
void DestroyPeerImpl(ReplaceSymbolEffectPeer* peer)
{
}
...
Ark_NativePointer GetScopeImpl(ReplaceSymbolEffectPeer* peer)
{
    return {};
}
void SetScopeImpl(ReplaceSymbolEffectPeer* peer,
