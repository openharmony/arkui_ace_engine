...
{
    switch (src) {
        case ARK_TEXT_SELECTABLE_MODE_SELECTABLE_UNFOCUSABLE:
            dst = TextSelectableMode::SELECTABLE_UNFOCUSABLE;
            break;
        case ARK_TEXT_SELECTABLE_MODE_SELECTABLE_FOCUSABLE:
            dst = TextSelectableMode::SELECTABLE_FOCUSABLE;
            break;
        case ARK_TEXT_SELECTABLE_MODE_UNSELECTABLE:
            dst = TextSelectableMode::UNSELECTABLE;
            break;
        default:
            LOGE("Unexpected enum value in Ark_TextSelectableMode: %{public}d", src);
    }
}
...
{
    switch (src) {
        case ARK_TEXT_SPAN_TYPE_TEXT:
            dst = TextSpanType::TEXT;
            break;
        case ARK_TEXT_SPAN_TYPE_IMAGE:
            dst = TextSpanType::IMAGE;
            break;
        case ARK_TEXT_SPAN_TYPE_MIXED:
            dst = TextSpanType::MIXED;
            break;
        default:
...
{
    switch (src) {
        case ARK_TEXT_RESPONSE_TYPE_RIGHT_CLICK:
            dst = TextResponseType::RIGHT_CLICK;
            break;
        case ARK_TEXT_RESPONSE_TYPE_LONG_PRESS:
            dst = TextResponseType::LONG_PRESS;
            break;
        case ARK_TEXT_RESPONSE_TYPE_SELECT:
            dst = TextResponseType::SELECTED_BY_MOUSE;
            break;
        default:
...
void SetTextOptionsImpl(Ark_NativePointer node, const Opt_Union_String_Resource* content, const Opt_TextOptions* value)
{
...
static void FontImplInternal(
    Ark_NativePointer node, const Opt_Font* value, std::optional<bool> enableVariableFontWeight = std::nullopt)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    ...
    if (font) {
        font.value().enableVariableFontWeight = enableVariableFontWeight;
    }
    TextModelNG::SetFont(frameNode, font);
}

void Font0Impl(Ark_NativePointer node, const Opt_Font* value)
{
    FontImplInternal(node, value);
}

void Font1Impl(Ark_NativePointer node, const Opt_Font* fontValue, const Opt_FontSettingOptions* options)
{
    std::optional<bool> enableVariableFontWeight;
    if (options) {
...
void MinFontSizeImpl(Ark_NativePointer node, const Opt_Union_Number_String_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void MaxFontSizeImpl(Ark_NativePointer node, const Opt_Union_Number_String_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void MinFontScaleImpl(Ark_NativePointer node, const Opt_Union_Number_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void MaxFontScaleImpl(Ark_NativePointer node, const Opt_Union_Number_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void FontWeight0Impl(Ark_NativePointer node, const Opt_Union_Number_FontWeight_String* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void FontWeight1Impl(
    Ark_NativePointer node, const Opt_Union_Number_FontWeight_String* weight, const Opt_FontSettingOptions* options)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void LineSpacingImpl(Ark_NativePointer node, const Opt_LengthMetrics* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void TextAlignImpl(Ark_NativePointer node, const Opt_TextAlign* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void LineHeightImpl(Ark_NativePointer node, const Opt_Union_Number_String_Resource* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void TextOverflowImpl(Ark_NativePointer node, const Opt_TextOverflowOptions* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    ...
    if (value->tag != InteropTag::INTEROP_TAG_UNDEFINED) {
        convValue = Converter::OptConvert<TextOverflow>(value->value.overflow);
    }
...
void MaxLinesImpl(Ark_NativePointer node, const Opt_Number* value)
{
    ...
    if (maxLines.has_value() && maxLines.value() >= 0) {
        convValue = static_cast<uint32_t>(maxLines.value());
    }
    TextModelNG::SetMaxLines(frameNode, convValue);
}
void DecorationImpl(Ark_NativePointer node, const Opt_DecorationStyleInterface* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void LetterSpacingImpl(Ark_NativePointer node, const Opt_Union_Number_String* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void TextCaseImpl(Ark_NativePointer node, const Opt_TextCase* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void BaselineOffsetImpl(Ark_NativePointer node, const Opt_Union_Number_String* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void DraggableImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    frameNode->SetDraggable(value->value);
}
void TextShadowImpl(Ark_NativePointer node, const Opt_Union_ShadowOptions_Array_ShadowOptions* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void HeightAdaptivePolicyImpl(Ark_NativePointer node, const Opt_TextHeightAdaptivePolicy* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void TextIndentImpl(Ark_NativePointer node, const Opt_Length* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void WordBreakImpl(Ark_NativePointer node, const Opt_WordBreak* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void LineBreakStrategyImpl(Ark_NativePointer node, const Opt_LineBreakStrategy* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void OnCopyImpl(Ark_NativePointer node, const Opt_Callback_String_Void* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onCopy = [arkCallback = CallbackHelper(value->value)](const std::u16string& param) {
...
void CaretColorImpl(Ark_NativePointer node, const Opt_ResourceColor* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
...
void EllipsisModeImpl(Ark_NativePointer node, const Opt_EllipsisMode* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void EnableDataDetectorImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void OnTextSelectionChangeImpl(Ark_NativePointer node, const Opt_Callback_Number_Number_Void* value)
{
    ...
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onSelectionChange = [arkCallback = CallbackHelper(value->value)](int32_t start, int32_t end) {
...
void PrivacySensitiveImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    ...
    CHECK_NULL_VOID(value);
    auto convValue = Converter::OptConvert<bool>(*value);
    ViewAbstract::SetPrivacySensitive(frameNode, convValue.value_or(false));
}
void TextSelectableImpl(Ark_NativePointer node, const Opt_TextSelectableMode* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void EditMenuOptionsImpl(Ark_NativePointer node, const Opt_EditMenuOptions* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void HalfLeadingImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    auto convValue = Converter::OptConvert<bool>(*value);
    TextModelNG::SetHalfLeading(frameNode, convValue.value_or(false));
}
void EnableHapticFeedbackImpl(Ark_NativePointer node, const Opt_Boolean* value)
{
    ...
    CHECK_NULL_VOID(value);
    auto convValue = Converter::OptConvert<bool>(*value);
    TextModelNG::SetEnableHapticFeedback(frameNode, convValue.value_or(true));
}
void SelectionImpl(Ark_NativePointer node, const Opt_Number* selectionStart, const Opt_Number* selectionEnd)
{
    ...
    CHECK_NULL_VOID(selectionStart->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    CHECK_NULL_VOID(selectionEnd->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto startIndex = Converter::Convert<int>(selectionStart->value);
    auto endIndex = Converter::Convert<int>(selectionEnd->value);
    ...
    const Opt_SelectionMenuOptions* options)
{
    ...
    CHECK_NULL_VOID(content->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    ...
    auto responseTypeValue = convResponseType.value_or(TextResponseType::LONG_PRESS);
    auto convBuildFunc = [callback = CallbackHelper(content->value), node]() {
    ...
    if (convMenuParam.has_value()) {
        auto optSpanTypeValue = optSpanType.value_or(TextSpanType::TEXT);
        TextModelNG::BindSelectionMenu(
            frameNode, optSpanTypeValue, responseTypeValue, convBuildFunc, convMenuParam.value());
    }
}
} // namespace TextAttributeModifier
