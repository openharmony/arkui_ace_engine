...
void SetImageSpanOptionsImpl(Ark_NativePointer node, const Ark_Union_ResourceStr_PixelMap* value)
{
...
void VerticalAlignImpl(Ark_NativePointer node, const Opt_ImageSpanAlignment* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void ColorFilterImpl(Ark_NativePointer node, const Opt_Union_ColorFilter_DrawingColorFilter* value)
{
    // ToDo
    //  ImageCommonMethods::ApplyColorFilterValues(node, value);
}
void ObjectFitImpl(Ark_NativePointer node, const Opt_ImageFit* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
...
void OnCompleteImpl(Ark_NativePointer node, const Opt_ImageCompleteCallback* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onComplete = [arkCallback = CallbackHelper(value->value)](const LoadImageSuccessEvent& info) {
...
void OnErrorImpl(Ark_NativePointer node, const Opt_ImageErrorCallback* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
    CHECK_NULL_VOID(value->tag != InteropTag::INTEROP_TAG_UNDEFINED);
    auto onError = [arkCallback = CallbackHelper(value->value)](const LoadImageFailEvent& info) {
        Ark_ImageError result = Converter::ArkValue<Ark_ImageError>(info);
        arkCallback.Invoke(result);
    };
    ImageSpanView::SetOnError(frameNode, std::move(onError));
}
void AltImpl(Ark_NativePointer node, const Opt_PixelMap* value)
{
    auto frameNode = reinterpret_cast<FrameNode*>(node);
    CHECK_NULL_VOID(frameNode);
    CHECK_NULL_VOID(value);
