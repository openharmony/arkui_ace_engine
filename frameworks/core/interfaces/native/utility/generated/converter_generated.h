...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_arkui_component_enums_Color_I32_String& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_BlendMode_uiEffect_BrightnessBlender& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_Tuple_Number_Number_Array_ParticlePropertyAnimationNumberInner& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_ComponentContent_SubTabBarStyle_BottomTabBarStyle_String_Resource_CustomNodeBuilder_TabBarOptions& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
ASSIGN_OPT(Opt_PositionNumberInner)
...
ASSIGN_OPT(Opt_Size)
ASSIGN_OPT(Opt_SizeNumberInner)
...
ASSIGN_OPT(Opt_Union_arkui_component_enums_Color_I32_String)
ASSIGN_OPT(Opt_Union_BlendMode_uiEffect_BrightnessBlender)
...
ASSIGN_OPT(Opt_Array_router_RouterState)
...
ASSIGN_OPT(Opt_Callback_BusinessError_Void)
...
ASSIGN_OPT(Opt_FrameCallbackHandler)
...
ASSIGN_OPT(Opt_NodeContainerOpsOnTouchCallback)
...
ASSIGN_OPT(Opt_RichEditorPreviewMenuOptions)
...
ASSIGN_OPT(Opt_Union_Tuple_Number_Number_Array_ParticlePropertyAnimationNumberInner)
...
ASSIGN_OPT(Opt_Union_ComponentContent_SubTabBarStyle_BottomTabBarStyle_String_Resource_CustomNodeBuilder_TabBarOptions)
