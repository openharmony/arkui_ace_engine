...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_ColorFilter_drawing_ColorFilter_ResourceColor& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
ASSIGN_OPT(Opt_AreaChangeCallback)
...
ASSIGN_OPT(Opt_AnchoredColorMode)
...
ASSIGN_OPT(Opt_DragAnimationType)
...
ASSIGN_OPT(Opt_GestureCollectIntervention)
...
ASSIGN_OPT(Opt_GestureShortcut)
...
ASSIGN_OPT(Opt_IncrementalUpdatePolicy)
...
ASSIGN_OPT(Opt_LazyForEachCustomComponentFreezeMode)
ASSIGN_OPT(Opt_LazyForEachMemOptStrategy)
ASSIGN_OPT(Opt_LazyForEachReleaseStrategy)
...
ASSIGN_OPT(Opt_MouseHistoricalPoint)
...
ASSIGN_OPT(Opt_NodeRenderState)
...
ASSIGN_OPT(Opt_OnZoomChangeEvent)
ASSIGN_OPT(Opt_OperateIntention)
...
ASSIGN_OPT(Opt_PanGestureOptionsProxy)
...
ASSIGN_OPT(Opt_TabBarDisplayMode)
ASSIGN_OPT(Opt_TabBarStyle)
...
ASSIGN_OPT(Opt_TabsSidebarDisplayStyle)
ASSIGN_OPT(Opt_TabVisibility)
...
ASSIGN_OPT(Opt_TextSelectionClearPolicy)
...
ASSIGN_OPT(Opt_uiMaterial_ImmersiveMaterial)
...
ASSIGN_OPT(Opt_VideoControllerAsync)
...
ASSIGN_OPT(Opt_WebKeyboardAppearanceMode)
...
ASSIGN_OPT(Opt_Array_BuilderSpanInfo)
...
ASSIGN_OPT(Opt_Array_FrameNodeCreateInfo)
...
ASSIGN_OPT(Opt_Array_MouseHistoricalPoint)
...
ASSIGN_OPT(Opt_Array_TextMenuItemId)
...
ASSIGN_OPT(Opt_Callback_ArcSwiperContentTransitionProxy_Void)
...
ASSIGN_OPT(Opt_Callback_BuilderSpanInfo_Void)
ASSIGN_OPT(Opt_Callback_ClearCache)
...
ASSIGN_OPT(Opt_Callback_GestureCollectIntervention_Void)
...
ASSIGN_OPT(Opt_Callback_HeightBreakpoint_Void)
...
ASSIGN_OPT(Opt_Callback_Opt_Map_String_Object_Void)
...
ASSIGN_OPT(Opt_Callback_ReleaseItemByIndex)
...
ASSIGN_OPT(Opt_Callback_SizeInfo_Void)
...
ASSIGN_OPT(Opt_Callback_TabBarDisplayMode_Void)
...
ASSIGN_OPT(Opt_Callback_WidthBreakpoint_Void)
...
ASSIGN_OPT(Opt_GestureCollectInterceptCallback)
...
ASSIGN_OPT(Opt_NavExtender_PushDestinationInner)
ASSIGN_OPT(Opt_NodeRenderStateChangeCallback)
...
ASSIGN_OPT(Opt_OnInputmethodAttachedCallback)
...
ASSIGN_OPT(Opt_OnZoomChangeCallback)
ASSIGN_OPT(Opt_Opt_Object)
...
ASSIGN_OPT(Opt_RestoreStateCallback)
...
ASSIGN_OPT(Opt_SaveStateCallback)
...
ASSIGN_OPT(Opt_ShouldRecognizerParallelWithCallback)
...
ASSIGN_OPT(Opt_TabsSidebarSearchFilterCallback)
...
ASSIGN_OPT(Opt_AreaChangeOptions)
...
ASSIGN_OPT(Opt_Bindable_HeightBreakpoint)
ASSIGN_OPT(Opt_Bindable_I32)
ASSIGN_OPT(Opt_Bindable_String)
ASSIGN_OPT(Opt_Bindable_WidthBreakpoint)
...
ASSIGN_OPT(Opt_BuilderSpanInfo)
...
ASSIGN_OPT(Opt_DecorationOptions)
...
ASSIGN_OPT(Opt_DistortionParam)
...
ASSIGN_OPT(Opt_FrameNodeCreateInfo)
...
ASSIGN_OPT(Opt_ListBackPressBehavior)
...
ASSIGN_OPT(Opt_NavigationConfiguration)
...
ASSIGN_OPT(Opt_TabsBreakpointType_TabBarDisplayMode)
...
ASSIGN_OPT(Opt_TabsSidebarSearchableOptions)
...
ASSIGN_OPT(Opt_FloatingTabBarWidth)
...
ASSIGN_OPT(Opt_RichEditorBuilderSpan)
...
ASSIGN_OPT(Opt_FloatingTabBarStyle)
