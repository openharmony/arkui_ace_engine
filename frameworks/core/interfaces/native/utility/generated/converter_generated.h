...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_NavDestinationInfo_NavBar& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
ASSIGN_OPT(Opt_BaseCustomComponent)
ASSIGN_OPT(Opt_BaseCustomDialog)
...
ASSIGN_OPT(Opt_CustomComponentV2)
...
ASSIGN_OPT(Opt_TextMenuController)
...
ASSIGN_OPT(Opt_uiObserver_DensityInfo)
...
ASSIGN_OPT(Opt_uiObserver_ScrollEventType)
ASSIGN_OPT(Opt_uiObserver_TabContentState)
...
ASSIGN_OPT(Opt_webview_WebHeader)
...
ASSIGN_OPT(Opt_curves_Callback_Number_Number)
...
ASSIGN_OPT(Opt_OnLazyLoadingFunc)
...
ASSIGN_OPT(Opt_OnTotalCountFunc)
...
ASSIGN_OPT(Opt_uiObserver_Callback_DensityInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_NavDestinationInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_NavDestinationSwitchInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_RouterPageInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_ScrollEventInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_TabContentInfo_Void)
ASSIGN_OPT(Opt_uiObserver_Callback_Void)
...
ASSIGN_OPT(Opt_uiObserver_ScrollEventInfo)
ASSIGN_OPT(Opt_uiObserver_TabContentInfo)
...
ASSIGN_OPT(Opt_Union_NavDestinationInfo_NavBar)
...
ASSIGN_OPT(Opt_uiObserver_NavDestinationSwitchInfo)
