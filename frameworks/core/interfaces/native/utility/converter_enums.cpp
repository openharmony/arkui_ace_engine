...
template<>
void AssignCast(std::optional<RectHeightStyle>& dst, const Ark_text_RectHeightStyle& src)
{
    switch (src) {
        case ARK_TEXT_RECT_HEIGHT_STYLE_TIGHT: dst = RectHeightStyle::TIGHT; break;
        case ARK_TEXT_RECT_HEIGHT_STYLE_MAX: dst = RectHeightStyle::MAX; break;
        case ARK_TEXT_RECT_HEIGHT_STYLE_INCLUDE_LINE_SPACE_MIDDLE:
            dst = RectHeightStyle::INCLUDE_LINE_SPACE_MIDDLE;
            break;
        case ARK_TEXT_RECT_HEIGHT_STYLE_INCLUDE_LINE_SPACE_TOP: dst = RectHeightStyle::INCLUDE_LINE_SPACE_TOP; break;
        case ARK_TEXT_RECT_HEIGHT_STYLE_INCLUDE_LINE_SPACE_BOTTOM:
            dst = RectHeightStyle::INCLUDE_LINE_SPACE_BOTTOM;
            break;
        case ARK_TEXT_RECT_HEIGHT_STYLE_STRUT: dst = RectHeightStyle::STRUT; break;
...
template<>
void AssignCast(std::optional<RectWidthStyle>& dst, const Ark_text_RectWidthStyle& src)
{
    switch (src) {
        case ARK_TEXT_RECT_WIDTH_STYLE_TIGHT: dst = RectWidthStyle::TIGHT; break;
        case ARK_TEXT_RECT_WIDTH_STYLE_MAX: dst = RectWidthStyle::MAX; break;
...
{
    switch (src) {
        case ARK_TEXT_TEXT_ALIGN_LEFT: dst = TextAlign::LEFT; break;
        case ARK_TEXT_TEXT_ALIGN_RIGHT: dst = TextAlign::RIGHT; break;
        case ARK_TEXT_TEXT_ALIGN_CENTER: dst = TextAlign::CENTER; break;
        case ARK_TEXT_TEXT_ALIGN_JUSTIFY: dst = TextAlign::JUSTIFY; break;
        case ARK_TEXT_TEXT_ALIGN_START: dst = TextAlign::START; break;
        case ARK_TEXT_TEXT_ALIGN_END: dst = TextAlign::END; break;
...
{
    switch (src) {
        case ARK_TEXT_WORD_BREAK_NORMAL: dst = WordBreak::NORMAL; break;
        case ARK_TEXT_WORD_BREAK_BREAK_ALL: dst = WordBreak::BREAK_ALL; break;
        case ARK_TEXT_WORD_BREAK_BREAK_WORD: dst = WordBreak::BREAK_WORD; break;
