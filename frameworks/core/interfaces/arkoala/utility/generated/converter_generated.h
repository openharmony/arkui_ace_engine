...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_Boolean_Callback_value_DismissPopupAction_Void& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_Number_Literal_Number_span_offset& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignUnionTo(std::optional<T>& dst,
                   const Ark_Union_Optional_Undefined& src)
{
    switch (src.selector) {
        case SELECTOR_ID_0: AssignTo(dst, src.value0); break;
        case SELECTOR_ID_1: AssignTo(dst, src.value1); break;
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Number_span_offset& src)
{
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Number_year_month_day& src)
{
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Number_surfaceWidth_surfaceHeight& src)
{
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_String_data_mimeType_encoding_baseUrl_historyUrl& src)
{
    AssignTo(dst, src.data);
}
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_String_script_Callback_result_String_Void_callback& src)
{
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Number_fingers_distance_PanDirection_direction& src)
{
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Union_Number_String_x_y_width_height& src)
{
    AssignTo(dst, src.x);
}
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Union_Number_String_width_height_String_commands& src)
{
    AssignTo(dst, src.width);
}
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Number_width_height& src)
{
    AssignTo(dst, src.width);
}
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Union_String_Number_width_height& src)
{
    AssignTo(dst, src.width);
}
...
template<typename T>
void AssignLiteralTo(std::optional<T>& dst,
                     const Ark_Literal_Union_Number_Literal_Number_span_offset_xs_sm_md_lg& src)
{
    AssignTo(dst, src.xs);
}
...
ASSIGN_OPT(Opt_Union_Boolean_Callback_value_DismissPopupAction_Void)
...
ASSIGN_OPT(Opt_Literal_String_data_mimeType_encoding_baseUrl_historyUrl)
ASSIGN_OPT(Opt_Literal_String_script_Callback_result_String_Void_callback)
...
ASSIGN_OPT(Opt_Literal_Number_fingers_distance_PanDirection_direction)
...
ASSIGN_OPT(Opt_AnimatableArithmetic)
...
ASSIGN_OPT(Opt_Literal_Union_Number_String_x_y_width_height)
ASSIGN_OPT(Opt_MenuAlignType)
ASSIGN_OPT(Opt_Union_Optional_Undefined)
...
ASSIGN_OPT(Opt_Literal_Union_Number_String_width_height_String_commands)
...
ASSIGN_OPT(Opt_Literal_Union_String_Number_width_height)
...
ASSIGN_OPT(Opt_Literal_Union_Number_Literal_Number_span_offset_xs_sm_md_lg)
