...
namespace OHOS::Ace::NG::GeneratedModifier {
    namespace MutableStyledStringModifier {
        ...
        void ReplaceStringImpl(MutableStyledStringPeer* peer, const Ark_Number* start, const Ark_Number* length, const Ark_String* other) {
        }
        void InsertStringImpl(MutableStyledStringPeer* peer, const Ark_Number* start, const Ark_String* other) {
        }
        ...
        void RemoveStylesImpl(MutableStyledStringPeer* peer, const Ark_Number* start, const Ark_Number* length) {
        }
        void ClearStylesImpl(MutableStyledStringPeer* peer) {
        }
        void ReplaceStyledStringImpl(MutableStyledStringPeer* peer, const Ark_Number* start, const Ark_Number* length, const Ark_Materialized* other) {
        }
        void InsertStyledStringImpl(MutableStyledStringPeer* peer, const Ark_Number* start, const Ark_Materialized* other) {
        }
        void AppendStyledStringImpl(MutableStyledStringPeer* peer, const Ark_Materialized* other) {
        }
