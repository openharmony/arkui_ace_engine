...
namespace OHOS::Ace::NG::GeneratedModifier {
    namespace SecurityComponentMethodModifier {
        void IconSizeImpl(Ark_NativePointer node, const Ark_Length* value) {
        }
        ...
        void FontWeightImpl(Ark_NativePointer node, const Type_SecurityComponentMethod_fontWeight_Arg0* value) {
        }
        void FontFamilyImpl(Ark_NativePointer node, const Type_SecurityComponentMethod_fontFamily_Arg0* value) {
        }
        void FontColorImpl(Ark_NativePointer node, const ResourceColor* value) {
        }
        void IconColorImpl(Ark_NativePointer node, const ResourceColor* value) {
        }
        void BackgroundColorImpl(Ark_NativePointer node, const ResourceColor* value) {
        }
        void BorderStyleImpl(Ark_NativePointer node, Ark_Int32 value) {
        }
        void BorderWidthImpl(Ark_NativePointer node, const Ark_Length* value) {
        }
        void BorderColorImpl(Ark_NativePointer node, const ResourceColor* value) {
        }
        void BorderRadiusImpl(Ark_NativePointer node, const Ark_Length* value) {
        }
        void PaddingImpl(Ark_NativePointer node, const Type_SecurityComponentMethod_padding_Arg0* value) {
        }
        void TextIconSpaceImpl(Ark_NativePointer node, const Ark_Length* value) {
        }
