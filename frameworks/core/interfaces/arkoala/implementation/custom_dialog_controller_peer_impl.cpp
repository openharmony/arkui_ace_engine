...
template<>
inline void AssignCast(std::optional<ShadowStyle>& dst, const Ark_ShadowStyle& src)
{
    switch (src) {
...
{
    auto borderStyle = Converter::OptConvert<BorderStyle>(src);
    return BorderStyleProperty({ borderStyle, borderStyle, borderStyle, borderStyle });
}
...
BorderStyleProperty Convert(const Ark_EdgeStyles& src)
{
    ...
    borderStyle.styleTop = Converter::OptConvert<BorderStyle>(src.top);
    borderStyle.styleLeft = Converter::OptConvert<BorderStyle>(src.left);
    borderStyle.styleBottom = Converter::OptConvert<BorderStyle>(src.bottom);
