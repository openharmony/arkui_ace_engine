...
namespace OHOS::Ace::NG::GeneratedModifier {
    namespace SearchInterfaceModifier {
        void _setSearchOptionsImpl(Ark_NativePointer node, const Opt_Type_SearchInterface__setSearchOptions_Arg0* options) {
        }
    } // SearchInterfaceModifier
    namespace SearchAttributeModifier {
        void SearchButtonImpl(Ark_NativePointer node, const Ark_String* value, const Opt_SearchButtonOptions* option) {
        }
        ...
        void InputFilterImpl(Ark_NativePointer node, const ResourceStr* value, const Opt_Callback* error) {
        }
        ...
        void TextFontImpl(Ark_NativePointer node, const Opt_Font* value) {
        }
        ...
        void MinFontSizeImpl(Ark_NativePointer node, const Type_SearchAttribute_minFontSize_Arg0* value) {
        }
        void MaxFontSizeImpl(Ark_NativePointer node, const Type_SearchAttribute_maxFontSize_Arg0* value) {
        }
        ...
        void LineHeightImpl(Ark_NativePointer node, const Type_SearchAttribute_lineHeight_Arg0* value) {
        }
