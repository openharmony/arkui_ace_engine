...
namespace OHOS::Ace::NG::GeneratedModifier {
    ...
    namespace ListAttributeModifier {
        void LanesImpl(Ark_NativePointer node, const Type_ListAttribute_lanes_Arg0* value, const Opt_Dimension* gutter) {
        }
        void AlignListItemImpl(Ark_NativePointer node, Ark_Int32 value) {
        }
        void ListDirectionImpl(Ark_NativePointer node, Ark_Int32 value) {
        }
        ...
        void ContentEndOffsetImpl(Ark_NativePointer node, const Ark_Number* value) {
        }
        void DividerImpl(Ark_NativePointer node, const Type_ListAttribute_divider_Arg0* value) {
        }
        ...
        void FrictionImpl(Ark_NativePointer node, const Type_ListAttribute_friction_Arg0* value) {
        }
        ...
        void OnScrollVisibleContentChangeImpl(Ark_NativePointer node, Ark_Function handler) {
        }
        ...
        void OnItemDeleteImpl(Ark_NativePointer node, Ark_Function event) {
        }
        void OnItemMoveImpl(Ark_NativePointer node, Ark_Function event) {
        }
