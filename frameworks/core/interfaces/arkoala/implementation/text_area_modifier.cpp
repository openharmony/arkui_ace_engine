...
namespace OHOS::Ace::NG::GeneratedModifier {
    namespace TextAreaInterfaceModifier {
        void _setTextAreaOptionsImpl(Ark_NativePointer node, const Opt_TextAreaOptions* value) {
        }
    ...
    namespace TextAreaAttributeModifier {
        ...
        void FontWeightImpl(Ark_NativePointer node, const Type_TextAreaAttribute_fontWeight_Arg0* value) {
        }
        ...
        void StyleImpl(Ark_NativePointer node, Ark_Int32 value) {
        }
        ...
        void MinFontSizeImpl(Ark_NativePointer node, const Type_TextAreaAttribute_minFontSize_Arg0* value) {
        }
        void MaxFontSizeImpl(Ark_NativePointer node, const Type_TextAreaAttribute_maxFontSize_Arg0* value) {
        }
        ...
        void LineHeightImpl(Ark_NativePointer node, const Type_TextAreaAttribute_lineHeight_Arg0* value) {
        }
        void TypeImpl(Ark_NativePointer node, Ark_Int32 value) {
        }
        void EnableAutoFillImpl(Ark_NativePointer node, Ark_Boolean value) {
        }
        void ContentTypeImpl(Ark_NativePointer node, Ark_Int32 contentType) {
        }
