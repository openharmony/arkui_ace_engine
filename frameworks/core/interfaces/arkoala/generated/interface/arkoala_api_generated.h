...
#define GENERATED_ARKUI_FULL_API_VERSION 104
...
typedef struct Ark_Callback_PopInfo_Void Ark_Callback_PopInfo_Void;
...
typedef struct Ark_VoidCallback Ark_VoidCallback;
...
typedef struct Ark_Callback_SwipeActionState_Void Ark_Callback_SwipeActionState_Void;
typedef struct Opt_Callback_SwipeActionState_Void Opt_Callback_SwipeActionState_Void;
typedef struct Ark_Callback_Void Ark_Callback_Void;
typedef struct Opt_Callback_Void Opt_Callback_Void;
typedef struct Ark_Callback_Any Ark_Callback_Any;
...
typedef struct Ark_Callback_DismissPopupAction_Void Ark_Callback_DismissPopupAction_Void;
...
typedef struct Ark_TextStyle Ark_TextStyle;
...
typedef struct Ark_Callback_GestureEvent_Void Ark_Callback_GestureEvent_Void;
typedef struct Opt_Callback_GestureEvent_Void Opt_Callback_GestureEvent_Void;
typedef struct Ark_Callback_ClickEvent_Void Ark_Callback_ClickEvent_Void;
...
typedef struct Ark_ArrayBuffer Ark_ArrayBuffer;
...
typedef struct Ark_Callback_DismissDialogAction_Void Ark_Callback_DismissDialogAction_Void;
...
typedef struct Ark_Union_ResourceColor_Undefined Ark_Union_ResourceColor_Undefined;
typedef struct Opt_Union_ResourceColor_Undefined Opt_Union_ResourceColor_Undefined;
...
typedef struct Ark_Callback_TabContentTransitionProxy_Void Ark_Callback_TabContentTransitionProxy_Void;
...
typedef struct Ark_Callback_NavigationTransitionProxy_Void Ark_Callback_NavigationTransitionProxy_Void;
typedef struct Opt_Callback_NavigationTransitionProxy_Void Opt_Callback_NavigationTransitionProxy_Void;
typedef struct Ark_Callback_Boolean_Void Ark_Callback_Boolean_Void;
...
typedef struct Ark_Callback_Literal_Boolean_isVisible_Void Ark_Callback_Literal_Boolean_isVisible_Void;
...
typedef struct Ark_GetItemMainSizeByIndex Ark_GetItemMainSizeByIndex;
...
typedef struct Ark_Callback_String_Void Ark_Callback_String_Void;
typedef struct Opt_Callback_String_Void Opt_Callback_String_Void;
typedef struct Ark_Callback_TimePickerResult_Void Ark_Callback_TimePickerResult_Void;
...
typedef struct Ark_Callback_TextPickerResult_Void Ark_Callback_TextPickerResult_Void;
...
typedef struct Ark_TextMenuItemId Ark_TextMenuItemId;
...
typedef struct Ark_OnDidChangeCallback Ark_OnDidChangeCallback;
typedef struct Opt_OnDidChangeCallback Opt_OnDidChangeCallback;
typedef struct Ark_Callback_StyledStringChangeValue_Boolean Ark_Callback_StyledStringChangeValue_Boolean;
...
typedef struct Ark_InterceptionModeCallback Ark_InterceptionModeCallback;
typedef struct Opt_InterceptionModeCallback Opt_InterceptionModeCallback;
typedef struct Ark_InterceptionShowCallback Ark_InterceptionShowCallback;
typedef struct Opt_InterceptionShowCallback Opt_InterceptionShowCallback;
typedef struct Ark_Callback_Date_Void Ark_Callback_Date_Void;
typedef struct Opt_Callback_Date_Void Opt_Callback_Date_Void;
typedef struct Ark_Callback_DatePickerResult_Void Ark_Callback_DatePickerResult_Void;
...
typedef struct Ark_OnMoveHandler Ark_OnMoveHandler;
...
typedef struct Ark_OnLinearIndicatorChangeCallback Ark_OnLinearIndicatorChangeCallback;
...
typedef struct Opt_Type_ButtonStyle_icons Opt_Type_ButtonStyle_icons;
...
typedef struct Ark_Callback_Literal_String_plainText_Void Ark_Callback_Literal_String_plainText_Void;
...
typedef struct Ark_Callback_SwiperContentTransitionProxy_Void Ark_Callback_SwiperContentTransitionProxy_Void;
...
typedef struct Ark_Union_DividerOptions_Undefined Ark_Union_DividerOptions_Undefined;
typedef struct Opt_Union_DividerOptions_Undefined Opt_Union_DividerOptions_Undefined;
...
typedef struct Ark_MenuOnAppearCallback Ark_MenuOnAppearCallback;
...
typedef struct Ark_Type_RectInterface_value_u1 Ark_Type_RectInterface_value_u1;
typedef struct Opt_Type_RectInterface_value_u1 Opt_Type_RectInterface_value_u1;
typedef struct Ark_Type_RectInterface_value_u0 Ark_Type_RectInterface_value_u0;
typedef struct Opt_Type_RectInterface_value_u0 Opt_Type_RectInterface_value_u0;
...
typedef struct Ark_Callback_Number_Void Ark_Callback_Number_Void;
...
typedef struct Ark_Callback_Number_Tuple_Number_Number_Number_Number Ark_Callback_Number_Tuple_Number_Number_Number_Number;
...
typedef struct Ark_Callback_Number_Tuple_Number_Number Ark_Callback_Number_Tuple_Number_Number;
...
typedef struct Ark_Callback_SheetType_Void Ark_Callback_SheetType_Void;
typedef struct Opt_Callback_SheetType_Void Opt_Callback_SheetType_Void;
typedef struct Ark_Callback_SpringBackAction_Void Ark_Callback_SpringBackAction_Void;
typedef struct Opt_Callback_SpringBackAction_Void Opt_Callback_SpringBackAction_Void;
typedef struct Ark_Callback_DismissSheetAction_Void Ark_Callback_DismissSheetAction_Void;
typedef struct Opt_Callback_DismissSheetAction_Void Opt_Callback_DismissSheetAction_Void;
typedef struct Ark_Callback_SheetDismiss_Void Ark_Callback_SheetDismiss_Void;
...
typedef struct Ark_Callback_DismissContentCoverAction_Void Ark_Callback_DismissContentCoverAction_Void;
...
typedef struct Ark_TransitionFinishCallback Ark_TransitionFinishCallback;
...
typedef struct Ark_WithThemeInterface Ark_WithThemeInterface;
typedef struct Opt_WithThemeInterface Opt_WithThemeInterface;
typedef struct Ark_SliderTriggerChangeCallback Ark_SliderTriggerChangeCallback;
typedef struct Opt_SliderTriggerChangeCallback Opt_SliderTriggerChangeCallback;
typedef struct Ark_ScrollOnWillScrollCallback Ark_ScrollOnWillScrollCallback;
typedef struct Opt_ScrollOnWillScrollCallback Opt_ScrollOnWillScrollCallback;
typedef struct Ark_ScrollOnScrollCallback Ark_ScrollOnScrollCallback;
typedef struct Opt_ScrollOnScrollCallback Opt_ScrollOnScrollCallback;
typedef struct Ark_PageTransitionCallback Ark_PageTransitionCallback;
typedef struct Opt_PageTransitionCallback Opt_PageTransitionCallback;
typedef struct Ark_OnWillScrollCallback Ark_OnWillScrollCallback;
typedef struct Opt_OnWillScrollCallback Opt_OnWillScrollCallback;
typedef struct Ark_OnScrollCallback Ark_OnScrollCallback;
...
typedef struct Ark_IsolatedComponentInterface Ark_IsolatedComponentInterface;
typedef struct Opt_IsolatedComponentInterface Opt_IsolatedComponentInterface;
typedef struct Ark_HoverCallback Ark_HoverCallback;
typedef struct Opt_HoverCallback Opt_HoverCallback;
typedef struct Ark_Callback_Any_Number_Void Ark_Callback_Any_Number_Void;
typedef struct Opt_Callback_Any_Number_Void Opt_Callback_Any_Number_Void;
typedef struct Ark_Callback_Any_Number_String Ark_Callback_Any_Number_String;
typedef struct Opt_Callback_Any_Number_String Opt_Callback_Any_Number_String;
typedef struct Ark_ButtonTriggerClickCallback Ark_ButtonTriggerClickCallback;
typedef struct Opt_ButtonTriggerClickCallback Opt_ButtonTriggerClickCallback;
typedef struct Ark_Callback_WithThemeAttribute_Void Ark_Callback_WithThemeAttribute_Void;
...
typedef struct Ark_Callback_WebKeyboardOptions_Void Ark_Callback_WebKeyboardOptions_Void;
typedef struct Opt_Callback_WebKeyboardOptions_Void Opt_Callback_WebKeyboardOptions_Void;
typedef struct Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void;
typedef struct Opt_Callback_Union_TabContentAnimatedTransition_Undefined_Void Opt_Callback_Union_TabContentAnimatedTransition_Undefined_Void;
typedef struct Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void;
typedef struct Opt_Callback_Union_NavigationAnimatedTransition_Undefined_Void Opt_Callback_Union_NavigationAnimatedTransition_Undefined_Void;
typedef struct Ark_Callback_GestureRecognizer_Void Ark_Callback_GestureRecognizer_Void;
typedef struct Opt_Callback_GestureRecognizer_Void Opt_Callback_GestureRecognizer_Void;
typedef struct Ark_Callback_OffsetResult_Void Ark_Callback_OffsetResult_Void;
...
typedef struct Ark_Callback_ScrollResult_Void Ark_Callback_ScrollResult_Void;
...
typedef struct Ark_Callback_OnScrollFrameBeginHandlerResult_Void Ark_Callback_OnScrollFrameBeginHandlerResult_Void;
typedef struct Opt_Callback_OnScrollFrameBeginHandlerResult_Void Opt_Callback_OnScrollFrameBeginHandlerResult_Void;
typedef struct Ark_Callback_Array_String_Void Ark_Callback_Array_String_Void;
typedef struct Opt_Callback_Array_String_Void Opt_Callback_Array_String_Void;
typedef struct Ark_Callback_IsolatedComponentAttribute_Void Ark_Callback_IsolatedComponentAttribute_Void;
...
typedef struct Ark_Callback_HitTestMode_Void Ark_Callback_HitTestMode_Void;
typedef struct Opt_Callback_HitTestMode_Void Opt_Callback_HitTestMode_Void;
typedef struct Ark_Callback_WebResourceResponse_Void Ark_Callback_WebResourceResponse_Void;
typedef struct Opt_Callback_WebResourceResponse_Void Opt_Callback_WebResourceResponse_Void;
typedef struct Ark_Callback_Tuple_Number_Number_Number_Number_Void Ark_Callback_Tuple_Number_Number_Number_Number_Void;
typedef struct Opt_Callback_Tuple_Number_Number_Number_Number_Void Opt_Callback_Tuple_Number_Number_Number_Number_Void;
typedef struct Ark_Callback_Tuple_Number_Number_Void Ark_Callback_Tuple_Number_Number_Void;
typedef struct Opt_Callback_Tuple_Number_Number_Void Opt_Callback_Tuple_Number_Number_Void;
typedef struct Ark_Callback_Literal_Number_offsetRemain_Void Ark_Callback_Literal_Number_offsetRemain_Void;
typedef struct Opt_Callback_Literal_Number_offsetRemain_Void Opt_Callback_Literal_Number_offsetRemain_Void;
typedef struct Ark_Callback_ComputedBarAttribute_Void Ark_Callback_ComputedBarAttribute_Void;
typedef struct Opt_Callback_ComputedBarAttribute_Void Opt_Callback_ComputedBarAttribute_Void;
typedef struct Ark_Callback_Callback_Any_Void Ark_Callback_Callback_Any_Void;
typedef struct Opt_Callback_Callback_Any_Void Opt_Callback_Callback_Any_Void;
typedef struct Ark_Callback_GestureJudgeResult_Void Ark_Callback_GestureJudgeResult_Void;
typedef struct Opt_Callback_GestureJudgeResult_Void Opt_Callback_GestureJudgeResult_Void;
typedef struct Ark_Callback_Union_CustomBuilder_DragItemInfo_Void Ark_Callback_Union_CustomBuilder_DragItemInfo_Void;
typedef struct Opt_Callback_Union_CustomBuilder_DragItemInfo_Void Opt_Callback_Union_CustomBuilder_DragItemInfo_Void;
typedef struct Ark_Callback_TouchResult_Void Ark_Callback_TouchResult_Void;
typedef struct Opt_Callback_TouchResult_Void Opt_Callback_TouchResult_Void;
typedef struct Ark_Callback_CustomObject_Void Ark_Callback_CustomObject_Void;
typedef struct Opt_Callback_CustomObject_Void Opt_Callback_CustomObject_Void;
...
typedef struct Ark_Union_String_Number_Resource_ArrayBuffer Ark_Union_String_Number_Resource_ArrayBuffer;
typedef struct Opt_Union_String_Number_Resource_ArrayBuffer Opt_Union_String_Number_Resource_ArrayBuffer;
...
typedef struct Ark_Union_Array_Number_Undefined Ark_Union_Array_Number_Undefined;
typedef struct Opt_Union_Array_Number_Undefined Opt_Union_Array_Number_Undefined;
...
typedef struct Ark_Literal_Boolean_next Ark_Literal_Boolean_next;
typedef struct Opt_Literal_Boolean_next Opt_Literal_Boolean_next;
...
typedef struct Ark_Union_OnMoveHandler_Undefined Ark_Union_OnMoveHandler_Undefined;
typedef struct Opt_Union_OnMoveHandler_Undefined Opt_Union_OnMoveHandler_Undefined;
...
typedef struct Opt_AnimatableArithmetic Opt_AnimatableArithmetic;
...
typedef struct Ark_Union_String_Undefined Ark_Union_String_Undefined;
typedef struct Opt_Union_String_Undefined Opt_Union_String_Undefined;
...
typedef struct Ark_Union_OnLinearIndicatorChangeCallback_Undefined Ark_Union_OnLinearIndicatorChangeCallback_Undefined;
typedef struct Opt_Union_OnLinearIndicatorChangeCallback_Undefined Opt_Union_OnLinearIndicatorChangeCallback_Undefined;
typedef struct Ark_Union_Boolean_Undefined Ark_Union_Boolean_Undefined;
typedef struct Opt_Union_Boolean_Undefined Opt_Union_Boolean_Undefined;
typedef struct Ark_Union_LinearIndicatorStyle_Undefined Ark_Union_LinearIndicatorStyle_Undefined;
typedef struct Opt_Union_LinearIndicatorStyle_Undefined Opt_Union_LinearIndicatorStyle_Undefined;
...
typedef struct Ark_Callback_Literal_Number_code_Want_want_Void Ark_Callback_Literal_Number_code_Want_want_Void;
typedef struct Opt_Callback_Literal_Number_code_Want_want_Void Opt_Callback_Literal_Number_code_Want_want_Void;
typedef struct Ark_Literal_Empty Ark_Literal_Empty;
typedef struct Opt_Literal_Empty Opt_Literal_Empty;
typedef struct Ark_Callback_Literal_Empty_Void Ark_Callback_Literal_Empty_Void;
typedef struct Opt_Callback_Literal_Empty_Void Opt_Callback_Literal_Empty_Void;
typedef Ark_Materialized Ark_UIExtensionProxy;
typedef struct Opt_UIExtensionProxy Opt_UIExtensionProxy;
typedef struct Ark_Callback_UIExtensionProxy_Void Ark_Callback_UIExtensionProxy_Void;
...
typedef struct Ark_Union_DividerStyle_Undefined Ark_Union_DividerStyle_Undefined;
typedef struct Opt_Union_DividerStyle_Undefined Opt_Union_DividerStyle_Undefined;
typedef struct Ark_ButtonStyle Ark_ButtonStyle;
typedef struct Opt_ButtonStyle Opt_ButtonStyle;
typedef struct Ark_Callback_Object_Void Ark_Callback_Object_Void;
...
typedef struct Ark_OnAdsBlockedCallback Ark_OnAdsBlockedCallback;
...
typedef struct Ark_WebKeyboardCallback Ark_WebKeyboardCallback;
typedef struct Opt_WebKeyboardCallback Opt_WebKeyboardCallback;
typedef struct Ark_OnViewportFitChangedCallback Ark_OnViewportFitChangedCallback;
...
typedef struct Ark_OnRenderProcessRespondingCallback Ark_OnRenderProcessRespondingCallback;
...
typedef struct Ark_OnRenderProcessNotRespondingCallback Ark_OnRenderProcessNotRespondingCallback;
...
typedef struct Ark_OnOverrideUrlLoadingCallback Ark_OnOverrideUrlLoadingCallback;
...
typedef struct Ark_Callback_NativeEmbedTouchInfo_Void Ark_Callback_NativeEmbedTouchInfo_Void;
...
typedef struct Ark_OnNativeEmbedVisibilityChangeCallback Ark_OnNativeEmbedVisibilityChangeCallback;
...
typedef struct Ark_Callback_NativeEmbedDataInfo_Void Ark_Callback_NativeEmbedDataInfo_Void;
...
typedef struct Ark_OnIntelligentTrackingPreventionCallback Ark_OnIntelligentTrackingPreventionCallback;
...
typedef struct Ark_OnNavigationEntryCommittedCallback Ark_OnNavigationEntryCommittedCallback;
typedef struct Opt_OnNavigationEntryCommittedCallback Opt_OnNavigationEntryCommittedCallback;
typedef struct Ark_OnSafeBrowsingCheckResultCallback Ark_OnSafeBrowsingCheckResultCallback;
...
typedef struct Ark_Callback_OnOverScrollEvent_Void Ark_Callback_OnOverScrollEvent_Void;
...
typedef struct Ark_Callback_OnLoadInterceptEvent_Boolean Ark_Callback_OnLoadInterceptEvent_Boolean;
...
typedef struct Ark_OnLargestContentfulPaintCallback Ark_OnLargestContentfulPaintCallback;
...
typedef struct Ark_OnFirstMeaningfulPaintCallback Ark_OnFirstMeaningfulPaintCallback;
...
typedef struct Ark_Callback_OnFirstContentfulPaintEvent_Void Ark_Callback_OnFirstContentfulPaintEvent_Void;
...
typedef struct Ark_Callback_OnAudioStateChangedEvent_Void Ark_Callback_OnAudioStateChangedEvent_Void;
...
typedef struct Ark_Callback_OnDataResubmittedEvent_Void Ark_Callback_OnDataResubmittedEvent_Void;
...
typedef struct Ark_Callback_OnPageVisibleEvent_Void Ark_Callback_OnPageVisibleEvent_Void;
...
typedef struct Ark_Callback_OnFaviconReceivedEvent_Void Ark_Callback_OnFaviconReceivedEvent_Void;
...
typedef struct Ark_Callback_OnTouchIconUrlReceivedEvent_Void Ark_Callback_OnTouchIconUrlReceivedEvent_Void;
...
typedef struct Ark_Callback_OnWindowNewEvent_Void Ark_Callback_OnWindowNewEvent_Void;
...
typedef struct Ark_Callback_OnClientAuthenticationEvent_Void Ark_Callback_OnClientAuthenticationEvent_Void;
...
typedef struct Ark_OnSslErrorEventCallback Ark_OnSslErrorEventCallback;
...
typedef struct Ark_Callback_OnSslErrorEventReceiveEvent_Void Ark_Callback_OnSslErrorEventReceiveEvent_Void;
...
typedef struct Ark_Callback_OnScrollEvent_Void Ark_Callback_OnScrollEvent_Void;
...
typedef struct Ark_Callback_OnSearchResultReceiveEvent_Void Ark_Callback_OnSearchResultReceiveEvent_Void;
typedef struct Opt_Callback_OnSearchResultReceiveEvent_Void Opt_Callback_OnSearchResultReceiveEvent_Void;
typedef struct Ark_OnContextMenuHideCallback Ark_OnContextMenuHideCallback;
...
typedef struct Ark_Callback_OnContextMenuShowEvent_Boolean Ark_Callback_OnContextMenuShowEvent_Boolean;
...
typedef struct Ark_Callback_OnScreenCaptureRequestEvent_Void Ark_Callback_OnScreenCaptureRequestEvent_Void;
...
typedef struct Ark_Callback_OnPermissionRequestEvent_Void Ark_Callback_OnPermissionRequestEvent_Void;
...
typedef struct Ark_Callback_OnInterceptRequestEvent_WebResourceResponse Ark_Callback_OnInterceptRequestEvent_WebResourceResponse;
...
typedef struct Ark_Callback_OnHttpAuthRequestEvent_Boolean Ark_Callback_OnHttpAuthRequestEvent_Boolean;
...
typedef struct Ark_Callback_OnScaleChangeEvent_Void Ark_Callback_OnScaleChangeEvent_Void;
...
typedef struct Ark_OnFullScreenEnterCallback Ark_OnFullScreenEnterCallback;
...
typedef struct Ark_Callback_OnResourceLoadEvent_Void Ark_Callback_OnResourceLoadEvent_Void;
...
typedef struct Ark_Callback_Literal_Function_callback_Object_fileSelector_Void Ark_Callback_Literal_Function_callback_Object_fileSelector_Void;
...
typedef struct Ark_Callback_Literal_Object_detail_Boolean Ark_Callback_Literal_Object_detail_Boolean;
...
typedef struct Ark_Callback_OnShowFileSelectorEvent_Boolean Ark_Callback_OnShowFileSelectorEvent_Boolean;
...
typedef struct Ark_Callback_OnRenderExitedEvent_Void Ark_Callback_OnRenderExitedEvent_Void;
...
typedef struct Ark_Callback_Literal_Function_handler_Object_error_Void Ark_Callback_Literal_Function_handler_Object_error_Void;
...
typedef struct Ark_Type_WebAttribute_onUrlLoadIntercept_callback Ark_Type_WebAttribute_onUrlLoadIntercept_callback;
...
typedef struct Ark_Callback_OnRefreshAccessedHistoryEvent_Void Ark_Callback_OnRefreshAccessedHistoryEvent_Void;
...
typedef struct Ark_Callback_OnDownloadStartEvent_Void Ark_Callback_OnDownloadStartEvent_Void;
...
typedef struct Ark_Callback_OnHttpErrorReceiveEvent_Void Ark_Callback_OnHttpErrorReceiveEvent_Void;
...
typedef struct Ark_Callback_OnErrorReceiveEvent_Void Ark_Callback_OnErrorReceiveEvent_Void;
...
typedef struct Ark_Callback_OnConsoleEvent_Boolean Ark_Callback_OnConsoleEvent_Boolean;
...
typedef struct Ark_Callback_OnPromptEvent_Boolean Ark_Callback_OnPromptEvent_Boolean;
...
typedef struct Ark_Callback_OnConfirmEvent_Boolean Ark_Callback_OnConfirmEvent_Boolean;
...
typedef struct Ark_Callback_OnBeforeUnloadEvent_Boolean Ark_Callback_OnBeforeUnloadEvent_Boolean;
...
typedef struct Ark_Callback_OnAlertEvent_Boolean Ark_Callback_OnAlertEvent_Boolean;
...
typedef struct Ark_Callback_OnGeolocationShowEvent_Void Ark_Callback_OnGeolocationShowEvent_Void;
...
typedef struct Ark_Callback_OnTitleReceiveEvent_Void Ark_Callback_OnTitleReceiveEvent_Void;
...
typedef struct Ark_Callback_OnProgressChangeEvent_Void Ark_Callback_OnProgressChangeEvent_Void;
...
typedef struct Ark_Callback_OnPageBeginEvent_Void Ark_Callback_OnPageBeginEvent_Void;
...
typedef struct Ark_Callback_OnPageEndEvent_Void Ark_Callback_OnPageEndEvent_Void;
...
typedef struct Ark_Literal_Number_time Ark_Literal_Number_time;
typedef struct Opt_Literal_Number_time Opt_Literal_Number_time;
typedef struct Ark_Callback_Literal_Number_time_Void Ark_Callback_Literal_Number_time_Void;
typedef struct Opt_Callback_Literal_Number_time_Void Opt_Callback_Literal_Number_time_Void;
typedef struct Ark_Literal_Number_duration Ark_Literal_Number_duration;
typedef struct Opt_Literal_Number_duration Opt_Literal_Number_duration;
typedef struct Ark_Callback_Literal_Number_duration_Void Ark_Callback_Literal_Number_duration_Void;
typedef struct Opt_Callback_Literal_Number_duration_Void Opt_Callback_Literal_Number_duration_Void;
typedef struct Ark_Literal_Boolean_fullscreen Ark_Literal_Boolean_fullscreen;
typedef struct Opt_Literal_Boolean_fullscreen Opt_Literal_Boolean_fullscreen;
typedef struct Ark_Callback_Literal_Boolean_fullscreen_Void Ark_Callback_Literal_Boolean_fullscreen_Void;
typedef struct Opt_Callback_Literal_Boolean_fullscreen_Void Opt_Callback_Literal_Boolean_fullscreen_Void;
...
typedef struct Ark_Type_TextPickerAttribute_onChange_callback Ark_Type_TextPickerAttribute_onChange_callback;
typedef struct Opt_Type_TextPickerAttribute_onChange_callback Opt_Type_TextPickerAttribute_onChange_callback;
typedef struct Ark_Callback_String_Number_Void Ark_Callback_String_Number_Void;
...
typedef struct Ark_Literal_CancelButtonStyle_style_IconOptions_icon Ark_Literal_CancelButtonStyle_style_IconOptions_icon;
typedef struct Opt_Literal_CancelButtonStyle_style_IconOptions_icon Opt_Literal_CancelButtonStyle_style_IconOptions_icon;
typedef struct Ark_Union_ResourceColor_UnderlineColor_Undefined Ark_Union_ResourceColor_UnderlineColor_Undefined;
typedef struct Opt_Union_ResourceColor_UnderlineColor_Undefined Opt_Union_ResourceColor_UnderlineColor_Undefined;
typedef struct Ark_Union_ResourceStr_Undefined Ark_Union_ResourceStr_Undefined;
typedef struct Opt_Union_ResourceStr_Undefined Opt_Union_ResourceStr_Undefined;
...
typedef struct Ark_Callback_EnterKeyType_SubmitEvent_Void Ark_Callback_EnterKeyType_SubmitEvent_Void;
...
typedef struct Ark_Union_DateTimeOptions_Undefined Ark_Union_DateTimeOptions_Undefined;
typedef struct Opt_Union_DateTimeOptions_Undefined Opt_Union_DateTimeOptions_Undefined;
...
typedef struct Ark_Callback_EnterKeyType_Void Ark_Callback_EnterKeyType_Void;
...
typedef struct Ark_Union_TabContentAnimatedTransition_Undefined Ark_Union_TabContentAnimatedTransition_Undefined;
typedef struct Opt_Union_TabContentAnimatedTransition_Undefined Opt_Union_TabContentAnimatedTransition_Undefined;
typedef struct Ark_Type_TabsAttribute_customContentTransition_delegate Ark_Type_TabsAttribute_customContentTransition_delegate;
typedef struct Opt_Type_TabsAttribute_customContentTransition_delegate Opt_Type_TabsAttribute_customContentTransition_delegate;
...
typedef struct Ark_Callback_Number_TabsAnimationEvent_Void Ark_Callback_Number_TabsAnimationEvent_Void;
typedef struct Opt_Callback_Number_TabsAnimationEvent_Void Opt_Callback_Number_TabsAnimationEvent_Void;
typedef struct Ark_TabsAnimationEvent Ark_TabsAnimationEvent;
typedef struct Opt_TabsAnimationEvent Opt_TabsAnimationEvent;
typedef struct Ark_Callback_Number_Number_TabsAnimationEvent_Void Ark_Callback_Number_Number_TabsAnimationEvent_Void;
typedef struct Opt_Callback_Number_Number_TabsAnimationEvent_Void Opt_Callback_Number_Number_TabsAnimationEvent_Void;
typedef struct Ark_Union_EdgeEffect_Undefined Ark_Union_EdgeEffect_Undefined;
typedef struct Opt_Union_EdgeEffect_Undefined Opt_Union_EdgeEffect_Undefined;
typedef struct Ark_Union_AnimationMode_Undefined Ark_Union_AnimationMode_Undefined;
typedef struct Opt_Union_AnimationMode_Undefined Opt_Union_AnimationMode_Undefined;
typedef struct Ark_Type_TabsInterface_value Ark_Type_TabsInterface_value;
typedef struct Opt_Type_TabsInterface_value Opt_Type_TabsInterface_value;
...
typedef struct Ark_ContentDidScrollCallback Ark_ContentDidScrollCallback;
...
typedef struct Ark_Callback_Number_SwiperAnimationEvent_Void Ark_Callback_Number_SwiperAnimationEvent_Void;
typedef struct Opt_Callback_Number_SwiperAnimationEvent_Void Opt_Callback_Number_SwiperAnimationEvent_Void;
...
typedef struct Ark_Callback_Number_Number_SwiperAnimationEvent_Void Ark_Callback_Number_Number_SwiperAnimationEvent_Void;
typedef struct Opt_Callback_Number_Number_SwiperAnimationEvent_Void Opt_Callback_Number_Number_SwiperAnimationEvent_Void;
...
typedef struct Ark_Callback_Number_SliderChangeMode_Void Ark_Callback_Number_SliderChangeMode_Void;
...
typedef struct Ark_Literal_Union_Number_String_height_width_x_y Ark_Literal_Union_Number_String_height_width_x_y;
typedef struct Opt_Literal_Union_Number_String_height_width_x_y Opt_Literal_Union_Number_String_height_width_x_y;
typedef struct Ark_Union_Union_DividerOptions_Undefined_Undefined Ark_Union_Union_DividerOptions_Undefined_Undefined;
typedef struct Opt_Union_Union_DividerOptions_Undefined_Undefined Opt_Union_Union_DividerOptions_Undefined_Undefined;
...
typedef struct Ark_Callback_Number_String_Void Ark_Callback_Number_String_Void;
...
typedef struct Ark_Callback_DeleteValue_Void Ark_Callback_DeleteValue_Void;
...
typedef struct Ark_Callback_DeleteValue_Boolean Ark_Callback_DeleteValue_Boolean;
typedef struct Opt_Callback_DeleteValue_Boolean Opt_Callback_DeleteValue_Boolean;
typedef struct Ark_Callback_InsertValue_Void Ark_Callback_InsertValue_Void;
...
typedef struct Ark_Callback_InsertValue_Boolean Ark_Callback_InsertValue_Boolean;
...
typedef struct Ark_Callback_String_PasteEvent_Void Ark_Callback_String_PasteEvent_Void;
...
typedef struct Ark_EditableTextOnChangeCallback Ark_EditableTextOnChangeCallback;
...
typedef struct Ark_Type_SearchInterface_options Ark_Type_SearchInterface_options;
typedef struct Opt_Type_SearchInterface_options Opt_Type_SearchInterface_options;
...
typedef struct Ark_OnScrollFrameBeginCallback Ark_OnScrollFrameBeginCallback;
...
typedef struct Ark_OnScrollEdgeCallback Ark_OnScrollEdgeCallback;
typedef struct Opt_OnScrollEdgeCallback Opt_OnScrollEdgeCallback;
typedef struct Ark_Callback_ClickEvent_SaveButtonOnClickResult_Void Ark_Callback_ClickEvent_SaveButtonOnClickResult_Void;
...
typedef struct Ark_Callback_CopyEvent_Void Ark_Callback_CopyEvent_Void;
...
typedef struct Ark_Callback_CutEvent_Void Ark_Callback_CutEvent_Void;
...
typedef struct Ark_Callback_RichEditorChangeValue_Boolean Ark_Callback_RichEditorChangeValue_Boolean;
...
typedef struct Ark_SubmitCallback Ark_SubmitCallback;
...
typedef struct Ark_PasteEventCallback Ark_PasteEventCallback;
...
typedef struct Ark_Callback_RichEditorDeleteValue_Boolean Ark_Callback_RichEditorDeleteValue_Boolean;
typedef struct Opt_Callback_RichEditorDeleteValue_Boolean Opt_Callback_RichEditorDeleteValue_Boolean;
typedef struct Ark_Callback_TextRange_Void Ark_Callback_TextRange_Void;
typedef struct Opt_Callback_TextRange_Void Opt_Callback_TextRange_Void;
typedef struct Ark_Callback_RichEditorTextSpanResult_Void Ark_Callback_RichEditorTextSpanResult_Void;
...
typedef struct Ark_Callback_RichEditorInsertValue_Boolean Ark_Callback_RichEditorInsertValue_Boolean;
...
typedef struct Ark_Callback_RichEditorRange_Void Ark_Callback_RichEditorRange_Void;
...
typedef struct Ark_Callback_RichEditorSelection_Void Ark_Callback_RichEditorSelection_Void;
...
typedef struct Ark_Union_Number_Undefined Ark_Union_Number_Undefined;
typedef struct Opt_Union_Number_Undefined Opt_Union_Number_Undefined;
typedef struct Ark_Callback_RefreshStatus_Void Ark_Callback_RefreshStatus_Void;
...
typedef struct Ark_Type_RectInterface_value Ark_Type_RectInterface_value;
typedef struct Opt_Type_RectInterface_value Opt_Type_RectInterface_value;
...
typedef struct Ark_Literal_PluginComponentTemplate_template_Any_data Ark_Literal_PluginComponentTemplate_template_Any_data;
typedef struct Opt_Literal_PluginComponentTemplate_template_Any_data Opt_Literal_PluginComponentTemplate_template_Any_data;
typedef struct Ark_Union_CircleStyleOptions_Undefined Ark_Union_CircleStyleOptions_Undefined;
typedef struct Opt_Union_CircleStyleOptions_Undefined Opt_Union_CircleStyleOptions_Undefined;
typedef struct Ark_Callback_Array_Number_Void Ark_Callback_Array_Number_Void;
...
typedef struct Ark_Literal_Union_Number_String_height_width_String_commands Ark_Literal_Union_Number_String_height_width_String_commands;
typedef struct Opt_Literal_Union_Number_String_height_width_String_commands Opt_Literal_Union_Number_String_height_width_String_commands;
typedef struct Ark_Callback_ClickEvent_PasteButtonOnClickResult_Void Ark_Callback_ClickEvent_PasteButtonOnClickResult_Void;
...
typedef struct Ark_Callback_Number_Number_PanelMode_Void Ark_Callback_Number_Number_PanelMode_Void;
...
typedef struct Ark_Union_SystemBarStyle_Undefined Ark_Union_SystemBarStyle_Undefined;
typedef struct Opt_Union_SystemBarStyle_Undefined Opt_Union_SystemBarStyle_Undefined;
...
typedef struct Ark_Union_NavigationAnimatedTransition_Undefined Ark_Union_NavigationAnimatedTransition_Undefined;
typedef struct Opt_Union_NavigationAnimatedTransition_Undefined Opt_Union_NavigationAnimatedTransition_Undefined;
typedef struct Ark_Type_NavigationAttribute_customNavContentTransition_delegate Ark_Type_NavigationAttribute_customNavContentTransition_delegate;
...
typedef struct Ark_Callback_String_Unknown_Void Ark_Callback_String_Unknown_Void;
typedef struct Opt_Callback_String_Unknown_Void Opt_Callback_String_Unknown_Void;
typedef struct Ark_Callback_NavigationMode_Void Ark_Callback_NavigationMode_Void;
typedef struct Opt_Callback_NavigationMode_Void Opt_Callback_NavigationMode_Void;
typedef struct Ark_Callback_NavigationTitleMode_Void Ark_Callback_NavigationTitleMode_Void;
...
typedef struct Ark_Callback_NavDestinationContext_Void Ark_Callback_NavDestinationContext_Void;
...
typedef struct Ark_Callback_Boolean Ark_Callback_Boolean;
...
typedef struct Ark_Union_DividerStyleOptions_Undefined Ark_Union_DividerStyleOptions_Undefined;
typedef struct Opt_Union_DividerStyleOptions_Undefined Opt_Union_DividerStyleOptions_Undefined;
...
typedef struct Ark_Callback_ClickEvent_LocationButtonOnClickResult_Void Ark_Callback_ClickEvent_LocationButtonOnClickResult_Void;
...
typedef struct Ark_Union_ListDividerOptions_Undefined Ark_Union_ListDividerOptions_Undefined;
typedef struct Opt_Union_ListDividerOptions_Undefined Opt_Union_ListDividerOptions_Undefined;
...
typedef struct Ark_Callback_Number_Number_Boolean Ark_Callback_Number_Number_Boolean;
typedef struct Opt_Callback_Number_Number_Boolean Opt_Callback_Number_Number_Boolean;
typedef struct Ark_Callback_Number_Boolean Ark_Callback_Number_Boolean;
...
typedef struct Ark_OnScrollVisibleContentChangeCallback Ark_OnScrollVisibleContentChangeCallback;
typedef struct Opt_OnScrollVisibleContentChangeCallback Opt_OnScrollVisibleContentChangeCallback;
typedef struct Ark_Callback_Number_Number_Number_Void Ark_Callback_Number_Number_Number_Void;
...
typedef struct Ark_ImageCompleteCallback Ark_ImageCompleteCallback;
...
typedef struct Ark_ImageErrorCallback Ark_ImageErrorCallback;
...
typedef struct Ark_Callback_Type_ImageAttribute_onComplete_callback_event_Void Ark_Callback_Type_ImageAttribute_onComplete_callback_event_Void;
...
typedef struct Ark_Callback_Number_ScrollState_Literal_Number_offsetRemain Ark_Callback_Number_ScrollState_Literal_Number_offsetRemain;
...
typedef struct Ark_Union_GridItemAlignment_Undefined Ark_Union_GridItemAlignment_Undefined;
typedef struct Opt_Union_GridItemAlignment_Undefined Opt_Union_GridItemAlignment_Undefined;
typedef struct Ark_Callback_ItemDragInfo_Number_Number_Boolean_Void Ark_Callback_ItemDragInfo_Number_Number_Boolean_Void;
typedef struct Opt_Callback_ItemDragInfo_Number_Number_Boolean_Void Opt_Callback_ItemDragInfo_Number_Number_Boolean_Void;
typedef struct Ark_Callback_ItemDragInfo_Number_Void Ark_Callback_ItemDragInfo_Number_Void;
typedef struct Opt_Callback_ItemDragInfo_Number_Void Opt_Callback_ItemDragInfo_Number_Void;
typedef struct Ark_Callback_ItemDragInfo_Number_Number_Void Ark_Callback_ItemDragInfo_Number_Number_Void;
typedef struct Opt_Callback_ItemDragInfo_Number_Number_Void Opt_Callback_ItemDragInfo_Number_Number_Void;
typedef struct Ark_Callback_ItemDragInfo_Void Ark_Callback_ItemDragInfo_Void;
...
typedef struct Ark_Callback_ItemDragInfo_Number_Callback_Any Ark_Callback_ItemDragInfo_Number_Callback_Any;
typedef struct Opt_Callback_ItemDragInfo_Number_Callback_Any Opt_Callback_ItemDragInfo_Number_Callback_Any;
typedef struct Ark_Callback_Number_Number_Void Ark_Callback_Number_Number_Void;
...
typedef struct Ark_Callback_Number_Number_ComputedBarAttribute Ark_Callback_Number_Number_ComputedBarAttribute;
...
typedef struct Ark_Callback_Number_ScrollState_Void Ark_Callback_Number_ScrollState_Void;
...
typedef struct Ark_Callback_Any_Void Ark_Callback_Any_Void;
...
typedef struct Ark_Callback_Literal_Number_errcode_String_msg_Void Ark_Callback_Literal_Number_errcode_String_msg_Void;
...
typedef struct Ark_Callback_FormCallbackInfo_Void Ark_Callback_FormCallbackInfo_Void;
...
typedef struct Ark_OnHoverStatusChangeCallback Ark_OnHoverStatusChangeCallback;
...
typedef struct Ark_OnFoldStatusChangeCallback Ark_OnFoldStatusChangeCallback;
...
typedef struct Ark_Callback_TerminationInfo_Void Ark_Callback_TerminationInfo_Void;
typedef struct Opt_Callback_TerminationInfo_Void Opt_Callback_TerminationInfo_Void;
typedef struct Ark_Literal_Union_String_Number_height_width Ark_Literal_Union_String_Number_height_width;
typedef struct Opt_Literal_Union_String_Number_height_width Opt_Literal_Union_String_Number_height_width;
...
typedef struct Ark_Union_ColumnSplitDividerStyle_Undefined Ark_Union_ColumnSplitDividerStyle_Undefined;
typedef struct Opt_Union_ColumnSplitDividerStyle_Undefined Opt_Union_ColumnSplitDividerStyle_Undefined;
...
typedef struct Ark_OnCheckboxGroupChangeCallback Ark_OnCheckboxGroupChangeCallback;
...
typedef struct Ark_OnCheckboxChangeCallback Ark_OnCheckboxChangeCallback;
...
typedef struct Ark_Callback_CalendarRequestedData_Void Ark_Callback_CalendarRequestedData_Void;
...
typedef struct Ark_Callback_CalendarSelectedDate_Void Ark_Callback_CalendarSelectedDate_Void;
...
typedef struct Ark_OnAlphabetIndexerPopupSelectCallback Ark_OnAlphabetIndexerPopupSelectCallback;
typedef struct Opt_OnAlphabetIndexerPopupSelectCallback Opt_OnAlphabetIndexerPopupSelectCallback;
typedef struct Ark_OnAlphabetIndexerRequestPopupDataCallback Ark_OnAlphabetIndexerRequestPopupDataCallback;
typedef struct Opt_OnAlphabetIndexerRequestPopupDataCallback Opt_OnAlphabetIndexerRequestPopupDataCallback;
typedef struct Ark_OnAlphabetIndexerSelectCallback Ark_OnAlphabetIndexerSelectCallback;
...
typedef struct Ark_VisibleAreaChangeCallback Ark_VisibleAreaChangeCallback;
...
typedef struct Ark_Union_TransitionFinishCallback_Undefined Ark_Union_TransitionFinishCallback_Undefined;
typedef struct Opt_Union_TransitionFinishCallback_Undefined Opt_Union_TransitionFinishCallback_Undefined;
...
typedef struct Ark_Union_Object_Undefined Ark_Union_Object_Undefined;
typedef struct Opt_Union_Object_Undefined Opt_Union_Object_Undefined;
typedef struct Ark_SizeChangeCallback Ark_SizeChangeCallback;
typedef struct Opt_SizeChangeCallback Opt_SizeChangeCallback;
typedef struct Ark_Callback_TouchEvent_HitTestMode Ark_Callback_TouchEvent_HitTestMode;
...
typedef struct Ark_ShouldBuiltInRecognizerParallelWithCallback Ark_ShouldBuiltInRecognizerParallelWithCallback;
...
typedef struct Ark_GestureRecognizerJudgeBeginCallback Ark_GestureRecognizerJudgeBeginCallback;
...
typedef struct Ark_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult Ark_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult;
...
typedef struct Ark_Callback_PreDragStatus_Void Ark_Callback_PreDragStatus_Void;
...
typedef struct Ark_Union_Array_UniformDataType_Undefined Ark_Union_Array_UniformDataType_Undefined;
typedef struct Opt_Union_Array_UniformDataType_Undefined Opt_Union_Array_UniformDataType_Undefined;
typedef struct Ark_Callback_DragEvent_String_Void Ark_Callback_DragEvent_String_Void;
...
typedef struct Ark_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo Ark_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo;
...
typedef struct Ark_Union_ClickEffect_Undefined Ark_Union_ClickEffect_Undefined;
typedef struct Opt_Union_ClickEffect_Undefined Opt_Union_ClickEffect_Undefined;
...
typedef struct Ark_Callback_Area_Area_Void Ark_Callback_Area_Area_Void;
...
typedef struct Ark_Callback_KeyEvent_Boolean Ark_Callback_KeyEvent_Boolean;
...
typedef struct Ark_Callback_KeyEvent_Void Ark_Callback_KeyEvent_Void;
...
typedef struct Ark_Callback_TouchEvent_Void Ark_Callback_TouchEvent_Void;
...
typedef struct Ark_Callback_MouseEvent_Void Ark_Callback_MouseEvent_Void;
...
typedef struct Ark_AccessibilityCallback Ark_AccessibilityCallback;
...
typedef struct Ark_Callback_Boolean_HoverEvent_Void Ark_Callback_Boolean_HoverEvent_Void;
...
typedef struct Ark_Callback_Array_TouchTestInfo_TouchResult Ark_Callback_Array_TouchTestInfo_TouchResult;
...
typedef struct Ark_Union_DrawModifier_Undefined Ark_Union_DrawModifier_Undefined;
typedef struct Opt_Union_DrawModifier_Undefined Opt_Union_DrawModifier_Undefined;
...
typedef enum Ark_ProgressStatus {
    ARK_PROGRESS_STATUS_LOADING,
    ARK_PROGRESS_STATUS_PROGRESSING,
} Ark_ProgressStatus;
...
typedef enum Ark_TransitionEdge {
    ARK_TRANSITION_EDGE_TOP,
    ARK_TRANSITION_EDGE_BOTTOM,
    ARK_TRANSITION_EDGE_START,
    ARK_TRANSITION_EDGE_END,
} Ark_TransitionEdge;
...
typedef enum Ark_ProgressStyle {
    ARK_PROGRESS_STYLE_LINEAR,
    ARK_PROGRESS_STYLE_RING,
    ARK_PROGRESS_STYLE_ECLIPSE,
    ARK_PROGRESS_STYLE_SCALE_RING,
    ARK_PROGRESS_STYLE_CAPSULE,
} Ark_ProgressStyle;
...
typedef enum Ark_ScrollSource {
    ...
    ARK_SCROLL_SOURCE_FLING,
    ARK_SCROLL_SOURCE_EDGE_EFFECT,
    ARK_SCROLL_SOURCE_OTHER_USER_INPUT,
    ARK_SCROLL_SOURCE_SCROLL_BAR,
    ARK_SCROLL_SOURCE_SCROLL_BAR_FLING,
    ARK_SCROLL_SOURCE_SCROLLER,
    ARK_SCROLL_SOURCE_SCROLLER_ANIMATION,
} Ark_ScrollSource;
...
typedef enum Ark_SwipeActionState {
    ARK_SWIPE_ACTION_STATE_COLLAPSED,
    ARK_SWIPE_ACTION_STATE_EXPANDED,
    ARK_SWIPE_ACTION_STATE_ACTIONING,
...
typedef struct Ark_Callback_SwipeActionState_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_SwipeActionState state);
} Ark_Callback_SwipeActionState_Void;
typedef struct Opt_Callback_SwipeActionState_Void {
    Ark_Tag tag;
    Ark_Callback_SwipeActionState_Void value;
} Opt_Callback_SwipeActionState_Void;
typedef struct Ark_Callback_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId);
} Ark_Callback_Void;
typedef struct Opt_Callback_Void {
    Ark_Tag tag;
    Ark_Callback_Void value;
} Opt_Callback_Void;
typedef struct Ark_Callback_Any {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Callback_CustomObject_Void continuation);
} Ark_Callback_Any;
typedef struct Opt_Callback_Any {
    Ark_Tag tag;
    Ark_Callback_Any value;
} Opt_Callback_Any;
...
typedef struct Ark_Callback_DismissPopupAction_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissPopupAction parameter);
} Ark_Callback_DismissPopupAction_Void;
typedef struct Opt_Callback_DismissPopupAction_Void {
    Ark_Tag tag;
    Ark_Callback_DismissPopupAction_Void value;
...
typedef struct Ark_Callback_DismissDialogAction_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissDialogAction parameter);
} Ark_Callback_DismissDialogAction_Void;
typedef struct Opt_Callback_DismissDialogAction_Void {
    Ark_Tag tag;
    Ark_Callback_DismissDialogAction_Void value;
...
typedef struct Ark_Callback_TabContentTransitionProxy_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized proxy);
} Ark_Callback_TabContentTransitionProxy_Void;
typedef struct Opt_Callback_TabContentTransitionProxy_Void {
    Ark_Tag tag;
    Ark_Callback_TabContentTransitionProxy_Void value;
...
typedef struct Ark_Callback_NavigationTransitionProxy_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized transitionProxy);
} Ark_Callback_NavigationTransitionProxy_Void;
typedef struct Opt_Callback_NavigationTransitionProxy_Void {
    Ark_Tag tag;
    Ark_Callback_NavigationTransitionProxy_Void value;
} Opt_Callback_NavigationTransitionProxy_Void;
typedef struct Ark_Callback_Boolean_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Boolean parameter);
} Ark_Callback_Boolean_Void;
typedef struct Opt_Callback_Boolean_Void {
    Ark_Tag tag;
    Ark_Callback_Boolean_Void value;
...
typedef struct Ark_Union_Boolean_Callback_DismissPopupAction_Void {
    ...
    union {
        Ark_Boolean value0;
        Ark_Callback_DismissPopupAction_Void value1;
    };
...
typedef struct Ark_Callback_Literal_Boolean_isVisible_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Boolean_isVisible event);
} Ark_Callback_Literal_Boolean_isVisible_Void;
typedef struct Opt_Callback_Literal_Boolean_isVisible_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Boolean_isVisible_Void value;
...
typedef struct Ark_GetItemMainSizeByIndex {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Callback_Number_Void continuation);
} Ark_GetItemMainSizeByIndex;
typedef struct Opt_GetItemMainSizeByIndex {
    Ark_Tag tag;
    Ark_GetItemMainSizeByIndex value;
...
typedef struct Ark_Callback_TextPickerResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextPickerResult value);
} Ark_Callback_TextPickerResult_Void;
typedef struct Opt_Callback_TextPickerResult_Void {
    Ark_Tag tag;
    Ark_Callback_TextPickerResult_Void value;
...
typedef struct Ark_OnDidChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextRange rangeBefore, const Ark_TextRange rangeAfter);
} Ark_OnDidChangeCallback;
typedef struct Opt_OnDidChangeCallback {
    Ark_Tag tag;
    Ark_OnDidChangeCallback value;
} Opt_OnDidChangeCallback;
typedef struct Ark_Callback_StyledStringChangeValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_StyledStringChangeValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_StyledStringChangeValue_Boolean;
typedef struct Opt_Callback_StyledStringChangeValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_StyledStringChangeValue_Boolean value;
...
typedef struct Ark_InterceptionModeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_NavigationMode mode);
} Ark_InterceptionModeCallback;
typedef struct Opt_InterceptionModeCallback {
    Ark_Tag tag;
    Ark_InterceptionModeCallback value;
} Opt_InterceptionModeCallback;
typedef struct Ark_InterceptionShowCallback {
    Ark_CallbackResource resource;
...
typedef struct Ark_Uint8ClampedArray {
    Ark_Number BYTES_PER_ELEMENT;
    Ark_ArrayBuffer buffer;
    Ark_Number byteLength;
    Ark_Number byteOffset;
    Ark_Number length;
...
typedef struct Ark_Callback_Literal_String_plainText_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_String_plainText selectedText);
} Ark_Callback_Literal_String_plainText_Void;
typedef struct Opt_Callback_Literal_String_plainText_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_String_plainText_Void value;
...
typedef struct Ark_TouchEvent {
    ...
    Ark_Callback_Void stopPropagation;
    Ark_Callback_Void preventDefault;
} Ark_TouchEvent;
...
typedef struct Ark_SubTabBarStyle {
    Opt_Union_ResourceStr_Union_ResourceStr_ComponentContent _content;
...
typedef struct Ark_TabContentAnimatedTransition {
    Opt_Number timeout;
    Ark_Callback_TabContentTransitionProxy_Void transition;
...
typedef struct Ark_Callback_SwiperContentTransitionProxy_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized parameter);
} Ark_Callback_SwiperContentTransitionProxy_Void;
typedef struct Opt_Callback_SwiperContentTransitionProxy_Void {
    Ark_Tag tag;
    Ark_Callback_SwiperContentTransitionProxy_Void value;
...
typedef struct Ark_LinearStyleOptions {
    Opt_Boolean enableScanEffect;
    Opt_Length strokeWidth;
    Opt_Union_PX_VP_LPX_Resource strokeRadius;
...
typedef struct Ark_NavigationAnimatedTransition {
    ...
    Ark_Callback_NavigationTransitionProxy_Void transition;
...
typedef struct Ark_Callback_Number_Tuple_Number_Number_Number_Number {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Callback_Tuple_Number_Number_Number_Number_Void continuation);
} Ark_Callback_Number_Tuple_Number_Number_Number_Number;
typedef struct Opt_Callback_Number_Tuple_Number_Number_Number_Number {
    Ark_Tag tag;
    Ark_Callback_Number_Tuple_Number_Number_Number_Number value;
} Opt_Callback_Number_Tuple_Number_Number_Number_Number;
typedef struct Ark_Callback_Number_Tuple_Number_Number {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Callback_Tuple_Number_Number_Void continuation);
} Ark_Callback_Number_Tuple_Number_Number;
typedef struct Opt_Callback_Number_Tuple_Number_Number {
    Ark_Tag tag;
    Ark_Callback_Number_Tuple_Number_Number value;
...
typedef struct Ark_Callback_DismissContentCoverAction_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DismissContentCoverAction parameter);
} Ark_Callback_DismissContentCoverAction_Void;
typedef struct Opt_Callback_DismissContentCoverAction_Void {
    Ark_Tag tag;
    Ark_Callback_DismissContentCoverAction_Void value;
...
typedef struct Ark_WithThemeInterface {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_WithThemeOptions options, const Ark_Callback_WithThemeAttribute_Void continuation);
} Ark_WithThemeInterface;
typedef struct Opt_WithThemeInterface {
    Ark_Tag tag;
    Ark_WithThemeInterface value;
} Opt_WithThemeInterface;
typedef struct Ark_SliderTriggerChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number value, Ark_SliderChangeMode mode);
} Ark_SliderTriggerChangeCallback;
typedef struct Opt_SliderTriggerChangeCallback {
    Ark_Tag tag;
    Ark_SliderTriggerChangeCallback value;
} Opt_SliderTriggerChangeCallback;
typedef struct Ark_ScrollOnWillScrollCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number xOffset, const Ark_Number yOffset, Ark_ScrollState scrollState, Ark_ScrollSource scrollSource, const Ark_Callback_OffsetResult_Void continuation);
} Ark_ScrollOnWillScrollCallback;
typedef struct Opt_ScrollOnWillScrollCallback {
    Ark_Tag tag;
    Ark_ScrollOnWillScrollCallback value;
} Opt_ScrollOnWillScrollCallback;
typedef struct Ark_ScrollOnScrollCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number xOffset, const Ark_Number yOffset, Ark_ScrollState scrollState);
} Ark_ScrollOnScrollCallback;
typedef struct Opt_ScrollOnScrollCallback {
    Ark_Tag tag;
    Ark_ScrollOnScrollCallback value;
} Opt_ScrollOnScrollCallback;
typedef struct Ark_PageTransitionCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_RouteType type, const Ark_Number progress);
} Ark_PageTransitionCallback;
typedef struct Opt_PageTransitionCallback {
    Ark_Tag tag;
    Ark_PageTransitionCallback value;
} Opt_PageTransitionCallback;
typedef struct Ark_OnWillScrollCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number scrollOffset, Ark_ScrollState scrollState, Ark_ScrollSource scrollSource, const Ark_Callback_ScrollResult_Void continuation);
} Ark_OnWillScrollCallback;
typedef struct Opt_OnWillScrollCallback {
    Ark_Tag tag;
    Ark_OnWillScrollCallback value;
} Opt_OnWillScrollCallback;
typedef struct Ark_OnScrollCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number scrollOffset, Ark_ScrollState scrollState);
} Ark_OnScrollCallback;
typedef struct Opt_OnScrollCallback {
    Ark_Tag tag;
    Ark_OnScrollCallback value;
...
typedef struct Ark_IsolatedComponentInterface {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_IsolatedOptions options, const Ark_Callback_IsolatedComponentAttribute_Void continuation);
} Ark_IsolatedComponentInterface;
typedef struct Opt_IsolatedComponentInterface {
    Ark_Tag tag;
    Ark_IsolatedComponentInterface value;
} Opt_IsolatedComponentInterface;
typedef struct Ark_HoverCallback {
    Ark_CallbackResource resource;
...
typedef struct Opt_HoverCallback {
    Ark_Tag tag;
    Ark_HoverCallback value;
} Opt_HoverCallback;
typedef struct Ark_Callback_Any_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CustomObject item, const Ark_Number index);
} Ark_Callback_Any_Number_Void;
typedef struct Opt_Callback_Any_Number_Void {
    Ark_Tag tag;
    Ark_Callback_Any_Number_Void value;
} Opt_Callback_Any_Number_Void;
typedef struct Ark_Callback_Any_Number_String {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CustomObject item, const Ark_Number index, const Ark_Callback_String_Void continuation);
} Ark_Callback_Any_Number_String;
typedef struct Opt_Callback_Any_Number_String {
    Ark_Tag tag;
    Ark_Callback_Any_Number_String value;
} Opt_Callback_Any_Number_String;
typedef struct Ark_ButtonTriggerClickCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number xPos, const Ark_Number yPos);
} Ark_ButtonTriggerClickCallback;
typedef struct Opt_ButtonTriggerClickCallback {
    Ark_Tag tag;
    Ark_ButtonTriggerClickCallback value;
} Opt_ButtonTriggerClickCallback;
typedef struct Ark_Callback_WithThemeAttribute_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_WithThemeAttribute value);
} Ark_Callback_WithThemeAttribute_Void;
typedef struct Opt_Callback_WithThemeAttribute_Void {
    Ark_Tag tag;
    Ark_Callback_WithThemeAttribute_Void value;
...
typedef struct Ark_Callback_WebKeyboardOptions_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_WebKeyboardOptions value);
} Ark_Callback_WebKeyboardOptions_Void;
typedef struct Opt_Callback_WebKeyboardOptions_Void {
    Ark_Tag tag;
    Ark_Callback_WebKeyboardOptions_Void value;
} Opt_Callback_WebKeyboardOptions_Void;
typedef struct Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Union_TabContentAnimatedTransition_Undefined value);
} Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void;
typedef struct Opt_Callback_Union_TabContentAnimatedTransition_Undefined_Void {
    Ark_Tag tag;
    Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void value;
} Opt_Callback_Union_TabContentAnimatedTransition_Undefined_Void;
typedef struct Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Union_NavigationAnimatedTransition_Undefined value);
} Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void;
typedef struct Opt_Callback_Union_NavigationAnimatedTransition_Undefined_Void {
    Ark_Tag tag;
    Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void value;
} Opt_Callback_Union_NavigationAnimatedTransition_Undefined_Void;
typedef struct Ark_Callback_GestureRecognizer_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized value);
} Ark_Callback_GestureRecognizer_Void;
typedef struct Opt_Callback_GestureRecognizer_Void {
    Ark_Tag tag;
    Ark_Callback_GestureRecognizer_Void value;
} Opt_Callback_GestureRecognizer_Void;
typedef struct Ark_Callback_OffsetResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OffsetResult value);
} Ark_Callback_OffsetResult_Void;
typedef struct Opt_Callback_OffsetResult_Void {
    Ark_Tag tag;
    Ark_Callback_OffsetResult_Void value;
...
typedef struct Ark_Callback_ScrollResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ScrollResult value);
} Ark_Callback_ScrollResult_Void;
typedef struct Opt_Callback_ScrollResult_Void {
    Ark_Tag tag;
    Ark_Callback_ScrollResult_Void value;
...
typedef struct Ark_Callback_HitTestMode_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_HitTestMode value);
} Ark_Callback_HitTestMode_Void;
typedef struct Opt_Callback_HitTestMode_Void {
    Ark_Tag tag;
    Ark_Callback_HitTestMode_Void value;
} Opt_Callback_HitTestMode_Void;
typedef struct Ark_Callback_WebResourceResponse_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized value);
} Ark_Callback_WebResourceResponse_Void;
typedef struct Opt_Callback_WebResourceResponse_Void {
    Ark_Tag tag;
    Ark_Callback_WebResourceResponse_Void value;
} Opt_Callback_WebResourceResponse_Void;
typedef struct Ark_Callback_Tuple_Number_Number_Number_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Tuple_Number_Number_Number_Number value);
} Ark_Callback_Tuple_Number_Number_Number_Number_Void;
typedef struct Opt_Callback_Tuple_Number_Number_Number_Number_Void {
    Ark_Tag tag;
    Ark_Callback_Tuple_Number_Number_Number_Number_Void value;
} Opt_Callback_Tuple_Number_Number_Number_Number_Void;
typedef struct Ark_Callback_Tuple_Number_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Tuple_Number_Number value);
} Ark_Callback_Tuple_Number_Number_Void;
typedef struct Opt_Callback_Tuple_Number_Number_Void {
    Ark_Tag tag;
    Ark_Callback_Tuple_Number_Number_Void value;
} Opt_Callback_Tuple_Number_Number_Void;
typedef struct Ark_Callback_Literal_Number_offsetRemain_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Number_offsetRemain value);
} Ark_Callback_Literal_Number_offsetRemain_Void;
typedef struct Opt_Callback_Literal_Number_offsetRemain_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Number_offsetRemain_Void value;
} Opt_Callback_Literal_Number_offsetRemain_Void;
typedef struct Ark_Callback_ComputedBarAttribute_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ComputedBarAttribute value);
} Ark_Callback_ComputedBarAttribute_Void;
typedef struct Opt_Callback_ComputedBarAttribute_Void {
    Ark_Tag tag;
    Ark_Callback_ComputedBarAttribute_Void value;
} Opt_Callback_ComputedBarAttribute_Void;
typedef struct Ark_Callback_Callback_Any_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Callback_Any value);
} Ark_Callback_Callback_Any_Void;
typedef struct Opt_Callback_Callback_Any_Void {
    Ark_Tag tag;
    Ark_Callback_Callback_Any_Void value;
} Opt_Callback_Callback_Any_Void;
typedef struct Ark_Callback_GestureJudgeResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_GestureJudgeResult value);
} Ark_Callback_GestureJudgeResult_Void;
typedef struct Opt_Callback_GestureJudgeResult_Void {
    Ark_Tag tag;
    Ark_Callback_GestureJudgeResult_Void value;
} Opt_Callback_GestureJudgeResult_Void;
typedef struct Ark_Callback_Union_CustomBuilder_DragItemInfo_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Union_CustomBuilder_DragItemInfo value);
} Ark_Callback_Union_CustomBuilder_DragItemInfo_Void;
typedef struct Opt_Callback_Union_CustomBuilder_DragItemInfo_Void {
    Ark_Tag tag;
    Ark_Callback_Union_CustomBuilder_DragItemInfo_Void value;
} Opt_Callback_Union_CustomBuilder_DragItemInfo_Void;
typedef struct Ark_Callback_TouchResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TouchResult value);
} Ark_Callback_TouchResult_Void;
typedef struct Opt_Callback_TouchResult_Void {
    Ark_Tag tag;
    Ark_Callback_TouchResult_Void value;
} Opt_Callback_TouchResult_Void;
typedef struct Ark_Callback_CustomObject_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CustomObject value);
} Ark_Callback_CustomObject_Void;
typedef struct Opt_Callback_CustomObject_Void {
    Ark_Tag tag;
    Ark_Callback_CustomObject_Void value;
} Opt_Callback_CustomObject_Void;
...
typedef struct Ark_Union_Array_Number_Undefined {
    Ark_Int32 selector;
    union {
        Array_Number value0;
        Ark_Undefined value1;
    };
} Ark_Union_Array_Number_Undefined;
typedef struct Opt_Union_Array_Number_Undefined {
    Ark_Tag tag;
    Ark_Union_Array_Number_Undefined value;
} Opt_Union_Array_Number_Undefined;
...
typedef struct Ark_Union_OnMoveHandler_Undefined {
    Ark_Int32 selector;
    union {
        Ark_OnMoveHandler value0;
        Ark_Undefined value1;
    };
} Ark_Union_OnMoveHandler_Undefined;
typedef struct Opt_Union_OnMoveHandler_Undefined {
    Ark_Tag tag;
    Ark_Union_OnMoveHandler_Undefined value;
...
typedef struct Ark_Union_OnLinearIndicatorChangeCallback_Undefined {
    Ark_Int32 selector;
    union {
        Ark_OnLinearIndicatorChangeCallback value0;
        Ark_Undefined value1;
    };
} Ark_Union_OnLinearIndicatorChangeCallback_Undefined;
typedef struct Opt_Union_OnLinearIndicatorChangeCallback_Undefined {
    Ark_Tag tag;
    Ark_Union_OnLinearIndicatorChangeCallback_Undefined value;
} Opt_Union_OnLinearIndicatorChangeCallback_Undefined;
typedef struct Ark_Union_Boolean_Undefined {
    Ark_Int32 selector;
    union {
        Ark_Boolean value0;
        Ark_Undefined value1;
    };
} Ark_Union_Boolean_Undefined;
typedef struct Opt_Union_Boolean_Undefined {
    Ark_Tag tag;
    Ark_Union_Boolean_Undefined value;
} Opt_Union_Boolean_Undefined;
typedef struct Ark_Union_LinearIndicatorStyle_Undefined {
    Ark_Int32 selector;
    union {
        Ark_LinearIndicatorStyle value0;
        Ark_Undefined value1;
    };
} Ark_Union_LinearIndicatorStyle_Undefined;
typedef struct Opt_Union_LinearIndicatorStyle_Undefined {
    Ark_Tag tag;
    Ark_Union_LinearIndicatorStyle_Undefined value;
...
typedef struct Ark_Callback_Literal_Number_code_Want_want_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Number_code_Want_want parameter);
} Ark_Callback_Literal_Number_code_Want_want_Void;
typedef struct Opt_Callback_Literal_Number_code_Want_want_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Number_code_Want_want_Void value;
} Opt_Callback_Literal_Number_code_Want_want_Void;
typedef struct Ark_Literal_Empty {
    void *handle;
} Ark_Literal_Empty;
typedef struct Opt_Literal_Empty {
    Ark_Tag tag;
    Ark_Literal_Empty value;
} Opt_Literal_Empty;
typedef struct Ark_Callback_Literal_Empty_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Empty parameter);
} Ark_Callback_Literal_Empty_Void;
typedef struct Opt_Callback_Literal_Empty_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Empty_Void value;
} Opt_Callback_Literal_Empty_Void;
typedef struct Opt_UIExtensionProxy {
    Ark_Tag tag;
    Ark_UIExtensionProxy value;
} Opt_UIExtensionProxy;
typedef struct Ark_Callback_UIExtensionProxy_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized proxy);
} Ark_Callback_UIExtensionProxy_Void;
typedef struct Opt_Callback_UIExtensionProxy_Void {
    Ark_Tag tag;
    Ark_Callback_UIExtensionProxy_Void value;
...
typedef struct Ark_WebKeyboardCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_WebKeyboardCallbackInfo keyboardCallbackInfo, const Ark_Callback_WebKeyboardOptions_Void continuation);
} Ark_WebKeyboardCallback;
typedef struct Opt_WebKeyboardCallback {
    Ark_Tag tag;
    Ark_WebKeyboardCallback value;
} Opt_WebKeyboardCallback;
typedef struct Ark_OnViewportFitChangedCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_ViewportFit viewportFit);
} Ark_OnViewportFitChangedCallback;
typedef struct Opt_OnViewportFitChangedCallback {
    Ark_Tag tag;
    Ark_OnViewportFitChangedCallback value;
...
typedef struct Ark_ExpandedMenuItemOptions {
    Ark_ResourceStr content;
    Opt_ResourceStr startIcon;
    Ark_Callback_Literal_String_plainText_Void action;
...
typedef struct Ark_OnRenderProcessRespondingCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId);
} Ark_OnRenderProcessRespondingCallback;
typedef struct Opt_OnRenderProcessRespondingCallback {
    Ark_Tag tag;
    Ark_OnRenderProcessRespondingCallback value;
...
typedef struct Ark_OnRenderProcessNotRespondingCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RenderProcessNotRespondingData data);
} Ark_OnRenderProcessNotRespondingCallback;
typedef struct Opt_OnRenderProcessNotRespondingCallback {
    Ark_Tag tag;
    Ark_OnRenderProcessNotRespondingCallback value;
...
typedef struct Ark_OnOverrideUrlLoadingCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized webResourceRequest, const Ark_Callback_Boolean_Void continuation);
} Ark_OnOverrideUrlLoadingCallback;
typedef struct Opt_OnOverrideUrlLoadingCallback {
    Ark_Tag tag;
    Ark_OnOverrideUrlLoadingCallback value;
...
typedef struct Ark_Callback_NativeEmbedTouchInfo_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_NativeEmbedTouchInfo event);
} Ark_Callback_NativeEmbedTouchInfo_Void;
typedef struct Opt_Callback_NativeEmbedTouchInfo_Void {
    Ark_Tag tag;
    Ark_Callback_NativeEmbedTouchInfo_Void value;
...
typedef struct Ark_Callback_NativeEmbedDataInfo_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_NativeEmbedDataInfo event);
} Ark_Callback_NativeEmbedDataInfo_Void;
typedef struct Opt_Callback_NativeEmbedDataInfo_Void {
    Ark_Tag tag;
    Ark_Callback_NativeEmbedDataInfo_Void value;
...
typedef struct Ark_OnIntelligentTrackingPreventionCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_IntelligentTrackingPreventionDetails details);
} Ark_OnIntelligentTrackingPreventionCallback;
typedef struct Opt_OnIntelligentTrackingPreventionCallback {
    Ark_Tag tag;
    Ark_OnIntelligentTrackingPreventionCallback value;
...
typedef struct Ark_Callback_OnOverScrollEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnOverScrollEvent parameter);
} Ark_Callback_OnOverScrollEvent_Void;
typedef struct Opt_Callback_OnOverScrollEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnOverScrollEvent_Void value;
...
typedef struct Ark_Callback_OnLoadInterceptEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnLoadInterceptEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnLoadInterceptEvent_Boolean;
typedef struct Opt_Callback_OnLoadInterceptEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnLoadInterceptEvent_Boolean value;
...
typedef struct Ark_Callback_OnFirstContentfulPaintEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnFirstContentfulPaintEvent parameter);
} Ark_Callback_OnFirstContentfulPaintEvent_Void;
typedef struct Opt_Callback_OnFirstContentfulPaintEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnFirstContentfulPaintEvent_Void value;
...
typedef struct Ark_Callback_OnAudioStateChangedEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnAudioStateChangedEvent parameter);
} Ark_Callback_OnAudioStateChangedEvent_Void;
typedef struct Opt_Callback_OnAudioStateChangedEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnAudioStateChangedEvent_Void value;
...
typedef struct Ark_Callback_OnDataResubmittedEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnDataResubmittedEvent parameter);
} Ark_Callback_OnDataResubmittedEvent_Void;
typedef struct Opt_Callback_OnDataResubmittedEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnDataResubmittedEvent_Void value;
...
typedef struct Ark_Callback_OnPageVisibleEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnPageVisibleEvent parameter);
} Ark_Callback_OnPageVisibleEvent_Void;
typedef struct Opt_Callback_OnPageVisibleEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnPageVisibleEvent_Void value;
...
typedef struct Ark_Callback_OnFaviconReceivedEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnFaviconReceivedEvent parameter);
} Ark_Callback_OnFaviconReceivedEvent_Void;
typedef struct Opt_Callback_OnFaviconReceivedEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnFaviconReceivedEvent_Void value;
...
typedef struct Ark_Callback_OnTouchIconUrlReceivedEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnTouchIconUrlReceivedEvent parameter);
} Ark_Callback_OnTouchIconUrlReceivedEvent_Void;
typedef struct Opt_Callback_OnTouchIconUrlReceivedEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnTouchIconUrlReceivedEvent_Void value;
...
typedef struct Ark_Callback_OnWindowNewEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnWindowNewEvent parameter);
} Ark_Callback_OnWindowNewEvent_Void;
typedef struct Opt_Callback_OnWindowNewEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnWindowNewEvent_Void value;
...
typedef struct Ark_Callback_OnClientAuthenticationEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnClientAuthenticationEvent parameter);
} Ark_Callback_OnClientAuthenticationEvent_Void;
typedef struct Opt_Callback_OnClientAuthenticationEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnClientAuthenticationEvent_Void value;
...
typedef struct Ark_Callback_OnSslErrorEventReceiveEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnSslErrorEventReceiveEvent parameter);
} Ark_Callback_OnSslErrorEventReceiveEvent_Void;
typedef struct Opt_Callback_OnSslErrorEventReceiveEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnSslErrorEventReceiveEvent_Void value;
...
typedef struct Ark_Callback_OnSearchResultReceiveEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnSearchResultReceiveEvent parameter);
} Ark_Callback_OnSearchResultReceiveEvent_Void;
typedef struct Opt_Callback_OnSearchResultReceiveEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnSearchResultReceiveEvent_Void value;
} Opt_Callback_OnSearchResultReceiveEvent_Void;
typedef struct Ark_OnContextMenuHideCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId);
} Ark_OnContextMenuHideCallback;
typedef struct Opt_OnContextMenuHideCallback {
    Ark_Tag tag;
    Ark_OnContextMenuHideCallback value;
...
typedef struct Ark_Callback_OnContextMenuShowEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnContextMenuShowEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnContextMenuShowEvent_Boolean;
typedef struct Opt_Callback_OnContextMenuShowEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnContextMenuShowEvent_Boolean value;
...
typedef struct Ark_Callback_OnScreenCaptureRequestEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnScreenCaptureRequestEvent parameter);
} Ark_Callback_OnScreenCaptureRequestEvent_Void;
typedef struct Opt_Callback_OnScreenCaptureRequestEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnScreenCaptureRequestEvent_Void value;
...
typedef struct Ark_Callback_OnPermissionRequestEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnPermissionRequestEvent parameter);
} Ark_Callback_OnPermissionRequestEvent_Void;
typedef struct Opt_Callback_OnPermissionRequestEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnPermissionRequestEvent_Void value;
...
typedef struct Ark_Callback_OnInterceptRequestEvent_WebResourceResponse {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnInterceptRequestEvent parameter, const Ark_Callback_WebResourceResponse_Void continuation);
} Ark_Callback_OnInterceptRequestEvent_WebResourceResponse;
typedef struct Opt_Callback_OnInterceptRequestEvent_WebResourceResponse {
    Ark_Tag tag;
    Ark_Callback_OnInterceptRequestEvent_WebResourceResponse value;
...
typedef struct Ark_Callback_OnHttpAuthRequestEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnHttpAuthRequestEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnHttpAuthRequestEvent_Boolean;
typedef struct Opt_Callback_OnHttpAuthRequestEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnHttpAuthRequestEvent_Boolean value;
...
typedef struct Ark_Callback_OnScaleChangeEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnScaleChangeEvent parameter);
} Ark_Callback_OnScaleChangeEvent_Void;
typedef struct Opt_Callback_OnScaleChangeEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnScaleChangeEvent_Void value;
...
typedef struct Ark_Callback_OnResourceLoadEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnResourceLoadEvent parameter);
} Ark_Callback_OnResourceLoadEvent_Void;
typedef struct Opt_Callback_OnResourceLoadEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnResourceLoadEvent_Void value;
...
typedef struct Ark_Callback_Literal_Function_callback_Object_fileSelector_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Function_callback_Object_fileSelector event);
} Ark_Callback_Literal_Function_callback_Object_fileSelector_Void;
typedef struct Opt_Callback_Literal_Function_callback_Object_fileSelector_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Function_callback_Object_fileSelector_Void value;
...
typedef struct Ark_Callback_Literal_Object_detail_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Object_detail event, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_Literal_Object_detail_Boolean;
typedef struct Opt_Callback_Literal_Object_detail_Boolean {
    Ark_Tag tag;
    Ark_Callback_Literal_Object_detail_Boolean value;
...
typedef struct Ark_Callback_OnShowFileSelectorEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnShowFileSelectorEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnShowFileSelectorEvent_Boolean;
typedef struct Opt_Callback_OnShowFileSelectorEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnShowFileSelectorEvent_Boolean value;
...
typedef struct Ark_Callback_OnRenderExitedEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnRenderExitedEvent parameter);
} Ark_Callback_OnRenderExitedEvent_Void;
typedef struct Opt_Callback_OnRenderExitedEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnRenderExitedEvent_Void value;
...
typedef struct Ark_Callback_Literal_Function_handler_Object_error_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Function_handler_Object_error event);
} Ark_Callback_Literal_Function_handler_Object_error_Void;
typedef struct Opt_Callback_Literal_Function_handler_Object_error_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Function_handler_Object_error_Void value;
...
typedef struct Ark_Type_WebAttribute_onUrlLoadIntercept_callback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Union_String_WebResourceRequest_data event, const Ark_Callback_Boolean_Void continuation);
} Ark_Type_WebAttribute_onUrlLoadIntercept_callback;
typedef struct Opt_Type_WebAttribute_onUrlLoadIntercept_callback {
    Ark_Tag tag;
    Ark_Type_WebAttribute_onUrlLoadIntercept_callback value;
...
typedef struct Ark_Callback_OnRefreshAccessedHistoryEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnRefreshAccessedHistoryEvent parameter);
} Ark_Callback_OnRefreshAccessedHistoryEvent_Void;
typedef struct Opt_Callback_OnRefreshAccessedHistoryEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnRefreshAccessedHistoryEvent_Void value;
...
typedef struct Ark_Callback_OnDownloadStartEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnDownloadStartEvent parameter);
} Ark_Callback_OnDownloadStartEvent_Void;
typedef struct Opt_Callback_OnDownloadStartEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnDownloadStartEvent_Void value;
...
typedef struct Ark_Callback_OnHttpErrorReceiveEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnHttpErrorReceiveEvent parameter);
} Ark_Callback_OnHttpErrorReceiveEvent_Void;
typedef struct Opt_Callback_OnHttpErrorReceiveEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnHttpErrorReceiveEvent_Void value;
...
typedef struct Ark_Callback_OnErrorReceiveEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnErrorReceiveEvent parameter);
} Ark_Callback_OnErrorReceiveEvent_Void;
typedef struct Opt_Callback_OnErrorReceiveEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnErrorReceiveEvent_Void value;
...
typedef struct Ark_Callback_OnConsoleEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnConsoleEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnConsoleEvent_Boolean;
typedef struct Opt_Callback_OnConsoleEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnConsoleEvent_Boolean value;
...
typedef struct Ark_Callback_OnPromptEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnPromptEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnPromptEvent_Boolean;
typedef struct Opt_Callback_OnPromptEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnPromptEvent_Boolean value;
...
typedef struct Ark_Callback_OnConfirmEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnConfirmEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnConfirmEvent_Boolean;
typedef struct Opt_Callback_OnConfirmEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnConfirmEvent_Boolean value;
...
typedef struct Ark_Callback_OnBeforeUnloadEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnBeforeUnloadEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnBeforeUnloadEvent_Boolean;
typedef struct Opt_Callback_OnBeforeUnloadEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnBeforeUnloadEvent_Boolean value;
...
typedef struct Ark_Callback_OnAlertEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnAlertEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_OnAlertEvent_Boolean;
typedef struct Opt_Callback_OnAlertEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_OnAlertEvent_Boolean value;
...
typedef struct Ark_Callback_OnGeolocationShowEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnGeolocationShowEvent parameter);
} Ark_Callback_OnGeolocationShowEvent_Void;
typedef struct Opt_Callback_OnGeolocationShowEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnGeolocationShowEvent_Void value;
...
typedef struct Ark_Callback_OnTitleReceiveEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnTitleReceiveEvent parameter);
} Ark_Callback_OnTitleReceiveEvent_Void;
typedef struct Opt_Callback_OnTitleReceiveEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnTitleReceiveEvent_Void value;
...
typedef struct Ark_Callback_OnProgressChangeEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnProgressChangeEvent parameter);
} Ark_Callback_OnProgressChangeEvent_Void;
typedef struct Opt_Callback_OnProgressChangeEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnProgressChangeEvent_Void value;
...
typedef struct Ark_Callback_OnPageBeginEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_OnPageBeginEvent parameter);
} Ark_Callback_OnPageBeginEvent_Void;
typedef struct Opt_Callback_OnPageBeginEvent_Void {
    Ark_Tag tag;
    Ark_Callback_OnPageBeginEvent_Void value;
...
typedef struct Ark_Callback_Literal_Number_time_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Number_time event);
} Ark_Callback_Literal_Number_time_Void;
typedef struct Opt_Callback_Literal_Number_time_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Number_time_Void value;
...
typedef struct Ark_Callback_Literal_Number_duration_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Number_duration event);
} Ark_Callback_Literal_Number_duration_Void;
typedef struct Opt_Callback_Literal_Number_duration_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Number_duration_Void value;
...
typedef struct Ark_Callback_Literal_Boolean_fullscreen_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Boolean_fullscreen event);
} Ark_Callback_Literal_Boolean_fullscreen_Void;
typedef struct Opt_Callback_Literal_Boolean_fullscreen_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Boolean_fullscreen_Void value;
} Opt_Callback_Literal_Boolean_fullscreen_Void;
...
typedef struct Ark_Callback_EnterKeyType_SubmitEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_EnterKeyType enterKey, const Ark_SubmitEvent event);
} Ark_Callback_EnterKeyType_SubmitEvent_Void;
typedef struct Opt_Callback_EnterKeyType_SubmitEvent_Void {
    Ark_Tag tag;
    Ark_Callback_EnterKeyType_SubmitEvent_Void value;
...
typedef struct Ark_Union_DateTimeOptions_Undefined {
    Ark_Int32 selector;
    union {
        Ark_CustomObject value0;
        Ark_Undefined value1;
    };
} Ark_Union_DateTimeOptions_Undefined;
typedef struct Opt_Union_DateTimeOptions_Undefined {
    Ark_Tag tag;
    Ark_Union_DateTimeOptions_Undefined value;
} Opt_Union_DateTimeOptions_Undefined;
...
typedef struct Ark_Callback_EnterKeyType_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_EnterKeyType enterKey);
} Ark_Callback_EnterKeyType_Void;
typedef struct Opt_Callback_EnterKeyType_Void {
    Ark_Tag tag;
    Ark_Callback_EnterKeyType_Void value;
...
typedef struct Ark_Type_TabsAttribute_customContentTransition_delegate {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const Ark_Callback_Union_TabContentAnimatedTransition_Undefined_Void continuation);
} Ark_Type_TabsAttribute_customContentTransition_delegate;
typedef struct Opt_Type_TabsAttribute_customContentTransition_delegate {
    Ark_Tag tag;
    Ark_Type_TabsAttribute_customContentTransition_delegate value;
...
typedef struct Ark_Callback_Number_TabsAnimationEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_TabsAnimationEvent event);
} Ark_Callback_Number_TabsAnimationEvent_Void;
typedef struct Opt_Callback_Number_TabsAnimationEvent_Void {
    Ark_Tag tag;
    Ark_Callback_Number_TabsAnimationEvent_Void value;
} Opt_Callback_Number_TabsAnimationEvent_Void;
...
typedef struct Ark_Callback_Number_Number_TabsAnimationEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Number targetIndex, const Ark_TabsAnimationEvent event);
} Ark_Callback_Number_Number_TabsAnimationEvent_Void;
typedef struct Opt_Callback_Number_Number_TabsAnimationEvent_Void {
    Ark_Tag tag;
    Ark_Callback_Number_Number_TabsAnimationEvent_Void value;
} Opt_Callback_Number_Number_TabsAnimationEvent_Void;
typedef struct Ark_Union_EdgeEffect_Undefined {
    Ark_Int32 selector;
    union {
        Ark_EdgeEffect value0;
        Ark_Undefined value1;
    };
} Ark_Union_EdgeEffect_Undefined;
typedef struct Opt_Union_EdgeEffect_Undefined {
    Ark_Tag tag;
    Ark_Union_EdgeEffect_Undefined value;
} Opt_Union_EdgeEffect_Undefined;
typedef struct Ark_Union_AnimationMode_Undefined {
    Ark_Int32 selector;
    union {
        Ark_AnimationMode value0;
        Ark_Undefined value1;
    };
} Ark_Union_AnimationMode_Undefined;
typedef struct Opt_Union_AnimationMode_Undefined {
    Ark_Tag tag;
    Ark_Union_AnimationMode_Undefined value;
...
typedef struct Ark_ContentDidScrollCallback {
    Ark_CallbackResource resource;
...
} Ark_ContentDidScrollCallback;
typedef struct Opt_ContentDidScrollCallback {
    Ark_Tag tag;
    Ark_ContentDidScrollCallback value;
...
typedef struct Ark_SwiperContentAnimatedTransition {
    Opt_Number timeout;
    Ark_Callback_SwiperContentTransitionProxy_Void transition;
...
typedef struct Ark_Callback_Number_Number_SwiperAnimationEvent_Void {
    Ark_CallbackResource resource;
...
} Ark_Callback_Number_Number_SwiperAnimationEvent_Void;
typedef struct Opt_Callback_Number_Number_SwiperAnimationEvent_Void {
    Ark_Tag tag;
    Ark_Callback_Number_Number_SwiperAnimationEvent_Void value;
...
typedef struct Ark_Callback_Number_SliderChangeMode_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number value, Ark_SliderChangeMode mode);
} Ark_Callback_Number_SliderChangeMode_Void;
typedef struct Opt_Callback_Number_SliderChangeMode_Void {
    Ark_Tag tag;
    Ark_Callback_Number_SliderChangeMode_Void value;
...
typedef struct Ark_Literal_Union_Number_String_height_width_x_y {
    Opt_Union_Number_String x;
    Opt_Union_Number_String y;
    Opt_Union_Number_String width;
    Opt_Union_Number_String height;
} Ark_Literal_Union_Number_String_height_width_x_y;
typedef struct Opt_Literal_Union_Number_String_height_width_x_y {
    Ark_Tag tag;
    Ark_Literal_Union_Number_String_height_width_x_y value;
} Opt_Literal_Union_Number_String_height_width_x_y;
typedef struct Ark_Union_Union_DividerOptions_Undefined_Undefined {
    Ark_Int32 selector;
    union {
        Ark_Union_DividerOptions_Undefined value0;
        Ark_Undefined value1;
    };
} Ark_Union_Union_DividerOptions_Undefined_Undefined;
typedef struct Opt_Union_Union_DividerOptions_Undefined_Undefined {
    Ark_Tag tag;
    Ark_Union_Union_DividerOptions_Undefined_Undefined value;
...
typedef struct Ark_Callback_DeleteValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DeleteValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_DeleteValue_Boolean;
typedef struct Opt_Callback_DeleteValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_DeleteValue_Boolean value;
} Opt_Callback_DeleteValue_Boolean;
typedef struct Ark_Callback_InsertValue_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_InsertValue parameter);
} Ark_Callback_InsertValue_Void;
typedef struct Opt_Callback_InsertValue_Void {
    Ark_Tag tag;
    Ark_Callback_InsertValue_Void value;
...
typedef struct Ark_Callback_InsertValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_InsertValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_InsertValue_Boolean;
typedef struct Opt_Callback_InsertValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_InsertValue_Boolean value;
...
typedef struct Ark_OnScrollFrameBeginCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const Ark_Callback_OnScrollFrameBeginHandlerResult_Void continuation);
} Ark_OnScrollFrameBeginCallback;
typedef struct Opt_OnScrollFrameBeginCallback {
    Ark_Tag tag;
    Ark_OnScrollFrameBeginCallback value;
...
typedef struct Ark_Callback_RichEditorChangeValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorChangeValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_RichEditorChangeValue_Boolean;
typedef struct Opt_Callback_RichEditorChangeValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_RichEditorChangeValue_Boolean value;
...
typedef struct Ark_SubmitCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_EnterKeyType enterKey, const Ark_SubmitEvent event);
} Ark_SubmitCallback;
typedef struct Opt_SubmitCallback {
    Ark_Tag tag;
    Ark_SubmitCallback value;
} Opt_SubmitCallback;
...
typedef struct Ark_Callback_RichEditorDeleteValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorDeleteValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_RichEditorDeleteValue_Boolean;
typedef struct Opt_Callback_RichEditorDeleteValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_RichEditorDeleteValue_Boolean value;
} Opt_Callback_RichEditorDeleteValue_Boolean;
typedef struct Ark_Callback_TextRange_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextRange parameter);
} Ark_Callback_TextRange_Void;
typedef struct Opt_Callback_TextRange_Void {
    Ark_Tag tag;
    Ark_Callback_TextRange_Void value;
} Opt_Callback_TextRange_Void;
typedef struct Ark_Callback_RichEditorTextSpanResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorTextSpanResult parameter);
} Ark_Callback_RichEditorTextSpanResult_Void;
typedef struct Opt_Callback_RichEditorTextSpanResult_Void {
    Ark_Tag tag;
    Ark_Callback_RichEditorTextSpanResult_Void value;
...
typedef struct Ark_Callback_RichEditorInsertValue_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorInsertValue parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_RichEditorInsertValue_Boolean;
typedef struct Opt_Callback_RichEditorInsertValue_Boolean {
    Ark_Tag tag;
    Ark_Callback_RichEditorInsertValue_Boolean value;
...
typedef struct Ark_Callback_RichEditorRange_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorRange parameter);
} Ark_Callback_RichEditorRange_Void;
typedef struct Opt_Callback_RichEditorRange_Void {
    Ark_Tag tag;
    Ark_Callback_RichEditorRange_Void value;
...
typedef struct Ark_Callback_RichEditorSelection_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorSelection parameter);
} Ark_Callback_RichEditorSelection_Void;
typedef struct Opt_Callback_RichEditorSelection_Void {
    Ark_Tag tag;
    Ark_Callback_RichEditorSelection_Void value;
...
typedef struct Ark_Union_Number_Undefined {
    Ark_Int32 selector;
    union {
        Ark_Number value0;
        Ark_Undefined value1;
...
typedef struct Opt_Union_Number_Undefined {
    Ark_Tag tag;
    Ark_Union_Number_Undefined value;
} Opt_Union_Number_Undefined;
typedef struct Ark_Callback_RefreshStatus_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_RefreshStatus state);
} Ark_Callback_RefreshStatus_Void;
typedef struct Opt_Callback_RefreshStatus_Void {
    Ark_Tag tag;
    Ark_Callback_RefreshStatus_Void value;
...
typedef struct Ark_Union_CircleStyleOptions_Undefined {
    Ark_Int32 selector;
    union {
        Ark_CircleStyleOptions value0;
        Ark_Undefined value1;
    };
} Ark_Union_CircleStyleOptions_Undefined;
typedef struct Opt_Union_CircleStyleOptions_Undefined {
    Ark_Tag tag;
    Ark_Union_CircleStyleOptions_Undefined value;
} Opt_Union_CircleStyleOptions_Undefined;
typedef struct Ark_Callback_Array_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Array_Number input);
} Ark_Callback_Array_Number_Void;
typedef struct Opt_Callback_Array_Number_Void {
    Ark_Tag tag;
    Ark_Callback_Array_Number_Void value;
...
typedef struct Ark_Literal_Union_Number_String_height_width_String_commands {
    Opt_Union_Number_String width;
    Opt_Union_Number_String height;
    Opt_String commands;
} Ark_Literal_Union_Number_String_height_width_String_commands;
typedef struct Opt_Literal_Union_Number_String_height_width_String_commands {
    Ark_Tag tag;
    Ark_Literal_Union_Number_String_height_width_String_commands value;
} Opt_Literal_Union_Number_String_height_width_String_commands;
typedef struct Ark_Callback_ClickEvent_PasteButtonOnClickResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ClickEvent event, Ark_PasteButtonOnClickResult result);
} Ark_Callback_ClickEvent_PasteButtonOnClickResult_Void;
typedef struct Opt_Callback_ClickEvent_PasteButtonOnClickResult_Void {
    Ark_Tag tag;
    Ark_Callback_ClickEvent_PasteButtonOnClickResult_Void value;
...
typedef struct Ark_Union_SystemBarStyle_Undefined {
    Ark_Int32 selector;
    union {
        Ark_CustomObject value0;
        Ark_Undefined value1;
    };
} Ark_Union_SystemBarStyle_Undefined;
typedef struct Opt_Union_SystemBarStyle_Undefined {
    Ark_Tag tag;
    Ark_Union_SystemBarStyle_Undefined value;
} Opt_Union_SystemBarStyle_Undefined;
...
typedef struct Ark_Type_NavigationAttribute_customNavContentTransition_delegate {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_NavContentInfo from, const Ark_NavContentInfo to, Ark_NavigationOperation operation, const Ark_Callback_Union_NavigationAnimatedTransition_Undefined_Void continuation);
} Ark_Type_NavigationAttribute_customNavContentTransition_delegate;
typedef struct Opt_Type_NavigationAttribute_customNavContentTransition_delegate {
    Ark_Tag tag;
    Ark_Type_NavigationAttribute_customNavContentTransition_delegate value;
} Opt_Type_NavigationAttribute_customNavContentTransition_delegate;
typedef struct Ark_Callback_String_Unknown_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_String name, const Ark_CustomObject param);
} Ark_Callback_String_Unknown_Void;
typedef struct Opt_Callback_String_Unknown_Void {
    Ark_Tag tag;
    Ark_Callback_String_Unknown_Void value;
} Opt_Callback_String_Unknown_Void;
typedef struct Ark_Callback_NavigationMode_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_NavigationMode mode);
} Ark_Callback_NavigationMode_Void;
typedef struct Opt_Callback_NavigationMode_Void {
    Ark_Tag tag;
    Ark_Callback_NavigationMode_Void value;
} Opt_Callback_NavigationMode_Void;
typedef struct Ark_Callback_NavigationTitleMode_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_NavigationTitleMode titleMode);
} Ark_Callback_NavigationTitleMode_Void;
typedef struct Opt_Callback_NavigationTitleMode_Void {
    Ark_Tag tag;
    Ark_Callback_NavigationTitleMode_Void value;
...
typedef struct Ark_Callback_NavDestinationContext_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized parameter);
} Ark_Callback_NavDestinationContext_Void;
typedef struct Opt_Callback_NavDestinationContext_Void {
    Ark_Tag tag;
    Ark_Callback_NavDestinationContext_Void value;
...
typedef struct Ark_Callback_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_Boolean;
typedef struct Opt_Callback_Boolean {
    Ark_Tag tag;
    Ark_Callback_Boolean value;
...
typedef struct Ark_Callback_ClickEvent_LocationButtonOnClickResult_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ClickEvent event, Ark_LocationButtonOnClickResult result);
} Ark_Callback_ClickEvent_LocationButtonOnClickResult_Void;
typedef struct Opt_Callback_ClickEvent_LocationButtonOnClickResult_Void {
    Ark_Tag tag;
    Ark_Callback_ClickEvent_LocationButtonOnClickResult_Void value;
...
typedef struct Ark_Callback_Number_Number_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_Number_Number_Boolean;
typedef struct Opt_Callback_Number_Number_Boolean {
    Ark_Tag tag;
    Ark_Callback_Number_Number_Boolean value;
} Opt_Callback_Number_Number_Boolean;
typedef struct Ark_Callback_Number_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_Number_Boolean;
typedef struct Opt_Callback_Number_Boolean {
    Ark_Tag tag;
    Ark_Callback_Number_Boolean value;
...
typedef struct Ark_Callback_Type_ImageAttribute_onComplete_callback_event_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Type_ImageAttribute_onComplete_callback_event event);
} Ark_Callback_Type_ImageAttribute_onComplete_callback_event_Void;
typedef struct Opt_Callback_Type_ImageAttribute_onComplete_callback_event_Void {
    Ark_Tag tag;
    Ark_Callback_Type_ImageAttribute_onComplete_callback_event_Void value;
...
typedef struct Ark_Callback_Number_ScrollState_Literal_Number_offsetRemain {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const Ark_Callback_Literal_Number_offsetRemain_Void continuation);
} Ark_Callback_Number_ScrollState_Literal_Number_offsetRemain;
typedef struct Opt_Callback_Number_ScrollState_Literal_Number_offsetRemain {
    Ark_Tag tag;
    Ark_Callback_Number_ScrollState_Literal_Number_offsetRemain value;
} Opt_Callback_Number_ScrollState_Literal_Number_offsetRemain;
typedef struct Ark_Union_GridItemAlignment_Undefined {
    Ark_Int32 selector;
    union {
        Ark_GridItemAlignment value0;
        Ark_Undefined value1;
    };
} Ark_Union_GridItemAlignment_Undefined;
typedef struct Opt_Union_GridItemAlignment_Undefined {
    Ark_Tag tag;
    Ark_Union_GridItemAlignment_Undefined value;
} Opt_Union_GridItemAlignment_Undefined;
typedef struct Ark_Callback_ItemDragInfo_Number_Number_Boolean_Void {
    Ark_CallbackResource resource;
...
} Ark_Callback_ItemDragInfo_Number_Number_Boolean_Void;
typedef struct Opt_Callback_ItemDragInfo_Number_Number_Boolean_Void {
    Ark_Tag tag;
    Ark_Callback_ItemDragInfo_Number_Number_Boolean_Void value;
} Opt_Callback_ItemDragInfo_Number_Number_Boolean_Void;
typedef struct Ark_Callback_ItemDragInfo_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ItemDragInfo event, const Ark_Number itemIndex);
} Ark_Callback_ItemDragInfo_Number_Void;
typedef struct Opt_Callback_ItemDragInfo_Number_Void {
    Ark_Tag tag;
    Ark_Callback_ItemDragInfo_Number_Void value;
} Opt_Callback_ItemDragInfo_Number_Void;
typedef struct Ark_Callback_ItemDragInfo_Number_Number_Void {
    Ark_CallbackResource resource;
...
typedef struct Ark_Callback_ItemDragInfo_Number_Callback_Any {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ItemDragInfo event, const Ark_Number itemIndex, const Ark_Callback_Callback_Any_Void continuation);
} Ark_Callback_ItemDragInfo_Number_Callback_Any;
typedef struct Opt_Callback_ItemDragInfo_Number_Callback_Any {
    Ark_Tag tag;
    Ark_Callback_ItemDragInfo_Number_Callback_Any value;
} Opt_Callback_ItemDragInfo_Number_Callback_Any;
typedef struct Ark_Callback_Number_Number_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number first, const Ark_Number last);
} Ark_Callback_Number_Number_Void;
typedef struct Opt_Callback_Number_Number_Void {
    Ark_Tag tag;
    Ark_Callback_Number_Number_Void value;
...
typedef struct Ark_Callback_Number_Number_ComputedBarAttribute {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Number offset, const Ark_Callback_ComputedBarAttribute_Void continuation);
} Ark_Callback_Number_Number_ComputedBarAttribute;
typedef struct Opt_Callback_Number_Number_ComputedBarAttribute {
    Ark_Tag tag;
    Ark_Callback_Number_Number_ComputedBarAttribute value;
...
typedef struct Ark_Callback_Number_ScrollState_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number scrollOffset, Ark_ScrollState scrollState);
} Ark_Callback_Number_ScrollState_Void;
typedef struct Opt_Callback_Number_ScrollState_Void {
    Ark_Tag tag;
    Ark_Callback_Number_ScrollState_Void value;
...
typedef struct Ark_Callback_Literal_Number_errcode_String_msg_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Literal_Number_errcode_String_msg info);
} Ark_Callback_Literal_Number_errcode_String_msg_Void;
typedef struct Opt_Callback_Literal_Number_errcode_String_msg_Void {
    Ark_Tag tag;
    Ark_Callback_Literal_Number_errcode_String_msg_Void value;
...
typedef struct Ark_Callback_FormCallbackInfo_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_FormCallbackInfo parameter);
} Ark_Callback_FormCallbackInfo_Void;
typedef struct Opt_Callback_FormCallbackInfo_Void {
    Ark_Tag tag;
    Ark_Callback_FormCallbackInfo_Void value;
...
typedef struct Ark_OnHoverStatusChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_HoverEventParam param);
} Ark_OnHoverStatusChangeCallback;
typedef struct Opt_OnHoverStatusChangeCallback {
    Ark_Tag tag;
    Ark_OnHoverStatusChangeCallback value;
...
typedef struct Ark_Callback_TerminationInfo_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TerminationInfo parameter);
} Ark_Callback_TerminationInfo_Void;
typedef struct Opt_Callback_TerminationInfo_Void {
    Ark_Tag tag;
    Ark_Callback_TerminationInfo_Void value;
} Opt_Callback_TerminationInfo_Void;
typedef struct Ark_Literal_Union_String_Number_height_width {
    Opt_Union_String_Number width;
    Opt_Union_String_Number height;
} Ark_Literal_Union_String_Number_height_width;
typedef struct Opt_Literal_Union_String_Number_height_width {
    Ark_Tag tag;
    Ark_Literal_Union_String_Number_height_width value;
...
typedef struct Ark_OnCheckboxGroupChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CheckboxGroupResult value);
} Ark_OnCheckboxGroupChangeCallback;
typedef struct Opt_OnCheckboxGroupChangeCallback {
    Ark_Tag tag;
    Ark_OnCheckboxGroupChangeCallback value;
...
typedef struct Ark_OnCheckboxChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Boolean value);
} Ark_OnCheckboxChangeCallback;
typedef struct Opt_OnCheckboxChangeCallback {
    Ark_Tag tag;
    Ark_OnCheckboxChangeCallback value;
...
typedef struct Ark_Callback_CalendarRequestedData_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CalendarRequestedData event);
} Ark_Callback_CalendarRequestedData_Void;
typedef struct Opt_Callback_CalendarRequestedData_Void {
    Ark_Tag tag;
    Ark_Callback_CalendarRequestedData_Void value;
...
typedef struct Ark_Callback_CalendarSelectedDate_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CalendarSelectedDate event);
} Ark_Callback_CalendarSelectedDate_Void;
typedef struct Opt_Callback_CalendarSelectedDate_Void {
    Ark_Tag tag;
    Ark_Callback_CalendarSelectedDate_Void value;
...
typedef struct Ark_OnAlphabetIndexerPopupSelectCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index);
} Ark_OnAlphabetIndexerPopupSelectCallback;
typedef struct Opt_OnAlphabetIndexerPopupSelectCallback {
    Ark_Tag tag;
    Ark_OnAlphabetIndexerPopupSelectCallback value;
} Opt_OnAlphabetIndexerPopupSelectCallback;
typedef struct Ark_OnAlphabetIndexerRequestPopupDataCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const Ark_Callback_Array_String_Void continuation);
} Ark_OnAlphabetIndexerRequestPopupDataCallback;
typedef struct Opt_OnAlphabetIndexerRequestPopupDataCallback {
    Ark_Tag tag;
    Ark_OnAlphabetIndexerRequestPopupDataCallback value;
} Opt_OnAlphabetIndexerRequestPopupDataCallback;
typedef struct Ark_OnAlphabetIndexerSelectCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index);
} Ark_OnAlphabetIndexerSelectCallback;
typedef struct Opt_OnAlphabetIndexerSelectCallback {
    Ark_Tag tag;
    Ark_OnAlphabetIndexerSelectCallback value;
...
typedef struct Ark_Union_TransitionFinishCallback_Undefined {
    Ark_Int32 selector;
    union {
        Ark_TransitionFinishCallback value0;
        Ark_Undefined value1;
    };
} Ark_Union_TransitionFinishCallback_Undefined;
typedef struct Opt_Union_TransitionFinishCallback_Undefined {
    Ark_Tag tag;
...
typedef struct Ark_Union_Object_Undefined {
    Ark_Int32 selector;
    union {
        Ark_CustomObject value0;
        Ark_Undefined value1;
    };
} Ark_Union_Object_Undefined;
typedef struct Opt_Union_Object_Undefined {
    Ark_Tag tag;
    Ark_Union_Object_Undefined value;
} Opt_Union_Object_Undefined;
typedef struct Ark_SizeChangeCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_SizeOptions oldValue, const Ark_SizeOptions newValue);
} Ark_SizeChangeCallback;
typedef struct Opt_SizeChangeCallback {
    Ark_Tag tag;
    Ark_SizeChangeCallback value;
} Opt_SizeChangeCallback;
typedef struct Ark_Callback_TouchEvent_HitTestMode {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TouchEvent parameter, const Ark_Callback_HitTestMode_Void continuation);
} Ark_Callback_TouchEvent_HitTestMode;
typedef struct Opt_Callback_TouchEvent_HitTestMode {
    Ark_Tag tag;
    Ark_Callback_TouchEvent_HitTestMode value;
...
typedef struct Ark_ShouldBuiltInRecognizerParallelWithCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Materialized current, const Array_GestureRecognizer others, const Ark_Callback_GestureRecognizer_Void continuation);
} Ark_ShouldBuiltInRecognizerParallelWithCallback;
typedef struct Opt_ShouldBuiltInRecognizerParallelWithCallback {
    Ark_Tag tag;
    Ark_ShouldBuiltInRecognizerParallelWithCallback value;
...
typedef struct Ark_GestureRecognizerJudgeBeginCallback {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_BaseGestureEvent event, const Ark_Materialized current, const Array_GestureRecognizer recognizers, const Ark_Callback_GestureJudgeResult_Void continuation);
} Ark_GestureRecognizerJudgeBeginCallback;
typedef struct Opt_GestureRecognizerJudgeBeginCallback {
    Ark_Tag tag;
    Ark_GestureRecognizerJudgeBeginCallback value;
...
typedef struct Ark_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_GestureInfo gestureInfo, const Ark_BaseGestureEvent event, const Ark_Callback_GestureJudgeResult_Void continuation);
} Ark_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult;
typedef struct Opt_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult {
    Ark_Tag tag;
    Ark_Callback_GestureInfo_BaseGestureEvent_GestureJudgeResult value;
...
typedef struct Ark_Callback_PreDragStatus_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, Ark_PreDragStatus parameter);
} Ark_Callback_PreDragStatus_Void;
typedef struct Opt_Callback_PreDragStatus_Void {
    Ark_Tag tag;
    Ark_Callback_PreDragStatus_Void value;
...
typedef struct Ark_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DragEvent event, const Opt_String extraParams, const Ark_Callback_Union_CustomBuilder_DragItemInfo_Void continuation);
} Ark_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo;
typedef struct Opt_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo {
    Ark_Tag tag;
    Ark_Callback_DragEvent_String_Union_CustomBuilder_DragItemInfo value;
...
typedef struct Ark_Callback_KeyEvent_Boolean {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_KeyEvent parameter, const Ark_Callback_Boolean_Void continuation);
} Ark_Callback_KeyEvent_Boolean;
typedef struct Opt_Callback_KeyEvent_Boolean {
    Ark_Tag tag;
    Ark_Callback_KeyEvent_Boolean value;
...
typedef struct Ark_Callback_Boolean_HoverEvent_Void {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Boolean isHover, const Ark_HoverEvent event);
} Ark_Callback_Boolean_HoverEvent_Void;
typedef struct Opt_Callback_Boolean_HoverEvent_Void {
    Ark_Tag tag;
    Ark_Callback_Boolean_HoverEvent_Void value;
...
typedef struct Ark_Callback_Array_TouchTestInfo_TouchResult {
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Array_TouchTestInfo value, const Ark_Callback_TouchResult_Void continuation);
} Ark_Callback_Array_TouchTestInfo_TouchResult;
typedef struct Opt_Callback_Array_TouchTestInfo_TouchResult {
    Ark_Tag tag;
    Ark_Callback_Array_TouchTestInfo_TouchResult value;
...
typedef struct GENERATED_ArkUITransitionEffectAccessor {
    ...
    Ark_NativePointer (*asymmetric)(const Ark_Materialized* appear,
...
typedef struct GENERATED_ArkUIUIExtensionComponentEventsReceiver {
    ...
    void (*onReceive)(Ark_Int32 nodeId,
