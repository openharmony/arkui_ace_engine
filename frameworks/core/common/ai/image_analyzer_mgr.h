...
public:
    ...
    void BuildNodeFunc(const std::string& uri, void* pixelMap, int frameTimestamp, void* config,
        ImageAnalyzerInnerConfig* uiConfig, void** overlayData) override;
    void UpdateImage(void** overlayData,  void* pixelMap, void* config,
        ImageAnalyzerInnerConfig* uiConfig) override;
    void UpdateImage(void** overlayData, const std::string& uri, void* pixelMap, int frameTimestamp,
