...
StatisticEventInfo StatisticEventReporter::ConvertToEvent(StatisticEventType eventType)
{
    switch (eventType) {
        ...
        case StatisticEventType::FOCUSBOXSTYLE_MAIGIN_STROKEWIDTH_MODIFIER:
            return { "FRAMEWORK", "FOCUSBOXSTYLE_MAIGIN_STROKEWIDTH_MODIFIER" };
        case StatisticEventType::GESTURE_TOW_FINGER_LONGPRESS_TRIGGER_INFO:
            return { "FRAMEWORK", "GESTURE_TOW_FINGER_LONGPRESS_TRIGGER_INFO" };
        case StatisticEventType::FA_AND_DECLARATIVE_APP_SRART:
            return { "FRAMEWORK", "FA_AND_DECLARATIVE_APP_SRART" };
