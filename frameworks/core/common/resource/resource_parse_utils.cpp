...
std::string GetReplaceContentStr(int pos, const std::string& type,
    std::vector<ResourceObjectParams> params, int32_t containCount)
{
...
void ReplaceHolder(std::string& originStr, std::vector<ResourceObjectParams> params, int32_t containCount)
{
