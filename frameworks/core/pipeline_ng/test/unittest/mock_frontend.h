...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_PIPELINE_NG_TEST_UNITTEST_MOCK_FRONTEND_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_PIPELINE_NG_TEST_UNITTEST_MOCK_FRONTEND_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_PIPELINE_NG_TEST_UNITTEST_MOCK_FRONTEND_H
