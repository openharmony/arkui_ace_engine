...
public:
    ...
    MOCK_METHOD0(GetTimeFromExternalTimer, uint64_t());
    MOCK_METHOD3(
    ...
    MOCK_METHOD2(OnVsyncEvent, void(uint64_t nanoTimestamp, uint32_t frameCount));
    ...
    MOCK_METHOD1(SendEventToAccessibility, void(const AccessibilityEvent& accessibilityEvent));
    ...
    MOCK_METHOD1(OnActionEvent, void(const std::string& action));
    ...
    MOCK_CONST_METHOD0(GetAccessibilityManager, RefPtr<AccessibilityManager>());
