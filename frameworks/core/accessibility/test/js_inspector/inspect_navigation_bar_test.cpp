...
#include "frameworks/core/accessibility/js_inspector/inspect_navigation_bar.h"

using namespace testing;
using namespace testing::ext;
namespace OHOS::Ace::Framework {
class InspectNavigationBarTest : public testing::Test {
public:
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InspectNavigationBarTest, InspectNavigationBarTest001, TestSize.Level1)
{
    NodeId nodeId = -1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(InspectNavigationBarTest, InspectNavigationBarTest002, TestSize.Level1)
{
    NodeId nodeId = -1;
    std::string tag = "tagTest";
    InspectNavigationBar inspectNavigationBar(nodeId, tag);
