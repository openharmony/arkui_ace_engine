...
extern ACE_FORCE_EXPORT const char PATTERN_BG_COLOR_HOVERED[];
extern const char PATTERN_BG_COLOR_CLICKED[];
extern ACE_FORCE_EXPORT const char PATTERN_BG_COLOR_PRESSED[];
extern const char PATTERN_BG_COLOR_SELECTED[];
extern ACE_FORCE_EXPORT const char PATTERN_BG_COLOR_FOCUSED[];
extern const char PATTERN_BG_COLOR_DISABLED_ALPHA[];
extern const char PATTERN_BG_COLOR_ALPHA[];
extern ACE_FORCE_EXPORT const char PATTERN_TEXT_COLOR[];
