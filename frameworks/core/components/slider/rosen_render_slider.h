...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SLIDER_ROSEN_RENDER_SLIDER_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SLIDER_ROSEN_RENDER_SLIDER_H
...
class RosenRenderSlider final : public RenderSlider {
    DECLARE_ACE_TYPE(RosenRenderSlider, RenderSlider);

public:
    RosenRenderSlider() = default;
    ~RosenRenderSlider() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SLIDER_ROSEN_RENDER_SLIDER_H
