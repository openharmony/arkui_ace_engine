...
void RatingModelImpl::SetForegroundSrc(const std::string& value, bool flag, const RefPtr<ResourceObject>& resObj)
{
    auto ratingComponent = AceType::DynamicCast<RatingComponent>(ViewStackProcessor::GetInstance()->GetMainComponent());
    CHECK_NULL_VOID(ratingComponent);
...
void RatingModelImpl::SetSecondarySrc(const std::string& value, bool flag, const RefPtr<ResourceObject>& resObj)
{
    auto ratingComponent = AceType::DynamicCast<RatingComponent>(ViewStackProcessor::GetInstance()->GetMainComponent());
    CHECK_NULL_VOID(ratingComponent);
...
void RatingModelImpl::SetBackgroundSrc(const std::string& value, bool flag, const RefPtr<ResourceObject>& resObj)
{
    auto ratingComponent = AceType::DynamicCast<RatingComponent>(ViewStackProcessor::GetInstance()->GetMainComponent());
    CHECK_NULL_VOID(ratingComponent);
