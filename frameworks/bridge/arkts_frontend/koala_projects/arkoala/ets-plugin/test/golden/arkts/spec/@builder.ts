...
class ArkMyComponentComponent extends ArkStructBase<ArkMyComponentComponent, MyComponentOptions> {
    ...
    MenuBuilder() {
        ...
        }, { direction: FlexDirection.Column, justifyContent: FlexAlign.Center, alignItems: ItemAlign.Center } as FlexOptions);
    }
    /** @memo */
    __build(/**/
    /** @memo */
        ...
        ArkColumn(__builder, () => {
            ...
            ArkRow((__instance: ArkRowComponent) => {
                ...
                ArkNavigation((__instance: ArkNavigationComponent) => {
                    ...
                    }, { space: 5, initialIndex: 0 } as ListOptions);
