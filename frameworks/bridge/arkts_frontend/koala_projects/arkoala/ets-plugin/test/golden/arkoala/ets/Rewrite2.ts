import { ArkCommonMethodComponent, ArkPageTransitionEnterComponent, ArkPageTransitionExitComponent, ArkStructBase, ArkText, LocalStorage, MutableState, StorageLinkState, observableProxy } from "@koalaui/arkoala-arkui";
