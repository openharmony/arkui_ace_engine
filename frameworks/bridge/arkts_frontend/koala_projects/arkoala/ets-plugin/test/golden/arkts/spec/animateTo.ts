import { ArkButton, ArkButtonComponent, ArkColumn, ArkColumnComponent, ArkCommonMethodComponent, ArkFlex, ArkFlexComponent, ArkPageTransitionEnterComponent, ArkPageTransitionExitComponent, ArkStructBase, Color, ColumnOptions, Curve, FlexDirection, FlexOptions, ItemAlign, PlayMode, TransitionType, animateTo, stateOf } from "@koalaui/arkts-arkui";
...
class ArkTransitionExampleComponent extends ArkStructBase<ArkTransitionExampleComponent, TransitionExampleOptions> {
    ...
    content?: () => void, initializers?: TransitionExampleOptions) {
        ...
        }, { direction: FlexDirection.Column, alignItems: ItemAlign.Center, } as FlexOptions);
    }
}
export {};
/** @memo */
