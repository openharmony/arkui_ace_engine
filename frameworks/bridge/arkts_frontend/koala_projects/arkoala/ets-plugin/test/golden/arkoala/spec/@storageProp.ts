import { AppStorage, AppStorageLinkState, ArkButton, ArkButtonComponent, ArkCommonMethodComponent, ArkPageTransitionEnterComponent, ArkPageTransitionExitComponent, ArkRow, ArkStructBase, LocalStorage, MutableState, SyncedProperty, observableProxy, propState } from "@koalaui/arkoala-arkui";
...
registerArkuiEntry(MyComponent, "@storageProp");
