...
export class VideoController implements MaterializedBase {
    ...
    public setCurrentTime(value: number, seekMode?: SeekMode): undefined {
        ...
        if (RuntimeType.NUMBER == seekMode_type) {
            const value_casted = value as (number)
    ...
    private requestFullscreen_serialize(value: boolean): undefined {
        const retval = ArkUIGeneratedNativeModule._VideoController_requestFullscreen(this.peer!.ptr, +value)
        return retval
    }
    ...
    private setCurrentTime1_serialize(value: number, seekMode: SeekMode): undefined {
        const retval = ArkUIGeneratedNativeModule._VideoController_setCurrentTime1(this.peer!.ptr, value, seekMode)
        return retval
    }
