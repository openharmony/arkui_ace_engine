...
export class ArkCheckboxPeer extends ArkCommonMethodPeer {
    ...
    setCheckboxOptionsAttribute(options?: CheckboxOptions): void {
        ...
        ArkUIGeneratedNativeModule._CheckboxInterface_setCheckboxOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    selectAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._CheckboxAttribute_select(this.peer.ptr, +value)
    }
    selectedColorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._CheckboxAttribute_selectedColor(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    shapeAttribute(value: CheckBoxShape): void {
        ArkUIGeneratedNativeModule._CheckboxAttribute_shape(this.peer.ptr, value)
    }
    unselectedColorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._CheckboxAttribute_unselectedColor(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    markAttribute(value: MarkStyle): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writeMarkStyle(value)
        ArkUIGeneratedNativeModule._CheckboxAttribute_mark(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onChangeAttribute(value: OnCheckboxChangeCallback): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._CheckboxAttribute_onChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    contentModifierAttribute(value: ContentModifier<any>): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writeCustomObject("ContentModifier", value)
        ArkUIGeneratedNativeModule._CheckboxAttribute_contentModifier(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    _onChangeEvent_selectAttribute(callback: ((parameter: boolean) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(callback)
        ArkUIGeneratedNativeModule._CheckboxAttribute__onChangeEvent_select(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkCheckboxAttributes extends ArkCommonMethodAttributes {
    select?: boolean
