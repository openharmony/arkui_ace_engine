...
export class ArkRowPeer extends ArkCommonMethodPeer {
    ...
    setRowOptionsAttribute(options?: RowOptions): void {
        ...
        ArkUIGeneratedNativeModule._RowInterface_setRowOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    alignItemsAttribute(value: VerticalAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_alignItems(this.peer.ptr, value)
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_justifyContent(this.peer.ptr, value)
    }
    pointLightAttribute(value: PointLightStyle): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writePointLightStyle(value)
        ArkUIGeneratedNativeModule._RowAttribute_pointLight(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    reverseAttribute(value?: boolean): void {
        ...
        ArkUIGeneratedNativeModule._RowAttribute_reverse(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
