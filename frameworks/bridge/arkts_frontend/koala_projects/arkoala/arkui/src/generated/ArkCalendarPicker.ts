...
import { CalendarAlign, CalendarPickerAttribute, CalendarOptions } from "./ArkCalendarPickerInterfaces"
...
/** @memo:stable */
export class ArkCalendarPickerComponent extends ArkCommonMethodComponent {
    ...
    public onChange(value: ((parameter: Date) => void)): this {
        if (this.checkPriority("onChange")) {
            ...
            UseEventsProperties({CalendarPicker_onChange: value_casted})
...
/** @memo */
export function ArkCalendarPicker(
  /** @memo */
  style: ((attributes: ArkCalendarPickerComponent) => void) | undefined,
  /** @memo */
