...
import { ReceiveCallback, UIExtensionOptions, UIExtensionComponentAttribute, DpiFollowStrategy } from "./../ArkUiExtensionComponentInterfaces"
...
export class ArkUIExtensionComponentPeer extends ArkCommonMethodPeer {
    ...
    onResultAttribute(value: ((parameter: { code: number, want?: Want }) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
...
export interface ArkUIExtensionComponentAttributes extends ArkCommonMethodAttributes {
    ...
    onResult?: ((parameter: { code: number, want?: Want }) => void)
