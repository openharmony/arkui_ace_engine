...
import { ArkRowSplitPeer } from "./peers/ArkRowSplitPeer"
...
import { RowSplitAttribute } from "./ArkRowSplitInterfaces"
/** @memo:stable */
export class ArkRowSplitComponent extends ArkCommonMethodComponent {
...
export function ArkRowSplit(
  /** @memo */
  style: ((attributes: ArkRowSplitComponent) => void) | undefined,
  /** @memo */
