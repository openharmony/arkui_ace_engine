...
export interface DataPanelAttribute extends CommonMethod<DataPanelAttribute> {
    closeEffect: boolean;
    valueColors: Array<ResourceColor | LinearGradient>;
    trackBackgroundColor: ResourceColor;
    strokeWidth: Length;
    trackShadow: DataPanelShadowOptions;
    contentModifier: ContentModifier<DataPanelConfiguration>;
}
