...
import { ColumnAttribute } from "./../ArkColumnInterfaces"
...
import { GridContainerOptions, GridContainerAttribute, SizeType } from "./../ArkGridContainerInterfaces"
...
export class ArkGridContainerPeer extends ArkColumnPeer {
    ...
    setGridContainerOptionsAttribute(value?: GridContainerOptions): void {
        ...
        ArkUIGeneratedNativeModule._GridContainerInterface_setGridContainerOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
