...
export class ArkColumnSplitPeer extends ArkCommonMethodPeer {
    ...
    resizeableAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._ColumnSplitAttribute_resizeable(this.peer.ptr, +value)
    }
    dividerAttribute(value?: ColumnSplitDividerStyle): void {
        ...
        ArkUIGeneratedNativeModule._ColumnSplitAttribute_divider(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkColumnSplitAttributes extends ArkCommonMethodAttributes {
    resizeable?: boolean
