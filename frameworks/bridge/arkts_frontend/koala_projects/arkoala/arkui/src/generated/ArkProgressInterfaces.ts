...
import { FontWeight, FontStyle, HitTestMode, ImageSize, Alignment, BorderStyle, ColoringStrategy, HoverEffect, Color, Visibility, ItemAlign, Direction, GradientDirection, ObscuredReasons, RenderFit, ImageRepeat, Axis, ResponseType, FunctionKey, ModifierKey, PixelRoundCalcPolicy, Curve, PlayMode, TransitionType, HorizontalAlign, VerticalAlign, ClickEffectLevel, SharedTransitionEffectType, Placement, ArrowPointPosition, MouseButton, MouseAction, TouchType, KeyType, KeySource } from "./ArkEnumsInterfaces"
...
export interface ProgressAttribute extends CommonMethod<ProgressAttribute> {
    value: number;
    ...
    contentModifier: ContentModifier<ProgressConfiguration>;
}
