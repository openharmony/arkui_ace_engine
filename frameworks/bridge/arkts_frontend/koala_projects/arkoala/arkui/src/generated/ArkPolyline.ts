...
import { ArkPolylinePeer } from "./peers/ArkPolylinePeer"
...
/** @memo:stable */
export class ArkPolylineComponent extends ArkCommonShapeMethodComponent {
...
export function ArkPolyline(
  /** @memo */
  style: ((attributes: ArkPolylineComponent) => void) | undefined,
  /** @memo */
