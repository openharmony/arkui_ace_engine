...
import { ArkListItemGroupPeer } from "./peers/ArkListItemGroupPeer"
...
/** @memo:stable */
export class ArkListItemGroupComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkListItemGroup(
  /** @memo */
  style: ((attributes: ArkListItemGroupComponent) => void) | undefined,
  /** @memo */
