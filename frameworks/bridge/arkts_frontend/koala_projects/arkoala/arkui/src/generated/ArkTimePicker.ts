...
import { DateTimeOptions, TimePickerResult, TimePickerOptions, TimePickerAttribute, TimePickerFormat } from "./ArkTimePickerInterfaces"
/** @memo:stable */
export class ArkTimePickerComponent extends ArkCommonMethodComponent {
    ...
    public onChange(value: ((value: TimePickerResult) => void)): this {
        if (this.checkPriority("onChange")) {
            ...
            UseEventsProperties({TimePicker_onChange: value_casted})
    ...
    public _onChangeEvent_selected(callback: ((parameter: Date) => void)): void {
        if (this.checkPriority("_onChangeEvent_selected")) {
            ...
            UseEventsProperties({TimePicker__onChangeEvent_selected: callback_casted})
