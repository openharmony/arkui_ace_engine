...
export class ArkListItemPeer extends ArkCommonMethodPeer {
    ...
    stickyAttribute(value: Sticky): void {
        ArkUIGeneratedNativeModule._ListItemAttribute_sticky(this.peer.ptr, value)
    }
    editableAttribute(value: boolean | EditMode): void {
        ...
        if (RuntimeType.BOOLEAN == value_type) {
            ...
            const value_1 = unsafeCast<EditMode>(value)
    ...
    selectableAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._ListItemAttribute_selectable(this.peer.ptr, +value)
    }
    selectedAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._ListItemAttribute_selected(this.peer.ptr, +value)
    }
