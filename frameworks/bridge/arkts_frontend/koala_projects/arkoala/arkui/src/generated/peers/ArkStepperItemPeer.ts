...
export class ArkStepperItemPeer extends ArkCommonMethodPeer {
    ...
    statusAttribute(value?: ItemState): void {
        ...
        ArkUIGeneratedNativeModule._StepperItemAttribute_status(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkStepperItemAttributes extends ArkCommonMethodAttributes {
    prevLabel?: string
    nextLabel?: string
    status?: ItemState
}
