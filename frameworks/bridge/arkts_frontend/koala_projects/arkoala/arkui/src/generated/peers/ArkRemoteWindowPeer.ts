...
import { WindowAnimationTarget, RemoteWindowAttribute, RRect } from "./../ArkRemoteWindowInterfaces"
...
export class ArkRemoteWindowPeer extends ArkCommonMethodPeer {
    ...
    setRemoteWindowOptionsAttribute(target: WindowAnimationTarget): void {
        ...
        ArkUIGeneratedNativeModule._RemoteWindowInterface_setRemoteWindowOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkRemoteWindowAttributes extends ArkCommonMethodAttributes {
}
