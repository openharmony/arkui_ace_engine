...
import { SymbolSpanAttribute } from "./ArkSymbolSpanInterfaces"
/** @memo:stable */
export class ArkSymbolSpanComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkSymbolSpan(
  /** @memo */
  style: ((attributes: ArkSymbolSpanComponent) => void) | undefined,
  /** @memo */
