...
import { LengthUnit, ShapeSize, PathShapeOptions, RectShapeOptions, RoundRectShapeOptions, NodeController } from "./../ArkArkuiExternalInterfaces"
...
import { NodeContainerAttribute } from "./../ArkNodeContainerInterfaces"
...
export class ArkNodeContainerPeer extends ArkCommonMethodPeer {
    ...
    setNodeContainerOptionsAttribute(controller: NodeController): void {
        ...
        ArkUIGeneratedNativeModule._NodeContainerInterface_setNodeContainerOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkNodeContainerAttributes extends ArkCommonMethodAttributes {
}
