...
export class ArkFolderStackPeer extends ArkCommonMethodPeer {
    ...
    alignContentAttribute(value: Alignment): void {
        ArkUIGeneratedNativeModule._FolderStackAttribute_alignContent(this.peer.ptr, value)
    }
    ...
    enableAnimationAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._FolderStackAttribute_enableAnimation(this.peer.ptr, +value)
    }
    autoHalfFoldAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._FolderStackAttribute_autoHalfFold(this.peer.ptr, +value)
    }
}
