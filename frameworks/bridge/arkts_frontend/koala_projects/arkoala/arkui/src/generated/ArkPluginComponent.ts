...
import { PluginErrorCallback, PluginComponentOptions, PluginComponentAttribute, PluginComponentTemplate } from "./ArkPluginComponentInterfaces"
/** @memo:stable */
export class ArkPluginComponentComponent extends ArkCommonMethodComponent {
    ...
    public onComplete(value: VoidCallback): this {
        if (this.checkPriority("onComplete")) {
            ...
            UseEventsProperties({PluginComponent_onComplete: value_casted})
    ...
    public onError(value: PluginErrorCallback): this {
        if (this.checkPriority("onError")) {
            ...
            UseEventsProperties({PluginComponent_onError: value_casted})
