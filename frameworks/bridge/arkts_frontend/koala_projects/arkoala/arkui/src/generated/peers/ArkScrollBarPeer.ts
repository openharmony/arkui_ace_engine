...
import { ScrollBarOptions, ScrollBarAttribute, ScrollBarDirection } from "./../ArkScrollBarInterfaces"
...
export class ArkScrollBarPeer extends ArkCommonMethodPeer {
    ...
    setScrollBarOptionsAttribute(value: ScrollBarOptions): void {
        ...
        ArkUIGeneratedNativeModule._ScrollBarInterface_setScrollBarOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    enableNestedScrollAttribute(value?: boolean): void {
        const thisSerializer: Serializer = Serializer.hold()
        ...
        ArkUIGeneratedNativeModule._ScrollBarAttribute_enableNestedScroll(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkScrollBarAttributes extends ArkCommonMethodAttributes {
