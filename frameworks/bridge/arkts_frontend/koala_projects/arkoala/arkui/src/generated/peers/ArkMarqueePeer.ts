...
export class ArkMarqueePeer extends ArkCommonMethodPeer {
    ...
    allowScaleAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._MarqueeAttribute_allowScale(this.peer.ptr, +value)
    }
    ...
    marqueeUpdateStrategyAttribute(value: MarqueeUpdateStrategy): void {
        ArkUIGeneratedNativeModule._MarqueeAttribute_marqueeUpdateStrategy(this.peer.ptr, value)
    }
