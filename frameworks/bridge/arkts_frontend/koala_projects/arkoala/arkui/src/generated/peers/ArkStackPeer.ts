...
export class ArkStackPeer extends ArkCommonMethodPeer {
    ...
    setStackOptionsAttribute(options?: StackOptions): void {
        ...
        ArkUIGeneratedNativeModule._StackInterface_setStackOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    alignContentAttribute(value: Alignment): void {
        ArkUIGeneratedNativeModule._StackAttribute_alignContent(this.peer.ptr, value)
    }
    pointLightAttribute(value: PointLightStyle): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writePointLightStyle(value)
        ArkUIGeneratedNativeModule._StackAttribute_pointLight(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
