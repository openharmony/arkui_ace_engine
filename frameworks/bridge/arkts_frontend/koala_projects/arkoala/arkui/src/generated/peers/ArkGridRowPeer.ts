...
export class ArkGridRowPeer extends ArkCommonMethodPeer {
    ...
    setGridRowOptionsAttribute(option?: GridRowOptions): void {
        ...
        ArkUIGeneratedNativeModule._GridRowInterface_setGridRowOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onBreakpointChangeAttribute(value: ((breakpoints: string) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._GridRowAttribute_onBreakpointChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    alignItemsAttribute(value: ItemAlign): void {
        ArkUIGeneratedNativeModule._GridRowAttribute_alignItems(this.peer.ptr, value)
    }
}
