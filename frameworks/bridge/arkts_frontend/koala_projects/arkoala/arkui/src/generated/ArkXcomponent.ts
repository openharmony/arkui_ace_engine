...
import { OnNativeLoadCallback, XComponentAttribute, XComponentOptions, SurfaceRect, SurfaceRotationOptions } from "./ArkXcomponentInterfaces"
...
/** @memo:stable */
export class ArkXComponentComponent extends ArkCommonMethodComponent {
    getPeer(): ArkXComponentPeer {
        return (this.peer as ArkXComponentPeer)
    }
    /** @memo */
    public setXComponentOptions(value: { id: string, type: string, libraryname?: string, controller?: XComponentController } | XComponentOptions): this {
        if (this.checkPriority("setXComponentOptions")) {
            const value_type = runtimeType(value)
            if (RuntimeType.OBJECT == value_type) {
                const value_casted = value as ({ id: string, type: string, libraryname?: string, controller?: XComponentController })
            ...
            if (((RuntimeType.OBJECT) == (value_type)) && ((value!.hasOwnProperty("imageAIOptions")))) {
    ...
    public onLoad(value: OnNativeLoadCallback): this {
        if (this.checkPriority("onLoad")) {
            ...
            UseEventsProperties({XComponent_onLoad: value_casted})
    ...
    public onDestroy(value: VoidCallback): this {
        if (this.checkPriority("onDestroy")) {
            ...
            UseEventsProperties({XComponent_onDestroy: value_casted})
...
export function ArkXComponent(
  /** @memo */
  style: ((attributes: ArkXComponentComponent) => void) | undefined,
  /** @memo */
  content_: (() => void) | undefined,
  value: { id: string, type: string, libraryname?: string, controller?: XComponentController } | XComponentOptions
) {
