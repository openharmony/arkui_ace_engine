...
export class ArkNavigatorComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public setNavigatorOptions(value?: { target: string, type?: NavigationType }): this {
        if (this.checkPriority("setNavigatorOptions")) {
            ...
            if ((RuntimeType.OBJECT == value_type) || (RuntimeType.UNDEFINED == value_type)) {
                const value_casted = value as ({ target: string, type?: NavigationType } | undefined)
...
export function ArkNavigator(
  ...
  value?: { target: string, type?: NavigationType } | undefined
) {
