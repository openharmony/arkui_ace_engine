...
export type AbilityComponentInterface = (value: { want: Want }) => AbilityComponentAttribute;
export interface AbilityComponentAttribute extends CommonMethod<AbilityComponentAttribute> {
    onConnect: (() => void);
    onDisconnect: (() => void);
}
