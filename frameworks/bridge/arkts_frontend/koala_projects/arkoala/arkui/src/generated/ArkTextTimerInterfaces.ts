...
export interface TextTimerAttribute extends CommonMethod<TextTimerAttribute> {
    format: string;
    ...
    contentModifier: ContentModifier<TextTimerConfiguration>;
}
