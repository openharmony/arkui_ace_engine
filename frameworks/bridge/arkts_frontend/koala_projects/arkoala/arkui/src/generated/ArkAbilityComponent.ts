...
import { ArkAbilityComponentPeer } from "./peers/ArkAbilityComponentPeer"
...
/** @memo:stable */
export class ArkAbilityComponentComponent extends ArkCommonMethodComponent {
    getPeer(): ArkAbilityComponentPeer {
        return (this.peer as ArkAbilityComponentPeer)
    }
    /** @memo */
    public setAbilityComponentOptions(value: { want: Want }): this {
        if (this.checkPriority("setAbilityComponentOptions")) {
            const value_casted = value as ({ want: Want })
    ...
    /** @memo */
    public onConnect(value: (() => void)): this {
        if (this.checkPriority("onConnect")) {
            const value_casted = value as ((() => void))
            UseEventsProperties({AbilityComponent_onConnect: value_casted})
    ...
    /** @memo */
    public onDisconnect(value: (() => void)): this {
        if (this.checkPriority("onDisconnect")) {
            const value_casted = value as ((() => void))
            UseEventsProperties({AbilityComponent_onDisconnect: value_casted})
...
/** @memo */
export function ArkAbilityComponent(
  /** @memo */
  style: ((attributes: ArkAbilityComponentComponent) => void) | undefined,
  /** @memo */
