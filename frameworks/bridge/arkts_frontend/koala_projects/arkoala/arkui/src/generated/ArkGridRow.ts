...
import { GridRowOptions, GridRowAttribute, GutterOption, GridRowColumnOption, BreakPoints, GridRowDirection, GridRowSizeOption, BreakpointsReference } from "./ArkGridRowInterfaces"
/** @memo:stable */
export class ArkGridRowComponent extends ArkCommonMethodComponent {
    ...
    public onBreakpointChange(value: ((breakpoints: string) => void)): this {
        if (this.checkPriority("onBreakpointChange")) {
            ...
            UseEventsProperties({GridRow_onBreakpointChange: value_casted})
