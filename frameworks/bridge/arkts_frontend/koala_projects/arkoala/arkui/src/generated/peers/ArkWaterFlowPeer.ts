...
import { WaterFlowAttribute, WaterFlowOptions, WaterFlowLayoutMode, SectionOptions, GetItemMainSizeByIndex } from "./../ArkWaterFlowInterfaces"
...
export class ArkWaterFlowPeer extends ArkScrollableCommonMethodPeer {
    ...
    layoutDirectionAttribute(value: FlexDirection): void {
        ArkUIGeneratedNativeModule._WaterFlowAttribute_layoutDirection(this.peer.ptr, value)
    }
    ...
    enableScrollInteractionAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._WaterFlowAttribute_enableScrollInteraction(this.peer.ptr, +value)
    }
    ...
    cachedCount1Attribute(count: number, show: boolean): void {
        ArkUIGeneratedNativeModule._WaterFlowAttribute_cachedCount1(this.peer.ptr, count, +show)
    }
