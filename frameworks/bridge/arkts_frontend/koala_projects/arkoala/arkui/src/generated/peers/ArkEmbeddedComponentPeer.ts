...
import { LengthUnit, ShapeSize, PathShapeOptions, RectShapeOptions, RoundRectShapeOptions, ErrorCallback, Want } from "./../ArkArkuiExternalInterfaces"
...
import { TerminationInfo, EmbeddedComponentAttribute } from "./../ArkEmbeddedComponentInterfaces"
...
export class ArkEmbeddedComponentPeer extends ArkCommonMethodPeer {
    ...
    setEmbeddedComponentOptionsAttribute(loader: Want, type: EmbeddedType): void {
        ...
        ArkUIGeneratedNativeModule._EmbeddedComponentInterface_setEmbeddedComponentOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length(), type)
        thisSerializer.release()
    }
    onTerminatedAttribute(value: ((parameter: TerminationInfo) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._EmbeddedComponentAttribute_onTerminated(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onErrorAttribute(value: ErrorCallback): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._EmbeddedComponentAttribute_onError(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkEmbeddedComponentAttributes extends ArkCommonMethodAttributes {
