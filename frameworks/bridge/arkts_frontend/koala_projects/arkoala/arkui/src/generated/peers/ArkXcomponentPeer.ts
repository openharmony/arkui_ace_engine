...
export class ArkXComponentPeer extends ArkCommonMethodPeer {
    ...
    setXComponentOptions0Attribute(value: { id: string, type: string, libraryname?: string, controller?: XComponentController }): void {
    ...
    setXComponentOptions1Attribute(value: { id: string, type: string, libraryname?: string, controller?: XComponentController }): void {
        const thisSerializer: Serializer = Serializer.hold()
        const value_id = value.id
        thisSerializer.writeString(value_id)
        const value_type = value.type
    ...
    enableAnalyzerAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._XComponentAttribute_enableAnalyzer(this.peer.ptr, +value)
    }
    enableSecureAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._XComponentAttribute_enableSecure(this.peer.ptr, +value)
    }
}
