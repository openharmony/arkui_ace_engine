...
import { ArkCounterPeer } from "./peers/ArkCounterPeer"
...
import { CounterAttribute } from "./ArkCounterInterfaces"
/** @memo:stable */
export class ArkCounterComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public onInc(value: VoidCallback): this {
        if (this.checkPriority("onInc")) {
            const value_casted = value as (VoidCallback)
            UseEventsProperties({Counter_onInc: value_casted})
    ...
    /** @memo */
    public onDec(value: VoidCallback): this {
        if (this.checkPriority("onDec")) {
            const value_casted = value as (VoidCallback)
            UseEventsProperties({Counter_onDec: value_casted})
    ...
    /** @memo */
    public enableDec(value: boolean): this {
    ...
    /** @memo */
    public enableInc(value: boolean): this {
...
export function ArkCounter(
  /** @memo */
  style: ((attributes: ArkCounterComponent) => void) | undefined,
  /** @memo */
