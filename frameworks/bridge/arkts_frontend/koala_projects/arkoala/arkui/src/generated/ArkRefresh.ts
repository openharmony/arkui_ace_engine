...
export class ArkRefreshComponent extends ArkCommonMethodComponent {
    ...
    public onStateChange(value: ((state: RefreshStatus) => void)): this {
        if (this.checkPriority("onStateChange")) {
            ...
            UseEventsProperties({Refresh_onStateChange: value_casted})
    ...
    public onRefreshing(value: (() => void)): this {
        if (this.checkPriority("onRefreshing")) {
            ...
            UseEventsProperties({Refresh_onRefreshing: value_casted})
    ...
    public onOffsetChange(value: ((index: number) => void)): this {
        if (this.checkPriority("onOffsetChange")) {
            ...
            UseEventsProperties({Refresh_onOffsetChange: value_casted})
    ...
    public _onChangeEvent_refreshing(callback: ((parameter: boolean) => void)): void {
        if (this.checkPriority("_onChangeEvent_refreshing")) {
            ...
            UseEventsProperties({Refresh__onChangeEvent_refreshing: callback_casted})
...
export function ArkRefresh(
  /** @memo */
  style: ((attributes: ArkRefreshComponent) => void) | undefined,
  /** @memo */
