...
import { GridItemOptions, GridItemAttribute, GridItemStyle } from "./../ArkGridItemInterfaces"
...
export class ArkGridItemPeer extends ArkCommonMethodPeer {
    ...
    setGridItemOptionsAttribute(value?: GridItemOptions): void {
        ...
        ArkUIGeneratedNativeModule._GridItemInterface_setGridItemOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    forceRebuildAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._GridItemAttribute_forceRebuild(this.peer.ptr, +value)
    }
    selectableAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._GridItemAttribute_selectable(this.peer.ptr, +value)
    }
    selectedAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._GridItemAttribute_selected(this.peer.ptr, +value)
    }
    onSelectAttribute(value: ((parameter: boolean) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._GridItemAttribute_onSelect(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    _onChangeEvent_selectedAttribute(callback: ((parameter: boolean) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(callback)
        ArkUIGeneratedNativeModule._GridItemAttribute__onChangeEvent_selected(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkGridItemAttributes extends ArkCommonMethodAttributes {
    rowStart?: number
    rowEnd?: number
    columnStart?: number
    columnEnd?: number
