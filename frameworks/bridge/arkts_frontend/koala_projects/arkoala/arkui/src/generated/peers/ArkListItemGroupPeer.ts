...
import { ListItemGroupOptions, ListItemGroupAttribute, ListItemGroupStyle } from "./../ArkListItemGroupInterfaces"
...
export class ArkListItemGroupPeer extends ArkCommonMethodPeer {
    ...
    setListItemGroupOptionsAttribute(options?: ListItemGroupOptions): void {
        ...
        ArkUIGeneratedNativeModule._ListItemGroupInterface_setListItemGroupOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    dividerAttribute(value?: ListDividerOptions): void {
        ...
        ArkUIGeneratedNativeModule._ListItemGroupAttribute_divider(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    childrenMainSizeAttribute(value: ChildrenMainSize): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writeChildrenMainSize(value)
        ArkUIGeneratedNativeModule._ListItemGroupAttribute_childrenMainSize(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
