...
import { MenuItemGroupOptions, MenuItemGroupAttribute } from "./../ArkMenuItemGroupInterfaces"
...
export class ArkMenuItemGroupPeer extends ArkCommonMethodPeer {
    ...
    setMenuItemGroupOptionsAttribute(value?: MenuItemGroupOptions): void {
        ...
        ArkUIGeneratedNativeModule._MenuItemGroupInterface_setMenuItemGroupOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkMenuItemGroupAttributes extends ArkCommonMethodAttributes {
}
