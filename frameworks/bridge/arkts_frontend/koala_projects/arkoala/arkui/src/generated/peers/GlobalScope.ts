...
import { Finalizable, runtimeType, RuntimeType, SerializerBase, registerCallback, wrapCallback, KPointer, toPeerPtr, MaterializedBase, isInstanceOf } from "@koalaui/interop"
...
export class GlobalScope {
    ...
    static getContext_serialize(component?: Object): Context {
        ...
        const retval = ArkUIGeneratedNativeModule._GlobalScope_getContext(thisSerializer.asArray(), thisSerializer.length())
    ...
    static postCardAction_serialize(component: Object, action: Object): void {
        ...
        ArkUIGeneratedNativeModule._GlobalScope_postCardAction(thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    static dollar_r_serialize(value: string, params: Array<any>): Resource {
        const thisSerializer: Serializer = Serializer.hold()
        ...
        const retval = ArkUIGeneratedNativeModule._GlobalScope_dollar_r(value, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
        let retvalDeserializer: Deserializer = new Deserializer(retval.buffer, retval.byteLength)
    ...
    static animateTo_serialize(value: AnimateParam, event: (() => void)): void {
        ...
        ArkUIGeneratedNativeModule._GlobalScope_animateTo(thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    static animateToImmediately_serialize(value: AnimateParam, event: (() => void)): void {
        ...
        thisSerializer.writeAnimateParam(value)
        thisSerializer.holdAndWriteCallback(event)
        ArkUIGeneratedNativeModule._GlobalScope_animateToImmediately(thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    static Profiler_registerVsyncCallback_serialize(callback_: ((info: string) => void)): void {
        ...
        ArkUIGeneratedNativeModule._GlobalScope_Profiler_registerVsyncCallback(thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    static cursorControl_setCursor_serialize(value: PointerStyle): void {
        ArkUIGeneratedNativeModule._GlobalScope_cursorControl_setCursor(value)
    }
