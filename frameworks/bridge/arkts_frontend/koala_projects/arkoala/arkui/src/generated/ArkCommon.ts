...
export class ArkCommonMethodComponent extends ComponentBase {
    ...
    public transition(effect: TransitionOptions | TransitionEffect | TransitionEffect, onFinish?: TransitionFinishCallback): this {
        if (this.checkPriority("transition")) {
            ...
            if (((((RuntimeType.OBJECT) == (effect_type)) && (((effect!.hasOwnProperty("type")) || (effect!.hasOwnProperty("opacity")) || (effect!.hasOwnProperty("translate")) || (effect!.hasOwnProperty("scale")) || (effect!.hasOwnProperty("rotate"))))) || (((RuntimeType.OBJECT) == (effect_type)) && (effect instanceof TransitionEffect))) && (RuntimeType.UNDEFINED == onFinish_type)) {
                const value_casted = effect as (TransitionOptions | TransitionEffect)
                this.getPeer()?.transition0Attribute(value_casted)
                return this
            }
            if ((((RuntimeType.OBJECT) == (effect_type)) && (effect instanceof TransitionEffect)) && ((RuntimeType.FUNCTION == onFinish_type) || (RuntimeType.UNDEFINED == onFinish_type))) {
    ...
    public useEffect(useEffect: boolean, effectType?: EffectType): this {
        if (this.checkPriority("useEffect")) {
            ...
            if (RuntimeType.NUMBER == effectType_type) {
    ...
    /** @memo */
    public useSizeType(value: { xs?: number | { span: number, offset: number }, sm?: number | { span: number, offset: number }, md?: number | { span: number, offset: number }, lg?: number | { span: number, offset: number } }): this {
        if (this.checkPriority("useSizeType")) {
            const value_casted = value as ({ xs?: number | { span: number, offset: number }, sm?: number | { span: number, offset: number }, md?: number | { span: number, offset: number }, lg?: number | { span: number, offset: number } })
    ...
    public alignRules(value: AlignRuleOption | LocalizedAlignRuleOptions): this {
        if (this.checkPriority("alignRules")) {
            ...
            if (((RuntimeType.OBJECT) == (value_type)) && (((value!.hasOwnProperty("left")) || (value!.hasOwnProperty("right"))))) {
                const value_casted = value as (AlignRuleOption)
                this.getPeer()?.alignRules0Attribute(value_casted)
                return this
            }
            if (((RuntimeType.OBJECT) == (value_type)) && (((value!.hasOwnProperty("start")) || (value!.hasOwnProperty("end"))))) {
    ...
    /** @memo */
    public linearGradient(value: { angle?: number | string, direction?: GradientDirection, colors: Array<[ ResourceColor, number ]>, repeating?: boolean }): this {
        if (this.checkPriority("linearGradient")) {
            const value_casted = value as ({ angle?: number | string, direction?: GradientDirection, colors: Array<[ ResourceColor, number ]>, repeating?: boolean })
    ...
    /** @memo */
    public sweepGradient(value: { center: [ Length, Length ], start?: number | string, end?: number | string, rotation?: number | string, colors: Array<[ ResourceColor, number ]>, repeating?: boolean }): this {
        if (this.checkPriority("sweepGradient")) {
            const value_casted = value as ({ center: [ Length, Length ], start?: number | string, end?: number | string, rotation?: number | string, colors: Array<[ ResourceColor, number ]>, repeating?: boolean })
    ...
    /** @memo */
    public radialGradient(value: { center: [ Length, Length ], radius: number | string, colors: Array<[ ResourceColor, number ]>, repeating?: boolean }): this {
        if (this.checkPriority("radialGradient")) {
            const value_casted = value as ({ center: [ Length, Length ], radius: number | string, colors: Array<[ ResourceColor, number ]>, repeating?: boolean })
    ...
    /** @memo */
    public background(builder: CustomBuilder, options?: { align?: Alignment }): this {
    ...
    public bindContextMenu(content: CustomBuilder | boolean, responseType: ResponseType | CustomBuilder, options?: ContextMenuOptions): this {
        if (this.checkPriority("bindContextMenu")) {
            ...
            const options_type = runtimeType(options)
            if ((RuntimeType.FUNCTION == content_type) && (RuntimeType.NUMBER == responseType_type) && ((RuntimeType.OBJECT == options_type) || (RuntimeType.UNDEFINED == options_type))) {
    ...
    public bindContentCover(isShow: boolean | undefined, builder: CustomBuilder, type?: ModalTransition | undefined | ContentCoverOptions | undefined): this {
        if (this.checkPriority("bindContentCover")) {
            ...
            if (((RuntimeType.BOOLEAN == isShow_type) || (RuntimeType.UNDEFINED == isShow_type)) && ((RuntimeType.NUMBER == type_type) || (RuntimeType.UNDEFINED == type_type))) {
