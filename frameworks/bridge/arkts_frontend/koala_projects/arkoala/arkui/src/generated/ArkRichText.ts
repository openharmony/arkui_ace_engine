...
import { ArkRichTextPeer } from "./peers/ArkRichTextPeer"
...
import { RichTextAttribute } from "./ArkRichTextInterfaces"
/** @memo:stable */
export class ArkRichTextComponent extends ArkCommonMethodComponent {
    ...
    public onStart(value: (() => void)): this {
        if (this.checkPriority("onStart")) {
            ...
            UseEventsProperties({RichText_onStart: value_casted})
    ...
    public onComplete(value: (() => void)): this {
        if (this.checkPriority("onComplete")) {
            const value_casted = value as ((() => void))
            UseEventsProperties({RichText_onComplete: value_casted})
...
/** @memo */
export function ArkRichText(
  /** @memo */
  style: ((attributes: ArkRichTextComponent) => void) | undefined,
  /** @memo */
