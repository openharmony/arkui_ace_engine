...
export class ArkRefreshPeer extends ArkCommonMethodPeer {
    ...
    setRefreshOptionsAttribute(value: RefreshOptions): void {
        ...
        ArkUIGeneratedNativeModule._RefreshInterface_setRefreshOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onStateChangeAttribute(value: ((state: RefreshStatus) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._RefreshAttribute_onStateChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onRefreshingAttribute(value: (() => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._RefreshAttribute_onRefreshing(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    pullToRefreshAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._RefreshAttribute_pullToRefresh(this.peer.ptr, +value)
    }
    onOffsetChangeAttribute(value: ((index: number) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._RefreshAttribute_onOffsetChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    pullDownRatioAttribute(value?: number): void {
        ...
        ArkUIGeneratedNativeModule._RefreshAttribute_pullDownRatio(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    _onChangeEvent_refreshingAttribute(callback: ((parameter: boolean) => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(callback)
        ArkUIGeneratedNativeModule._RefreshAttribute__onChangeEvent_refreshing(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
