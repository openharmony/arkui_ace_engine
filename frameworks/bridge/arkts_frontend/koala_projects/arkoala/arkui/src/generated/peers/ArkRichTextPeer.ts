...
export class ArkRichTextPeer extends ArkCommonMethodPeer {
    ...
    onStartAttribute(value: (() => void)): void {
        ...
        ArkUIGeneratedNativeModule._RichTextAttribute_onStart(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onCompleteAttribute(value: (() => void)): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._RichTextAttribute_onComplete(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkRichTextAttributes extends ArkCommonMethodAttributes {
    onStart?: (() => void)
    onComplete?: (() => void)
}
