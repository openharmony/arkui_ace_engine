...
import { FormLinkOptions, FormLinkAttribute } from "./ArkFormLinkInterfaces"
/** @memo:stable */
export class ArkFormLinkComponent extends ArkCommonMethodComponent {
...
export function ArkFormLink(
  /** @memo */
  style: ((attributes: ArkFormLinkComponent) => void) | undefined,
  /** @memo */
