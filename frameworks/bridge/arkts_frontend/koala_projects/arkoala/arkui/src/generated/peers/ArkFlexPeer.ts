...
import { FlexOptions, FlexAttribute, FlexSpaceOptions } from "./../ArkFlexInterfaces"
...
export class ArkFlexPeer extends ArkCommonMethodPeer {
    ...
    setFlexOptionsAttribute(value?: FlexOptions): void {
        ...
        ArkUIGeneratedNativeModule._FlexInterface_setFlexOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    pointLightAttribute(value: PointLightStyle): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writePointLightStyle(value)
        ArkUIGeneratedNativeModule._FlexAttribute_pointLight(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkFlexAttributes extends ArkCommonMethodAttributes {
