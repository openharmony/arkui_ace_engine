...
import { ArkStepperItemPeer } from "./peers/ArkStepperItemPeer"
...
import { ItemState, StepperItemAttribute } from "./ArkStepperItemInterfaces"
/** @memo:stable */
export class ArkStepperItemComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public status(value?: ItemState): this {
...
export function ArkStepperItem(
  /** @memo */
  style: ((attributes: ArkStepperItemComponent) => void) | undefined,
  /** @memo */
