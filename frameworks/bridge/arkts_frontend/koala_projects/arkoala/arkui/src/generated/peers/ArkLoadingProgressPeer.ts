...
export class ArkLoadingProgressPeer extends ArkCommonMethodPeer {
    ...
    colorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._LoadingProgressAttribute_color(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    enableLoadingAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._LoadingProgressAttribute_enableLoading(this.peer.ptr, +value)
    }
    contentModifierAttribute(value: ContentModifier<any>): void {
        const thisSerializer: Serializer = Serializer.hold()
        thisSerializer.writeCustomObject("ContentModifier", value)
        ArkUIGeneratedNativeModule._LoadingProgressAttribute_contentModifier(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkLoadingProgressAttributes extends ArkCommonMethodAttributes {
    color?: ResourceColor
