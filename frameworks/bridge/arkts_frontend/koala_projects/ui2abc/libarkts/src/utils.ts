...
function fixNamespace(code: string) {
    ...
    */
    ...
    code = code.replaceAll(/public static (pageEntries)/g, "export const $1")
    code = code.replaceAll(/public static (globalRouterImp\:)/g, "export const $1")
    code = code.replaceAll(/public static (setRouter\(routerImp)/g, "export function $1")
    code = code.replaceAll(/public static (getParams\()/g, "export function $1")
    code = code.replaceAll(/public static (clear\(\)\: void)/g, "export function $1")
    code = code.replaceAll(/public static (pushUrl\(options)/g, "export function $1")
    code = code.replaceAll(/public static (push\(options)/g, "export function $1")
    code = code.replaceAll(/public static (back\(options)/g, "export function $1")
    code = code.replaceAll(/public static (UpdateVisiblePagePeerNode\(node)/g, "export function $1")
    code = code.replaceAll(/public static (createNode\(context)/g, "export function $1")
    code = code.replaceAll(/public static (clearFocus\()/g, "export function $1")
    code = code.replaceAll(/public static (requestFocus\(key)/g, "export function $1")
    ...
    code = code.replaceAll(/public static (openToast\(value: ShowToastOptions)/g, "export function $1")
    code = code.replaceAll(/public static (closeToast\(id: number)/g, "export function $1")
    ...
    code = code.replaceAll(/public static (setOverlayManagerOptions\(options: OverlayManagerOptions)/g, "export function $1")
    code = code.replaceAll(/public static (getOverlayManagerOptions\(\))/g, "export function $1")
    code = code.replaceAll(/public static (addComponentContent\(contentNode: KPointer)/g, "export function $1")
    code = code.replaceAll(/public static (addComponentContentWithOrder\(contentNode: KPointer)/g, "export function $1")
    code = code.replaceAll(/public static (removeComponentContent\(contentNode: KPointer)/g, "export function $1")
    code = code.replaceAll(/public static (showComponentContent\(contentNode: KPointer)/g, "export function $1")
