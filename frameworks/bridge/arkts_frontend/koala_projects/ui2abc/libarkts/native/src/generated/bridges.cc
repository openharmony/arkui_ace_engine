...
KNativePointer impl_ClassElementOriginEnumMemberConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ClassElementOriginEnumMemberConst(_context, _receiver);
    return (void*)result;
}
KOALA_INTEROP_2(ClassElementOriginEnumMemberConst, KNativePointer, KNativePointer, KNativePointer);

void impl_ClassElementSetOrigEnumMember(KNativePointer context, KNativePointer receiver, KNativePointer enumMember)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    const auto _enumMember = reinterpret_cast<es2panda_AstNode*>(enumMember);
    GetImpl()->ClassElementSetOrigEnumMember(_context, _receiver, _enumMember);
    return ;
}
KOALA_INTEROP_V3(ClassElementSetOrigEnumMember, KNativePointer, KNativePointer, KNativePointer);
...
KBoolean impl_ClassDefinitionIsIntEnumTransformedConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ClassDefinitionIsIntEnumTransformedConst(_context, _receiver);
    return result;
}
KOALA_INTEROP_2(ClassDefinitionIsIntEnumTransformedConst, KBoolean, KNativePointer, KNativePointer);

KBoolean impl_ClassDefinitionIsStringEnumTransformedConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ClassDefinitionIsStringEnumTransformedConst(_context, _receiver);
    return result;
}
KOALA_INTEROP_2(ClassDefinitionIsStringEnumTransformedConst, KBoolean, KNativePointer, KNativePointer);

KBoolean impl_ClassDefinitionIsEnumTransformedConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ClassDefinitionIsEnumTransformedConst(_context, _receiver);
    return result;
}
KOALA_INTEROP_2(ClassDefinitionIsEnumTransformedConst, KBoolean, KNativePointer, KNativePointer);
...
void impl_SwitchCaseStatementSetTest(KNativePointer context, KNativePointer receiver, KNativePointer test)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    const auto _test = reinterpret_cast<es2panda_AstNode*>(test);
    GetImpl()->SwitchCaseStatementSetTest(_context, _receiver, _test);
    return ;
}
KOALA_INTEROP_V3(SwitchCaseStatementSetTest, KNativePointer, KNativePointer, KNativePointer);
...
void impl_MethodDefinitionInitializeOverloadInfo(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    GetImpl()->MethodDefinitionInitializeOverloadInfo(_context, _receiver);
    return ;
}
...
void impl_SwitchStatementSetDiscriminant(KNativePointer context, KNativePointer receiver, KNativePointer discriminant)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    const auto _discriminant = reinterpret_cast<es2panda_AstNode*>(discriminant);
    GetImpl()->SwitchStatementSetDiscriminant(_context, _receiver, _discriminant);
    return ;
}
KOALA_INTEROP_V3(SwitchStatementSetDiscriminant, KNativePointer, KNativePointer, KNativePointer);
...
KNativePointer impl_CreateCatchClause1(KNativePointer context, KNativePointer other)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _other = reinterpret_cast<es2panda_AstNode*>(other);
    auto result = GetImpl()->CreateCatchClause1(_context, _other);
    return result;
}
KOALA_INTEROP_2(CreateCatchClause1, KNativePointer, KNativePointer, KNativePointer);

KNativePointer impl_UpdateCatchClause1(KNativePointer context, KNativePointer original, KNativePointer other)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _original = reinterpret_cast<es2panda_AstNode*>(original);
    const auto _other = reinterpret_cast<es2panda_AstNode*>(other);
    auto result = GetImpl()->UpdateCatchClause1(_context, _original, _other);
    return result;
}
KOALA_INTEROP_3(UpdateCatchClause1, KNativePointer, KNativePointer, KNativePointer, KNativePointer);
...
KNativePointer impl_ETSTypeReferencePartGetIdent(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ETSTypeReferencePartGetIdent(_context, _receiver);
    return result;
}
KOALA_INTEROP_2(ETSTypeReferencePartGetIdent, KNativePointer, KNativePointer, KNativePointer);
...
KNativePointer impl_ProgramSourceFileConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_Program*>(receiver);
    auto result = GetImpl()->ProgramSourceFileConst(_context, _receiver);
    return (void*)result;
}
KOALA_INTEROP_2(ProgramSourceFileConst, KNativePointer, KNativePointer, KNativePointer);
