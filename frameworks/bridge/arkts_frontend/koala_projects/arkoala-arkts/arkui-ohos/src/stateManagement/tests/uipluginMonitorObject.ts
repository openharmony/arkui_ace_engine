...
import { ILocalDecoratedVariable, IObservedObject }  from '../decorator'
...
class ClassA implements IObservedObject, IWatchSubscriberRegister {
    ...
    constructor() {
        ...
        this._monitor = 
        STATE_MGMT_FACTORY.makeMonitor(new Array<IMonitorPathInfo>(
                {path: 'classB', valueCallback: () => {
                    const result = this.classB;
                    console.log('lamda for path classB, value: ', result);
                    return result;
                }} as IMonitorPathInfo,
                {path: 'classB.propB1', valueCallback: () => {
    ...
    // @JsonIgnore
    private readonly subscribedWatches_: ISubscribedWatches = STATE_MGMT_FACTORY.makeSubscribedWatches();
    ...
    // @JsonIgnore
    private ____V1RenderId: Int = 0;
    public setV1RenderId(renderId: Int): void {
    ...
    // @JsonIgnore
    private readonly __meta_classB: IMutableStateMeta = STATE_MGMT_FACTORY.makeMutableStateMeta();
    ...
    // @JsonIgnore
    private readonly __meta_classC: IMutableStateMeta = STATE_MGMT_FACTORY.makeMutableStateMeta();
...
export function run_monitor_object(): boolean {
    ...
    let comp: ParentComponent = new ParentComponent(null, {});
    ...
    tcase('#2: change @Tracked property and verify Monitor function =====') {
        ...
        comp.a.classB.onPropChanged = (m: IMonitor) => {
            ...
            let monitorValue = m.value<string>('propB1');
        ...
        comp.a.onBChanged = (m: IMonitor) => {
            ...
            let monitorValue = m.value<string>('classB.propB1');
    ...
    tcase('#3: assign new ClassB and verify Monitor function =====') {
        ...
        comp.a.onBChanged = (m: IMonitor) => {
            ...
            let monitorValue = m.value<ClassB>('classB');
            ...
            let monitorValue2 = m.value<string>('classB.propB1');
