...
export class PatternLockModifier extends CommonMethodModifier implements PatternLockAttribute,AttributeModifier<PatternLockAttribute> {
    ...
    _pathStrokeWidth_0_0value?: number | string | undefined
    _onPatternComplete_0_flag: AttributeUpdaterFlag = AttributeUpdaterFlag.INITIAL
    _onPatternComplete_0_0value?: ((input: Array<number>) => void) | undefined
    ...
    applyModifierPatch(peer: ArkPatternLockPeer): void {
        super.applyModifierPatch(peer)
        if (this._sideLength_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._sideLength_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.sideLengthAttribute((this._sideLength_0_0value as Length | undefined));
                ...
                default: {
                    ...
                    peer.sideLengthAttribute((undefined as Length | undefined));
                }
            }
        }
        if (this._circleRadius_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._circleRadius_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.circleRadiusAttribute((this._circleRadius_0_0value as Length | undefined));
                ...
                default: {
                    ...
                    peer.circleRadiusAttribute((undefined as Length | undefined));
                }
            }
        }
        if (this._backgroundColor_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._backgroundColor_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.backgroundColorAttribute((this._backgroundColor_0_0value as ResourceColor | undefined));
                ...
                default: {
                    ...
                    peer.backgroundColorAttribute((undefined as ResourceColor | undefined));
                }
            }
        }
        if (this._regularColor_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._regularColor_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.regularColorAttribute((this._regularColor_0_0value as ResourceColor | undefined));
                ...
                default: {
                    ...
                    peer.regularColorAttribute((undefined as ResourceColor | undefined));
                }
            }
        }
        ...
        if (this._activeColor_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._activeColor_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.activeColorAttribute((this._activeColor_0_0value as ResourceColor | undefined));
                ...
                default: {
                    ...
                    peer.activeColorAttribute((undefined as ResourceColor | undefined));
                }
            }
        }
        if (this._pathColor_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._pathColor_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.pathColorAttribute((this._pathColor_0_0value as ResourceColor | undefined));
                ...
                default: {
                    ...
                    peer.pathColorAttribute((undefined as ResourceColor | undefined));
                }
            }
        }
        if (this._pathStrokeWidth_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._pathStrokeWidth_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.pathStrokeWidthAttribute((this._pathStrokeWidth_0_0value as number | string | undefined));
                ...
                default: {
                    ...
                    peer.pathStrokeWidthAttribute((undefined as number | string | undefined));
                }
            }
        }
        if (this._onPatternComplete_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onPatternComplete_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onPatternCompleteAttribute((this._onPatternComplete_0_0value as ((input: Array<number>) => void) | undefined));
                ...
                default: {
                    ...
                    peer.onPatternCompleteAttribute((undefined as ((input: Array<number>) => void) | undefined));
                }
            }
        }
        if (this._autoReset_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._autoReset_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.autoResetAttribute((this._autoReset_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.autoResetAttribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._onDotConnect_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onDotConnect_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onDotConnectAttribute((this._onDotConnect_0_0value as ((value0: number) => void) | undefined));
                ...
                default: {
                    ...
                    peer.onDotConnectAttribute((undefined as ((value0: number) => void) | undefined));
                }
            }
        }
        if (this._activateCircleStyle_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._activateCircleStyle_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.activateCircleStyleAttribute((this._activateCircleStyle_0_0value as CircleStyleOptions | undefined));
                ...
                default: {
                    ...
                    peer.activateCircleStyleAttribute((undefined as CircleStyleOptions | undefined));
                }
            }
        }
        if (this._skipUnselectedPoint_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._skipUnselectedPoint_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.skipUnselectedPointAttribute((this._skipUnselectedPoint_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.skipUnselectedPointAttribute((undefined as boolean | undefined));
                }
            }
        }
    }
    mergeModifier(modifier: PatternLockModifier): void {
        ...
        if (modifier._pathStrokeWidth_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (modifier._pathStrokeWidth_0_flag) {
                ...
                default: {
                    this.pathStrokeWidth((undefined as number | string | undefined));
                }
            }
        }
        if (modifier._onPatternComplete_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (modifier._onPatternComplete_0_flag) {
                ...
                default: {
                    this.onPatternComplete((undefined as ((input: Array<number>) => void) | undefined));
                }
            }
        }
