...
export class SwiperOps {
    public static registerIndexCallback(node: KPointer, value: number, callback: IndexCallback): KPointer {
        ...
        return SwiperOps.registerIndexCallback_serialize(node_casted, value_casted, callback_casted)
    }
    private static registerIndexCallback_serialize(node: KPointer, value: number, callback: IndexCallback): KPointer {
        ...
        const retval  = ArkUIGeneratedNativeModule._SwiperOps_registerIndexCallback(node, value, thisSerializer.asBuffer(), thisSerializer.length())
