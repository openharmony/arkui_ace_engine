...
import { BaseShape, CircleShape, ShapeSize, CommonShape, WebviewController, Summary, EffectDirection, EffectScope, EllipseShape, ImageModifier, IntentionCode, RectWidthStyle, RectHeightStyle, SymbolGlyphModifier, PathShape, PathShapeOptions, PerfMonitorActionType, PerfMonitorSourceType, SymbolEffect, RectShape, RectShapeOptions, RoundRectShapeOptions, ResolutionQuality, TextModifier, IndicatorStyle, WebHeader, WindowStatusType, ColorMetrics, EdgeStyles, ReplaceSymbolEffect, ScaleSymbolEffect, SnapshotOptions, LabelStyle } from "./../arkui-external"
...
import { DrawContext, Rect, LengthUnit, ShapeClip, RoundRect, Circle, CommandPath, ShapeMask, Size, Vector2, Vector3, BorderRadiuses_graphics, CornerRadius, Edges, Frame, Matrix4 } from "./../arkui-graphics"
...
export class TypeChecker {
    ...
    static isLiteral_String_anchor_HorizontalAlign_align(value: Object | string | number | undefined, arg0: boolean, arg1: boolean): boolean {
        return value instanceof Literal_String_anchor_HorizontalAlign_align
    }
    static isLiteral_String_anchor_VerticalAlign_align(value: Object | string | number | undefined, arg0: boolean, arg1: boolean): boolean {
