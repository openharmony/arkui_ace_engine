...
import { nullptr, KPointer, KInt, KBoolean, KStringPtr, runtimeType, RuntimeType, MaterializedBase, toPeerPtr,
    wrapCallback, NativeBuffer } from '@koalaui/interop';
import { Serializer } from './peers/Serializer';
import { ComponentBase } from './../ComponentBase';
import { PeerNode } from './../PeerNode';
import { ArkUIGeneratedNativeModule, TypeChecker } from '#components';
import { ArkCommonMethodPeer, CommonMethod, PointLightStyle, ArkCommonMethodComponent, ArkCommonMethodStyle,
...
export class ArkColumnPeer extends ArkCommonMethodPeer {
    ...
    setColumnOptions0Attribute(options?: ColumnOptions): void {
        ...
        ArkUIGeneratedNativeModule._ColumnInterface_setColumnOptions0(this.peer.ptr, thisSerializer.asBuffer(),
    ...
    setColumnOptions1Attribute(options?: ColumnOptions | ColumnOptionsV2): void {
        ...
        ArkUIGeneratedNativeModule._ColumnInterface_setColumnOptions1(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    alignItemsAttribute(value: HorizontalAlign | undefined): void {
        ...
        ArkUIGeneratedNativeModule._ColumnAttribute_alignItems(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    justifyContentAttribute(value: FlexAlign | undefined): void {
        ...
        ArkUIGeneratedNativeModule._ColumnAttribute_justifyContent(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    pointLightAttribute(value: PointLightStyle | undefined): void {
        ...
        ArkUIGeneratedNativeModule._ColumnAttribute_pointLight(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    reverseAttribute(value: boolean | undefined): void {
        ...
        ArkUIGeneratedNativeModule._ColumnAttribute_reverse(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
}
