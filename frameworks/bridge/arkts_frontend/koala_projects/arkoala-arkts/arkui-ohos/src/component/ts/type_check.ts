...
import { DrawContext, Rect, LengthUnit, ShapeClip, RoundRect, Circle, CommandPath, ShapeMask, Size, Vector2, Vector3, CornerRadius, Edges, Frame, Matrix4 } from "./../../Graphics"
...
export class TypeChecker {
    ...
    static isLiteral_String_anchor_HorizontalAlign_align(value: Object | string | number | undefined | boolean, duplicated_anchor: boolean, duplicated_align: boolean): boolean {
    ...
    static isLiteral_String_anchor_VerticalAlign_align(value: Object | string | number | undefined | boolean, duplicated_anchor: boolean, duplicated_align: boolean): boolean {
        if ((!duplicated_anchor) && (value?.hasOwnProperty("anchor"))) {
            return true
        }
        else if ((!duplicated_align) && (value?.hasOwnProperty("align"))) {
