...
import { TextMenuOptions } from "./textCommon"
export class GlobalScopeUicontextFontScale {
    ...
    public static getMaxFontScale(): number {
    ...
    private static getMaxFontScale_serialize(): number {
...
export class GlobalScopeUicontextTextMenu {
    ...
    private static setMenuOptions_serialize(options: TextMenuOptions): void {
        ...
        thisSerializer.writeTextMenuOptions(options)
