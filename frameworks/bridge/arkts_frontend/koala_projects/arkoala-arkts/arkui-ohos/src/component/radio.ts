...
import { ArkRadioComponent } from "./../generated/ArkRadio"
import { ArkRadioPeer } from "./../generated/peers/ArkRadioPeer"
...
export interface RadioAttribute extends CommonMethod {
    ...
    /** @memo */
    _onChangeEvent_checked(callback: ((parameter: boolean) => void)): void
}
/** @memo */
