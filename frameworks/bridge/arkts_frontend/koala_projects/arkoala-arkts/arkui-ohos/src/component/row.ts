...
export class ArkRowPeer extends ArkCommonMethodPeer {
    ...
    setRowOptions0Attribute(options?: RowOptions): void {
        ...
        ArkUIGeneratedNativeModule._RowInterface_setRowOptions0(this.peer.ptr, thisSerializer.asBuffer(),
    ...
    setRowOptions1Attribute(options?: RowOptions | RowOptionsV2): void {
        ...
        ArkUIGeneratedNativeModule._RowInterface_setRowOptions1(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    alignItemsAttribute(value: VerticalAlign | undefined): void {
        ...
        ArkUIGeneratedNativeModule._RowAttribute_alignItems(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    justifyContentAttribute(value: FlexAlign | undefined): void {
        ...
        ArkUIGeneratedNativeModule._RowAttribute_justifyContent(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    pointLightAttribute(value: PointLightStyle | undefined): void {
        ...
        ArkUIGeneratedNativeModule._RowAttribute_pointLight(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
    ...
    reverseAttribute(value: boolean | undefined): void {
        ...
        ArkUIGeneratedNativeModule._RowAttribute_reverse(this.peer.ptr, thisSerializer.asBuffer(),
            thisSerializer.length());
        thisSerializer.release();
    }
}
