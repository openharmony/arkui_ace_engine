...
export class ListItemOps {
    public static registerSelectedCallback(node: KPointer, value: boolean, callback: SelectedCallback): KPointer {
        ...
        return ListItemOps.registerSelectedCallback_serialize(node_casted, value_casted, callback_casted)
    }
    private static registerSelectedCallback_serialize(node: KPointer, value: boolean, callback: SelectedCallback): KPointer {
        ...
        const retval  = ArkUIGeneratedNativeModule._ListItemOps_registerSelectedCallback(node, value ? 1 : 0, thisSerializer.asBuffer(), thisSerializer.length())
