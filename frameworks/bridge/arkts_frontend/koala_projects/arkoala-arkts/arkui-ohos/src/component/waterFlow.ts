...
export interface WaterFlowAttribute extends ScrollableCommonMethod {
    ...
    /** @memo */
    onWillScroll(value: OnWillScrollCallback): this
    /** @memo */
