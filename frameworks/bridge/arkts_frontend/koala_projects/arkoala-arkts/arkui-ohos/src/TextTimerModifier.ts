...
export class TextTimerModifier extends CommonMethodModifier implements TextTimerAttribute,AttributeModifier<TextTimerAttribute> {
    ...
    applyPressedAttribute(instance: TextTimerAttribute): void { }
    applyFocusedAttribute(instance: TextTimerAttribute): void { }
    applyDisabledAttribute(instance: TextTimerAttribute): void { }
    applySelectedAttribute(instance: TextTimerAttribute): void { }
    ...
    _onTimer_0_0value?: ((utc: int64,elapsedTime: int64) => void) | undefined
    ...
    applyModifierPatch(peer: ArkTextTimerPeer): void {
        ...
        if (this._onTimer_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onTimer_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onTimerAttribute((this._onTimer_0_0value as ((utc: int64,elapsedTime: int64) => void) | undefined));
                ...
                default: {
                    ...
                    peer.onTimerAttribute((undefined as ((utc: int64,elapsedTime: int64) => void) | undefined));
                }
            }
        }
    ...
    mergeModifier(modifier: TextTimerModifier): void {
        ...
        if (modifier._onTimer_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (modifier._onTimer_0_flag) {
                ...
                default: {
                    this.onTimer((undefined as ((utc: int64,elapsedTime: int64) => void) | undefined));
                }
            }
        }
