...
export class CalendarPickerModifier extends CommonMethodModifier implements CalendarPickerAttribute,AttributeModifier<CalendarPickerAttribute> {
    ...
    applyPressedAttribute(instance: CalendarPickerAttribute): void { }
    applyFocusedAttribute(instance: CalendarPickerAttribute): void { }
    applyDisabledAttribute(instance: CalendarPickerAttribute): void { }
    applySelectedAttribute(instance: CalendarPickerAttribute): void { }
    ...
    applyModifierPatch(peer: ArkCalendarPickerPeer): void {
        ...
        if (this._onChange_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onChange_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onChange0Attribute((this._onChange_0_0value as ((value0: Date) => void) | undefined));
                ...
                default: {
                    ...
                    peer.onChange0Attribute((undefined as ((value0: Date) => void) | undefined));
                }
            }
        }
        if (this._markToday_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._markToday_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.markTodayAttribute((this._markToday_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.markTodayAttribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._edgeAlign_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._edgeAlign_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.edgeAlign0Attribute((this._edgeAlign_0_0value as CalendarAlign | undefined), (this._edgeAlign_0_1value as Offset | undefined));
                ...
                default: {
                    ...
                    peer.edgeAlign0Attribute((undefined as CalendarAlign | undefined), (undefined as Offset | undefined | undefined));
                }
            }
        }
    }
