...
export class SymbolGlyphModifier extends CommonMethodModifier implements SymbolGlyphAttribute, AttributeModifier<SymbolGlyphAttribute> {
    ...
    _fontColor_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _fontColor0_value?: Array<ResourceColor> | undefined
    _fontWeight_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _fontWeight0_value?: number | FontWeight | string | undefined
    _effectStrategy_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _effectStrategy0_value?: SymbolEffectStrategy | undefined
    _renderingStrategy_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _renderingStrategy0_value?: SymbolRenderingStrategy | undefined
    _minFontScale_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _minFontScale0_value?: number | Resource | undefined
    _maxFontScale_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    _maxFontScale0_value?: number | Resource | undefined
    _symbolEffect_flag:  AttributeUpdateFlag = AttributeUpdateFlag.INITIAL
    ...
    public fontColor(value: Array<ResourceColor> | undefined): this {
        if (this._fontColor_flag === AttributeUpdateFlag.INITIAL ||
            this._fontColor0_value !== value || !Type.of(value).isPrimitive()) {
            this._fontColor0_value = value
            this._fontColor_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._fontColor_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public fontWeight(value: number | FontWeight | string | undefined): this {
        if (this._fontWeight_flag === AttributeUpdateFlag.INITIAL || this._fontWeight0_value !== value) {
            this._fontWeight0_value = value
            this._fontWeight_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._fontWeight_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public effectStrategy(value: SymbolEffectStrategy | undefined): this {
        if (this._effectStrategy_flag === AttributeUpdateFlag.INITIAL || this._effectStrategy0_value !== value) {
            this._effectStrategy0_value = value
            this._effectStrategy_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._effectStrategy_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public renderingStrategy(value: SymbolRenderingStrategy | undefined): this {
        if (this._renderingStrategy_flag === AttributeUpdateFlag.INITIAL || this._renderingStrategy0_value !== value) {
            this._renderingStrategy0_value = value
            this._renderingStrategy_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._renderingStrategy_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public minFontScale(value: number | Resource | undefined): this {
        if (this._minFontScale_flag === AttributeUpdateFlag.INITIAL ||
            this._minFontScale0_value !== value || !Type.of(value).isPrimitive()) {
            this._minFontScale0_value = value
            this._minFontScale_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._minFontScale_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public maxFontScale(value: number | Resource | undefined): this {
        if (this._maxFontScale_flag === AttributeUpdateFlag.INITIAL ||
            this._maxFontScale0_value !== value || !Type.of(value).isPrimitive()) {
            this._maxFontScale0_value = value
            this._maxFontScale_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._maxFontScale_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }

    public symbolEffect(symbolEffect: SymbolEffect | undefined, isActive?: boolean | number): this {
        if (this._symbolEffect_flag === AttributeUpdateFlag.INITIAL || this._symbolEffect0_value !== symbolEffect ||
            ...
            this._symbolEffect_flag = AttributeUpdateFlag.UPDATE
        } else {
            this._symbolEffect_flag = AttributeUpdateFlag.SKIP
        }
        return this
    }
    ...
    applyModifierPatch(value: PeerNode): void {
        ...
        if (this._fontColor_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._fontColor_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._fontColor_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._fontColor_flag = AttributeUpdateFlag.RESET
        ...
        if (this._fontWeight_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._fontWeight_flag) {
                ...
                default: {
                    this._fontWeight_flag = AttributeUpdateFlag.INITIAL
                    peerNode.fontWeightAttribute(undefined)
                }
            }
        }
        if (this._effectStrategy_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._effectStrategy_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._effectStrategy_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._effectStrategy_flag = AttributeUpdateFlag.RESET
                ...
                default: {
                    this._effectStrategy_flag = AttributeUpdateFlag.INITIAL
                    peerNode.effectStrategyAttribute(undefined)
                }
            }
        }
        if (this._renderingStrategy_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._renderingStrategy_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._renderingStrategy_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._renderingStrategy_flag = AttributeUpdateFlag.RESET
                ...
                default: {
                    this._renderingStrategy_flag = AttributeUpdateFlag.INITIAL
        ...
        if (this._minFontScale_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._minFontScale_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._minFontScale_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._minFontScale_flag = AttributeUpdateFlag.RESET
                ...
                default: {
                    this._minFontScale_flag = AttributeUpdateFlag.INITIAL
        ...
        if (this._maxFontScale_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._maxFontScale_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._maxFontScale_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._maxFontScale_flag = AttributeUpdateFlag.RESET
                ...
                default: {
                    this._maxFontScale_flag = AttributeUpdateFlag.INITIAL
                    peerNode.maxFontScaleAttribute(undefined)
                }
            }
        }
        if (this._symbolEffect_flag !== AttributeUpdateFlag.INITIAL) {
            switch (this._symbolEffect_flag) {
                case AttributeUpdateFlag.UPDATE: {
                    ...
                    this._symbolEffect_flag = AttributeUpdateFlag.RESET
                    break
                }
                case AttributeUpdateFlag.SKIP: {
                    this._symbolEffect_flag = AttributeUpdateFlag.RESET
                ...
                default: {
                    this._symbolEffect_flag = AttributeUpdateFlag.INITIAL
    ...
    mergeModifier(value: CommonMethodModifier): void {
        ...
        if (value instanceof SymbolGlyphModifier) {
            ...
            if (symbolGlyphModifier._fontSize_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._fontColor_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._fontWeight_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._effectStrategy_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._renderingStrategy_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._minFontScale_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._maxFontScale_flag !== AttributeUpdateFlag.INITIAL) {
            ...
            if (symbolGlyphModifier._symbolEffect_flag !== AttributeUpdateFlag.INITIAL) {
