...
import { CustomComponent, IPropertySubscriber, ISinglePropertyChangeSubscriber, SubscribaleAbstract, CommonTransition, PageTransitionEnterInterface, PageTransitionExitInterface } from "./../../handwritten"
...
export class TypeChecker {
    ...
    static isLiteral_String_anchor_HorizontalAlign_align(value: object|string|number|undefined|null|boolean, duplicated_anchor: boolean, duplicated_align: boolean): boolean {
        if ((!duplicated_anchor) && (value?.hasOwnProperty("anchor"))) {
            ...
            throw new Error("Can not discriminate value typeof Literal_String_anchor_HorizontalAlign_align")
        }
    }
    static isLiteral_String_anchor_VerticalAlign_align(value: object|string|number|undefined|null|boolean, duplicated_anchor: boolean, duplicated_align: boolean): boolean {
        if ((!duplicated_anchor) && (value?.hasOwnProperty("anchor"))) {
            return true
        }
        else if ((!duplicated_align) && (value?.hasOwnProperty("align"))) {
            ...
            throw new Error("Can not discriminate value typeof Literal_String_anchor_VerticalAlign_align")
        }
    }
