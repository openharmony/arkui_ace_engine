...
export class ArkStackPeer extends ArkCommonMethodPeer {
    ...
    alignContentAttribute(value: Alignment): void {
        ArkUIGeneratedNativeModule._StackAttribute_alignContent(this.peer.ptr, value.valueOf())
    }
...
export interface ArkStackAttributes extends ArkCommonMethodAttributes {
