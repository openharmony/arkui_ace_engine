...
import { HitTestMode, ImageSize, Alignment, BorderStyle, ColoringStrategy, HoverEffect, Color, Visibility, ItemAlign, Direction, GradientDirection, ObscuredReasons, RenderFit, ImageRepeat, Axis, ResponseType, FunctionKey, ModifierKey, VerticalAlign, FlexAlign } from "./../../component/enums"
...
export class ArkRowPeer extends ArkCommonMethodPeer {
    ...
    alignItemsAttribute(value: VerticalAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_alignItems(this.peer.ptr, value.valueOf())
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_justifyContent(this.peer.ptr, value.valueOf())
    }
...
export interface ArkRowAttributes extends ArkCommonMethodAttributes {
