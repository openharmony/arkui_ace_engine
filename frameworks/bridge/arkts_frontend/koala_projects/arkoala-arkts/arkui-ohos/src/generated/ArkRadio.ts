...
import { ArkRadioPeer } from "./peers/ArkRadioPeer"
...
import { RadioStyle, RadioConfiguration, RadioOptions, RadioAttribute } from "./../component/radio"
/** @memo:stable */
export class ArkRadioComponent extends ArkCommonMethodComponent implements RadioAttribute {
    ...
    /** @memo */
    public radioStyle(value?: RadioStyle): this {
    ...
    /** @memo */
    public _onChangeEvent_checked(callback: ((parameter: boolean) => void)): void {
