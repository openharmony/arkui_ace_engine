...
import { ArkScrollBarPeer } from "./peers/ArkScrollBarPeer"
...
import { ScrollBarOptions, ScrollBarAttribute } from "./../component/scrollBar"
/** @memo:stable */
export class ArkScrollBarComponent extends ArkCommonMethodComponent implements ScrollBarAttribute {
    ...
    /** @memo */
    public enableNestedScroll(value?: boolean): this {
