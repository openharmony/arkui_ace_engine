...
import { ArkNavRouterPeer } from "./peers/ArkNavRouterPeer"
...
export class ArkNavRouterComponent extends ArkCommonMethodComponent implements NavRouterAttribute {
    ...
    public setNavRouterOptions(value?: RouteInfo): this {
        if (this.checkPriority("setNavRouterOptions")) {
            ...
            if (RuntimeType.OBJECT == value_type) {
                const value_casted = value as (RouteInfo)
                this.getPeer()?.setNavRouterOptions1Attribute(value_casted)
                return this
            }
    ...
    /** @memo */
    public onStateChange(value: ((parameter: boolean) => void)): this {
