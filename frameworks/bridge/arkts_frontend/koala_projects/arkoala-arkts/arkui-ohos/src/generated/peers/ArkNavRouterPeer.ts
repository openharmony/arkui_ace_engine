...
import { NavRouteMode, NavRouterAttribute, RouteInfo } from "./../../component/navRouter"
...
export class ArkNavRouterPeer extends ArkCommonMethodPeer {
    ...
    onStateChangeAttribute(value: ((parameter: boolean) => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
    ...
    modeAttribute(value: NavRouteMode): void {
        ArkUIGeneratedNativeModule._NavRouterAttribute_mode(this.peer.ptr, value.valueOf())
    }
}
export interface ArkNavRouterAttributes extends ArkCommonMethodAttributes {
    onStateChange?: ((parameter: boolean) => void)
    mode?: NavRouteMode
}
