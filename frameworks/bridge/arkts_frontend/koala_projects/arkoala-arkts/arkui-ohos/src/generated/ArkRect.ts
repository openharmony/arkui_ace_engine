...
import { ArkRectPeer } from "./peers/ArkRectPeer"
...
export class ArkRectComponent extends ArkCommonShapeMethodComponent implements RectAttribute {
    ...
    /** @memo */
    public radiusWidth(value: number | string): this {
    ...
    /** @memo */
    public radiusHeight(value: number | string): this {
    ...
    /** @memo */
    public radius(value: number | string | Array<number | string>): this {
        if (this.checkPriority("radius")) {
            const value_casted = value as (number | string | Array<number | string>)
