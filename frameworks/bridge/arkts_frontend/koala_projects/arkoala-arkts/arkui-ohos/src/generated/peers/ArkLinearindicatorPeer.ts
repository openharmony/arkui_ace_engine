...
import { LinearIndicatorStyle, OnLinearIndicatorChangeCallback, LinearIndicatorController, LinearIndicatorAttribute } from "./../../component/linearindicator"
...
export class ArkLinearIndicatorPeer extends ArkCommonMethodPeer {
    ...
    indicatorStyleAttribute(value?: LinearIndicatorStyle): void {
        const thisSerializer : Serializer = Serializer.hold()
    ...
    indicatorLoopAttribute(value?: boolean): void {
        const thisSerializer : Serializer = Serializer.hold()
        let value_type : int32 = RuntimeType.UNDEFINED
        value_type = runtimeType(value)
        thisSerializer.writeInt8(value_type as int32)
    ...
    onChangeAttribute(value?: OnLinearIndicatorChangeCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
        let value_type : int32 = RuntimeType.UNDEFINED
        value_type = runtimeType(value)
        thisSerializer.writeInt8(value_type as int32)
...
export interface ArkLinearIndicatorAttributes extends ArkCommonMethodAttributes {
    indicatorStyle?: LinearIndicatorStyle | undefined
    indicatorLoop?: boolean | undefined
    onChange?: OnLinearIndicatorChangeCallback | undefined
}
