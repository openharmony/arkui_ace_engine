...
export class ArkColumnPeer extends ArkCommonMethodPeer {
    ...
    setColumnOptionsAttribute(options?: ColumnOptions): void {
        ...
        ArkUIGeneratedNativeModule._ColumnInterface_setColumnOptions(this.peer.ptr, thisSerializer.asBuffer(), thisSerializer.length())
        thisSerializer.release()
    }
    alignItemsAttribute(value: HorizontalAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_alignItems(this.peer.ptr, value.valueOf())
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_justifyContent(this.peer.ptr, value.valueOf())
    }
