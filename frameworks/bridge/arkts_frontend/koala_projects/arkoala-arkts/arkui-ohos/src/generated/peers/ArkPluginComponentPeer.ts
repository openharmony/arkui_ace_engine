...
import { PluginErrorCallback, PluginComponentOptions, PluginComponentAttribute } from "./../../component/pluginComponent"
...
export class ArkPluginComponentPeer extends ArkCommonMethodPeer {
    ...
    onCompleteAttribute(value: VoidCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
    ...
    onErrorAttribute(value: PluginErrorCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
...
export interface ArkPluginComponentAttributes extends ArkCommonMethodAttributes {
