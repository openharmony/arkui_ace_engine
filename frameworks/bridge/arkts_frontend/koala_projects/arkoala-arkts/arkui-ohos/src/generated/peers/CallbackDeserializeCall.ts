...
import { Callback_SwiperContentTransitionProxy_Void, SwiperContentTransitionProxy, ContentDidScrollCallback, OnSwiperAnimationEndCallback, SwiperAnimationEvent, OnSwiperAnimationStartCallback, OnSwiperGestureSwipeCallback } from "./../../component/swiper"
import { Callback_TerminationInfo_Void, TerminationInfo } from "./../../component/embeddedComponent"
import { Callback_TimePickerResult_Void, TimePickerResult } from "./../../component/timePicker"
import { Callback_Type_ImageAttribute_onComplete_callback_event_Void, Type_ImageAttribute_onComplete_callback_event, ImageErrorCallback, ImageError } from "./../../component/image"
import { Callback_Void } from "./../../component/abilityComponent"
import { WithThemeAttribute, WithThemeInterface, WithThemeOptions } from "./../../component/withTheme"
...
import { ImageCompleteCallback, ImageLoadResult } from "./../../component/imageSpan"
...
export function deserializeAndCallCallback_Any_Void(thisDeserializer: Deserializer): void {
    ...
    let info : object = (thisDeserializer.readCustomObject("Any") as Object)
    _call(info)
}
...
export function deserializeAndCallCallback_String_Unknown_Void(thisDeserializer: Deserializer): void {
    const _resourceId : int32 = thisDeserializer.readInt32()
    const _call  = (ResourceHolder.instance().get(_resourceId) as ((name: string,param: object) => void))
    let name : string = (thisDeserializer.readString() as string)
    let param : object = (thisDeserializer.readCustomObject("Any") as Object)
    _call(name, param)
}
