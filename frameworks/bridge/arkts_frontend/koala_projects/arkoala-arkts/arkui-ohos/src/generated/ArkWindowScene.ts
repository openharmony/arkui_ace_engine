...
import { ArkWindowScenePeer } from "./peers/ArkWindowScenePeer"
...
export class ArkWindowSceneComponent extends ArkCommonMethodComponent implements WindowSceneAttribute {
    ...
    /** @memo */
    public attractionEffect(destination: Position, fraction: number): this {
        if (this.checkPriority("attractionEffect")) {
            const destination_casted = destination as (Position)
