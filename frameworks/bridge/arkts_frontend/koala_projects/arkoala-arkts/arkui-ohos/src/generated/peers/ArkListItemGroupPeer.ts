...
import { ListItemGroupOptions, ListItemGroupAttribute } from "./../../component/listItemGroup"
...
export class ArkListItemGroupPeer extends ArkCommonMethodPeer {
    ...
    childrenMainSizeAttribute(value: ChildrenMainSize): void {
        ArkUIGeneratedNativeModule._ListItemGroupAttribute_childrenMainSize(this.peer.ptr, toPeerPtr(value))
    }
}
export interface ArkListItemGroupAttributes extends ArkCommonMethodAttributes {
