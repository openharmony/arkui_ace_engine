...
export class ImageAnimatorModifier extends CommonMethodModifier implements ImageAnimatorAttribute,AttributeModifier<ImageAnimatorAttribute> {
    ...
    applyPressedAttribute(instance: ImageAnimatorAttribute): void { }
    applyFocusedAttribute(instance: ImageAnimatorAttribute): void { }
    applyDisabledAttribute(instance: ImageAnimatorAttribute): void { }
    applySelectedAttribute(instance: ImageAnimatorAttribute): void { }
    ...
    applyModifierPatch(peer: ArkImageAnimatorPeer): void {
        ...
        if (this._images_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._images_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.imagesAttribute((this._images_0_0value as Array<ImageFrameInfo> | undefined));
                ...
                default: {
                    ...
                    peer.imagesAttribute((undefined as Array<ImageFrameInfo> | undefined));
                }
            }
        }
        if (this._state_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._state_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.stateAttribute((this._state_0_0value as AnimationStatus | undefined));
                ...
                default: {
                    ...
                    peer.stateAttribute((undefined as AnimationStatus | undefined));
                }
            }
        }
        ...
        if (this._reverse_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._reverse_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.reverseAttribute((this._reverse_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.reverseAttribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._fixedSize_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._fixedSize_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.fixedSizeAttribute((this._fixedSize_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.fixedSizeAttribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._fillMode_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._fillMode_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.fillModeAttribute((this._fillMode_0_0value as FillMode | undefined));
                ...
                default: {
                    ...
                    peer.fillModeAttribute((undefined as FillMode | undefined));
                }
            }
        }
        if (this._iterations_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._iterations_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.iterationsAttribute((this._iterations_0_0value as number | undefined));
                ...
                default: {
                    ...
                    peer.iterationsAttribute((undefined as number | undefined));
                }
            }
        }
        if (this._monitorInvisibleArea_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._monitorInvisibleArea_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.monitorInvisibleAreaAttribute((this._monitorInvisibleArea_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.monitorInvisibleAreaAttribute((undefined as boolean | undefined));
                }
            }
        }
        ...
        if (this._onPause_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onPause_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onPauseAttribute((this._onPause_0_0value as (() => void) | undefined));
                ...
                default: {
                    ...
                    peer.onPauseAttribute((undefined as (() => void) | undefined));
                }
            }
        }
        if (this._onRepeat_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onRepeat_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onRepeatAttribute((this._onRepeat_0_0value as (() => void) | undefined));
                ...
                default: {
                    ...
                    peer.onRepeatAttribute((undefined as (() => void) | undefined));
                }
            }
        }
        if (this._onCancel_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onCancel_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onCancelAttribute((this._onCancel_0_0value as (() => void) | undefined));
                ...
                default: {
                    ...
                    peer.onCancelAttribute((undefined as (() => void) | undefined));
                }
            }
        }
