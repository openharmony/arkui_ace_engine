...
export class EllipseModifier extends CommonShapeMethodModifier implements EllipseAttribute, AttributeModifier<EllipseAttribute> {
    ...
    applyPressedAttribute(instance: EllipseAttribute): void { }
...
function hookEllipseAttributeModifier(component: ArkEllipseComponent, modifier: AttributeModifier<EllipseAttribute> | AttributeModifier<CommonMethod> | undefined): void {
    ...
    let attributeSet = (): EllipseModifier => {
        ...
        let initModifier = component.getPeer()._attributeSet ? component.getPeer()._attributeSet! : new EllipseModifier();
