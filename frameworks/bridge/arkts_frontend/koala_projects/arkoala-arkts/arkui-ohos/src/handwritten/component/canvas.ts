...
export function hookPutImageData(peerPtr: CanvasRenderer, imagedata: ImageData, dx: number | string, dy: number | string,
    dirtyX: number | string, dirtyY: number | string, dirtyWidth: number | string, dirtyHeight: number | string): void {
    ...
    ArkUIAniModule._CanvasRenderer_PutImageData1(peerPtr.peer!.ptr,
        imagedata.data, dx_val, dy_val, imagedata.width as int32, imagedata.height as int32, dirtyX_val, dirtyY_val, dirtyWidth_val, dirtyHeight_val)
}
