...
import { makeRecordfromObj } from './index';

/**
 * Singleton class used to keep existing theme instances which are used by theme scopes right now
 */
export class ArkThemeCache {
    // single instance
    private static instance: ArkThemeCache | undefined = undefined;
     ...
     */
    get(baselineThemeId: number, customTheme: CustomTheme | undefined, colorMode: ThemeColorMode): ArkThemeBase | undefined {
     ...
     * @returns true if theme instance contains in cache; false otherwise
     */
    containsByAttributes(baselineThemeId: number, customTheme: CustomTheme | undefined, colorMode: ThemeColorMode): boolean {
     ...
     */
    private isEqualsCustomThemes(theme1: CustomTheme | undefined, theme2: CustomTheme | undefined): boolean {
        if (theme1 === theme2) {
