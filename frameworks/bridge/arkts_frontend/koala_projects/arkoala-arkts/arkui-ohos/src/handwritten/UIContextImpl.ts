...
import { UIContext, MeasureUtils, Font, FocusController, ComponentUtils, ContextMenuController,
    FrameCallback, UIInspector, UIObserver, PromptAction, AtomicServiceBar, Router }
...
export class UIContextImpl extends UIContext {
    ...
    public getFont() : Font {
        let font : Font = new FontImpl(this.instanceId_);
        return font;
    }
    public getMeasureUtils() : MeasureUtils {
        let measureUtils : MeasureUtils = new MeasureUtilsImpl(this.instanceId_);
        return measureUtils;
    }
