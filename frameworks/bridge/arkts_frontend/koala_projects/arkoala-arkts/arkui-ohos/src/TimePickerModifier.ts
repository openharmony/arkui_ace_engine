...
import { ArkTimePickerPeer, OnTimePickerChangeCallback, TimePickerResult, TimePickerAttribute } from "./component/timePicker"
...
export class TimePickerModifier extends CommonMethodModifier implements TimePickerAttribute,AttributeModifier<TimePickerAttribute> {
    ...
    applyPressedAttribute(instance: TimePickerAttribute): void { }
    applyFocusedAttribute(instance: TimePickerAttribute): void { }
    applyDisabledAttribute(instance: TimePickerAttribute): void { }
    applySelectedAttribute(instance: TimePickerAttribute): void { }
    ...
    _dateTimeOptions_0_0value?: DateTimeOptions | undefined
    ...
    applyModifierPatch(peer: ArkTimePickerPeer): void {
        ...
        if (this._useMilitaryTime_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._useMilitaryTime_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.useMilitaryTime0Attribute((this._useMilitaryTime_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.useMilitaryTime0Attribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._loop_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._loop_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.loop0Attribute((this._loop_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.loop0Attribute((undefined as boolean | undefined));
                }
            }
        }
        ...
        if (this._dateTimeOptions_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._dateTimeOptions_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.dateTimeOptions0Attribute((this._dateTimeOptions_0_0value as DateTimeOptions | undefined));
                ...
                default: {
                    ...
                    peer.dateTimeOptions0Attribute((undefined as DateTimeOptions | undefined));
                }
            }
        }
        if (this._onChange_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onChange_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onChange0Attribute((this._onChange_0_0value as OnTimePickerChangeCallback | undefined));
                ...
                default: {
                    ...
                    peer.onChange0Attribute((undefined as OnTimePickerChangeCallback | undefined));
                }
            }
        }
        if (this._onEnterSelectedArea_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onEnterSelectedArea_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onEnterSelectedAreaAttribute((this._onEnterSelectedArea_0_0value as ((value0: TimePickerResult) => void) | undefined));
                ...
                default: {
                    ...
                    peer.onEnterSelectedAreaAttribute((undefined as ((value0: TimePickerResult) => void) | undefined));
                }
            }
        }
        if (this._enableHapticFeedback_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._enableHapticFeedback_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.enableHapticFeedback0Attribute((this._enableHapticFeedback_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.enableHapticFeedback0Attribute((undefined as boolean | undefined));
                }
            }
        }
        ...
        if (this._enableCascade_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._enableCascade_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.enableCascadeAttribute((this._enableCascade_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.enableCascadeAttribute((undefined as boolean | undefined));
                }
            }
        }
    }
    mergeModifier(modifier: TimePickerModifier): void {
        ...
        if (modifier._dateTimeOptions_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (modifier._dateTimeOptions_0_flag) {
                ...
                default: {
                    this.dateTimeOptions((undefined as DateTimeOptions | undefined));
                }
            }
        }
