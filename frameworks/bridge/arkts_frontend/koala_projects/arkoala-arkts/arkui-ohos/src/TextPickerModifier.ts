...
export class TextPickerModifier extends CommonMethodModifier implements TextPickerAttribute,AttributeModifier<TextPickerAttribute> {
    ...
    _divider_0_0value?: DividerOptions | null | undefined
    ...
    applyModifierPatch(peer: ArkTextPickerPeer): void {
        ...
        if (this._defaultPickerItemHeight_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._defaultPickerItemHeight_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.defaultPickerItemHeight0Attribute((this._defaultPickerItemHeight_0_0value as number | string | undefined));
                ...
                default: {
                    ...
                    peer.defaultPickerItemHeight0Attribute((undefined as number | string | undefined));
                }
            }
        }
        if (this._canLoop_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._canLoop_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.canLoop0Attribute((this._canLoop_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.canLoop0Attribute((undefined as boolean | undefined));
                }
            }
        }
        ...
        if (this._disableTextStyleAnimation_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._disableTextStyleAnimation_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.disableTextStyleAnimationAttribute((this._disableTextStyleAnimation_0_0value as boolean | undefined));
                ...
                default: {
                    ...
                    peer.disableTextStyleAnimationAttribute((undefined as boolean | undefined));
                }
            }
        }
        if (this._defaultTextStyle_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._defaultTextStyle_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.defaultTextStyleAttribute((this._defaultTextStyle_0_0value as TextPickerTextStyle | undefined));
                ...
                default: {
                    ...
                    peer.defaultTextStyleAttribute((undefined as TextPickerTextStyle | undefined));
                }
            }
        }
        if (this._onChange_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onChange_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onChange0Attribute((this._onChange_0_0value as OnTextPickerChangeCallback | undefined));
                ...
                default: {
                    ...
                    peer.onChange0Attribute((undefined as OnTextPickerChangeCallback | undefined));
                }
            }
        }
        if (this._onScrollStop_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onScrollStop_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onScrollStop0Attribute((this._onScrollStop_0_0value as TextPickerScrollStopCallback | undefined));
                ...
                default: {
                    ...
                    peer.onScrollStop0Attribute((undefined as TextPickerScrollStopCallback | undefined));
                }
            }
        }
        if (this._onEnterSelectedArea_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._onEnterSelectedArea_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.onEnterSelectedAreaAttribute((this._onEnterSelectedArea_0_0value as TextPickerEnterSelectedAreaCallback | undefined));
                ...
                default: {
                    ...
                    peer.onEnterSelectedAreaAttribute((undefined as TextPickerEnterSelectedAreaCallback | undefined));
                }
            }
        }
        if (this._selectedIndex_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._selectedIndex_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.selectedIndex0Attribute((this._selectedIndex_0_0value as number | Array<number> | undefined));
                ...
                default: {
                    ...
                    peer.selectedIndex0Attribute((undefined as number | Array<number> | undefined));
                }
            }
        }
        if (this._divider_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._divider_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.divider0Attribute((this._divider_0_0value as DividerOptions | null | undefined));
                ...
                default: {
                    ...
                    peer.divider0Attribute((undefined as DividerOptions | null | undefined));
                }
            }
        }
        if (this._gradientHeight_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (this._gradientHeight_0_flag) {
                case AttributeUpdaterFlag.UPDATE: {
                    peer.gradientHeight0Attribute((this._gradientHeight_0_0value as Dimension | undefined));
                ...
                default: {
                    ...
                    peer.gradientHeight0Attribute((undefined as Dimension | undefined));
                }
            }
        }
    ...
    mergeModifier(modifier: TextPickerModifier): void {
        ...
        if (modifier._divider_0_flag != AttributeUpdaterFlag.INITIAL)
        {
            switch (modifier._divider_0_flag) {
                ...
                default: {
                    this.divider((undefined as DividerOptions | null | undefined));
                }
            }
        }
