...
export class ArkEmbeddedComponentPeer extends ArkCommonMethodPeer {
    ...
    setEmbeddedComponentOptionsAttribute(loader: Want, type: EmbeddedType): void {
        ...
        ArkUIGeneratedNativeModule._EmbeddedComponentInterface_setEmbeddedComponentOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length(), (type.valueOf() as int32))
