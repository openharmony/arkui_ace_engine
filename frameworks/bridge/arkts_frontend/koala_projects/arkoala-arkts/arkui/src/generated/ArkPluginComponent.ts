...
import { ArkPluginComponentPeer } from "./peers/ArkPluginComponentPeer"
...
import { PluginErrorCallback, PluginComponentOptions, PluginComponentAttribute } from "./ArkPluginComponentInterfaces"
/** @memo:stable */
export class ArkPluginComponentComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public onComplete(value: VoidCallback): this {
    ...
    /** @memo */
    public onError(value: PluginErrorCallback): this {
        if (this.checkPriority("onError")) {
            const value_casted = value as (PluginErrorCallback)
...
/** @memo */
export function ArkPluginComponent(
  /** @memo */
  style: ((attributes: ArkPluginComponentComponent) => void) | undefined,
  /** @memo */
