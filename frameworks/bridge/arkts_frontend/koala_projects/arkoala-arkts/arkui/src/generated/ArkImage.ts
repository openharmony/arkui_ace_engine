...
export class ArkImageComponent extends ArkCommonMethodComponent {
    ...
    public setImageOptions(src: PixelMap | ResourceStr | DrawableDescriptor | PixelMap | ResourceStr | DrawableDescriptor | ImageContent, imageAIOptions?: ImageAIOptions): this {
        if (this.checkPriority("setImageOptions")) {
            ...
            if (((((RuntimeType.OBJECT) == (src_type)) && (TypeChecker.isPixelMap(src, false, false))) || ((RuntimeType.STRING == src_type) || (RuntimeType.OBJECT == src_type)) || (TypeChecker.isDrawableDescriptor(src, false))) && (RuntimeType.UNDEFINED == imageAIOptions_type)) {
                const src_casted = src as (PixelMap | ResourceStr | DrawableDescriptor)
                this.getPeer()?.setImageOptions0Attribute(src_casted)
                return this
            }
            if (((((RuntimeType.OBJECT) == (src_type)) && (TypeChecker.isPixelMap(src, false, false))) || ((RuntimeType.STRING == src_type) || (RuntimeType.OBJECT == src_type)) || (TypeChecker.isDrawableDescriptor(src, false))) && (RuntimeType.OBJECT == imageAIOptions_type)) {
                const src_casted = src as (PixelMap | ResourceStr | DrawableDescriptor)
            ...
            if (((((RuntimeType.OBJECT) == (src_type)) && (TypeChecker.isPixelMap(src, false, false))) || ((RuntimeType.STRING == src_type) || (RuntimeType.OBJECT == src_type)) || (TypeChecker.isDrawableDescriptor(src, false)) || (TypeChecker.isImageContent(src))) && (RuntimeType.UNDEFINED == imageAIOptions_type)) {
