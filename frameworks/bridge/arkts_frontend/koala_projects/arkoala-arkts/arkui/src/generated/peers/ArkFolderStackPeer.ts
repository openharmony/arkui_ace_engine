...
export class ArkFolderStackPeer extends ArkCommonMethodPeer {
    ...
    setFolderStackOptionsAttribute(options?: FolderStackOptions): void {
        ...
        ArkUIGeneratedNativeModule._FolderStackInterface_setFolderStackOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    alignContentAttribute(value: Alignment): void {
        ArkUIGeneratedNativeModule._FolderStackAttribute_alignContent(this.peer.ptr, ((value as Alignment) as int32))
    }
    onFolderStateChangeAttribute(value: OnFoldStatusChangeCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._FolderStackAttribute_onFolderStateChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onHoverStatusChangeAttribute(value: OnHoverStatusChangeCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._FolderStackAttribute_onHoverStatusChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
...
export interface ArkFolderStackAttributes extends ArkCommonMethodAttributes {
    alignContent?: Alignment
    onFolderStateChange?: OnFoldStatusChangeCallback
    onHoverStatusChange?: OnHoverStatusChangeCallback
