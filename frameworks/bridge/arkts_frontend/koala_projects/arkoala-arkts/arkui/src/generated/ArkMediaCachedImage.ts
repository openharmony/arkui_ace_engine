...
/** @memo:stable */
export class ArkMediaCachedImageComponent extends ArkImageComponent {
...
/** @memo */
export function ArkMediaCachedImage(
  /** @memo */
  style: ((attributes: ArkMediaCachedImageComponent) => void) | undefined,
  /** @memo */
