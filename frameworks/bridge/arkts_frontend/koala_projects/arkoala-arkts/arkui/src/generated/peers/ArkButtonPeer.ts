...
export class ArkButtonPeer extends ArkCommonMethodPeer {
    ...
    setButtonOptions1Attribute(options: ButtonOptions): void {
        ...
        ArkUIGeneratedNativeModule._ButtonInterface_setButtonOptions1(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    setButtonOptions2Attribute(label: ResourceStr, options?: ButtonOptions): void {
        ...
        ArkUIGeneratedNativeModule._ButtonInterface_setButtonOptions2(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    typeAttribute(value: ButtonType): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_type(this.peer.ptr, (value.valueOf() as int32))
    }
    ...
    buttonStyleAttribute(value: ButtonStyleMode): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_buttonStyle(this.peer.ptr, (value.valueOf() as int32))
    }
    controlSizeAttribute(value: ControlSize): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_controlSize(this.peer.ptr, (value as int32))
    }
    roleAttribute(value: ButtonRole): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_role(this.peer.ptr, (value.valueOf() as int32))
    }
    fontColorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._ButtonAttribute_fontColor(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    fontWeightAttribute(value: number | FontWeight | string): void {
        ...
        ArkUIGeneratedNativeModule._ButtonAttribute_fontWeight(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    fontStyleAttribute(value: FontStyle): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_fontStyle(this.peer.ptr, (value.valueOf() as int32))
    }
    fontFamilyAttribute(value: string | Resource): void {
        ...
        ArkUIGeneratedNativeModule._ButtonAttribute_fontFamily(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    contentModifierAttribute(value: ContentModifier<object>): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.writeCustomObject("ContentModifier", value)
        ArkUIGeneratedNativeModule._ButtonAttribute_contentModifier(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    labelStyleAttribute(value: LabelStyle): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.writeLabelStyle(value)
        ArkUIGeneratedNativeModule._ButtonAttribute_labelStyle(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
