...
import { PolygonOptions, PolygonAttribute } from "./../ArkPolygonInterfaces"
...
export class ArkPolygonPeer extends ArkCommonShapeMethodPeer {
    ...
    setPolygonOptionsAttribute(options?: PolygonOptions): void {
        ...
        ArkUIGeneratedNativeModule._PolygonInterface_setPolygonOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    pointsAttribute(value: Array<Point>): void {
        ...
        ArkUIGeneratedNativeModule._PolygonAttribute_points(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
