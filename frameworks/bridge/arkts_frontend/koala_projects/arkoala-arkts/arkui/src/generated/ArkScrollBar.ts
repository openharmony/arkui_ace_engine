...
import { ScrollBarOptions, ScrollBarAttribute } from "./ArkScrollBarInterfaces"
/** @memo:stable */
export class ArkScrollBarComponent extends ArkCommonMethodComponent {
...
export function ArkScrollBar(
  /** @memo */
  style: ((attributes: ArkScrollBarComponent) => void) | undefined,
  /** @memo */
