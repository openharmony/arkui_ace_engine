...
export class ArkSymbolGlyphPeer extends ArkCommonMethodPeer {
    ...
    fontColorAttribute(value: Array<ResourceColor>): void {
        ...
        for (let i = 0; i < value.length; i++) {
            ...
            if (TypeChecker.isColor(value_element)) {
                ...
                thisSerializer.writeInt32((value_element_0.valueOf() as int32))
            }
    ...
    effectStrategyAttribute(value: SymbolEffectStrategy): void {
        ArkUIGeneratedNativeModule._SymbolGlyphAttribute_effectStrategy(this.peer.ptr, (value.valueOf() as int32))
    }
    renderingStrategyAttribute(value: SymbolRenderingStrategy): void {
        ArkUIGeneratedNativeModule._SymbolGlyphAttribute_renderingStrategy(this.peer.ptr, (value.valueOf() as int32))
    }
