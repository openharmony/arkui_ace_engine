...
import { ArkColumnSplitPeer } from "./peers/ArkColumnSplitPeer"
...
import { ColumnSplitDividerStyle, ColumnSplitAttribute } from "./ArkColumnSplitInterfaces"
/** @memo:stable */
export class ArkColumnSplitComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public divider(value?: ColumnSplitDividerStyle): this {
...
/** @memo */
export function ArkColumnSplit(
  /** @memo */
  style: ((attributes: ArkColumnSplitComponent) => void) | undefined,
  /** @memo */
