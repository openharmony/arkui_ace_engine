...
import { ArkScreenPeer } from "./peers/ArkScreenPeer"
...
import { ScreenAttribute } from "./ArkScreenInterfaces"
/** @memo:stable */
export class ArkScreenComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkScreen(
  /** @memo */
  style: ((attributes: ArkScreenComponent) => void) | undefined,
  /** @memo */
