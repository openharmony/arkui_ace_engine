...
import { DataPanelShadowOptions, DataPanelConfiguration, DataPanelOptions, DataPanelAttribute } from "./../ArkDataPanelInterfaces"
        ...
        for (let i = 0; i < value.length; i++) {
            ...
            if ((TypeChecker.isColor(value_element)) || (RuntimeType.NUMBER == value_element_type) || (RuntimeType.STRING == value_element_type) || (RuntimeType.OBJECT == value_element_type)) {
                ...
                if (TypeChecker.isColor(value_element_0)) {
                    ...
                    thisSerializer.writeInt32((value_element_0_0.valueOf() as int32))
                }
            ...
            else if (((RuntimeType.OBJECT) == (value_element_type)) && (TypeChecker.isLinearGradient(value_element))) {
                thisSerializer.writeInt8(1 as int32)
