...
export class ArkLinearIndicatorPeer extends ArkCommonMethodPeer {
    ...
    setLinearIndicatorOptionsAttribute(count?: number, controller?: LinearIndicatorController): void {
        ...
        ArkUIGeneratedNativeModule._LinearIndicatorInterface_setLinearIndicatorOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    indicatorStyleAttribute(value?: LinearIndicatorStyle): void {
        ...
        ArkUIGeneratedNativeModule._LinearIndicatorAttribute_indicatorStyle(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    indicatorLoopAttribute(value?: boolean): void {
        ...
        ArkUIGeneratedNativeModule._LinearIndicatorAttribute_indicatorLoop(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onChangeAttribute(value?: OnLinearIndicatorChangeCallback): void {
        ...
        ArkUIGeneratedNativeModule._LinearIndicatorAttribute_onChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
