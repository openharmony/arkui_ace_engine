...
import { EllipseOptions, EllipseAttribute } from "./../ArkEllipseInterfaces"
...
export class ArkEllipsePeer extends ArkCommonShapeMethodPeer {
    ...
    setEllipseOptionsAttribute(options?: EllipseOptions): void {
        ...
        ArkUIGeneratedNativeModule._EllipseInterface_setEllipseOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkEllipseAttributes extends ArkCommonShapeMethodAttributes {
}
