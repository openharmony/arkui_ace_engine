...
import { RootSceneSession, RootSceneAttribute } from "./../ArkRootSceneInterfaces"
...
export class ArkRootScenePeer extends ArkCommonMethodPeer {
    ...
    setRootSceneOptionsAttribute(session: RootSceneSession): void {
        ...
        thisSerializer.writeRootSceneSession(session)
        ArkUIGeneratedNativeModule._RootSceneInterface_setRootSceneOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkRootSceneAttributes extends ArkCommonMethodAttributes {
}
