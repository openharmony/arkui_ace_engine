...
import { LineOptions, LineAttribute } from "./../ArkLineInterfaces"
...
export class ArkLinePeer extends ArkCommonShapeMethodPeer {
    ...
    setLineOptionsAttribute(options?: LineOptions): void {
        ...
        ArkUIGeneratedNativeModule._LineInterface_setLineOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    startPointAttribute(value: Array<Length>): void {
        ...
        ArkUIGeneratedNativeModule._LineAttribute_startPoint(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    endPointAttribute(value: Array<Length>): void {
        ...
        ArkUIGeneratedNativeModule._LineAttribute_endPoint(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
