...
export class ArkSpanPeer extends ArkBaseSpanPeer {
    ...
    fontStyleAttribute(value: FontStyle): void {
        ArkUIGeneratedNativeModule._SpanAttribute_fontStyle(this.peer.ptr, (value.valueOf() as int32))
    }
    ...
    textCaseAttribute(value: TextCase): void {
        ArkUIGeneratedNativeModule._SpanAttribute_textCase(this.peer.ptr, (value.valueOf() as int32))
    }
