...
export class GlobalScope_common {
    ...
    private static getContext_serialize(component?: Object): Context {
        ...
        return new Deserializer(retval, retval.length).readContext()
    }
    ...
    private static dollar_r_serialize(value: string, params: Array<object>): Resource {
        const thisSerializer : Serializer = Serializer.hold()
        ...
        thisSerializer.release()
        return new Deserializer(retval, retval.length).readResource()
    }
