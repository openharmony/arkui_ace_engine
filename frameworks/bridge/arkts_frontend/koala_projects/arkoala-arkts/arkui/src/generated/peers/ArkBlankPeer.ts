...
import { BlankAttribute } from "./../ArkBlankInterfaces"
...
export class ArkBlankPeer extends ArkCommonMethodPeer {
    ...
    setBlankOptionsAttribute(min?: number | string): void {
        ...
        ArkUIGeneratedNativeModule._BlankInterface_setBlankOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    colorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._BlankAttribute_color(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkBlankAttributes extends ArkCommonMethodAttributes {
    color?: ResourceColor
}
