...
import { ArkRootScenePeer } from "./peers/ArkRootScenePeer"
...
/** @memo:stable */
export class ArkRootSceneComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkRootScene(
  /** @memo */
  style: ((attributes: ArkRootSceneComponent) => void) | undefined,
  /** @memo */
