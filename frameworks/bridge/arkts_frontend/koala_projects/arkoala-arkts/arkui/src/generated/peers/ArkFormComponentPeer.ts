...
export class ArkFormComponentPeer extends ArkCommonMethodPeer {
    ...
    dimensionAttribute(value: FormDimension): void {
        ArkUIGeneratedNativeModule._FormComponentAttribute_dimension(this.peer.ptr, (value.valueOf() as int32))
    }
    ...
    visibilityAttribute(value: Visibility): void {
        ArkUIGeneratedNativeModule._FormComponentAttribute_visibility(this.peer.ptr, (value.valueOf() as int32))
    }
