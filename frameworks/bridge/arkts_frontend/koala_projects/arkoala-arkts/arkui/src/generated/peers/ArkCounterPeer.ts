...
export class ArkCounterPeer extends ArkCommonMethodPeer {
    ...
    onIncAttribute(value: VoidCallback): void {
        ...
        ArkUIGeneratedNativeModule._CounterAttribute_onInc(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onDecAttribute(value: VoidCallback): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._CounterAttribute_onDec(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
