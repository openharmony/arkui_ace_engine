...
/** @memo:stable */
export class ArkWindowSceneComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkWindowScene(
  /** @memo */
  style: ((attributes: ArkWindowSceneComponent) => void) | undefined,
  /** @memo */
