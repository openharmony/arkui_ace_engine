...
export class ArkColumnPeer extends ArkCommonMethodPeer {
    ...
    public static create(component?: ComponentBase, flags: int32 = 0): ArkColumnPeer {
    ...
    setColumnOptionsAttribute(options?: ColumnOptions): void {
        ...
        ArkUIGeneratedNativeModule._ColumnInterface_setColumnOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    alignItemsAttribute(value: HorizontalAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_alignItems(this.peer.ptr, ((value as HorizontalAlign) as int32))
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_justifyContent(this.peer.ptr, ((value as FlexAlign) as int32))
    }
    pointLightAttribute(value: PointLightStyle): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.writePointLightStyle(value)
        ArkUIGeneratedNativeModule._ColumnAttribute_pointLight(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    reverseAttribute(value?: boolean): void {
        ...
        ArkUIGeneratedNativeModule._ColumnAttribute_reverse(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkColumnAttributes extends ArkCommonMethodAttributes {
