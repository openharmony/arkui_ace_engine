...
export class ArkGridColPeer extends ArkCommonMethodPeer {
    ...
    setGridColOptionsAttribute(option?: GridColOptions): void {
        ...
        ArkUIGeneratedNativeModule._GridColInterface_setGridColOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    spanAttribute(value: number | GridColColumnOption): void {
        ...
        ArkUIGeneratedNativeModule._GridColAttribute_span(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    gridColOffsetAttribute(value: number | GridColColumnOption): void {
        ...
        ArkUIGeneratedNativeModule._GridColAttribute_gridColOffset(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    orderAttribute(value: number | GridColColumnOption): void {
        ...
        ArkUIGeneratedNativeModule._GridColAttribute_order(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkGridColAttributes extends ArkCommonMethodAttributes {
