...
import { GuideLineStyle, BarrierStyle, LocalizedBarrierStyle, RelativeContainerAttribute } from "./../ArkRelativeContainerInterfaces"
...
export class ArkRelativeContainerPeer extends ArkCommonMethodPeer {
    ...
    guideLineAttribute(value: Array<GuideLineStyle>): void {
        ...
        ArkUIGeneratedNativeModule._RelativeContainerAttribute_guideLine(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    barrier0Attribute(value: Array<BarrierStyle>): void {
        ...
        ArkUIGeneratedNativeModule._RelativeContainerAttribute_barrier0(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    barrier1Attribute(value: Array<LocalizedBarrierStyle>): void {
        ...
        ArkUIGeneratedNativeModule._RelativeContainerAttribute_barrier1(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
