...
export class BounceSymbolEffect implements MaterializedBase,SymbolEffect {
    ...
    private setScope_serialize(scope: EffectScope): void {
        ArkUIGeneratedNativeModule._BounceSymbolEffect_setScope(this.peer!.ptr, (scope.valueOf() as int32))
    }
    ...
    private setDirection_serialize(direction: EffectDirection): void {
        ArkUIGeneratedNativeModule._BounceSymbolEffect_setDirection(this.peer!.ptr, (direction.valueOf() as int32))
    }
}
