...
import { ArkBlankPeer } from "./peers/ArkBlankPeer"
...
/** @memo:stable */
export class ArkBlankComponent extends ArkCommonMethodComponent {
...
/** @memo */
export function ArkBlank(
  /** @memo */
  style: ((attributes: ArkBlankComponent) => void) | undefined,
  /** @memo */
