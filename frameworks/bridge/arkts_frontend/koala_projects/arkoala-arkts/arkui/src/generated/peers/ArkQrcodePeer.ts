...
export class ArkQRCodePeer extends ArkCommonMethodPeer {
    ...
    colorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._QRCodeAttribute_color(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    backgroundColorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._QRCodeAttribute_backgroundColor(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    contentOpacityAttribute(value: number | Resource): void {
        ...
        ArkUIGeneratedNativeModule._QRCodeAttribute_contentOpacity(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
