...
export class ArkWaterFlowPeer extends ArkScrollableCommonMethodPeer {
    ...
    onWillScrollAttribute(value?: OnWillScrollCallback): void {
        ...
        ArkUIGeneratedNativeModule._GridAttribute_onWillScroll(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onDidScrollAttribute(value?: OnScrollCallback): void {
        ...
        ArkUIGeneratedNativeModule._GridAttribute_onDidScroll(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length());
        thisSerializer.release();
    }
