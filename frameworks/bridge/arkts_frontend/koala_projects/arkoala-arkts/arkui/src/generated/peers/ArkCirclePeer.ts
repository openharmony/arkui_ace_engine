...
import { CircleOptions, CircleAttribute } from "./../ArkCircleInterfaces"
...
export class ArkCirclePeer extends ArkCommonShapeMethodPeer {
    ...
    setCircleOptionsAttribute(value?: CircleOptions): void {
        ...
        ArkUIGeneratedNativeModule._CircleInterface_setCircleOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkCircleAttributes extends ArkCommonShapeMethodAttributes {
}
