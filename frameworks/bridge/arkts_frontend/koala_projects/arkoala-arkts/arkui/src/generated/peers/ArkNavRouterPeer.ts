...
export class ArkNavRouterPeer extends ArkCommonMethodPeer {
    ...
    setNavRouterOptions1Attribute(value: RouteInfo): void {
        ...
        ArkUIGeneratedNativeModule._NavRouterInterface_setNavRouterOptions1(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onStateChangeAttribute(value: ((parameter: boolean) => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._NavRouterAttribute_onStateChange(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    modeAttribute(value: NavRouteMode): void {
        ArkUIGeneratedNativeModule._NavRouterAttribute_mode(this.peer.ptr, ((value as NavRouteMode) as int32))
    }
}
