...
export class ArkAlphabetIndexerPeer extends ArkCommonMethodPeer {
    ...
    popupBackgroundBlurStyleAttribute(value: BlurStyle): void {
        ArkUIGeneratedNativeModule._AlphabetIndexerAttribute_popupBackgroundBlurStyle(this.peer.ptr, (value.valueOf() as int32))
    }
    ...
    alignStyleAttribute(value: IndexerAlign, offset?: Length): void {
        ...
        ArkUIGeneratedNativeModule._AlphabetIndexerAttribute_alignStyle(this.peer.ptr, (value.valueOf() as int32), thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
