...
import { ArkCheckboxGroupPeer } from "./peers/ArkCheckboxgroupPeer"
...
/** @memo:stable */
export class ArkCheckboxGroupComponent extends ArkCommonMethodComponent {
    ...
    /** @memo */
    public _onChangeEvent_selectAll(callback: ((parameter: boolean) => void)): void {
...
export function ArkCheckboxGroup(
  /** @memo */
  style: ((attributes: ArkCheckboxGroupComponent) => void) | undefined,
  /** @memo */
