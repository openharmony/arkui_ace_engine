...
export class ArkUIGeneratedNativeModule {
    ...
    @ani.unsafe.Direct
    native static _SymbolGlyphAttribute_symbolEffect0(ptr: KPointer, symbolEffect: KPointer, thisArray: KSerializerBuffer, thisLength: int32): void
    @ani.unsafe.Direct
    native static _SymbolGlyphAttribute_symbolEffect1(ptr: KPointer, symbolEffect: KPointer, thisArray: KSerializerBuffer, thisLength: int32): void
    @ani.unsafe.Direct
