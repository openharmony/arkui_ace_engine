...
import { QRCodeAttribute } from "./ArkQrcodeInterfaces"
/** @memo:stable */
export class ArkQRCodeComponent extends ArkCommonMethodComponent {
...
export function ArkQRCode(
  /** @memo */
  style: ((attributes: ArkQRCodeComponent) => void) | undefined,
  /** @memo */
