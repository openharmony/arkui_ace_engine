...
import { HitTestMode, ImageSize, Alignment, BorderStyle, ColoringStrategy, HoverEffect, Color, Visibility, ItemAlign, Direction, GradientDirection, ObscuredReasons, RenderFit, ImageRepeat, Axis, ResponseType, FunctionKey, ModifierKey, LineCapStyle } from "./../ArkEnumsInterfaces"
...
import { DividerAttribute } from "./../ArkDividerInterfaces"
...
export class ArkDividerPeer extends ArkCommonMethodPeer {
    ...
    colorAttribute(value: ResourceColor): void {
        ...
        ArkUIGeneratedNativeModule._DividerAttribute_color(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
    ...
    strokeWidthAttribute(value: number | string): void {
        ...
        ArkUIGeneratedNativeModule._DividerAttribute_strokeWidth(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    lineCapAttribute(value: LineCapStyle): void {
        ArkUIGeneratedNativeModule._DividerAttribute_lineCap(this.peer.ptr, ((value as LineCapStyle) as int32))
    }
}
export interface ArkDividerAttributes extends ArkCommonMethodAttributes {
    vertical?: boolean
    color?: ResourceColor
