...
export class ArkAbilityComponentPeer extends ArkCommonMethodPeer {
    ...
    public static create(component?: ComponentBase, flags: int32 = 0): ArkAbilityComponentPeer {
    ...
    setAbilityComponentOptionsAttribute(value: Literal_Want_want): void {
        const thisSerializer : Serializer = Serializer.hold()
        const value_want  = value.want
        thisSerializer.writeWant(value_want)
        ArkUIGeneratedNativeModule._AbilityComponentInterface_setAbilityComponentOptions(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onConnectAttribute(value: (() => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._AbilityComponentAttribute_onConnect(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
    onDisconnectAttribute(value: (() => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
        ArkUIGeneratedNativeModule._AbilityComponentAttribute_onDisconnect(this.peer.ptr, thisSerializer.asArray(), thisSerializer.length())
        thisSerializer.release()
    }
}
export interface ArkAbilityComponentAttributes extends ArkCommonMethodAttributes {
    onConnect?: (() => void)
    onDisconnect?: (() => void)
}
