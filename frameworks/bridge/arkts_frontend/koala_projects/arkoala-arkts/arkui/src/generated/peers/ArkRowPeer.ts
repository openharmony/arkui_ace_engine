...
export class ArkRowPeer extends ArkCommonMethodPeer {
    ...
    alignItemsAttribute(value: VerticalAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_alignItems(this.peer.ptr, (value.valueOf() as int32))
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_justifyContent(this.peer.ptr, (value.valueOf() as int32))
    }
