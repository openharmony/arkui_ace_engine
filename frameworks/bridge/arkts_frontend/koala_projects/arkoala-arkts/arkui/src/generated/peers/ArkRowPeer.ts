...
export class ArkRowPeer extends ArkCommonMethodPeer {
    ...
    alignItemsAttribute(value: VerticalAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_alignItems(this.peer.ptr, ((value as VerticalAlign) as int32))
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._RowAttribute_justifyContent(this.peer.ptr, ((value as FlexAlign) as int32))
    }
