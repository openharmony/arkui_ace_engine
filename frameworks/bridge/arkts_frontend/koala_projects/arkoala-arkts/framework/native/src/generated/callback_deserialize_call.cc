...
void deserializeAndCallCallback_BusinessError_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int32 code, const Ark_String message)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_CALLBACK_BUSINESSERROR_VOID))));
    thisDeserializer.readPointer();
...
void deserializeAndCallCallback_Number_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Number data)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_CALLBACK_NUMBER_VOID))));
    thisDeserializer.readPointer();
...
void deserializeAndCallSyncCallback_Number_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number data)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_CALLBACK_NUMBER_VOID))));
    Ark_Number data = static_cast<Ark_Number>(thisDeserializer.readNumber());
    callSyncMethod(vmContext, resourceId, data);
}
void deserializeAndCallCallback_Object_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Object data)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_CALLBACK_OBJECT_VOID))));
    thisDeserializer.readPointer();
...
void deserializeAndCallSyncCallback_Object_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Object data)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_CALLBACK_OBJECT_VOID))));
    Ark_Object data = static_cast<Ark_Object>(thisDeserializer.readObject());
    callSyncMethod(vmContext, resourceId, data);
}
...
void deserializeAndCallCallback_Void_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_CALLBACK_VOID_VOID))));
    thisDeserializer.readPointer();
    call(resourceId);
}
void deserializeAndCallSyncCallback_Void_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_CALLBACK_VOID_VOID))));
    callSyncMethod(vmContext, resourceId);
}
...
void deserializeAndCallFrameCallbackHandler(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int64 arg)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_FRAMECALLBACKHANDLER))));
    thisDeserializer.readPointer();
    Ark_Int64 arg = thisDeserializer.readInt64();
    call(resourceId, arg);
}
void deserializeAndCallSyncFrameCallbackHandler(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Int64 arg)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_FRAMECALLBACKHANDLER))));
    Ark_Int64 arg = thisDeserializer.readInt64();
...
void deserializeAndCallNavExtender_CreateNavDestination(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int32 index, const Callback_Pointer_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_NAVEXTENDER_CREATENAVDESTINATION))));
    thisDeserializer.readPointer();
    Ark_Int32 index = thisDeserializer.readInt32();
    Callback_Pointer_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_CALLBACK_POINTER_VOID)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_CALLBACK_POINTER_VOID))))};
    call(resourceId, index, continuationResult);
...
void deserializeAndCallNodeContainerOpsOnTouchCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    const auto call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_TouchEvent event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(KIND_NODECONTAINEROPSONTOUCHCALLBACK))));
    thisDeserializer.readPointer();
    Ark_TouchEvent event = static_cast<Ark_TouchEvent>(TouchEvent_serializer::read(thisDeserializer));
    call(resourceId, event);
}
void deserializeAndCallSyncNodeContainerOpsOnTouchCallback(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TouchEvent event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(KIND_NODECONTAINEROPSONTOUCHCALLBACK))));
    Ark_TouchEvent event = static_cast<Ark_TouchEvent>(TouchEvent_serializer::read(thisDeserializer));
    callSyncMethod(vmContext, resourceId, event);
}
...
void deserializeAndCallCallback(Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (static_cast<CallbackKind>(kind)) {
        ...
        case KIND_CALLBACK_VOID_VOID: return deserializeAndCallCallback_Void_Void(thisArray, thisLength);
        ...
        case KIND_FRAMECALLBACKHANDLER: return deserializeAndCallFrameCallbackHandler(thisArray, thisLength);
        ...
        case KIND_NODECONTAINEROPSONTOUCHCALLBACK: return deserializeAndCallNodeContainerOpsOnTouchCallback(thisArray, thisLength);
...
void deserializeAndCallCallbackSync(Ark_VMContext vmContext, Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (kind) {
        ...
        case KIND_CALLBACK_VOID_VOID: return deserializeAndCallSyncCallback_Void_Void(vmContext, thisArray, thisLength);
        ...
        case KIND_FRAMECALLBACKHANDLER: return deserializeAndCallSyncFrameCallbackHandler(vmContext, thisArray, thisLength);
        ...
        case KIND_NODECONTAINEROPSONTOUCHCALLBACK: return deserializeAndCallSyncNodeContainerOpsOnTouchCallback(vmContext, thisArray, thisLength);
