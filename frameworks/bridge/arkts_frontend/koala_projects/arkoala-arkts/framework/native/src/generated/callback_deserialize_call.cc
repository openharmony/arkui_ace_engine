...
void deserializeAndCallAccessibilityTransparentCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_TouchEvent event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_AccessibilityTransparentCallback))));
    thisDeserializer.readPointer();
...
void deserializeAndCallCallback_DrawContext_LeadingMarginSpanDrawInfo_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_DrawContext context, const Ark_LeadingMarginSpanDrawInfo drawInfo)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_DrawContext_LeadingMarginSpanDrawInfo_Void))));
    thisDeserializer.readPointer();
    Ark_DrawContext context = static_cast<Ark_DrawContext>(DrawContext_serializer::read(thisDeserializer));
...
void deserializeAndCallCallback_LengthMetrics(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Callback_LengthMetrics_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_LengthMetrics))));
    thisDeserializer.readPointer();
...
void deserializeAndCallCallback_LengthMetrics_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_LengthMetrics value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_LengthMetrics_Void))));
    thisDeserializer.readPointer();
...
void deserializeAndCallCallback_OnPdfLoadEvent_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_OnPdfLoadEvent value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_OnPdfLoadEvent_Void))));
    thisDeserializer.readPointer();
    Ark_OnPdfLoadEvent value0 = OnPdfLoadEvent_serializer::read(thisDeserializer);
    _call(_resourceId, value0);
}
void deserializeAndCallSyncCallback_OnPdfLoadEvent_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_OnPdfLoadEvent value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_OnPdfLoadEvent_Void))));
    Ark_OnPdfLoadEvent value0 = OnPdfLoadEvent_serializer::read(thisDeserializer);
    callSyncMethod(vmContext, resourceId, value0);
}
void deserializeAndCallCallback_OnPdfScrollEvent_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_OnPdfScrollEvent value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_OnPdfScrollEvent_Void))));
    thisDeserializer.readPointer();
    Ark_OnPdfScrollEvent value0 = OnPdfScrollEvent_serializer::read(thisDeserializer);
    _call(_resourceId, value0);
}
void deserializeAndCallSyncCallback_OnPdfScrollEvent_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_OnPdfScrollEvent value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_OnPdfScrollEvent_Void))));
    Ark_OnPdfScrollEvent value0 = OnPdfScrollEvent_serializer::read(thisDeserializer);
    callSyncMethod(vmContext, resourceId, value0);
}
...
void deserializeAndCallCallback_ScrollState_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, Ark_ScrollState value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_ScrollState_Void))));
    thisDeserializer.readPointer();
    Ark_ScrollState value0 = static_cast<Ark_ScrollState>(thisDeserializer.readInt32());
    _call(_resourceId, value0);
}
void deserializeAndCallSyncCallback_ScrollState_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, Ark_ScrollState value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_ScrollState_Void))));
    Ark_ScrollState value0 = static_cast<Ark_ScrollState>(thisDeserializer.readInt32());
    callSyncMethod(vmContext, resourceId, value0);
}
...
void deserializeAndCallCustomBuilderT_Arkui_Component_Enums_ResponseType(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, Ark_ResponseType t, const Ark_NativePointer parentNode, const Callback_Pointer_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_CustomBuilderT_Arkui_Component_Enums_ResponseType))));
    thisDeserializer.readPointer();
    Ark_ResponseType t = static_cast<Ark_ResponseType>(thisDeserializer.readInt32());
    Ark_NativePointer parentNode = thisDeserializer.readPointer();
    Callback_Pointer_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_Pointer_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_Pointer_Void))))};
    _call(_resourceId, t, parentNode, continuationResult);
}
void deserializeAndCallSyncCustomBuilderT_Arkui_Component_Enums_ResponseType(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    ...
    Ark_NativePointer parentNode = thisDeserializer.readPointer();
    Callback_Pointer_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_Pointer_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_Pointer_Void))))};
    callSyncMethod(vmContext, resourceId, t, parentNode, continuationResult);
}
...
void deserializeAndCallGestureRecognizerJudgeBeginCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    if ((touchRecognizersTmpBuf_runtimeType) != (INTEROP_RUNTIME_UNDEFINED)) {
        const Ark_Int32 touchRecognizersTmpBuf_Length = thisDeserializer.readInt32();
        Array_TouchRecognizer touchRecognizersTmpBuf_ = {};
        thisDeserializer.resizeArray<std::decay<decltype(touchRecognizersTmpBuf_)>::type,
        std::decay<decltype(*touchRecognizersTmpBuf_.array)>::type>(&touchRecognizersTmpBuf_, touchRecognizersTmpBuf_Length);
        for (int touchRecognizersTmpBuf_BufCounterI = 0; touchRecognizersTmpBuf_BufCounterI < touchRecognizersTmpBuf_Length; touchRecognizersTmpBuf_BufCounterI++) {
            touchRecognizersTmpBuf_.array[touchRecognizersTmpBuf_BufCounterI] = static_cast<Ark_TouchRecognizer>(TouchRecognizer_serializer::read(thisDeserializer));
        }
        touchRecognizersTmpBuf.value = touchRecognizersTmpBuf_;
    }
    Opt_Array_TouchRecognizer touchRecognizers = touchRecognizersTmpBuf;
    Callback_GestureJudgeResult_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, Ark_GestureJudgeResult value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_GestureJudgeResult_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, Ark_GestureJudgeResult value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_GestureJudgeResult_Void))))};
    _call(_resourceId, event, current, recognizers, touchRecognizers, continuationResult);
}
...
void deserializeAndCallInterceptionCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Union_NavPathInfo_NavBar from, const Ark_Union_NavPathInfo_NavBar to, const Ark_NavPathStack pathStack, Ark_NavigationOperation operation, const Ark_Boolean isAnimated)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_InterceptionCallback))));
    thisDeserializer.readPointer();
    const Ark_Int8 fromTmpBufUnionSelector = thisDeserializer.readInt8();
    Ark_Union_NavPathInfo_NavBar fromTmpBuf = {};
    ...
    Ark_Union_NavPathInfo_NavBar from = static_cast<Ark_Union_NavPathInfo_NavBar>(fromTmpBuf);
    const Ark_Int8 toTmpBufUnionSelector = thisDeserializer.readInt8();
    Ark_Union_NavPathInfo_NavBar toTmpBuf = {};
    ...
    Ark_Union_NavPathInfo_NavBar to = static_cast<Ark_Union_NavPathInfo_NavBar>(toTmpBuf);
    ...
    _call(_resourceId, from, to, pathStack, operation, isAnimated);
}
void deserializeAndCallSyncInterceptionCallback(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Union_NavPathInfo_NavBar from, const Ark_Union_NavPathInfo_NavBar to, const Ark_NavPathStack pathStack, Ark_NavigationOperation operation, const Ark_Boolean isAnimated)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_InterceptionCallback))));
    const Ark_Int8 fromTmpBufUnionSelector = thisDeserializer.readInt8();
    Ark_Union_NavPathInfo_NavBar fromTmpBuf = {};
    fromTmpBuf.selector = fromTmpBufUnionSelector;
    if (fromTmpBufUnionSelector == 0) {
...
void deserializeAndCallMouseInfoCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativeEmbedMouseInfo event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_MouseInfoCallback))));
    thisDeserializer.readPointer();
...
void deserializeAndCallNavExtender_PageMapNodeBuilder(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_String url, const Opt_Object params, const Callback_Pointer_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_NavExtender_PageMapNodeBuilder))));
    thisDeserializer.readPointer();
    ...
    Callback_Pointer_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_Pointer_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_NativePointer value)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_Pointer_Void))))};
    _call(_resourceId, url, params, continuationResult);
}
...
void deserializeAndCallOnDetectBlankScreenCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_BlankScreenDetectionEventInfo event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnDetectBlankScreenCallback))));
    thisDeserializer.readPointer();
...
void deserializeAndCallOnDidStopDraggingCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Boolean willFling)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnDidStopDraggingCallback))));
    thisDeserializer.readPointer();
    Ark_Boolean willFling = thisDeserializer.readBoolean();
    _call(_resourceId, willFling);
}
...
void deserializeAndCallOnGridScrollIndexCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int32 first, const Ark_Int32 last)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnGridScrollIndexCallback))));
    thisDeserializer.readPointer();
    Ark_Int32 first = thisDeserializer.readInt32();
    Ark_Int32 last = thisDeserializer.readInt32();
    _call(_resourceId, first, last);
...
void deserializeAndCallOnListScrollIndexCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int32 start, const Ark_Int32 end, const Ark_Int32 center)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnListScrollIndexCallback))));
    thisDeserializer.readPointer();
    Ark_Int32 start = thisDeserializer.readInt32();
    Ark_Int32 end = thisDeserializer.readInt32();
    Ark_Int32 center = thisDeserializer.readInt32();
...
void deserializeAndCallOnNativeEmbedObjectParamChangeCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_NativeEmbedParamDataInfo event)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnNativeEmbedObjectParamChangeCallback))));
    thisDeserializer.readPointer();
...
void deserializeAndCallOnNeedSoftkeyboardCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Callback_Boolean_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnNeedSoftkeyboardCallback))));
    thisDeserializer.readPointer();
    Callback_Boolean_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Boolean value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_Boolean_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Boolean value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_Boolean_Void))))};
    _call(_resourceId, continuationResult);
}
void deserializeAndCallSyncOnNeedSoftkeyboardCallback(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto callSyncMethod = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Callback_Boolean_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_OnNeedSoftkeyboardCallback))));
    Callback_Boolean_Void continuationResult = {thisDeserializer.readCallbackResource(), reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Boolean value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_Callback_Boolean_Void)))), reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Boolean value0)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCallerSync(Kind_Callback_Boolean_Void))))};
    callSyncMethod(vmContext, resourceId, continuationResult);
}
void deserializeAndCallOnOverrideErrorPageCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_OnErrorReceiveEvent errorPageEvent, const Callback_String_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnOverrideErrorPageCallback))));
    thisDeserializer.readPointer();
    ...
    _call(_resourceId, errorPageEvent, continuationResult);
}
...
void deserializeAndCallOnPrepareMenuCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Array_TextMenuItem menuItems, const Callback_Array_TextMenuItem_Void continuation)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnPrepareMenuCallback))));
    thisDeserializer.readPointer();
    const Ark_Int32 menuItemsTmpBufLength = thisDeserializer.readInt32();
    Array_TextMenuItem menuItemsTmpBuf = {};
    thisDeserializer.resizeArray<std::decay<decltype(menuItemsTmpBuf)>::type,
...
void deserializeAndCallOnWaterFlowScrollIndexCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Int32 first, const Ark_Int32 last)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnWaterFlowScrollIndexCallback))));
    thisDeserializer.readPointer();
    Ark_Int32 first = thisDeserializer.readInt32();
    Ark_Int32 last = thisDeserializer.readInt32();
    _call(_resourceId, first, last);
...
void deserializeAndCallOnWillStopDraggingCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Float64 velocity)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_OnWillStopDraggingCallback))));
    thisDeserializer.readPointer();
    Ark_Float64 velocity = thisDeserializer.readFloat64();
    _call(_resourceId, velocity);
}
...
void deserializeAndCallScrollOnDidZoomCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_Float64 scale)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_ScrollOnDidZoomCallback))));
    thisDeserializer.readPointer();
    Ark_Float64 scale = thisDeserializer.readFloat64();
    _call(_resourceId, scale);
}
...
void deserializeAndCallTouchTestDoneCallback(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_BaseGestureEvent event, const Array_GestureRecognizer recognizers)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_TouchTestDoneCallback))));
    thisDeserializer.readPointer();
    Ark_BaseGestureEvent event = static_cast<Ark_BaseGestureEvent>(BaseGestureEvent_serializer::read(thisDeserializer));
    const Ark_Int32 recognizersTmpBufLength = thisDeserializer.readInt32();
    Array_GestureRecognizer recognizersTmpBuf = {};
    ...
    Array_GestureRecognizer recognizers = recognizersTmpBuf;
    _call(_resourceId, event, recognizers);
}
...
void deserializeAndCallUIStatesChangeHandler(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    DeserializerBase thisDeserializer = DeserializerBase(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_FrameNode node, const Ark_Int32 currentUIStates)>(thisDeserializer.readPointerOrDefault(reinterpret_cast<Ark_NativePointer>(getManagedCallbackCaller(Kind_UIStatesChangeHandler))));
    thisDeserializer.readPointer();
    ...
    _call(_resourceId, node, currentUIStates);
}
...
void deserializeAndCallCallback(Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (static_cast<CallbackKind>(kind)) {
        ...
        case Kind_CustomBuilderT_Arkui_Component_Enums_ResponseType: return deserializeAndCallCustomBuilderT_Arkui_Component_Enums_ResponseType(thisArray, thisLength);
...
void deserializeAndCallCallbackSync(Ark_VMContext vmContext, Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (kind) {
        ...
        case Kind_Callback_T_Void_F64: return deserializeAndCallSyncCallback_T_Void_F64(vmContext, thisArray, thisLength);
        ...
        case Kind_CustomBuilderT_Arkui_Component_Enums_ResponseType: return deserializeAndCallSyncCustomBuilderT_Arkui_Component_Enums_ResponseType(vmContext, thisArray, thisLength);
