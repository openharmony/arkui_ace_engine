...
void CallManagedCallback_TouchEvent_HitTestMode(Ark_Int32 resourceId, Ark_TouchEvent data, Callback_HitTestMode_Void continuation)
{
    CallbackBuffer callbackBuffer = {{}, {}};
    const Ark_CallbackResource callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    callbackBuffer.resourceHolder.holdCallbackResource(&callbackResourceSelf);
...
void CallManagedCallback_TouchEvent_HitTestModeSync(Ark_VMContext vmContext, Ark_Int32 resourceId, Ark_TouchEvent data, Callback_HitTestMode_Void continuation)
{
    SerializerBase argsSerializer = SerializerBase(nullptr);
    argsSerializer.writeInt32(API_KIND);
    argsSerializer.writeInt32(KIND_CALLBACK_TOUCHEVENT_HITTESTMODE);
