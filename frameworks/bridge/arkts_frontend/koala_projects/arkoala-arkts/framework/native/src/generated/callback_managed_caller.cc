...
void CallManagedCallback_BusinessError_VoidSync(Ark_VMContext vmContext, Ark_Int32 resourceId, Ark_Int32 code, Ark_String message)
{
    SerializerBase argsSerializer = SerializerBase(nullptr);
    argsSerializer.writeInt32(API_KIND);
    argsSerializer.writeInt32(KIND_CALLBACK_BUSINESSERROR_VOID);
...
void CallManagedCallback_Object_Void(Ark_Int32 resourceId, Ark_Object data)
{
    ...
    argsSerializer.writeInt32(resourceId);
    const Ark_CallbackResource arg0Resource = {data.resource.resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
...
Ark_NativePointer getManagedCallbackCaller(CallbackKind kind)
{
    switch (kind) {
        ...
        case KIND_CALLBACK_BUSINESSERROR_VOID: return reinterpret_cast<Ark_NativePointer>(CallManagedCallback_BusinessError_Void);
        ...
        case KIND_CALLBACK_VOID_VOID: return reinterpret_cast<Ark_NativePointer>(CallManagedCallback_Void_Void);
        ...
        case KIND_FRAMECALLBACKHANDLER: return reinterpret_cast<Ark_NativePointer>(CallManagedFrameCallbackHandler);
        ...
        case KIND_NODECONTAINEROPSONTOUCHCALLBACK: return reinterpret_cast<Ark_NativePointer>(CallManagedNodeContainerOpsOnTouchCallback);
...
Ark_NativePointer getManagedCallbackCallerSync(CallbackKind kind)
{
    switch (kind) {
        ...
        case KIND_CALLBACK_BUSINESSERROR_VOID: return reinterpret_cast<Ark_NativePointer>(CallManagedCallback_BusinessError_VoidSync);
        ...
        case KIND_CALLBACK_VOID_VOID: return reinterpret_cast<Ark_NativePointer>(CallManagedCallback_Void_VoidSync);
        ...
        case KIND_FRAMECALLBACKHANDLER: return reinterpret_cast<Ark_NativePointer>(CallManagedFrameCallbackHandlerSync);
        ...
        case KIND_NODECONTAINEROPSONTOUCHCALLBACK: return reinterpret_cast<Ark_NativePointer>(CallManagedNodeContainerOpsOnTouchCallbackSync);
