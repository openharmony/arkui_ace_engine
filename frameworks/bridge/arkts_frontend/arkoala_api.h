...
struct ArkUICommonModifierAPI {
  ...
  void (*setLinearGradient)(ArkUINodeHandle node, Arkoala_Float32 angle,
                            Arkoala_Int32 direction, Arkoala_Bool repeat,
                            const Arkoala_Int32 *colors,
                            const Arkoala_Float32 *positions);
  void (*resetLinearGradient)(ArkUINodeHandle node);

  void (*setPadding)(ArkUINodeHandle node, const Arkoala_Float32 *values,
                     const Arkoala_Int32 *units);
  void (*resetPadding)(ArkUINodeHandle node);

  void (*setMargin)(ArkUINodeHandle node, const Arkoala_Float32 *values,
                    const Arkoala_Int32 *units);
  void (*resetMargin)(ArkUINodeHandle node);

  void (*setBorderRadius)(ArkUINodeHandle node, const Arkoala_Float32 *values,
                          const Arkoala_Int32 *units);
  void (*resetBorderRadius)(ArkUINodeHandle node);

  void (*setBorderColor)(ArkUINodeHandle node, const Arkoala_Int32 *colors,
                         Arkoala_Int32 length);
  ...
  void (*setBackgroundImage)(ArkUINodeHandle node, Arkoala_CharPtr src,
                             Arkoala_Int32 repeat);
  void (*setBackgroundImageResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                                     Arkoala_Int32 type, Arkoala_CharPtr name,
                                     Arkoala_CharPtr bundleName,
                                     Arkoala_CharPtr moduleName,
                                     Arkoala_Int32 repeat);
  void (*resetBackgroundImage)(ArkUINodeHandle node);

  void (*setBackgroundImageSize)(ArkUINodeHandle node, Arkoala_Bool flag,
                                 const Arkoala_Float32 *values);
  ...
  void (*notifyResetComponentAsyncEvent)(ArkUINodeHandle nodePtr,
                                         Arkoala_Int32 subKind);

  void (*setScaleOptions)(ArkUINodeHandle node, Arkoala_Float32 *values,
                          Arkoala_Int32 length);
  void (*setTranslateOptions)(ArkUINodeHandle node, Arkoala_Float32 *values,
                              Arkoala_Int32 length);
  void (*setRotateOptions)(ArkUINodeHandle node, Arkoala_Float32 *values,
                           Arkoala_Int32 length);
  void (*setTransform)(ArkUINodeHandle node, Arkoala_Float32 *matrix,
                       Arkoala_Int32 length);
  void (*setVisibleAreaChangeRatios)(ArkUINodeHandle node, Arkoala_Float32 *values,
                                     Arkoala_Int32 length);

  void (*setAlign)(ArkUINodeHandle node, Arkoala_Int32 value);

  void (*setAspectRatio)(ArkUINodeHandle node, Arkoala_Float32 value);
  void (*setTransition)(ArkUINodeHandle node, Arkoala_Int32 type,
                        Arkoala_Float32 opacity, Arkoala_Float32 *translate,
                        Arkoala_Float32 *scale, Arkoala_Float32 *rotate);
  void (*setChainedTransition)(ArkUINodeHandle node, Arkoala_Float32 *appearPtr,
                               Arkoala_Float32 *disappearPtr,
                               Arkoala_Int32 appearLen,
                               Arkoala_Int32 disappearLen);
  ...
  void (*setPosition)(ArkUINodeHandle node, Arkoala_Float32 *values,
                      Arkoala_Int32 length);
  void (*setMarkAnchor)(ArkUINodeHandle node, Arkoala_Float32 *values,
                        Arkoala_Int32 length);
  void (*setOffset)(ArkUINodeHandle node, Arkoala_Float32 *values,
                    Arkoala_Int32 length);
  void (*setEnabled)(ArkUINodeHandle node, Arkoala_Bool value);
  void (*setShadow)(ArkUINodeHandle node, Arkoala_Float32 radius,
                    Arkoala_Int32 color, Arkoala_Float32 offsetX,
  ...
  void (*setResponseRegion)(ArkUINodeHandle node, Arkoala_Float32 *rectangles,
                            Arkoala_Int32 length);
  void (*resetResponseRegion)(ArkUINodeHandle node);
  void (*setConstraintSize)(ArkUINodeHandle node, Arkoala_Int32 minWValue,
                            Arkoala_Int32 minWUnit, Arkoala_Int32 minHValue,
                            Arkoala_Int32 minHUnit, Arkoala_Int32 maxWValue,
                            Arkoala_Int32 maxWUnit, Arkoala_Int32 maxHValue,
  ...
  void (*setSizeType)(ArkUINodeHandle node, Arkoala_Int32 type, Arkoala_Int32 span,
                      Arkoala_Int32 offset);
  void (*setSizeTypeNumber)(ArkUINodeHandle node, Arkoala_Int32 type,
                            Arkoala_Int32 value);
  void (*setDefaultFocus)(ArkUINodeHandle node, Arkoala_Bool flag);
  void (*setBackgroundImagePosition)(ArkUINodeHandle node, Arkoala_Float32 *values,
                                     Arkoala_Int32 length);
  void (*setBackgroundBlurStyle)(ArkUINodeHandle node, Arkoala_Int32 value,
                                 Arkoala_Int32 colorMode,
                                 Arkoala_Int32 adaptiveColor,
                                 Arkoala_Float32 scale);
  void (*setForegroundBlurStyle)(ArkUINodeHandle node, Arkoala_Int32 value,
                                 Arkoala_Int32 colorMode,
                                 Arkoala_Int32 adaptiveColor,
                                 Arkoala_Float32 scale);
};
...
struct ArkUIShapedCommonModifierAPI {
  ...
  void (*setStrokeWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                         Arkoala_Int32 unit);
  void (*setStrokeDashArray)(ArkUINodeHandle node, Arkoala_Float32 *value,
                             Arkoala_Int32 *unit, Arkoala_Int32 valueLength,
                             Arkoala_Int32 unitLength);
  void (*setAntiAlias)(ArkUINodeHandle node, Arkoala_Bool value);
  void (*setStrokeDashOffset)(ArkUINodeHandle node, Arkoala_Float32 value,
                              Arkoala_Int32 unit);
...
struct ArkUILineModifierAPI {
  void (*setStartPoint)(ArkUINodeHandle node, Arkoala_Float32 xValue,
                        Arkoala_Int32 xUnit, Arkoala_Float32 yValue,
                        Arkoala_Int32 yUnit);
  void (*setEndPoint)(ArkUINodeHandle node, Arkoala_Float32 xValue,
                      Arkoala_Int32 xUnit, Arkoala_Float32 yValue,
                      Arkoala_Int32 yUnit);
};
...
struct ArkUIPolygonModifierAPI {
  void (*setPoints)(ArkUINodeHandle node, Arkoala_Float32 *points,
                    Arkoala_Int32 length, Arkoala_Bool isPolygon);
};

struct ArkUIRectModifierAPI {
  void (*setRadiusWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                         Arkoala_Int32 unit);
  void (*setRadiusHeight)(ArkUINodeHandle node, Arkoala_Float32 value,
                          Arkoala_Int32 unit);
  void (*setRadius)(ArkUINodeHandle node, Arkoala_Float32 *points,
                    Arkoala_Int32 length);
};

struct ArkUIShapeModifierAPI {
  void (*setViewPort)(ArkUINodeHandle node, Arkoala_Float32 *ports,
                      Arkoala_Int32 length);
  void (*setMesh)(ArkUINodeHandle node, Arkoala_Float32 *meshPoints,
                  Arkoala_Int32 length, Arkoala_Int32 column,
                  Arkoala_Int32 row);
};
struct ArkUITextModifierAPI {
  ...
  void (*setTextBaselineOffset)(ArkUINodeHandle nodePtr, Arkoala_Float32 value,
                                Arkoala_Int32 unit);
  ...
  void (*setTextFontSize)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                          Arkoala_Int32 unit);
  void (*resetTextFontSize)(ArkUINodeHandle nodePtr);

  void (*setTextMinFontSize)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                             Arkoala_Int32 unit);
  void (*resetTextMinFontSize)(ArkUINodeHandle nodePtr);

  void (*setTextMaxFontSize)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                             Arkoala_Int32 unit);
  ...
  void (*setTextLineHeight)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                            Arkoala_Int32 unit);
  ...
  void (*setTextLetterSpacing)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                               Arkoala_Int32 unit);
  void (*setTextCase)(ArkUINodeHandle nodePtr, Arkoala_Int32 value);
  void (*setTextIndent)(ArkUINodeHandle nodePtr, Arkoala_Float32 number,
                        Arkoala_Int32 unit);
};
...
struct ArkUIButtonModifierAPI {
  ...
  void (*setButtonFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                            Arkoala_Int32 unit);
...
struct ArkUIImageModifierAPI {
  ...
  void (*setImageResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                           Arkoala_Int32 type, Arkoala_CharPtr name,
                           Arkoala_CharPtr bundleName,
                           Arkoala_CharPtr moduleName);
  void (*setImageAltResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                              Arkoala_Int32 type, Arkoala_CharPtr name,
                              Arkoala_CharPtr bundleName,
                              Arkoala_CharPtr moduleName);
...
struct ArkUIColumnModifierAPI {
  void (*setColumnOptions)(ArkUINodeHandle node, Arkoala_Float32 value,
                           Arkoala_Int32 unit);
...
struct ArkUIRowModifierAPI {
  void (*setRowOptions)(ArkUINodeHandle node, Arkoala_Float32 value,
                        Arkoala_Int32 unit);
...
struct ArkUIDividerModifierAPI {
  ...
  void (*setDividerStrokeWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                                Arkoala_Int32 unit);
...
struct ArkUIFlexModifierAPI {
  void (*setFlexOptions)(ArkUINodeHandle node, Arkoala_Int32 *options,
                         Arkoala_Int32 length);
};
...
struct ArkUIListModifierAPI {
  ...
  void (*setListOptions)(ArkUINodeHandle node, Arkoala_Float32 space,
                         Arkoala_Int32 unit, Arkoala_Int32 initialIndex);
  ...
  void (*setListDivider)(ArkUINodeHandle node, Arkoala_Float32 *strokeWidth,
                         Arkoala_Int32 color, Arkoala_Float32 *startMargin,
                         Arkoala_Float32 *endMargin);
  ...
  void (*setChainAnimationOptions)(ArkUINodeHandle node, Arkoala_Float32 *option,
                                   Arkoala_Int32 effect);
};

struct ArkUIListItemGroupModifierAPI {
  void (*setListItemGroupDivider)(ArkUINodeHandle node, Arkoala_Float32 *strokeWidth,
                                  Arkoala_Int32 color,
                                  Arkoala_Float32 *startMargin,
                                  Arkoala_Float32 *endMargin);
...
struct ArkUISwiperModifierAPI {
  ...
  void (*setSwiperItemSpace)(ArkUINodeHandle node, Arkoala_Float32 value,
                             Arkoala_Int32 unit);
  void (*resetSwiperItemSpace)(ArkUINodeHandle node);
  void (*setIndicatorStyle)(ArkUINodeHandle node, Arkoala_Float32 *values,
                            Arkoala_Int32 *units, Arkoala_Bool mask,
                            Arkoala_Int32 *colors);
...
struct ArkUIVideoModifierAPI {
  ...
  void (*setVideoSrcResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                              Arkoala_Int32 type, Arkoala_CharPtr name,
                              Arkoala_CharPtr bundleName,
                              Arkoala_CharPtr moduleName);
};
...
struct ArkUIGridModifierAPI {
  ...
  void (*setGridColumnsGap)(ArkUINodeHandle node, Arkoala_Float32 gap,
                            Arkoala_Int32 unit);
  void (*resetGridColumnsGap)(ArkUINodeHandle node);
  void (*setGridRowsGap)(ArkUINodeHandle node, Arkoala_Float32 gap,
                         Arkoala_Int32 unit);
...
struct ArkUIScrollerModifierAPI {
  ...
  void (*scrollBy)(ArkUINodeHandle node, Arkoala_Float32 *values,
                   Arkoala_Int32 *units);
...
struct ArkUIGestureModifierAPI {
  void (*tapGestureAsyncEvent)(ArkUINodeHandle nodePtr, Arkoala_Int32 mask,
                               Arkoala_Int32 priority, Arkoala_Int32 count,
                               Arkoala_Int32 fingers);
  void (*longPressGestureAsyncEvent)(ArkUINodeHandle nodePtr, Arkoala_Int32 mask,
                                     Arkoala_Int32 priority,
                                     Arkoala_Int32 fingers,
                                     Arkoala_Int32 repeat,
                                     Arkoala_Int32 duration,
                                     Arkoala_Int32 *event);
  void (*panGestureAsyncEvent)(ArkUINodeHandle nodePtr, Arkoala_Int32 mask,
                               Arkoala_Int32 priority, Arkoala_Int32 fingers,
                               Arkoala_Int32 direction, Arkoala_Int32 distance,
                               Arkoala_Int32 *event);
  void (*pinchGestureAsyncEvent)(ArkUINodeHandle nodePtr, Arkoala_Int32 mask,
                                 Arkoala_Int32 priority, Arkoala_Int32 fingers,
                                 Arkoala_Int32 distance, Arkoala_Int32 *event);
  void (*groupGestureAsyncEvent)(ArkUINodeHandle nodePtr, Arkoala_Int32 mode,
                                 Arkoala_Int32 *event);
  void (*notifyResetGestureAsyncEvent)(ArkUINodeHandle nodePtr,
                                       Arkoala_Int32 subKind);
};
...
struct ArkUISliderModifierAPI {
  ...
  void (*setTrackThickness)(ArkUINodeHandle node, Arkoala_Float32 value,
                            Arkoala_Int32 unit);
...
struct ArkUIProgressModifierAPI {
  ...
  void (*setProgressColor)(ArkUINodeHandle node, Arkoala_Int32 *colors,
                           Arkoala_Float32 *offsets, Arkoala_Int32 length);
  void (*setProgressInit)(ArkUINodeHandle node, Arkoala_Float32 value,
                          Arkoala_Float32 total, Arkoala_Int32 type);
  void (*setProgressStyleOptions)(ArkUINodeHandle node, Arkoala_Float32 *value);
  void (*setCapsuleStyleOptions)(ArkUINodeHandle node, Arkoala_Float32 *value,
                                 Arkoala_CharPtr content,
...
struct ArkUITextAreaModifierAPI {
  ...
  void (*setTextAreaFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                              Arkoala_Int32 unit);
...
struct ArkUITextInputModifierAPI {
  ...
  void (*setTextInputPlaceholderResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                                          Arkoala_Int32 type,
                                          Arkoala_CharPtr name,
                                          Arkoala_CharPtr bundleName,
                                          Arkoala_CharPtr moduleName);
  void (*setTextInputTextString)(ArkUINodeHandle node, Arkoala_CharPtr value);
  void (*setTextInputTextResource)(ArkUINodeHandle node, Arkoala_Int32 id,
                                   Arkoala_Int32 type, Arkoala_CharPtr name,
                                   Arkoala_CharPtr bundleName,
                                   Arkoala_CharPtr moduleName);
  void (*setTextInputFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                               Arkoala_Int32 units);
...
struct ArkUIWebModifierAPI {
  ...
  void (*setWebSrcResources)(ArkUINodeHandle node, Arkoala_Int32 id,
                             Arkoala_Int32 type, Arkoala_CharPtr name,
                             Arkoala_CharPtr bundleName,
                             Arkoala_CharPtr moduleName);
...
struct ArkUICheckboxModifierAPI {
  ...
  void (*setCheckboxMark)(ArkUINodeHandle node, Arkoala_Int32 color,
                          Arkoala_Float32 sizeValue, Arkoala_Int32 sizeUnit,
                          Arkoala_Float32 strokeWidthValue,
                          Arkoala_Int32 strokeWidthUnit);
...
struct ArkUIMenuModifierAPI {
  ...
  void (*setMenuFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                          Arkoala_Int32 unit);
  void (*setMenuFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                      Arkoala_Int32 fontWeight, Arkoala_Int32 fontStyle,
                      Arkoala_CharPtr fontFamily);
};

struct ArkUIMenuItemModifierAPI {
  void (*setMenuItemContent)(ArkUINodeHandle node, const char *value);
  void (*setMenuItemContentFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                                 Arkoala_Int32 fontWeight,
                                 Arkoala_Int32 fontStyle,
                                 Arkoala_CharPtr fontFamily);
  void (*setMenuItemContentFontColor)(ArkUINodeHandle node, Arkoala_Int32 color);
  void (*setMenuItemLabelFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                               Arkoala_Int32 fontWeight,
                               Arkoala_Int32 fontStyle,
                               Arkoala_CharPtr fontFamily);
...
struct ArkUIToggleModifierAPI {
  void (*setToggleOptions)(ArkUINodeHandle node, Arkoala_Int32 type,
                           Arkoala_Bool isOn);
...
struct ArkUINavigationModifierAPI {
  ...
  void (*setNavBarWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                         Arkoala_Int32 unit);
  void (*setTitleMode)(ArkUINodeHandle node, Arkoala_Int32 value);
};

struct ArkUIGaugeModifierAPI {
  void (*setGaugeStrokeWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                              Arkoala_Int32 unit);
...
struct ArkUIBadgeModifierAPI {
  void (*setBadgeParameters)(ArkUINodeHandle node, Arkoala_Int32 *intValue,
                             Arkoala_Float32 *floatValue);
...
struct ArkUIAlphabetIndexerModifierAPI {
  ...
  void (*selectIndexerFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                            Arkoala_Int32 fontWeight, Arkoala_Int32 fontStyle,
                            Arkoala_CharPtr fontFamily);
  void (*setIndexerPopupFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                              Arkoala_Int32 fontWeight, Arkoala_Int32 fontStyle,
                              Arkoala_CharPtr fontFamily);
  void (*setAlphabetIndexerInit)(ArkUINodeHandle node, Arkoala_CharPtr *array,
                                 Arkoala_Int32 selected, Arkoala_Int32 length);
};
...
struct ArkUIImageAnimatorModifierAPI {
  void (*setImageAnimatorImages)(ArkUINodeHandle node, Arkoala_CharPtr *src,
                                 Arkoala_Int32 srcLength, Arkoala_Float32 *info,
                                 Arkoala_Int32 length);
...
struct ArkUIRatingModifierAPI {
  void (*setRatingValue)(ArkUINodeHandle node, Arkoala_Float32 ratingScore,
                         Arkoala_Bool indicator);
  void (*setRatingStars)(ArkUINodeHandle node, Arkoala_Int32 value);
  void (*setRatingStarStyle)(ArkUINodeHandle node, Arkoala_CharPtr backgroundUri,
                             Arkoala_CharPtr foregroundUri,
                             Arkoala_CharPtr secondaryUri);
};

struct ArkUISearchModifierAPI {
  void (*setSearchValue)(ArkUINodeHandle node, Arkoala_CharPtr value,
                         Arkoala_CharPtr placeholder, Arkoala_CharPtr icon);
  void (*setSearchPlaceholderFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                                   Arkoala_Int32 fontWeight,
                                   Arkoala_Int32 fontStyle,
                                   Arkoala_CharPtr fontFamily);
  void (*setSearchTextAlign)(ArkUINodeHandle node, Arkoala_Int32 value);
  void (*setSearchTextFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                            Arkoala_Int32 fontWeight, Arkoala_Int32 fontStyle,
                            Arkoala_CharPtr fontFamily);
};
...
struct ArkUITextClockModifierAPI {
  ...
  void (*setTextClockFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                               Arkoala_Int32 unit);
...
struct ArkUITextPickerModifierAPI {
  void (*setDisappearTextStyle)(ArkUINodeHandle node, Arkoala_Int32 color,
                                Arkoala_Float32 *fontSize,
                                Arkoala_Int32 fontWeight,
                                Arkoala_Int32 fontStyle,
                                Arkoala_CharPtr fontFamily);
  void (*setTextPickerTextStyle)(ArkUINodeHandle node, Arkoala_Int32 color,
                                 Arkoala_Float32 *fontSize,
                                 Arkoala_Int32 fontWeight,
                                 Arkoala_Int32 fontStyle,
                                 Arkoala_CharPtr fontFamily);
  void (*setSelectedTextStyle)(ArkUINodeHandle node, Arkoala_Int32 color,
                               Arkoala_Float32 *fontSize,
                               Arkoala_Int32 fontWeight,
                               Arkoala_Int32 fontStyle,
                               Arkoala_CharPtr fontFamily);
  void (*setTextPickerRange)(ArkUINodeHandle node, Arkoala_CharPtr *iconArray,
                             Arkoala_CharPtr *textArray, Arkoala_Int32 length);
  void (*setTextPickerSelected)(ArkUINodeHandle node, Arkoala_Int32 *selected,
                                Arkoala_Int32 length);
  void (*setTextPickerValue)(ArkUINodeHandle node, Arkoala_CharPtr *values,
                             Arkoala_Int32 length);
};

struct ArkUITextTimerModifierAPI {
  void (*setTextTimerFormat)(ArkUINodeHandle node, Arkoala_CharPtr value);
  void (*setTextTimerOptions)(ArkUINodeHandle node, Arkoala_Bool isCountDown,
                              Arkoala_Int32 count);
  void (*setTextTimerFontColor)(ArkUINodeHandle node, Arkoala_Int32 value);
  void (*setTextTimerFontSize)(ArkUINodeHandle node, Arkoala_Float32 value,
                               Arkoala_Int32 unit);
...
struct ArkUIMarqueeModifierAPI {
  void (*setMarqueeValue)(ArkUINodeHandle node, Arkoala_CharPtr value,
                          Arkoala_Bool playerStatus,
                          Arkoala_Float32 scrollAmount, Arkoala_Int32 loop,
                          Arkoala_Bool direction);
};

struct ArkUISpanModifierAPI {
  void (*setSpanFont)(ArkUINodeHandle node, Arkoala_Float32 *fontSize,
                      Arkoala_Int32 fontWeight, Arkoala_Int32 fontStyle,
                      Arkoala_CharPtr fontFamily);
...
struct ArkUISelectModifierAPI {
  ...
  void (*setSelectSpace)(ArkUINodeHandle node, Arkoala_Float32 value,
                         Arkoala_Int32 unit);
  void (*setSelectParam)(ArkUINodeHandle node, Arkoala_CharPtr *array,
                         Arkoala_Int32 length);
};
...
struct ArkUIGridColModifierAPI {
  void (*setGridColSpan)(ArkUINodeHandle node, const Arkoala_Int32 *span,
                         Arkoala_Int32 length);
  void (*setGridColOffset)(ArkUINodeHandle node, const Arkoala_Int32 *offset,
                           Arkoala_Int32 length);
  void (*setGridColOrder)(ArkUINodeHandle node, const Arkoala_Int32 *order,
                          Arkoala_Int32 length);
};

struct ArkUIGridRowModifierAPI {
  void (*setGridRowColumns)(ArkUINodeHandle node, const Arkoala_Int32 *column,
                            Arkoala_Int32 length);
  void (*setGridRowDirection)(ArkUINodeHandle node, const Arkoala_Int32 value);
  void (*setGridRowGutter)(ArkUINodeHandle node, const Arkoala_Float32 *gutterValue,
                           const Arkoala_Int32 *gutterUnit,
                           Arkoala_Int32 valueLength, Arkoala_Int32 unitLength);
  void (*setGridRowBreakpoints)(ArkUINodeHandle node, const Arkoala_Float32 *Value,
                                const Arkoala_Int32 *unit,
                                Arkoala_Int32 valueLength,
                                Arkoala_Int32 unitLength,
                                Arkoala_Int32 reference);
};

struct ArkUIRadioModifierAPI {
  void (*setRadioChecked)(ArkUINodeHandle node, Arkoala_Bool value);
  void (*setRadioGroup)(ArkUINodeHandle node, Arkoala_CharPtr group,
                        Arkoala_CharPtr value);
};
...
struct ArkUIPatternLockModifierAPI {
  void (*setPatternLockSideLength)(ArkUINodeHandle node, Arkoala_Float32 value,
                                   Arkoala_Int32 unit);
  void (*setPatternLockCircleRadius)(ArkUINodeHandle node, Arkoala_Float32 value,
                                     Arkoala_Int32 unit);
  ...
  void (*setPatternLockPathStrokeWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                                        Arkoala_Int32 unit);
...
struct ArkUIDataPanelModifierAPI {
  ...
  void (*setDataPanelStrokeWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                                  Arkoala_Int32 unit);
  void (*setDataPanelTrackShadow)(ArkUINodeHandle node, Arkoala_Float32 *shadow,
                                  Arkoala_Int32 length,
                                  Arkoala_Int32 *colorLength,
                                  Arkoala_Int32 *colors,
                                  Arkoala_Float32 *offsets);
  void (*setDataPanelTrackShadowDisable)(ArkUINodeHandle node);
  void (*setDataPanelInit)(ArkUINodeHandle node, Arkoala_Int32 *data,
                           Arkoala_Int32 length, Arkoala_Int32 max,
                           Arkoala_Int32 type);
  void (*setDataPanelValueColors)(ArkUINodeHandle node, Arkoala_Int32 length,
                                  Arkoala_Int32 *colorLength,
                                  Arkoala_Int32 *colors,
                                  Arkoala_Float32 *offsets);
};
...
struct ArkUISideBarModifierAPI {
  ...
  void (*setControlButton)(ArkUINodeHandle node, Arkoala_Float32 *position,
                           Arkoala_Int32 positionArrayLength,
                           Arkoala_CharPtr *showIcon,
                           Arkoala_Int32 showArrayLength,
                           Arkoala_CharPtr *hiddenIcon,
                           Arkoala_Int32 hiddenArrayLength,
                           Arkoala_CharPtr *switchingIcon,
                           Arkoala_Int32 switchingArrayLength);
  void (*setShowControlButton)(ArkUINodeHandle node, Arkoala_Bool value);
  void (*setSideBarWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                          Arkoala_Int32 unit);
  void (*setMinSideBarWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                             Arkoala_Int32 unit);
  void (*setMaxSideBarWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                             Arkoala_Int32 unit);
  void (*setAutoHide)(ArkUINodeHandle node, Arkoala_Bool value);
  void (*setSideBarPosition)(ArkUINodeHandle node, Arkoala_Int32 unit);
  void (*setSideBarDivider)(ArkUINodeHandle node, Arkoala_Float32 *strokeWidth,
                            Arkoala_Int32 color, Arkoala_Float32 *startMargin,
                            Arkoala_Float32 *endMargin);
  void (*setMinContentWidth)(ArkUINodeHandle node, Arkoala_Float32 value,
                             Arkoala_Int32 unit);
};
...
struct ArkUIXComponentModifierAPI {
  ...
  // cannot be completed.
  ArkUIVMObject (*loadXComponent)(ArkUIVMContext vmContext,
                                    ArkUINodeHandle node, ArkUIVMKind vmKind,
                                    Arkoala_CharPtr libraryName,
                                    Arkoala_Int32 errorCallbackId);
  void (*setXComponentOptions)(ArkUINodeHandle node, Arkoala_CharPtr id,
                               Arkoala_CharPtr type,
                               Arkoala_CharPtr libraryName);
  Arkoala_CharPtr (*getXComponentSurfaceId)(
      ArkUIXComponentControllerHandle controller);
  void (*setXComponentSurfaceSize)(ArkUIXComponentControllerHandle controller,
                                   Arkoala_Int32 surfaceWidth,
                                   Arkoala_Int32 surfaceHeight);
  ArkUIXComponentControllerHandle (*getXComponentController)(ArkUINodeHandle node);
};

struct ArkUIBasicAPI {
  /// Tree operations.
  ArkUINodeHandle (*createNode)(Arkoala_CharPtr type, Arkoala_Int32 id,
                           Arkoala_Int32 flags);
  ...
  void (*insertChildAfter)(ArkUINodeHandle parent, ArkUINodeHandle child,
                           ArkUINodeHandle sibling);
  // Returned pointer is valid only till node is alive.
  Arkoala_CharPtr (*getAttribute)(ArkUINodeHandle node, Arkoala_CharPtr attribute);
  void (*setAttribute)(ArkUINodeHandle node, Arkoala_CharPtr attribute,
                       Arkoala_CharPtr value);
  ...
  Arkoala_Int32 (*measureLayoutAndDraw)(ArkUIVMContext vmContext,
                                        ArkUINodeHandle node);
  Arkoala_Int32 (*measureNode)(ArkUIVMContext vmContext, ArkUINodeHandle node,
                               Arkoala_Float32 *data);
  Arkoala_Int32 (*layoutNode)(ArkUIVMContext vmContext, ArkUINodeHandle node,
                              Arkoala_Float32 *data);
  Arkoala_Int32 (*drawNode)(ArkUIVMContext vmContext, ArkUINodeHandle node,
                            Arkoala_Float32 *data);
  ...
  void (*setLazyItemIndexer)(ArkUIVMContext vmContext, ArkUINodeHandle node,
                             Arkoala_Int32 indexerId);

  /// Vsync support.
  Arkoala_Int32 (*setVsyncCallback)(ArkUIVMContext vmContext,
                                    Arkoala_Int32 device,
                                    Arkoala_Int32 callbackId);
...
struct ArkUIAnimationAPI {
  Arkoala_Int32 (*startAnimation)(const ArkUIAPIAnimationSpec *spec,
                                  Arkoala_Int32 callbackId);
  void (*openImplicitAnimation)(ArkUIVMContext vmContext,
                                Arkoala_Int32 curve, Arkoala_Float32 *options,
                                Arkoala_Int32 callbackId);
...
struct ArkUINavigationAPI {
  ...
  void (*setNavDestinationBackPressed)(ArkUIVMContext vmContext,
                                       ArkUINodeHandle node,
                                       Arkoala_Int32 indexerId);
};
...
struct ArkUINodeAPI {
  ...
  const ArkUITextClockControllerModifierAPI *(
      *getTextClockControllerModifier)();
  const ArkUITextPickerModifierAPI *(*getTextPickerModifier)();
  const ArkUITextTimerModifierAPI *(*getTextTimerModifier)();
  const ArkUITextTimerControllerModifierAPI *(
      *getTextTimerControllerModifier)();
  ...
  const ArkUIRichEditorControllerModifierAPI *(
      *getRichEditorControllerModifier)();
  ...
  const ArkUICanvasRenderingContext2DModifierAPI *(
      *getCanvasRenderingContext2DModifier)();
  const ArkUIPatternLockControllerModifierAPI *(
      *getPatternLockControllerModifier)();
...
struct ArkUIGraphicsCanvasAPI {
  ...
  void (*drawPoint)(ArkUICanvasHandle canvas, Arkoala_Float32 x,
                    Arkoala_Float32 y, ArkUIPaintHandle paint);
  void (*drawPoints)(ArkUICanvasHandle canvas, Arkoala_Int32 mode,
                     Arkoala_Float32 *coords, Arkoala_Int32 count,
                     ArkUIPaintHandle paint);
  void (*drawLine)(ArkUICanvasHandle canvas, Arkoala_Float32 x0,
                   Arkoala_Float32 y0, Arkoala_Float32 x1, Arkoala_Float32 y1,
                   ArkUIPaintHandle paint);
  void (*drawArc)(ArkUICanvasHandle canvas, Arkoala_Float32 left,
                  Arkoala_Float32 top, Arkoala_Float32 right,
                  Arkoala_Float32 bottom, Arkoala_Float32 startAngle,
                  Arkoala_Float32 sweepAngle, Arkoala_Bool includeCenter,
                  ArkUIPaintHandle paint);
  void (*drawRect)(ArkUICanvasHandle canvas, Arkoala_Float32 left,
                   Arkoala_Float32 top, Arkoala_Float32 right,
                   Arkoala_Float32 bottom, ArkUIPaintHandle paint);
  void (*drawOval)(ArkUICanvasHandle canvas, Arkoala_Float32 left,
                   Arkoala_Float32 top, Arkoala_Float32 right,
                   Arkoala_Float32 bottom, ArkUIPaintHandle paint);
  void (*drawCircle)(ArkUICanvasHandle canvas, Arkoala_Float32 x,
                     Arkoala_Float32 y, Arkoala_Float32 radius,
                     ArkUIPaintHandle paintPtr);
  void (*drawRRect)(ArkUICanvasHandle canvas, Arkoala_Float32 left,
                    Arkoala_Float32 top, Arkoala_Float32 right,
                    Arkoala_Float32 bottom, Arkoala_Float32 *jradii,
                    Arkoala_Int32 jradiiSize, ArkUIPaintHandle paintPtr);
  void (*drawDRRect)(ArkUICanvasHandle canvas, Arkoala_Float32 ol,
                     Arkoala_Float32 ot, Arkoala_Float32 oright,
                     Arkoala_Float32 ob, Arkoala_Float32 *ojradii,
                     Arkoala_Int32 ojradiiSize, Arkoala_Float32 il,
                     Arkoala_Float32 it, Arkoala_Float32 ir, Arkoala_Float32 ib,
                     Arkoala_Float32 *ijradii, Arkoala_Int32 ijradiiSize,
                     ArkUIPaintHandle paint);
  void (*drawString)(ArkUICanvasHandle canvas, Arkoala_CharPtr string,
                     Arkoala_Float32 x, Arkoala_Float32 y, ArkUIFontHandle font,
                     ArkUIPaintHandle paint);
};
