...
typedef struct KotlinInteropBuffer KInteropReturnBuffer;
typedef struct KotlinInteropBuffer KInteropBuffer;
...
typedef double KInteropNumber;
typedef const char *KStringPtr;
typedef void *KSerializerBuffer;
typedef void *KNativePointer;
typedef KByte *KByteArray;
typedef KInt *KIntArray;
