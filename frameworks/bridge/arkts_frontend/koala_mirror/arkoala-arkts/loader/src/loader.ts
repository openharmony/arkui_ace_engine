...
class Application {
    ...
    constructor(vmKind: int32, bootFiles: string, userFiles: string, nativePath: string, app: string, params: string) {
...
export function checkLoader(variant: string, app: string, params: string, loopIterations?: number): Promise<AppControl> {
    ...
    return new Application(vmKind, bootFiles, userFiles, nativePath, app, params).start(loopIterations)
}
