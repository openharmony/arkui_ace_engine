...
declare interface BusinessError<T = void> {
    name: string;
    message: string;
    stack?: string;
    code: number;
...
declare class Context extends BaseContext {
    ...
    getGroupDir(dataGroupID: string): string;
}
...
declare class LazyForEachOps {
    static NeedMoreElements(node: number|bigint, mark: number|bigint, direction: number): number|bigint;
    static OnRangeUpdate(node: number|bigint, totalCount: number, updater: Callback_RangeUpdate): void;
    static SetCurrentIndex(node: number|bigint, index: number): void;
    static Prepare(node: number|bigint, itemCount: number, offset: number): void;
    static NotifyChange(node: number|bigint, startIndex: number, endIndex: number, count: number): void;
}
...
declare class Scene {
    static load(uri?: ResourceStr): Scene;
    destroy(): void;
}
...
declare class UIContext {
    ...
    openBindSheet<T extends Object>(bindSheetContent: ComponentContent, sheetOptions?: SheetOptions, targetId?: number): void;
    updateBindSheet<T extends Object>(bindSheetContent: ComponentContent, sheetOptions: SheetOptions, partialUpdate?: boolean): void;
    closeBindSheet<T extends Object>(bindSheetContent: ComponentContent): void;
...
declare class LayeredDrawableDescriptor extends DrawableDescriptor {
...
declare class PixelMapDrawableDescriptor extends DrawableDescriptor {
...
declare class AnimatedDrawableDescriptor extends DrawableDescriptor {
    constructor(pixelMaps: PixelMap[], options?: AnimationOptions);
}
...
declare class DrawingColorFilter {
    static createBlendModeColorFilter(color: Color, mode: BlendMode): DrawingColorFilter;
    static createBlendModeColorFilter(color: number, mode: BlendMode): DrawingColorFilter;
    static createComposeColorFilter(outer: DrawingColorFilter, inner: DrawingColorFilter): DrawingColorFilter;
    static createLinearToSRGBGamma(): DrawingColorFilter;
    static createSRGBGammaToLinear(): DrawingColorFilter;
    static createLumaColorFilter(): DrawingColorFilter;
    static createMatrixColorFilter(matrix: number[]): DrawingColorFilter;
}
declare class DrawingLattice {
    static createImageLattice(xDivs: number[], yDivs: number[], fXCount: number, fYCount: number, fBounds?: Rect, fRectTypes?: RectType[], fColors?: (Color|number)[]): DrawingLattice;
}
declare enum RectType {
    DEFAULT = 0,
    TRANSPARENT = 1,
    FIXEDCOLOR = 2,
}
...
declare class GlobalScope_ohos_arkui_componentSnapshot {
    static get(id: string, callback_: ((result: PixelMap) => void), options?: SnapshotOptions): void;
}
...
declare type ReceiveCallback = ((data: Map<string,Object>) => void);
declare enum ResolutionQuality {
    LOW = 1,
    MEDIUM = 2,
    HIGH = 3,
}
declare type ImageMatrix = Matrix4Transit;
...
declare interface FontVariation {
    axis: string;
    value: number;
}
...
declare interface PolyToPolyOptions {
    src: common2D.Point[];
    srcIndex?: number;
    dst: common2D.Point[];
    dstIndex?: number;
...
declare interface Matrix4Transit {
    copy(): Matrix4Transit;
...
declare type Tuple_Number_Number_Number = [ number, number, number ]
...
declare enum WaterRippleMode {
    SMALL2MEDIUM_RECV = 0,
    SMALL2MEDIUM_SEND = 1,
    SMALL2SMALL = 2,
}
declare enum FlyMode {
    BOTTOM = 0,
    TOP = 1,
}
declare interface Filter {
    pixelStretch(stretchSizes: number[], tileMode: TileMode): Filter;
...
declare interface BrightnessBlender {
    cubicRate: number;
...
declare type Blender = BrightnessBlender;
declare interface VisualEffect {
    backgroundColorBlender(blender: BrightnessBlender): VisualEffect;
}
declare enum UniformDataType {
...
declare type Callback_WrappedBuilder_Args_Void = ((...args: CommonConfiguration[]) => void);
declare class WrappedBuilder {
    builder: ((...args: CommonConfiguration[]) => void);
}
declare function wrapBuilder(builder: ((...args: CommonConfiguration[]) => void)): WrappedBuilder;
...
declare type NavExtender_OnUpdateStack = ((name: string) => void);
declare class NavExtender {
    ...
    static navigationCreate(peer: number, flag: number): number|bigint;
    static setNavigationOptions(navigation: number|bigint, stack: NavPathStack): void;
    static setNavDestinationNode(peer: NavPathStack, index: number, node: number|bigint): void;
    static setNavigationMode(navigation: number|bigint, mode: NavigationMode): void;
    static hideTitleBar(navigation: number|bigint, isHide: boolean, isAnimated: boolean): void;
    static hideToolBar(navigation: number|bigint, isHide: boolean, isAnimated: boolean): void;
    static hideNavBar(navigation: number|bigint, hide: boolean): void;
    static hideBackButton(navigation: number|bigint, hide: boolean): void;
    static setNavBarStateChange(navigation: number|bigint, stateCallback: ((isVisible: boolean) => void)): void;
    static setTitleModeChange(navigation: number|bigint, titleCallback: ((titleMode: NavigationTitleMode) => void)): void;
    static setTitleMode(navigation: number|bigint, titleMode: NavigationTitleMode): void;
    static title(navigation: number|bigint, title: string, hasSubTitle: boolean): void;
    static subTitle(navigation: number|bigint, subTitle: string): void;
}
declare class Want {
    bundleName?: string;
    abilityName?: string;
...
declare type OnHoverCallback = (() => void);
declare type MenuCallback = (() => void);
...
declare type Literal__want = { want: Want }
...
declare class ActionSheet {
    static show(value: ActionSheetOptions): void;
}
...
declare class ButtonAttribute extends CommonMethod<ButtonAttribute> {
    ...
    contentModifier(value: ContentModifier): ButtonAttribute;
...
declare type Type_CalendarInterface_callable0_value = { date: { year: number, month: number, day: number }, currentData: MonthData, preData: MonthData, nextData: MonthData, controller?: CalendarController }
...
declare type Callback_Boolean_Void = ((isVisible: boolean) => void);
...
declare class NavigationAttribute extends CommonMethod<NavigationAttribute> {
    ...
    onNavBarStateChange(value: ((isVisible: boolean) => void)): NavigationAttribute;
...
declare class CommonMethod<T> {
    ...
    margin(value: (Padding|Length|LocalizedPadding)): T;
    ...
    transform(value: TransformationMatrix): T;
    ...
    advancedBlendMode(effect: (BlendMode|BrightnessBlender), type?: BlendApplyType): T;
...
declare class View {
    create(value: number|bigint): number|bigint;
}
...
declare class CheckboxAttribute extends CommonMethod<CheckboxAttribute> {
    ...
    contentModifier(value: ContentModifier): CheckboxAttribute;
    _onChangeEvent_select(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class CheckboxGroupAttribute extends CommonMethod<CheckboxGroupAttribute> {
    ...
    _onChangeEvent_selectAll(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class DataPanelAttribute extends CommonMethod<DataPanelAttribute> {
    ...
    contentModifier(value: ContentModifier): DataPanelAttribute;
}
...
declare class DatePickerDialog {
    static show(options?: DatePickerDialogOptions): void;
}
...
declare type FormComponentAttribute_onRouter_callback_type = ((info: string) => void);
declare class FormComponentAttribute extends CommonMethod<FormComponentAttribute> {
    ...
    onRouter(value: ((info: string) => void)): FormComponentAttribute;
...
declare class GaugeAttribute extends CommonMethod<GaugeAttribute> {
    ...
    contentModifier(value: ContentModifier): GaugeAttribute;
}
...
declare type GridAttribute_onItemDragStart_event_type = ((event: ItemDragInfo, itemIndex: number) => CustomBuilder);
...
declare class GridItemAttribute extends CommonMethod<GridItemAttribute> {
    ...
    onSelect(value: ((isVisible: boolean) => void)): GridItemAttribute;
    _onChangeEvent_selected(callback_: ((isVisible: boolean) => void)): void;
}
...
declare type ListAttribute_onItemDragStart_event_type = ((event: ItemDragInfo, itemIndex: number) => CustomBuilder);
...
declare class ListItemAttribute extends CommonMethod<ListItemAttribute> {
    ...
    onSelect(value: ((isVisible: boolean) => void)): ListItemAttribute;
    _onChangeEvent_selected(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class LoadingProgressAttribute extends CommonMethod<LoadingProgressAttribute> {
    ...
    contentModifier(value: ContentModifier): LoadingProgressAttribute;
}
...
declare class MenuItemAttribute extends CommonMethod<MenuItemAttribute> {
    ...
    onChange(value: ((isVisible: boolean) => void)): MenuItemAttribute;
...
declare class NavRouterAttribute extends CommonMethod<NavRouterAttribute> {
    onStateChange(value: ((isVisible: boolean) => void)): NavRouterAttribute;
...
declare class PolygonAttribute extends CommonShapeMethod<PolygonAttribute> {
    points(value: common2D.Point[]): PolygonAttribute;
}
...
declare class PolylineAttribute extends CommonShapeMethod<PolylineAttribute> {
    points(value: common2D.Point[]): PolylineAttribute;
}
...
declare class ProgressAttribute extends CommonMethod<ProgressAttribute> {
    ...
    contentModifier(value: ContentModifier): ProgressAttribute;
}
...
declare class RadioAttribute extends CommonMethod<RadioAttribute> {
    ...
    onChange(value: ((isVisible: boolean) => void)): RadioAttribute;
    radioStyle(value: RadioStyle): RadioAttribute;
    contentModifier(value: ContentModifier): RadioAttribute;
    _onChangeEvent_checked(callback_: ((isVisible: boolean) => void)): void;
}
declare interface RadioConfiguration extends CommonConfiguration {
    value: string;
    checked: boolean;
    triggerChange: ((isVisible: boolean) => void);
}
...
declare interface RatingConfiguration extends CommonConfiguration {
    rating: number;
    indicator: boolean;
    stars: number;
    stepSize: number;
...
declare class RatingAttribute extends CommonMethod<RatingAttribute> {
    ...
    contentModifier(value: ContentModifier): RatingAttribute;
...
declare class RefreshAttribute extends CommonMethod<RefreshAttribute> {
    ...
    _onChangeEvent_refreshing(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class RichEditorAttribute extends CommonMethod<RichEditorAttribute> {
    ...
    onEditingChange(value: ((isVisible: boolean) => void)): RichEditorAttribute;
...
declare class SearchAttribute extends CommonMethod<SearchAttribute> {
    ...
    onEditChange(value: ((isVisible: boolean) => void)): SearchAttribute;
...
declare class SelectAttribute extends CommonMethod<SelectAttribute> {
    ...
    menuItemContentModifier(value: ContentModifier): SelectAttribute;
...
declare interface MenuItemConfiguration extends CommonConfiguration {
    value: ResourceStr;
    icon?: ResourceStr;
    symbolIcon?: SymbolGlyphModifier;
    selected: boolean;
...
declare interface SliderConfiguration extends CommonConfiguration {
    value: number;
    min: number;
    max: number;
    step: number;
...
declare class SliderAttribute extends CommonMethod<SliderAttribute> {
    ...
    contentModifier(value: ContentModifier): SliderAttribute;
...
declare class TextAreaAttribute extends CommonMethod<TextAreaAttribute> {
    ...
    onEditChange(value: ((isVisible: boolean) => void)): TextAreaAttribute;
...
declare class TextClockAttribute extends CommonMethod<TextClockAttribute> {
    ...
    contentModifier(value: ContentModifier): TextClockAttribute;
...
declare type AsyncCallback_Array_TextMenuItem_Array_TextMenuItem = ((menuItems: TextMenuItem[]) => TextMenuItem[]);
declare type AsyncCallback_TextMenuItem_TextRange_Boolean = ((menuItem: TextMenuItem, range: TextRange) => boolean);
...
declare class TextInputAttribute extends CommonMethod<TextInputAttribute> {
    ...
    onEditChanged(value: ((isVisible: boolean) => void)): TextInputAttribute;
    onEditChange(value: ((isVisible: boolean) => void)): TextInputAttribute;
    ...
    onSecurityStateChange(value: ((isVisible: boolean) => void)): TextInputAttribute;
...
declare type TextTimerAttribute_onTimer_event_type = ((utc: number, elapsedTime: number) => void);
declare class TextTimerAttribute extends CommonMethod<TextTimerAttribute> {
    ...
    onTimer(value: ((utc: number, elapsedTime: number) => void)): TextTimerAttribute;
    textShadow(value: (ShadowOptions|ShadowOptions[])): TextTimerAttribute;
    contentModifier(value: ContentModifier): TextTimerAttribute;
}
...
declare class TimePickerDialog {
    static show(options?: TimePickerDialogOptions): void;
}
...
declare interface ToggleConfiguration extends CommonConfiguration {
    isOn: boolean;
    enabled: boolean;
    triggerChange: ((isVisible: boolean) => void);
}
...
declare class ToggleAttribute extends CommonMethod<ToggleAttribute> {
    onChange(value: ((isVisible: boolean) => void)): ToggleAttribute;
    contentModifier(value: ContentModifier): ToggleAttribute;
    ...
    _onChangeEvent_isOn(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class XComponentController {
    constructor();
    onSurfaceCreated: ((breakpoints: string) => void);
    onSurfaceChanged: ((surfaceId: string, rect: SurfaceRect) => void);
    onSurfaceDestroyed: ((breakpoints: string) => void);
...
declare type Type_XComponentInterface_callable0_value = { id: string, type: string, libraryname?: string, controller?: XComponentController }
declare type Type_XComponentInterface_callable1_value = { id: string, type: XComponentType, libraryname?: string, controller?: XComponentController }
...
declare class SideBarContainerAttribute extends CommonMethod<SideBarContainerAttribute> {
    ...
    onChange(value: ((isVisible: boolean) => void)): SideBarContainerAttribute;
    ...
    _onChangeEvent_showSideBar(callback_: ((isVisible: boolean) => void)): void;
}
...
declare class UIExtensionComponentAttribute extends CommonMethod<UIExtensionComponentAttribute> {
    ...
    onReceive(value: ((parameter: Map<string,Object>) => void)): UIExtensionComponentAttribute;
...
declare type Callback_Map_String_Object_Void = ((parameter: Map<string,Object>) => void);
declare type Literal_Number_code__want = { code: number, want?: Want }
declare type Callback_Literal_Number_code__want_Void = ((parameter: { code: number, want?: Want }) => void);
...
declare type AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics = ((measureInfo: CustomSpanMeasureInfo) => CustomSpanMetrics);
