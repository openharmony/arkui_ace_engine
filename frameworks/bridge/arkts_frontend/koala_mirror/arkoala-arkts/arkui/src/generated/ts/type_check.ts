...
export class TypeChecker {
    ...
    static isCalendarOptions(value: Object | string | number | undefined | boolean, duplicated_hintRadius: boolean, duplicated_selected: boolean): boolean {
    ...
    static isCalendarPickerAttribute(value: Object | string | number | undefined | boolean, duplicated_textStyle: boolean, duplicated_onChange: boolean): boolean {
    ...
    static isCapsuleStyleOptions(value: Object | string | number | undefined | boolean, duplicated_borderColor: boolean, duplicated_borderWidth: boolean, duplicated_content: boolean, duplicated_font: boolean, duplicated_fontColor: boolean, duplicated_showDefaultPercentage: boolean): boolean {
    ...
    static isCircleStyleOptions(value: Object | string | number | undefined | boolean, duplicated_color: boolean, duplicated_radius: boolean, duplicated_enableWaveEffect: boolean): boolean {
        if ((!duplicated_color) && (value?.hasOwnProperty("color"))) {
            return true
        }
        else if ((!duplicated_radius) && (value?.hasOwnProperty("radius"))) {
    ...
    static iscommon2DPoint(value: Object | string | number | undefined | boolean, duplicated_x: boolean, duplicated_y: boolean): boolean {
        if ((!duplicated_x) && (value?.hasOwnProperty("x"))) {
            ...
            throw new Error("Can not discriminate value typeof common2D.Point")
        }
    }
    ...
    static isContextMenuOptions(value: Object | string | number | undefined | boolean, duplicated_offset: boolean, duplicated_placement: boolean, duplicated_enableArrow: boolean, duplicated_arrowOffset: boolean, duplicated_preview: boolean, duplicated_borderRadius: boolean, duplicated_onAppear: boolean, duplicated_onDisappear: boolean, duplicated_aboutToAppear: boolean, duplicated_aboutToDisappear: boolean, duplicated_layoutRegionMargin: boolean, duplicated_previewAnimationOptions: boolean, duplicated_backgroundColor: boolean, duplicated_backgroundBlurStyle: boolean, duplicated_transition: boolean, duplicated_enableHoverMode: boolean): boolean {
    ...
    static isCustomDialogBuildOptions(value: Object | string | number | undefined | boolean, duplicated_controller: boolean): boolean {
        if ((!duplicated_controller) && (value?.hasOwnProperty("controller"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof CustomDialogBuildOptions")
        }
    }
    ...
    static isCustomDialogControllerBuilder(value: Object | string | number | undefined | boolean, duplicated_buildOptions: boolean, duplicated_build: boolean): boolean {
        if ((!duplicated_buildOptions) && (value?.hasOwnProperty("buildOptions"))) {
            return true
        }
        else if ((!duplicated_build) && (value?.hasOwnProperty("build"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof CustomDialogControllerBuilder")
        }
    }
    ...
    static isCustomSpan(value: Object | string | number | undefined | boolean, duplicated_onMeasure: boolean, duplicated_onDraw: boolean): boolean {
        if ((!duplicated_onMeasure) && (value?.hasOwnProperty("onMeasure"))) {
            return true
        }
        else if ((!duplicated_onDraw) && (value?.hasOwnProperty("onDraw"))) {
            return true
        }
        else {
    ...
    static isDatePickerOptions(value: Object | string | number | undefined | boolean, duplicated_start: boolean, duplicated_end: boolean, duplicated_selected: boolean): boolean {
    ...
    static isDecoration(value: Object | string | number | undefined | boolean, duplicated_textDecoration: boolean, duplicated_color: boolean, duplicated_decorationStyle: boolean, duplicated_decorationThicknessScale: boolean): boolean {
        if ((!duplicated_textDecoration) && (value?.hasOwnProperty("textDecoration"))) {
            return true
        }
        else if ((!duplicated_color) && (value?.hasOwnProperty("color"))) {
            return true
        }
        else if ((!duplicated_decorationStyle) && (value?.hasOwnProperty("decorationStyle"))) {
            return true
        }
        else if ((!duplicated_decorationThicknessScale) && (value?.hasOwnProperty("decorationThicknessScale"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof Decoration")
        }
    }
    ...
    static isDividerStyleOptions(value: Object | string | number | undefined | boolean, duplicated_strokeWidth: boolean, duplicated_color: boolean, duplicated_startMargin: boolean, duplicated_endMargin: boolean): boolean {
        if ((!duplicated_strokeWidth) && (value?.hasOwnProperty("strokeWidth"))) {
            return true
        }
        else if ((!duplicated_color) && (value?.hasOwnProperty("color"))) {
    ...
    static isDragInteractionOptions(value: Object | string | number | undefined | boolean, duplicated_isMultiSelectionEnabled: boolean, duplicated_defaultAnimationBeforeLifting: boolean): boolean {
    ...
    static isDragPreviewOptions(value: Object | string | number | undefined | boolean, duplicated_mode: boolean, duplicated_modifier: boolean, duplicated_numberBadge: boolean): boolean {
    ...
    static isEdgeEffectOptions(value: Object | string | number | undefined | boolean, duplicated_alwaysEnabled: boolean): boolean {
    ...
    static isEllipsisMode(value: Object | string | number | undefined | boolean): boolean {
        ...
        else if ((value) === (EllipsisMode.MIDDLE)) {
            return true
        }
    ...
    static isEventTarget(value: Object | string | number | undefined | boolean, duplicated_area: boolean): boolean {
    ...
    static isFingerInfo(value: Object | string | number | undefined | boolean, duplicated_id: boolean, duplicated_globalX: boolean, duplicated_globalY: boolean, duplicated_localX: boolean, duplicated_localY: boolean, duplicated_displayX: boolean, duplicated_displayY: boolean): boolean {
        if ((!duplicated_id) && (value?.hasOwnProperty("id"))) {
            return true
        }
    ...
    static isFontFeature(value: Object | string | number | undefined | boolean, duplicated_name: boolean, duplicated_value: boolean): boolean {
        if ((!duplicated_name) && (value?.hasOwnProperty("name"))) {
            return true
        }
            ...
            throw new Error("Can not discriminate value typeof FontFeature")
        }
    }
    ...
    static isFontMetrics(value: Object | string | number | undefined | boolean, duplicated_flags: boolean, duplicated_top: boolean, duplicated_ascent: boolean, duplicated_descent: boolean, duplicated_bottom: boolean, duplicated_leading: boolean, duplicated_avgCharWidth: boolean, duplicated_maxCharWidth: boolean, duplicated_xMin: boolean, duplicated_xMax: boolean, duplicated_xHeight: boolean, duplicated_capHeight: boolean, duplicated_underlineThickness: boolean, duplicated_underlinePosition: boolean, duplicated_strikethroughThickness: boolean, duplicated_strikethroughPosition: boolean): boolean {
        if ((!duplicated_top) && (value?.hasOwnProperty("top"))) {
            return true
        }
        ...
        else if ((!duplicated_leading) && (value?.hasOwnProperty("leading"))) {
            return true
        }
        else if ((!duplicated_flags) && (value?.hasOwnProperty("flags"))) {
            return true
        }
        else if ((!duplicated_avgCharWidth) && (value?.hasOwnProperty("avgCharWidth"))) {
            return true
        }
        else if ((!duplicated_maxCharWidth) && (value?.hasOwnProperty("maxCharWidth"))) {
            return true
        }
        else if ((!duplicated_xMin) && (value?.hasOwnProperty("xMin"))) {
            return true
        }
        else if ((!duplicated_xMax) && (value?.hasOwnProperty("xMax"))) {
            return true
        }
        else if ((!duplicated_xHeight) && (value?.hasOwnProperty("xHeight"))) {
            return true
        }
        else if ((!duplicated_capHeight) && (value?.hasOwnProperty("capHeight"))) {
            return true
        }
        else if ((!duplicated_underlineThickness) && (value?.hasOwnProperty("underlineThickness"))) {
            return true
        }
        else if ((!duplicated_underlinePosition) && (value?.hasOwnProperty("underlinePosition"))) {
            return true
        }
        else if ((!duplicated_strikethroughThickness) && (value?.hasOwnProperty("strikethroughThickness"))) {
            return true
        }
        else if ((!duplicated_strikethroughPosition) && (value?.hasOwnProperty("strikethroughPosition"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof FontMetrics")
        }
    }
    static isFontMetricsFlags(value: Object | string | number | undefined | boolean): boolean {
        if ((value) === (FontMetricsFlags.UNDERLINE_THICKNESS_VALID)) {
            return true
        }
        else if ((value) === (FontMetricsFlags.UNDERLINE_POSITION_VALID)) {
            return true
        }
        else if ((value) === (FontMetricsFlags.STRIKETHROUGH_THICKNESS_VALID)) {
            return true
        }
        else if ((value) === (FontMetricsFlags.STRIKETHROUGH_POSITION_VALID)) {
            return true
        }
        else if ((value) === (FontMetricsFlags.BOUNDS_INVALID)) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof FontMetricsFlags")
        }
    }
    ...
    static isFontStyle(value: Object | string | number | undefined | boolean): boolean {
        ...
        else if ((value) === (FontStyle.OBLIQUE)) {
            return true
        }
        else {
    ...
    static isFontVariation(value: Object | string | number | undefined | boolean, duplicated_axis: boolean, duplicated_value: boolean): boolean {
        if ((!duplicated_axis) && (value?.hasOwnProperty("axis"))) {
            return true
        }
        else if ((!duplicated_value) && (value?.hasOwnProperty("value"))) {
            return true
            ...
            throw new Error("Can not discriminate value typeof FontVariation")
        }
    }
    ...
    static isFontWidth(value: Object | string | number | undefined | boolean): boolean {
        if ((value) === (FontWidth.ULTRA_CONDENSED)) {
            return true
        }
        else if ((value) === (FontWidth.EXTRA_CONDENSED)) {
            return true
        }
        else if ((value) === (FontWidth.CONDENSED)) {
            return true
        }
        else if ((value) === (FontWidth.SEMI_CONDENSED)) {
            return true
        }
        else if ((value) === (FontWidth.NORMAL)) {
            return true
        }
        else if ((value) === (FontWidth.SEMI_EXPANDED)) {
            return true
        }
        else if ((value) === (FontWidth.EXPANDED)) {
            return true
        }
        else if ((value) === (FontWidth.EXTRA_EXPANDED)) {
            return true
        }
        else if ((value) === (FontWidth.ULTRA_EXPANDED)) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof FontWidth")
        }
    }
    ...
    static isHoverEvent(value: Object | string | number | undefined | boolean, duplicated_stopPropagation: boolean): boolean {
    ...
    static isImageAttachment(value: Object | string | number | undefined | boolean, duplicated_value: boolean, duplicated_size: boolean, duplicated_verticalAlign: boolean, duplicated_objectFit: boolean, duplicated_layoutStyle: boolean): boolean {
        if ((!duplicated_value) && (value?.hasOwnProperty("value"))) {
            return true
        }
        else if ((!duplicated_size) && (value?.hasOwnProperty("size"))) {
    ...
    static isImageAttachmentInterface(value: Object | string | number | undefined | boolean, duplicated_value: boolean, duplicated_size: boolean, duplicated_verticalAlign: boolean, duplicated_objectFit: boolean, duplicated_layoutStyle: boolean): boolean {
        if ((!duplicated_value) && (value?.hasOwnProperty("value"))) {
            return true
        }
        else if ((!duplicated_size) && (value?.hasOwnProperty("size"))) {
    ...
    static isMeasurable(value: Object | string | number | undefined | boolean): boolean {
    ...
    static isNavigationTitleOptions(value: Object | string | number | undefined | boolean, duplicated_backgroundColor: boolean, duplicated_backgroundBlurStyle: boolean, duplicated_barStyle: boolean, duplicated_paddingStart: boolean, duplicated_paddingEnd: boolean, duplicated_mainTitleModifier: boolean, duplicated_subTitleModifier: boolean, duplicated_enableHoverMode: boolean): boolean {
    ...
    static isNavigationToolbarOptions(value: Object | string | number | undefined | boolean, duplicated_backgroundColor: boolean, duplicated_backgroundBlurStyle: boolean, duplicated_barStyle: boolean): boolean {
        if ((!duplicated_backgroundColor) && (value?.hasOwnProperty("backgroundColor"))) {
            return true
        }
        else if ((!duplicated_backgroundBlurStyle) && (value?.hasOwnProperty("backgroundBlurStyle"))) {
    ...
    static isNavPathInfo(value: Object | string | number | undefined | boolean, duplicated_name: boolean, duplicated_param: boolean, duplicated_onPop: boolean, duplicated_isEntry: boolean): boolean {
        if ((!duplicated_name) && (value?.hasOwnProperty("name"))) {
            return true
        }
        else if ((!duplicated_param) && (value?.hasOwnProperty("param"))) {
    ...
    static isParagraphStyle(value: Object | string | number | undefined | boolean, duplicated_textAlign: boolean, duplicated_textIndent: boolean, duplicated_maxLines: boolean, duplicated_overflow: boolean, duplicated_wordBreak: boolean, duplicated_leadingMargin: boolean): boolean {
    ...
    static isParagraphStyleInterface(value: Object | string | number | undefined | boolean, duplicated_textAlign: boolean, duplicated_textIndent: boolean, duplicated_maxLines: boolean, duplicated_overflow: boolean, duplicated_wordBreak: boolean, duplicated_leadingMargin: boolean): boolean {
        if ((!duplicated_textAlign) && (value?.hasOwnProperty("textAlign"))) {
            return true
        }
        else if ((!duplicated_textIndent) && (value?.hasOwnProperty("textIndent"))) {
    ...
    static isRectStyle(value: Object | string | number | undefined | boolean, duplicated_color: boolean, duplicated_leftTopRadius: boolean, duplicated_rightTopRadius: boolean, duplicated_rightBottomRadius: boolean, duplicated_leftBottomRadius: boolean): boolean {
        if ((!duplicated_color) && (value?.hasOwnProperty("color"))) {
            return true
        }
        else if ((!duplicated_leftTopRadius) && (value?.hasOwnProperty("leftTopRadius"))) {
            return true
        }
        else if ((!duplicated_rightTopRadius) && (value?.hasOwnProperty("rightTopRadius"))) {
            return true
        }
        else if ((!duplicated_rightBottomRadius) && (value?.hasOwnProperty("rightBottomRadius"))) {
            return true
        }
        else if ((!duplicated_leftBottomRadius) && (value?.hasOwnProperty("leftBottomRadius"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof RectStyle")
        }
    }
    ...
    static isRichEditorBuilderSpanOptions(value: Object | string | number | undefined | boolean, duplicated_offset: boolean): boolean {
        if ((!duplicated_offset) && (value?.hasOwnProperty("offset"))) {
            return true
        }
        else {
    ...
    static isRichEditorGesture(value: Object | string | number | undefined | boolean, duplicated_onClick: boolean, duplicated_onLongPress: boolean): boolean {
        if ((!duplicated_onClick) && (value?.hasOwnProperty("onClick"))) {
            return true
        }
        else if ((!duplicated_onLongPress) && (value?.hasOwnProperty("onLongPress"))) {
    ...
    static isRichEditorImageSpanOptions(value: Object | string | number | undefined | boolean, duplicated_offset: boolean, duplicated_imageStyle: boolean, duplicated_gesture: boolean): boolean {
        if ((!duplicated_offset) && (value?.hasOwnProperty("offset"))) {
            return true
        }
    ...
    static isRichEditorParagraphStyle(value: Object | string | number | undefined | boolean, duplicated_textAlign: boolean, duplicated_leadingMargin: boolean, duplicated_wordBreak: boolean, duplicated_lineBreakStrategy: boolean): boolean {
        if ((!duplicated_textAlign) && (value?.hasOwnProperty("textAlign"))) {
            return true
        }
        else if ((!duplicated_leadingMargin) && (value?.hasOwnProperty("leadingMargin"))) {
    ...
    static isRichEditorTextSpanOptions(value: Object | string | number | undefined | boolean, duplicated_offset: boolean, duplicated_style: boolean, duplicated_paragraphStyle: boolean, duplicated_gesture: boolean): boolean {
        if ((!duplicated_offset) && (value?.hasOwnProperty("offset"))) {
            return true
        }
        else if ((!duplicated_style) && (value?.hasOwnProperty("style"))) {
    ...
    static isRichEditorUpdateTextSpanStyleOptions(value: Object | string | number | undefined | boolean, duplicated_textStyle: boolean): boolean {
        if ((!duplicated_textStyle) && (value?.hasOwnProperty("textStyle"))) {
            return true
        }
        else {
    ...
    static isRunMetrics(value: Object | string | number | undefined | boolean, duplicated_textStyle: boolean, duplicated_fontMetrics: boolean): boolean {
        if ((!duplicated_textStyle) && (value?.hasOwnProperty("textStyle"))) {
            return true
        }
        else if ((!duplicated_fontMetrics) && (value?.hasOwnProperty("fontMetrics"))) {
            return true
        }
        else {
    ...
    static isSelectionMenuOptions(value: Object | string | number | undefined | boolean, duplicated_onAppear: boolean, duplicated_onDisappear: boolean, duplicated_menuType: boolean): boolean {
    ...
    static isSelectionMenuOptionsExt(value: Object | string | number | undefined | boolean, duplicated_onAppear: boolean, duplicated_onDisappear: boolean, duplicated_preview: boolean, duplicated_menuType: boolean): boolean {
        if ((!duplicated_onAppear) && (value?.hasOwnProperty("onAppear"))) {
            return true
        }
        else if ((!duplicated_onDisappear) && (value?.hasOwnProperty("onDisappear"))) {
    ...
    static isSwipeActionItem(value: Object | string | number | undefined | boolean, duplicated_builder: boolean, duplicated_actionAreaDistance: boolean, duplicated_onAction: boolean, duplicated_onEnterActionArea: boolean, duplicated_onExitActionArea: boolean, duplicated_onStateChange: boolean): boolean {
        if ((!duplicated_builder) && (value?.hasOwnProperty("builder"))) {
            return true
        }
    ...
    static isSymbolGlyphAttribute(value: Object | string | number | undefined | boolean, duplicated_fontSize: boolean, duplicated_fontColor: boolean, duplicated_fontWeight: boolean, duplicated_effectStrategy: boolean, duplicated_renderingStrategy: boolean): boolean {
        if ((!duplicated_fontSize) && (value?.hasOwnProperty("fontSize"))) {
            return true
        }
        else if ((!duplicated_fontColor) && (value?.hasOwnProperty("fontColor"))) {
    ...
    static isTabsOptions(value: Object | string | number | undefined | boolean, duplicated_barPosition: boolean, duplicated_index: boolean, duplicated_controller: boolean): boolean {
    ...
    static istextTextStyle(value: Object | string | number | undefined | boolean, duplicated_decoration: boolean, duplicated_color: boolean, duplicated_fontWeight: boolean, duplicated_fontStyle: boolean, duplicated_baseline: boolean, duplicated_fontFamilies: boolean, duplicated_fontSize: boolean, duplicated_letterSpacing: boolean, duplicated_wordSpacing: boolean, duplicated_heightScale: boolean, duplicated_halfLeading: boolean, duplicated_heightOnly: boolean, duplicated_ellipsis: boolean, duplicated_ellipsisMode: boolean, duplicated_locale: boolean, duplicated_baselineShift: boolean, duplicated_fontFeatures: boolean, duplicated_textShadows: boolean, duplicated_backgroundRect: boolean, duplicated_fontVariations: boolean): boolean {
        ...
        else if ((!duplicated_fontFamilies) && (value?.hasOwnProperty("fontFamilies"))) {
            return true
        }
        else if ((!duplicated_fontSize) && (value?.hasOwnProperty("fontSize"))) {
            return true
        ...
        else if ((!duplicated_wordSpacing) && (value?.hasOwnProperty("wordSpacing"))) {
            return true
        }
        else if ((!duplicated_heightScale) && (value?.hasOwnProperty("heightScale"))) {
            return true
        }
        else if ((!duplicated_halfLeading) && (value?.hasOwnProperty("halfLeading"))) {
            return true
        }
        else if ((!duplicated_heightOnly) && (value?.hasOwnProperty("heightOnly"))) {
            return true
        }
        else if ((!duplicated_ellipsis) && (value?.hasOwnProperty("ellipsis"))) {
            return true
        }
        ...
        else if ((!duplicated_baselineShift) && (value?.hasOwnProperty("baselineShift"))) {
            return true
        }
        else if ((!duplicated_fontFeatures) && (value?.hasOwnProperty("fontFeatures"))) {
            return true
        }
        else if ((!duplicated_textShadows) && (value?.hasOwnProperty("textShadows"))) {
            return true
        }
        else if ((!duplicated_backgroundRect) && (value?.hasOwnProperty("backgroundRect"))) {
            return true
        }
        else if ((!duplicated_fontVariations) && (value?.hasOwnProperty("fontVariations"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof text.TextStyle")
        }
    }
    ...
    static isTextBaseline(value: Object | string | number | undefined | boolean): boolean {
        if ((value) === (TextBaseline.ALPHABETIC)) {
            return true
        }
        else if ((value) === (TextBaseline.IDEOGRAPHIC)) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof TextBaseline")
        }
    }
    ...
    static isTextDecorationType(value: Object | string | number | undefined | boolean): boolean {
        ...
        else if ((value) === (TextDecorationType.LINE_THROUGH)) {
            return true
        }
        else {
    ...
    static isTextMenuItem(value: Object | string | number | undefined | boolean, duplicated_content: boolean, duplicated_icon: boolean, duplicated_id: boolean): boolean {
        if ((!duplicated_content) && (value?.hasOwnProperty("content"))) {
            return true
        }
        else if ((!duplicated_id) && (value?.hasOwnProperty("id"))) {
    ...
    static isTextPickerOptions(value: Object | string | number | undefined | boolean, duplicated_range: boolean, duplicated_value: boolean, duplicated_selected: boolean): boolean {
        if ((!duplicated_range) && (value?.hasOwnProperty("range"))) {
            return true
        }
        else if ((!duplicated_value) && (value?.hasOwnProperty("value"))) {
    ...
    static isTextShadow(value: Object | string | number | undefined | boolean, duplicated_color: boolean, duplicated_point: boolean, duplicated_blurRadius: boolean): boolean {
        if ((!duplicated_color) && (value?.hasOwnProperty("color"))) {
            return true
        }
        else if ((!duplicated_point) && (value?.hasOwnProperty("point"))) {
            return true
        }
        else if ((!duplicated_blurRadius) && (value?.hasOwnProperty("blurRadius"))) {
            return true
        }
        else {
            throw new Error("Can not discriminate value typeof TextShadow")
        }
    }
    ...
    static isTimePickerOptions(value: Object | string | number | undefined | boolean, duplicated_selected: boolean, duplicated_format: boolean): boolean {
        if ((!duplicated_selected) && (value?.hasOwnProperty("selected"))) {
            return true
        }
    ...
    static isType_CommonMethod_linearGradient_value(value: Object | string | number | undefined | boolean, duplicated_angle: boolean, duplicated_direction: boolean, duplicated_colors: boolean, duplicated_repeating: boolean): boolean {
        if ((!duplicated_colors) && (value?.hasOwnProperty("colors"))) {
            return true
        }
        else if ((!duplicated_angle) && (value?.hasOwnProperty("angle"))) {
    ...
    static isType_CommonMethod_radialGradient_value(value: Object | string | number | undefined | boolean, duplicated_center: boolean, duplicated_radius: boolean, duplicated_colors: boolean, duplicated_repeating: boolean): boolean {
    ...
    static isType_CommonMethod_sweepGradient_value(value: Object | string | number | undefined | boolean, duplicated_center: boolean, duplicated_start: boolean, duplicated_end: boolean, duplicated_rotation: boolean, duplicated_colors: boolean, duplicated_repeating: boolean): boolean {
        if ((!duplicated_center) && (value?.hasOwnProperty("center"))) {
            return true
        }
        else if ((!duplicated_colors) && (value?.hasOwnProperty("colors"))) {
    ...
    static isUIExtensionOptions(value: Object | string | number | undefined | boolean, duplicated_isTransferringCaller: boolean, duplicated_placeholder: boolean, duplicated_areaChangePlaceholder: boolean, duplicated_dpiFollowStrategy: boolean): boolean {
    ...
    static isVideoOptions(value: Object | string | number | undefined | boolean, duplicated_src: boolean, duplicated_currentProgressRate: boolean, duplicated_previewUri: boolean, duplicated_controller: boolean, duplicated_imageAIOptions: boolean): boolean {
        if ((!duplicated_src) && (value?.hasOwnProperty("src"))) {
            return true
        }
    ...
    static isWaterFlowOptions(value: Object | string | number | undefined | boolean, duplicated_footer: boolean, duplicated_scroller: boolean, duplicated_sections: boolean, duplicated_layoutMode: boolean): boolean {
    ...
    static isXComponentController(value: Object | string | number | undefined | boolean, duplicated_onSurfaceCreated: boolean, duplicated_onSurfaceChanged: boolean, duplicated_onSurfaceDestroyed: boolean): boolean {
        if ((!duplicated_onSurfaceCreated) && (value?.hasOwnProperty("onSurfaceCreated"))) {
            return true
        }
        else if ((!duplicated_onSurfaceChanged) && (value?.hasOwnProperty("onSurfaceChanged"))) {
            return true
        }
        else if ((!duplicated_onSurfaceDestroyed) && (value?.hasOwnProperty("onSurfaceDestroyed"))) {
            return true
        }
        else {
    ...
    static isXComponentOptions(value: Object | string | number | undefined | boolean, duplicated_type: boolean, duplicated_controller: boolean, duplicated_imageAIOptions: boolean): boolean {
        if ((!duplicated_type) && (value?.hasOwnProperty("type"))) {
            return true
        }
        else if ((!duplicated_controller) && (value?.hasOwnProperty("controller"))) {
    ...
    static FontMetricsFlags_FromNumeric(ordinal: int32): FontMetricsFlags {
        return ordinal as FontMetricsFlags
    }
    ...
    static TextBaseline_FromNumeric(ordinal: int32): TextBaseline {
        return ordinal as TextBaseline
    }
