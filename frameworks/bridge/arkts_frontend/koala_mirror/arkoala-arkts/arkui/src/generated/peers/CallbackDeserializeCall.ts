...
import { AsyncCallback_Array_TextMenuItem_Array_TextMenuItem, TextMenuItem, AsyncCallback_TextMenuItem_TextRange_Boolean, TextRange, DeleteValue, InsertValue, Callback_StyledStringChangeValue_Boolean, StyledStringChangeValue, EditableTextOnChangeCallback, PreviewText, OnDidChangeCallback } from "./../text_common"
import { AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics, CustomSpanMeasureInfo, CustomSpanMetrics, Callback_DrawContext_CustomSpanDrawInfo_Void, CustomSpanDrawInfo, StyledString } from "./../styled_string"
...
import { Callback_ClickEvent_LocationButtonOnClickResult_Void, LocationButtonOnClickResult } from "./../location_button"
import { Callback_ClickEvent_PasteButtonOnClickResult_Void, PasteButtonOnClickResult } from "./../paste_button"
import { Callback_ClickEvent_SaveButtonOnClickResult_Void, SaveButtonOnClickResult } from "./../save_button"
...
import { Callback_CopyEvent_Void, CopyEvent, Callback_CutEvent_Void, CutEvent, Callback_RichEditorChangeValue_Boolean, RichEditorChangeValue, Callback_RichEditorDeleteValue_Boolean, RichEditorDeleteValue, Callback_RichEditorInsertValue_Boolean, RichEditorInsertValue, Callback_RichEditorRange_Void, RichEditorRange, Callback_RichEditorSelection_Void, RichEditorSelection, Callback_RichEditorTextSpanResult_Void, RichEditorTextSpanResult, PasteEvent, Callback_TextRange_Void, MenuOnAppearCallback, PasteEventCallback, SubmitCallback } from "./../rich_editor"
import { Callback_Date_Void } from "./../calendar_picker"
import { Callback_DatePickerResult_Void, DatePickerResult } from "./../date_picker"
import { Callback_DeleteValue_Boolean, Callback_DeleteValue_Void, Callback_InsertValue_Boolean, Callback_InsertValue_Void, SearchSubmitCallback } from "./../search"
import { Callback_DismissDialogAction_Void, DismissDialogAction } from "./../action_sheet"
import { DrawContext } from "./../arkui-graphics"
import { Callback_EnterKeyType_Void, Callback_String_PasteEvent_Void, TextAreaSubmitCallback } from "./../text_area"
import { EnterKeyType, OnContentScrollCallback, OnPasteCallback, OnSubmitCallback, SubmitEvent, OnTextSelectionChangeCallback } from "./../text_input"
import { Callback_Extender_OnFinish, Callback_Extender_OnProgress } from "./../animation_extender"
import { Callback_FormCallbackInfo_Void, FormCallbackInfo, Callback_Literal_Number_errcode_String_msg_Void, Literal_Number_errcode_String_msg } from "./../form_component"
...
import { Callback_Literal_Number_code__want_Void, Literal_Number_code__want, Callback_Map_String_Object_Void, Callback_UIExtensionProxy_Void, UIExtensionProxy } from "./../ui_extension_component"
...
import { Callback_Number_Number_PanelMode_Void, PanelMode, Callback_PanelMode_Void } from "./../panel"
import { Callback_Number_SliderChangeMode_Void, SliderChangeMode, SliderTriggerChangeCallback } from "./../slider"
import { Callback_Number_String_Void, Callback_ResourceStr_Void, Callback_Union_Number_Resource_Void } from "./../select"
import { Tuple_Number_Number } from "./../arkui-synthetics"
import { Callback_Number_Void, OnAlphabetIndexerPopupSelectCallback, OnAlphabetIndexerRequestPopupDataCallback, OnAlphabetIndexerSelectCallback } from "./../alphabet_indexer"
...
import { Callback_String_Number_Void, Callback_TextPickerResult_Void, TextPickerResult, Callback_Union_Number_Array_Number_Void, Callback_Union_String_Array_String_Void, Type_TextPickerAttribute_onChange_callback } from "./../text_picker"
import { Callback_String_SurfaceRect_Void, SurfaceRect, OnNativeLoadCallback } from "./../xcomponent"
import { Callback_String_Void } from "./../grid_row"
import { Callback_SwipeActionState_Void, SwipeActionState } from "./../list_item"
import { Callback_SwiperContentTransitionProxy_Void, SwiperContentTransitionProxy, ContentDidScrollCallback, OnSwiperAnimationEndCallback, SwiperAnimationEvent, OnSwiperAnimationStartCallback, OnSwiperGestureSwipeCallback } from "./../swiper"
import { Callback_TerminationInfo_Void, TerminationInfo } from "./../embedded_component"
import { Callback_TimePickerResult_Void, TimePickerResult } from "./../time_picker"
...
import { WithThemeAttribute, WithThemeInterface, WithThemeOptions } from "./../with_theme"
...
import { FormComponentAttribute_onRouter_callback_type, GridAttribute_onItemDragStart_event_type, ListAttribute_onItemDragStart_event_type, TextTimerAttribute_onTimer_event_type } from "./../type-replacements"
import { GetItemMainSizeByIndex } from "./../water_flow"
import { ImageCompleteCallback, ImageLoadResult } from "./../image_span"
import { MenuCallback, OnHoverCallback } from "./../sdk-stubs"
import { NavExtender_OnUpdateStack } from "./../navigation_extender"
import { OnCheckboxChangeCallback } from "./../checkbox"
import { OnCheckboxGroupChangeCallback, CheckboxGroupResult } from "./../checkboxgroup"
import { OnFoldStatusChangeCallback, OnFoldStatusChangeInfo, OnHoverStatusChangeCallback, HoverEventParam } from "./../folder_stack"
import { OnLinearIndicatorChangeCallback } from "./../linearindicator"
import { PageTransitionCallback, RouteType } from "./../page_transition"
import { PluginErrorCallback, PluginErrorData } from "./../plugin_component"
...
export function deserializeAndCallAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(thisDeserializer: Deserializer): void {
    const _resourceId : int32 = thisDeserializer.readInt32()
    const _call  = (ResourceHolder.instance().get(_resourceId) as ((measureInfo: CustomSpanMeasureInfo) => CustomSpanMetrics))
    let measureInfo : CustomSpanMeasureInfo = thisDeserializer.readCustomSpanMeasureInfo()
    let _continuation : ((value: CustomSpanMetrics) => void) = thisDeserializer.readCallback_CustomSpanMetrics_Void(true)
...
export function deserializeAndCallCallback_CustomSpanMetrics_Void(thisDeserializer: Deserializer): void {
    const _resourceId : int32 = thisDeserializer.readInt32()
    const _call  = (ResourceHolder.instance().get(_resourceId) as ((value: CustomSpanMetrics) => void))
    let value : CustomSpanMetrics = thisDeserializer.readCustomSpanMetrics()
    _call(value)
}
...
export function deserializeAndCallCallback_DrawContext_CustomSpanDrawInfo_Void(thisDeserializer: Deserializer): void {
    const _resourceId : int32 = thisDeserializer.readInt32()
    ...
    let drawInfo : CustomSpanDrawInfo = thisDeserializer.readCustomSpanDrawInfo()
...
export function deserializeAndCallCallback_String_Unknown_Void(thisDeserializer: Deserializer): void {
    ...
    let param : object = (thisDeserializer.readObject() as object)
    _call(name, param)
}
...
export function deserializeAndCallFormComponentAttribute_onRouter_callback_type(thisDeserializer: Deserializer): void {
    const _resourceId : int32 = thisDeserializer.readInt32()
    const _call  = (ResourceHolder.instance().get(_resourceId) as ((info: string) => void))
    let info : string = (thisDeserializer.readString() as string)
    _call(info)
}
...
export function deserializeAndCallCallback(thisDeserializer: Deserializer): void {
    ...
    switch (kind) {
        ...
        case -1689064068/*CallbackKind.Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics*/: return deserializeAndCallAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(thisDeserializer);
        ...
        case -1092975373/*CallbackKind.Kind_FormComponentAttribute_onRouter_callback_type*/: return deserializeAndCallFormComponentAttribute_onRouter_callback_type(thisDeserializer);
