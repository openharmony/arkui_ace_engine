...
export class ArkRatingPeer extends ArkCommonMethodPeer {
    ...
    starsAttribute(value: number): void {
        ArkUIGeneratedNativeModule._RatingAttribute_stars(this.peer.ptr, value)
    }
    stepSizeAttribute(value: number): void {
        ArkUIGeneratedNativeModule._RatingAttribute_stepSize(this.peer.ptr, value)
    }
    starStyleAttribute(value: StarStyleOptions): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.writeStarStyleOptions(value)
...
export interface RatingAttribute extends CommonMethod {
    ...
    starStyle(value: StarStyleOptions): this
