...
import { Callback_TerminationInfo_Void, TerminationInfo } from "./embedded_component"
...
export class ArkUIExtensionComponentPeer extends ArkCommonMethodPeer {
    ...
    onReceiveAttribute(value: ((parameter: Map<string, Object>) => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
    ...
    onResultAttribute(value: ((parameter: Literal_Number_code__want) => void)): void {
        const thisSerializer : Serializer = Serializer.hold()
        thisSerializer.holdAndWriteCallback(value)
...
export interface UIExtensionComponentAttribute extends CommonMethod {
    ...
    onReceive(value: ((parameter: Map<string, Object>) => void)): this
    onResult(value: ((parameter: Literal_Number_code__want) => void)): this
...
export class ArkUIExtensionComponentStyle extends ArkCommonMethodStyle implements UIExtensionComponentAttribute {
    ...
    onReceive_value?: ((parameter: Map<string, Object>) => void)
    onResult_value?: ((parameter: Literal_Number_code__want) => void)
    ...
    public onReceive(value: ((parameter: Map<string, Object>) => void)): this {
        return this
    }
    public onResult(value: ((parameter: Literal_Number_code__want) => void)): this {
        return this
    }
...
export class ArkUIExtensionComponentComponent extends ArkCommonMethodComponent implements UIUIExtensionComponentAttribute {
    ...
    public onReceive(value: ((parameter: Map<string, Object>) => void)): this {
        if (this.checkPriority("onReceive")) {
            const value_casted = value as (((parameter: Map<string, Object>) => void))
    ...
    public onResult(value: ((parameter: Literal_Number_code__want) => void)): this {
        if (this.checkPriority("onResult")) {
            const value_casted = value as (((parameter: Literal_Number_code__want) => void))
