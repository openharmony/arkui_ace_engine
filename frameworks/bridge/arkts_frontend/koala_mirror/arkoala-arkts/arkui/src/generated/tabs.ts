...
import { TranslateOptions, ArkCommonMethodPeer, CommonMethod, BlurStyle, BackgroundEffectOptions, BackgroundBlurStyleOptions, BlurStyleOptions, BlurStyleActivePolicy, ArkCommonMethodComponent, ArkCommonMethodStyle, UICommonMethod } from "./common"
...
import { EdgeEffect, Color } from "./enums"
...
export class ArkTabsPeer extends ArkCommonMethodPeer {
    ...
    barPositionAttribute(value: BarPosition): void {
        ArkUIGeneratedNativeModule._TabsAttribute_barPosition(this.peer.ptr, TypeChecker.BarPosition_ToNumeric(value))
    }
    ...
    barMode0Attribute(value: BarMode): void {
        ArkUIGeneratedNativeModule._TabsAttribute_barMode0(this.peer.ptr, TypeChecker.BarMode_ToNumeric(value))
    }
    barMode1Attribute(value: BarMode, options?: ScrollableBarModeOptions): void {
        ...
        ArkUIGeneratedNativeModule._TabsAttribute_barMode1(this.peer.ptr, TypeChecker.BarMode_ToNumeric(value), thisSerializer.asBuffer(), thisSerializer.length())
        thisSerializer.release()
    }
    ...
    barBackgroundBlurStyle0Attribute(value: BlurStyle): void {
        ArkUIGeneratedNativeModule._TabsAttribute_barBackgroundBlurStyle0(this.peer.ptr, TypeChecker.BlurStyle_ToNumeric(value))
    }
    barBackgroundBlurStyle1Attribute(style: BlurStyle, options: BackgroundBlurStyleOptions): void {
        ...
        ArkUIGeneratedNativeModule._TabsAttribute_barBackgroundBlurStyle1(this.peer.ptr, TypeChecker.BlurStyle_ToNumeric(style), thisSerializer.asBuffer(), thisSerializer.length())
        thisSerializer.release()
    }
...
export class ArkTabsStyle extends ArkCommonMethodStyle implements TabsAttribute {
    ...
    barBackgroundBlurStyle_value?: BlurStyle
...
export class ArkTabsComponent extends ArkCommonMethodComponent implements UITabsAttribute {
    ...
    public barMode(value: BarMode, options?: ScrollableBarModeOptions): this {
        if (this.checkPriority("barMode")) {
            ...
            if (TypeChecker.isBarMode(value)) {
    ...
    public barBackgroundBlurStyle(style: BlurStyle, options?: BackgroundBlurStyleOptions): this {
        if (this.checkPriority("barBackgroundBlurStyle")) {
            ...
            const options_type = runtimeType(options)
            if (TypeChecker.isBlurStyle(style)) {
