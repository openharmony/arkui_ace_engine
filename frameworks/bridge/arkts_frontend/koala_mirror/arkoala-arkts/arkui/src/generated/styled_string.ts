...
import { ResourceColor, SizeOptions, ResourceStr, Padding, BorderRadiuses } from "./units"
import { FontStyle, TextDecorationType, TextDecorationStyle } from "./arkui-graphics-text"
import { Color, TextAlign, TextOverflow, WordBreak, ImageSpanAlignment, ImageFit, FontWeight } from "./enums"
import { Resource } from "./resource"
import { LengthMetrics, LengthMetricsInternal, DrawContext } from "./arkui-graphics"
import { ShadowOptions, Callback_ClickEvent_Void, ClickEvent } from "./common"
import { TextBackgroundStyle } from "./span"
import { LeadingMarginPlaceholder } from "./rich_editor"
...
export type AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics = (measureInfo: CustomSpanMeasureInfo) => CustomSpanMetrics;
export type Callback_DrawContext_CustomSpanDrawInfo_Void = (context: DrawContext, drawInfo: CustomSpanDrawInfo) => void;
