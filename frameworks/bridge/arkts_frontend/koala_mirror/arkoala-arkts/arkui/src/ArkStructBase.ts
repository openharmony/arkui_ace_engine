...
import { ArkColumnPeer, PageTransitionOptions, UICommonMethod } from "./generated"
...
export class ArkStructBase<T, T_Options> extends ArkCustomComponentImpl {
    private isEntry:boolean
    constructor(isEntry:boolean = false) {
        super()
    ...
    static _instantiate<T extends ArkStructBase<T, T_Options>, T_Options>(
        /** @memo */
        attributes: undefined | ((instance: UICommonMethod) => void),
        factory: () => T,
        /** @memo */
        arg1?: () => void,
        arg2?: T_Options,
    ...
    __build(
        ...
        // TODO: the compiler doesn't allow annotations on abstract methods now
        // This is panda issue 24817.
        console.log("__build in StructBase should never be called directly")
    }

    /** @memo */
    private static _instantiateReusable<T extends ArkStructBase<T, T_Options>, T_Options>(
        reuseId: string,
        /** @memo */
        attributes: undefined | ((instance: UICommonMethod) => void),
        factory: () => T,
        ...
        NodeAttach(() => ArkColumnPeer.create(), (node: ArkColumnPeer) => { // temporarily using Column, will replace with purely frontend node
    ...
    protected __toRecord(param: Object): Record<string, Object> { return {} } // implementation generated by compiler plugin

    /** @memo */
    pageTransition(): void {
        if (this.isEntry) {
            ArkPageTransitionEnter(undefined, undefined, { delay: 100 } as PageTransitionOptions)
            ArkPageTransitionExit(undefined, undefined, { delay: 100 } as PageTransitionOptions)
        }
    }
}
