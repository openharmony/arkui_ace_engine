...
import { SystemBarStyle, NavigationCommonTitle, NavigationCustomTitle, NavigationMenuItem, NavigationOperation, NavigationMode, ToolbarItem, NavigationTitleOptions, NavigationToolbarOptions, NavigationTitleMode, NavContentInfo, NavigationAnimatedTransition, NavBarPosition, PixelMap, Resource, CustomBuilder, ResourceStr, LayoutSafeAreaType, LayoutSafeAreaEdge } from "./../generated"
import { SymbolGlyphModifier } from "../generated/arkui.SymbolGlyphModifier"
import { PeerNode } from "../PeerNode"
import { ArkCommonMethodPeer, Dimension, Length, NavExtender, NavPathStack } from "../generated"
...
export class ArkNavigationPeer extends ArkCommonMethodPeer {
    ...
    menusAttribute(value: NavigationMenuItem[] | CustomBuilder): void {
    ...
    toolbarConfigurationAttribute(value: ToolbarItem[] | CustomBuilder, options?: NavigationToolbarOptions): void {
    ...
    ignoreLayoutSafeAreaAttribute(types?: LayoutSafeAreaType[], edges?: LayoutSafeAreaEdge[]): void {
