...
import { FrameNode, FrameNodeInternal } from "./generated"
import { GlobalScope_ohos_font } from "./generated"
import { GlobalScope_ohos_measure_utils } from "./generated"
import { FontOptions, FontInfo, MeasureOptions } from "./generated"
...
export class UIContext {
    ...
    public getFont() : Font_UIContext {
        let font : Font_UIContext = new Font_UIContext(this.instanceId_);
        return font;
    }
    ...
    public getComponentSnapshot() : ComponentSnapshot {
        console.log(`TODO SHOPPING: @ohos.arkui.UIContext getComponentSnapshot`);
        return new ComponentSnapshot();
    }

    public getComponentUtils() : ComponentUtils {
        console.log(`TODO SHOPPING: @ohos.arkui.UIContext getComponentUtils`);
