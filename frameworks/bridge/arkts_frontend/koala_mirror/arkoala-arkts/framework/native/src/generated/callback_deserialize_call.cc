...
void deserializeAndCallAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    Deserializer thisDeserializer = Deserializer(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    ...
    thisDeserializer.readPointer();
    Ark_CustomSpanMeasureInfo measureInfo = thisDeserializer.readCustomSpanMeasureInfo();
...
void deserializeAndCallSyncAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    Deserializer thisDeserializer = Deserializer(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
...
void deserializeAndCallCallback_CustomSpanMetrics_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    thisDeserializer.readPointer();
    Ark_CustomSpanMetrics value = thisDeserializer.readCustomSpanMetrics();
    _call(_resourceId, value);
}
...
void deserializeAndCallCallback_DrawContext_CustomSpanDrawInfo_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    Ark_CustomSpanDrawInfo drawInfo = thisDeserializer.readCustomSpanDrawInfo();
...
void deserializeAndCallCallback_String_Unknown_Void(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    Deserializer thisDeserializer = Deserializer(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_String name, const Ark_Object param)>(thisDeserializer.readPointer());
    thisDeserializer.readPointer();
    Ark_String name = static_cast<Ark_String>(thisDeserializer.readString());
    Ark_Object param = static_cast<Ark_Object>(thisDeserializer.readObject());
...
void deserializeAndCallSyncCallback_String_Unknown_Void(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    ...
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto _callSync = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_String name, const Ark_Object param)>(thisDeserializer.readPointer());
    Ark_String name = static_cast<Ark_String>(thisDeserializer.readString());
    Ark_Object param = static_cast<Ark_Object>(thisDeserializer.readObject());
...
void deserializeAndCallFormComponentAttribute_onRouter_callback_type(KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    Deserializer thisDeserializer = Deserializer(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    const auto _call = reinterpret_cast<void(*)(const Ark_Int32 resourceId, const Ark_String info)>(thisDeserializer.readPointer());
    thisDeserializer.readPointer();
    Ark_String info = static_cast<Ark_String>(thisDeserializer.readString());
    _call(_resourceId, info);
}
void deserializeAndCallSyncFormComponentAttribute_onRouter_callback_type(Ark_VMContext vmContext, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    Deserializer thisDeserializer = Deserializer(thisArray, thisLength);
    const Ark_Int32 _resourceId = thisDeserializer.readInt32();
    thisDeserializer.readPointer();
    const auto _callSync = reinterpret_cast<void(*)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_String info)>(thisDeserializer.readPointer());
    Ark_String info = static_cast<Ark_String>(thisDeserializer.readString());
    _callSync(vmContext, _resourceId, info);
}
...
void deserializeAndCallCallback(Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (kind) {
        ...
        case -1689064068/*Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics*/: return deserializeAndCallAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(thisArray, thisLength);
        ...
        case -1092975373/*Kind_FormComponentAttribute_onRouter_callback_type*/: return deserializeAndCallFormComponentAttribute_onRouter_callback_type(thisArray, thisLength);
...
void deserializeAndCallCallbackSync(Ark_VMContext vmContext, Ark_Int32 kind, KSerializerBuffer thisArray, Ark_Int32 thisLength)
{
    switch (kind) {
        ...
        case -1689064068/*Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics*/: return deserializeAndCallSyncAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(vmContext, thisArray, thisLength);
        ...
        case -1092975373/*Kind_FormComponentAttribute_onRouter_callback_type*/: return deserializeAndCallSyncFormComponentAttribute_onRouter_callback_type(vmContext, thisArray, thisLength);
