...
void callManagedAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics(Ark_Int32 resourceId, Ark_CustomSpanMeasureInfo measureInfo, Callback_CustomSpanMetrics_Void continuation)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
    Serializer argsSerializer = Serializer((KSerializerBuffer)&(_buffer.buffer), sizeof(_buffer.buffer), &(_buffer.resourceHolder));
    argsSerializer.writeInt32(Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics);
    argsSerializer.writeInt32(resourceId);
    argsSerializer.writeCustomSpanMeasureInfo(measureInfo);
    argsSerializer.writeCallbackResource(continuation.resource);
    argsSerializer.writePointer(reinterpret_cast<Ark_NativePointer>(continuation.call));
    argsSerializer.writePointer(reinterpret_cast<Ark_NativePointer>(continuation.callSync));
    enqueueCallback(&_buffer);
}
void callManagedAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetricsSync(Ark_VMContext vmContext, Ark_Int32 resourceId, Ark_CustomSpanMeasureInfo measureInfo, Callback_CustomSpanMetrics_Void continuation)
{
    uint8_t _buffer[4096];
    Serializer argsSerializer = Serializer((KSerializerBuffer)&_buffer, sizeof(_buffer), nullptr);
    argsSerializer.writeInt32(Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics);
...
void callManagedCallback_CustomSpanMetrics_Void(Ark_Int32 resourceId, Ark_CustomSpanMetrics value)
{
    ...
    argsSerializer.writeInt32(resourceId);
    argsSerializer.writeCustomSpanMetrics(value);
    enqueueCallback(&_buffer);
}
...
void callManagedCallback_DrawContext_CustomSpanDrawInfo_Void(Ark_Int32 resourceId, Ark_DrawContext context, Ark_CustomSpanDrawInfo drawInfo)
{
    ...
    argsSerializer.writeCustomSpanDrawInfo(drawInfo);
    enqueueCallback(&_buffer);
}
...
void callManagedCallback_PanelMode_Void(Ark_Int32 resourceId, Ark_PanelMode mode)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
...
void callManagedCallback_ResourceStr_Void(Ark_Int32 resourceId, Ark_ResourceStr value)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
...
void callManagedCallback_String_Unknown_Void(Ark_Int32 resourceId, Ark_String name, Ark_Object param)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
    ...
    const Ark_CallbackResource arg1Resource = {param.resource.resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&arg1Resource);
    argsSerializer.writeObject(param);
    enqueueCallback(&_buffer);
}
void callManagedCallback_String_Unknown_VoidSync(Ark_VMContext vmContext, Ark_Int32 resourceId, Ark_String name, Ark_Object param)
{
    uint8_t _buffer[4096];
    Serializer argsSerializer = Serializer((KSerializerBuffer)&_buffer, sizeof(_buffer), nullptr);
    argsSerializer.writeInt32(Kind_Callback_String_Unknown_Void);
...
void callManagedCallback_Union_Number_Resource_Void(Ark_Int32 resourceId, Ark_Union_Number_Resource selected)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
    ...
    if (selected_type == 0) {
        ...
        argsSerializer.writeInt8(1);
        const auto selected_1 = selected.value1;
        argsSerializer.writeResource(selected_1);
    }
    enqueueCallback(&_buffer);
}
...
void callManagedFormComponentAttribute_onRouter_callback_type(Ark_Int32 resourceId, Ark_String info)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
    Serializer argsSerializer = Serializer((KSerializerBuffer)&(_buffer.buffer), sizeof(_buffer.buffer), &(_buffer.resourceHolder));
    argsSerializer.writeInt32(Kind_FormComponentAttribute_onRouter_callback_type);
    argsSerializer.writeInt32(resourceId);
    argsSerializer.writeString(info);
    enqueueCallback(&_buffer);
}
void callManagedFormComponentAttribute_onRouter_callback_typeSync(Ark_VMContext vmContext, Ark_Int32 resourceId, Ark_String info)
{
    uint8_t _buffer[4096];
    Serializer argsSerializer = Serializer((KSerializerBuffer)&_buffer, sizeof(_buffer), nullptr);
    argsSerializer.writeInt32(Kind_FormComponentAttribute_onRouter_callback_type);
...
void callManagedMenuCallback(Ark_Int32 resourceId)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResourceSelf = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResourceSelf);
...
void callManagedMenuCallbackSync(Ark_VMContext vmContext, Ark_Int32 resourceId)
{
    uint8_t _buffer[4096];
    Serializer argsSerializer = Serializer((KSerializerBuffer)&_buffer, sizeof(_buffer), nullptr);
    argsSerializer.writeInt32(Kind_MenuCallback);
...
Ark_NativePointer getManagedCallbackCaller(CallbackKind kind)
{
    switch (kind) {
        ...
        case Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics: return reinterpret_cast<Ark_NativePointer>(callManagedAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics);
        ...
        case Kind_Callback_PanelMode_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_PanelMode_Void);
        ...
        case Kind_Callback_String_Unknown_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_String_Unknown_Void);
        ...
        case Kind_Callback_Union_Number_Resource_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_Union_Number_Resource_Void);
        ...
        case Kind_FormComponentAttribute_onRouter_callback_type: return reinterpret_cast<Ark_NativePointer>(callManagedFormComponentAttribute_onRouter_callback_type);
...
Ark_NativePointer getManagedCallbackCallerSync(CallbackKind kind)
{
    switch (kind) {
        ...
        case Kind_AsyncCallback_CustomSpanMeasureInfo_CustomSpanMetrics: return reinterpret_cast<Ark_NativePointer>(callManagedAsyncCallback_CustomSpanMeasureInfo_CustomSpanMetricsSync);
        ...
        case Kind_Callback_PanelMode_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_PanelMode_VoidSync);
        ...
        case Kind_Callback_String_Unknown_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_String_Unknown_VoidSync);
        ...
        case Kind_Callback_Union_Number_Resource_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_Union_Number_Resource_VoidSync);
        ...
        case Kind_FormComponentAttribute_onRouter_callback_type: return reinterpret_cast<Ark_NativePointer>(callManagedFormComponentAttribute_onRouter_callback_typeSync);
