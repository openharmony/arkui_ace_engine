...
export namespace Assert {
     ...
     * @param message - message to display on error
     */
    export function isNull<T>(value: T | null, message?: string): void {
     ...
     * @param message - message to display on error
     */
    export function isNotNull<T>(value: T | null, message?: string): void {
     ...
     * @param message - message to display on error
     */
    export function notExists<T>(value?: T | null, message?: string): void {
     ...
     * /
    export function throw(func: () => void): void {
        Assert.throws(func)
    }
     ...
     * @param message   Message to display on error.
     */
    export function closeTo(actual: number, expected: number, delta: number, message?: string): void {
