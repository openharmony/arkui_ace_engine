...
/*
 * THIS FILE IS AUTOGENERATED BY arktscgen v2.1.9-arktscgen-9. DO NOT EDIT MANUALLY!
 * es2panda 28c8b1b3a51011c50d084284c6ad42c22452568e(2025-08-16) sdk v1.5.0-dev.42052
 */
...
void impl_ArrowFunctionExpressionSetConvertedLambdaMayNeedFix(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    GetImpl()->ArrowFunctionExpressionSetConvertedLambdaMayNeedFix(_context, _receiver);
    return ;
}
KOALA_INTEROP_V2(ArrowFunctionExpressionSetConvertedLambdaMayNeedFix, KNativePointer, KNativePointer);

KBoolean impl_ArrowFunctionExpressionDoesConvertedLambdaMayNeedFixConst(KNativePointer context, KNativePointer receiver)
{
    const auto _context = reinterpret_cast<es2panda_Context*>(context);
    const auto _receiver = reinterpret_cast<es2panda_AstNode*>(receiver);
    auto result = GetImpl()->ArrowFunctionExpressionDoesConvertedLambdaMayNeedFixConst(_context, _receiver);
    return result;
}
KOALA_INTEROP_2(ArrowFunctionExpressionDoesConvertedLambdaMayNeedFixConst, KBoolean, KNativePointer, KNativePointer);
