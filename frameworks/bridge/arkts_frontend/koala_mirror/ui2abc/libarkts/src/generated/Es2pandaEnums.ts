...
export enum Es2pandaTokenType {
    ...
    TOKEN_TYPE_KEYW_NON_NULLABLE = 146,
    TOKEN_TYPE_LITERAL_NULL = 147,
    TOKEN_TYPE_KEYW_NUMBER = 148,
    TOKEN_TYPE_KEYW_OBJECT = 149,
    TOKEN_TYPE_KEYW_BUILTIN_OBJECT = 150,
    TOKEN_TYPE_KEYW_OF = 151,
    TOKEN_TYPE_KEYW_FINAL = 152,
    TOKEN_TYPE_KEYW_OUT = 153,
    TOKEN_TYPE_KEYW_OVERLOAD = 154,
    TOKEN_TYPE_KEYW_OVERRIDE = 155,
    TOKEN_TYPE_KEYW_PACKAGE = 156,
    TOKEN_TYPE_KEYW_INTERNAL = 157,
    TOKEN_TYPE_KEYW_PRIVATE = 158,
    TOKEN_TYPE_KEYW_PROTECTED = 159,
    TOKEN_TYPE_KEYW_PUBLIC = 160,
    TOKEN_TYPE_KEYW_READONLY = 161,
    TOKEN_TYPE_KEYW_RETURN = 162,
    TOKEN_TYPE_KEYW_REQUIRE = 163,
    TOKEN_TYPE_KEYW_SET = 164,
    TOKEN_TYPE_KEYW_SHORT = 165,
    TOKEN_TYPE_KEYW_BUILTIN_SHORT = 166,
    TOKEN_TYPE_KEYW_STATIC = 167,
    TOKEN_TYPE_KEYW_STRING = 168,
    TOKEN_TYPE_KEYW_BUILTIN_STRING = 169,
    TOKEN_TYPE_KEYW_STRUCT = 170,
    TOKEN_TYPE_KEYW_SUPER = 171,
    TOKEN_TYPE_KEYW_SWITCH = 172,
    TOKEN_TYPE_KEYW_TARGET = 173,
    TOKEN_TYPE_KEYW_THIS = 174,
    TOKEN_TYPE_KEYW_THROW = 175,
    TOKEN_TYPE_LITERAL_TRUE = 176,
    TOKEN_TYPE_KEYW_TRY = 177,
    TOKEN_TYPE_KEYW_TYPE = 178,
    TOKEN_TYPE_KEYW_TYPEOF = 179,
    TOKEN_TYPE_KEYW_U8 = 180,
    TOKEN_TYPE_KEYW_U16 = 181,
    TOKEN_TYPE_KEYW_U32 = 182,
    TOKEN_TYPE_KEYW_U64 = 183,
    TOKEN_TYPE_KEYW_UNDEFINED = 184,
    TOKEN_TYPE_KEYW_UNKNOWN = 185,
    TOKEN_TYPE_KEYW_USIZE = 186,
    TOKEN_TYPE_KEYW_V128 = 187,
    TOKEN_TYPE_KEYW_VAR = 188,
    TOKEN_TYPE_KEYW_VOID = 189,
    TOKEN_TYPE_KEYW_WHILE = 190,
    TOKEN_TYPE_KEYW_WITH = 191,
    TOKEN_TYPE_KEYW_YIELD = 192,
...
export enum Es2pandaPropertySearchFlags {
    ...
    PROPERTY_SEARCH_FLAGS_IGNORE_OVERLOAD = 8192,
