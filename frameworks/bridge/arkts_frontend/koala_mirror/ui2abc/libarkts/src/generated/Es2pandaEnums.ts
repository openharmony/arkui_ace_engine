...
export enum Es2pandaAstNodeType {
    ...
    AST_NODE_TYPE_PREFIX_ASSERTION_EXPRESSION = 54,
    AST_NODE_TYPE_PROPERTY = 55,
    AST_NODE_TYPE_REGEXP_LITERAL = 56,
    AST_NODE_TYPE_REEXPORT_STATEMENT = 57,
    AST_NODE_TYPE_RETURN_STATEMENT = 58,
    AST_NODE_TYPE_SCRIPT_FUNCTION = 59,
    AST_NODE_TYPE_SEQUENCE_EXPRESSION = 60,
    AST_NODE_TYPE_STRING_LITERAL = 61,
    AST_NODE_TYPE_ETS_NULL_TYPE = 62,
    AST_NODE_TYPE_ETS_UNDEFINED_TYPE = 63,
    AST_NODE_TYPE_ETS_NEVER_TYPE = 64,
    AST_NODE_TYPE_ETS_STRING_LITERAL_TYPE = 65,
    AST_NODE_TYPE_ETS_FUNCTION_TYPE = 66,
    AST_NODE_TYPE_ETS_WILDCARD_TYPE = 67,
    AST_NODE_TYPE_ETS_PRIMITIVE_TYPE = 68,
    AST_NODE_TYPE_ETS_PACKAGE_DECLARATION = 69,
    AST_NODE_TYPE_ETS_CLASS_LITERAL = 70,
    AST_NODE_TYPE_ETS_TYPE_REFERENCE = 71,
    AST_NODE_TYPE_ETS_TYPE_REFERENCE_PART = 72,
    AST_NODE_TYPE_ETS_UNION_TYPE = 73,
    AST_NODE_TYPE_ETS_KEYOF_TYPE = 74,
    AST_NODE_TYPE_ETS_NEW_ARRAY_INSTANCE_EXPRESSION = 75,
    AST_NODE_TYPE_ETS_NEW_MULTI_DIM_ARRAY_INSTANCE_EXPRESSION = 76,
    AST_NODE_TYPE_ETS_NEW_CLASS_INSTANCE_EXPRESSION = 77,
    AST_NODE_TYPE_ETS_IMPORT_DECLARATION = 78,
    AST_NODE_TYPE_ETS_PARAMETER_EXPRESSION = 79,
    AST_NODE_TYPE_ETS_TUPLE = 80,
    AST_NODE_TYPE_ETS_MODULE = 81,
    AST_NODE_TYPE_SUPER_EXPRESSION = 82,
    AST_NODE_TYPE_STRUCT_DECLARATION = 83,
    AST_NODE_TYPE_SWITCH_CASE_STATEMENT = 84,
    AST_NODE_TYPE_SWITCH_STATEMENT = 85,
    AST_NODE_TYPE_TS_ENUM_DECLARATION = 86,
    AST_NODE_TYPE_TS_ENUM_MEMBER = 87,
    AST_NODE_TYPE_TS_EXTERNAL_MODULE_REFERENCE = 88,
    AST_NODE_TYPE_TS_NUMBER_KEYWORD = 89,
    AST_NODE_TYPE_TS_ANY_KEYWORD = 90,
    AST_NODE_TYPE_TS_STRING_KEYWORD = 91,
    AST_NODE_TYPE_TS_BOOLEAN_KEYWORD = 92,
    AST_NODE_TYPE_TS_VOID_KEYWORD = 93,
    AST_NODE_TYPE_TS_UNDEFINED_KEYWORD = 94,
    AST_NODE_TYPE_TS_UNKNOWN_KEYWORD = 95,
    AST_NODE_TYPE_TS_OBJECT_KEYWORD = 96,
    AST_NODE_TYPE_TS_BIGINT_KEYWORD = 97,
    AST_NODE_TYPE_TS_NEVER_KEYWORD = 98,
    AST_NODE_TYPE_TS_NON_NULL_EXPRESSION = 99,
    AST_NODE_TYPE_TS_NULL_KEYWORD = 100,
    AST_NODE_TYPE_TS_ARRAY_TYPE = 101,
    AST_NODE_TYPE_TS_UNION_TYPE = 102,
    AST_NODE_TYPE_TS_TYPE_LITERAL = 103,
    AST_NODE_TYPE_TS_PROPERTY_SIGNATURE = 104,
    AST_NODE_TYPE_TS_METHOD_SIGNATURE = 105,
    AST_NODE_TYPE_TS_SIGNATURE_DECLARATION = 106,
    AST_NODE_TYPE_TS_PARENT_TYPE = 107,
    AST_NODE_TYPE_TS_LITERAL_TYPE = 108,
    AST_NODE_TYPE_TS_INFER_TYPE = 109,
    AST_NODE_TYPE_TS_CONDITIONAL_TYPE = 110,
    AST_NODE_TYPE_TS_IMPORT_TYPE = 111,
    AST_NODE_TYPE_TS_INTERSECTION_TYPE = 112,
    AST_NODE_TYPE_TS_MAPPED_TYPE = 113,
    AST_NODE_TYPE_TS_MODULE_BLOCK = 114,
    AST_NODE_TYPE_TS_THIS_TYPE = 115,
    AST_NODE_TYPE_TS_TYPE_OPERATOR = 116,
    AST_NODE_TYPE_TS_TYPE_PARAMETER = 117,
    AST_NODE_TYPE_TS_TYPE_PARAMETER_DECLARATION = 118,
    AST_NODE_TYPE_TS_TYPE_PARAMETER_INSTANTIATION = 119,
    AST_NODE_TYPE_TS_TYPE_PREDICATE = 120,
    AST_NODE_TYPE_TS_PARAMETER_PROPERTY = 121,
    AST_NODE_TYPE_TS_MODULE_DECLARATION = 122,
    AST_NODE_TYPE_TS_IMPORT_EQUALS_DECLARATION = 123,
    AST_NODE_TYPE_TS_FUNCTION_TYPE = 124,
    AST_NODE_TYPE_TS_CONSTRUCTOR_TYPE = 125,
    AST_NODE_TYPE_TS_TYPE_ALIAS_DECLARATION = 126,
    AST_NODE_TYPE_TS_TYPE_REFERENCE = 127,
    AST_NODE_TYPE_TS_QUALIFIED_NAME = 128,
    AST_NODE_TYPE_TS_INDEXED_ACCESS_TYPE = 129,
    AST_NODE_TYPE_TS_INTERFACE_DECLARATION = 130,
    AST_NODE_TYPE_TS_INTERFACE_BODY = 131,
    AST_NODE_TYPE_TS_INTERFACE_HERITAGE = 132,
    AST_NODE_TYPE_TS_TUPLE_TYPE = 133,
    AST_NODE_TYPE_TS_NAMED_TUPLE_MEMBER = 134,
    AST_NODE_TYPE_TS_INDEX_SIGNATURE = 135,
    AST_NODE_TYPE_TS_TYPE_QUERY = 136,
    AST_NODE_TYPE_TS_AS_EXPRESSION = 137,
    AST_NODE_TYPE_TS_CLASS_IMPLEMENTS = 138,
    AST_NODE_TYPE_TS_TYPE_ASSERTION = 139,
    AST_NODE_TYPE_TAGGED_TEMPLATE_EXPRESSION = 140,
    AST_NODE_TYPE_TEMPLATE_ELEMENT = 141,
    AST_NODE_TYPE_TEMPLATE_LITERAL = 142,
    AST_NODE_TYPE_THIS_EXPRESSION = 143,
    AST_NODE_TYPE_TYPEOF_EXPRESSION = 144,
    AST_NODE_TYPE_THROW_STATEMENT = 145,
    AST_NODE_TYPE_TRY_STATEMENT = 146,
    AST_NODE_TYPE_UNARY_EXPRESSION = 147,
    AST_NODE_TYPE_UPDATE_EXPRESSION = 148,
    AST_NODE_TYPE_VARIABLE_DECLARATION = 149,
    AST_NODE_TYPE_VARIABLE_DECLARATOR = 150,
    AST_NODE_TYPE_WHILE_STATEMENT = 151,
    AST_NODE_TYPE_YIELD_EXPRESSION = 152,
    AST_NODE_TYPE_OPAQUE_TYPE_NODE = 153,
    AST_NODE_TYPE_BLOCK_EXPRESSION = 154,
    AST_NODE_TYPE_BROKEN_TYPE_NODE = 155,
    AST_NODE_TYPE_ARRAY_EXPRESSION = 156,
    AST_NODE_TYPE_ARRAY_PATTERN = 157,
    AST_NODE_TYPE_ASSIGNMENT_EXPRESSION = 158,
    AST_NODE_TYPE_ASSIGNMENT_PATTERN = 159,
    AST_NODE_TYPE_OBJECT_EXPRESSION = 160,
    AST_NODE_TYPE_OBJECT_PATTERN = 161,
    AST_NODE_TYPE_SPREAD_ELEMENT = 162,
    AST_NODE_TYPE_REST_ELEMENT = 163
}
...
export enum Es2pandaTokenType {
    ...
    TOKEN_TYPE_KEYW_ASSERTS = 73,
    TOKEN_TYPE_KEYW_ASYNC = 74,
    TOKEN_TYPE_KEYW_AWAIT = 75,
    TOKEN_TYPE_KEYW_BIGINT = 76,
    TOKEN_TYPE_KEYW_BUILTIN_BIGINT = 77,
    TOKEN_TYPE_KEYW_BOOLEAN = 78,
    TOKEN_TYPE_KEYW_BUILTIN_BOOLEAN = 79,
    TOKEN_TYPE_KEYW_BREAK = 80,
    TOKEN_TYPE_KEYW_BYTE = 81,
    TOKEN_TYPE_KEYW_BUILTIN_BYTE = 82,
    TOKEN_TYPE_KEYW_CASE = 83,
    TOKEN_TYPE_KEYW_CATCH = 84,
    TOKEN_TYPE_KEYW_CHAR = 85,
    TOKEN_TYPE_KEYW_BUILTIN_CHAR = 86,
    TOKEN_TYPE_KEYW_CLASS = 87,
    TOKEN_TYPE_KEYW_CONST = 88,
    TOKEN_TYPE_KEYW_CONSTRUCTOR = 89,
    TOKEN_TYPE_KEYW_CONTINUE = 90,
    TOKEN_TYPE_KEYW_DATAREF = 91,
    TOKEN_TYPE_KEYW_DEBUGGER = 92,
    TOKEN_TYPE_KEYW_DECLARE = 93,
    TOKEN_TYPE_KEYW_DEFAULT = 94,
    TOKEN_TYPE_KEYW_DELETE = 95,
    TOKEN_TYPE_KEYW_DO = 96,
    TOKEN_TYPE_KEYW_DOUBLE = 97,
    TOKEN_TYPE_KEYW_BUILTIN_DOUBLE = 98,
    TOKEN_TYPE_KEYW_ELSE = 99,
    TOKEN_TYPE_KEYW_ENUM = 100,
    TOKEN_TYPE_KEYW_EQREF = 101,
    TOKEN_TYPE_KEYW_EVAL = 102,
    TOKEN_TYPE_KEYW_EXPORT = 103,
    TOKEN_TYPE_KEYW_EXTENDS = 104,
    TOKEN_TYPE_KEYW_EXTERNREF = 105,
    TOKEN_TYPE_KEYW_F32 = 106,
    TOKEN_TYPE_KEYW_F64 = 107,
    TOKEN_TYPE_LITERAL_FALSE = 108,
    TOKEN_TYPE_KEYW_FINALLY = 109,
    TOKEN_TYPE_KEYW_FLOAT = 110,
    TOKEN_TYPE_KEYW_BUILTIN_FLOAT = 111,
    TOKEN_TYPE_KEYW_FOR = 112,
    TOKEN_TYPE_KEYW_FROM = 113,
    TOKEN_TYPE_KEYW_FUNCREF = 114,
    TOKEN_TYPE_KEYW_FUNCTION = 115,
    TOKEN_TYPE_KEYW_GET = 116,
    TOKEN_TYPE_KEYW_GLOBAL = 117,
    TOKEN_TYPE_KEYW_I8 = 118,
    TOKEN_TYPE_KEYW_I16 = 119,
    TOKEN_TYPE_KEYW_I31REF = 120,
    TOKEN_TYPE_KEYW_I32 = 121,
    TOKEN_TYPE_KEYW_I64 = 122,
    TOKEN_TYPE_KEYW_IF = 123,
    TOKEN_TYPE_KEYW_IMPLEMENTS = 124,
    TOKEN_TYPE_KEYW_IMPORT = 125,
    TOKEN_TYPE_KEYW_IN = 126,
    TOKEN_TYPE_KEYW_INFER = 127,
    TOKEN_TYPE_KEYW_INSTANCEOF = 128,
    TOKEN_TYPE_KEYW_INT = 129,
    TOKEN_TYPE_KEYW_BUILTIN_INT = 130,
    TOKEN_TYPE_KEYW_INTERFACE = 131,
    TOKEN_TYPE_KEYW_IS = 132,
    TOKEN_TYPE_KEYW_ISIZE = 133,
    TOKEN_TYPE_KEYW_KEYOF = 134,
    TOKEN_TYPE_KEYW_LET = 135,
    TOKEN_TYPE_KEYW_LONG = 136,
    TOKEN_TYPE_KEYW_BUILTIN_LONG = 137,
    TOKEN_TYPE_KEYW_META = 138,
    TOKEN_TYPE_KEYW_MODULE = 139,
    TOKEN_TYPE_KEYW_NAMESPACE = 140,
    TOKEN_TYPE_KEYW_NATIVE = 141,
    TOKEN_TYPE_KEYW_NEVER = 142,
    TOKEN_TYPE_KEYW_NEW = 143,
    TOKEN_TYPE_LITERAL_NULL = 144,
    TOKEN_TYPE_KEYW_NUMBER = 145,
    TOKEN_TYPE_KEYW_OBJECT = 146,
    TOKEN_TYPE_KEYW_BUILTIN_OBJECT = 147,
    TOKEN_TYPE_KEYW_OF = 148,
    TOKEN_TYPE_KEYW_FINAL = 149,
    TOKEN_TYPE_KEYW_OUT = 150,
    TOKEN_TYPE_KEYW_OVERRIDE = 151,
    TOKEN_TYPE_KEYW_PACKAGE = 152,
    TOKEN_TYPE_KEYW_INTERNAL = 153,
    TOKEN_TYPE_KEYW_PRIVATE = 154,
    TOKEN_TYPE_KEYW_PROTECTED = 155,
    TOKEN_TYPE_KEYW_PUBLIC = 156,
    TOKEN_TYPE_KEYW_READONLY = 157,
    TOKEN_TYPE_KEYW_RETHROWS = 158,
    TOKEN_TYPE_KEYW_RETURN = 159,
    TOKEN_TYPE_KEYW_REQUIRE = 160,
    TOKEN_TYPE_KEYW_SET = 161,
    TOKEN_TYPE_KEYW_SHORT = 162,
    TOKEN_TYPE_KEYW_BUILTIN_SHORT = 163,
    TOKEN_TYPE_KEYW_STATIC = 164,
    TOKEN_TYPE_KEYW_STRING = 165,
    TOKEN_TYPE_KEYW_BUILTIN_STRING = 166,
    TOKEN_TYPE_KEYW_STRUCT = 167,
    TOKEN_TYPE_KEYW_SUPER = 168,
    TOKEN_TYPE_KEYW_SWITCH = 169,
    TOKEN_TYPE_KEYW_TARGET = 170,
    TOKEN_TYPE_KEYW_THIS = 171,
    TOKEN_TYPE_KEYW_THROW = 172,
    TOKEN_TYPE_KEYW_THROWS = 173,
    TOKEN_TYPE_LITERAL_TRUE = 174,
    TOKEN_TYPE_KEYW_TRY = 175,
    TOKEN_TYPE_KEYW_TYPE = 176,
    TOKEN_TYPE_KEYW_TYPEOF = 177,
    TOKEN_TYPE_KEYW_U8 = 178,
    TOKEN_TYPE_KEYW_U16 = 179,
    TOKEN_TYPE_KEYW_U32 = 180,
    TOKEN_TYPE_KEYW_U64 = 181,
    TOKEN_TYPE_KEYW_UNDEFINED = 182,
    TOKEN_TYPE_KEYW_UNKNOWN = 183,
    TOKEN_TYPE_KEYW_USIZE = 184,
    TOKEN_TYPE_KEYW_V128 = 185,
    TOKEN_TYPE_KEYW_VAR = 186,
    TOKEN_TYPE_KEYW_VOID = 187,
    TOKEN_TYPE_KEYW_WHILE = 188,
    TOKEN_TYPE_KEYW_WITH = 189,
    TOKEN_TYPE_KEYW_YIELD = 190,
    TOKEN_TYPE_JS_DOC_START = 191,
    TOKEN_TYPE_JS_DOC_END = 192,
...
export enum Es2pandaAstNodeFlags {
    ...
    AST_NODE_FLAGS_RECHECK = 32,
    AST_NODE_FLAGS_NOCLEANUP = 64,
    AST_NODE_FLAGS_RESIZABLE_REST = 128
}
...
export enum Es2pandaGlobalTypeId {
    ...
    GLOBAL_TYPE_ID_ETS_FUNCTION_BUILTIN = 73,
    GLOBAL_TYPE_ID_ETS_REGEXP_BUILTIN = 74,
    GLOBAL_TYPE_ID_ETS_ARRAY_BUILTIN = 75,
    GLOBAL_TYPE_ID_ETS_ARRAY = 76,
    GLOBAL_TYPE_ID_ETS_INTEROP_JSRUNTIME_BUILTIN = 77,
    GLOBAL_TYPE_ID_ETS_INTEROP_JSVALUE_BUILTIN = 78,
    GLOBAL_TYPE_ID_ETS_BOX_BUILTIN = 79,
    GLOBAL_TYPE_ID_ETS_BOOLEAN_BOX_BUILTIN = 80,
    GLOBAL_TYPE_ID_ETS_BYTE_BOX_BUILTIN = 81,
    GLOBAL_TYPE_ID_ETS_CHAR_BOX_BUILTIN = 82,
    GLOBAL_TYPE_ID_ETS_SHORT_BOX_BUILTIN = 83,
    GLOBAL_TYPE_ID_ETS_INT_BOX_BUILTIN = 84,
    GLOBAL_TYPE_ID_ETS_LONG_BOX_BUILTIN = 85,
    GLOBAL_TYPE_ID_ETS_FLOAT_BOX_BUILTIN = 86,
    GLOBAL_TYPE_ID_ETS_DOUBLE_BOX_BUILTIN = 87,
    GLOBAL_TYPE_ID_ETS_BIG_INT_BUILTIN = 88,
    GLOBAL_TYPE_ID_ETS_BIG_INT = 89,
    GLOBAL_TYPE_ID_ETS_FUNCTION0_CLASS = 90,
    GLOBAL_TYPE_ID_ETS_FUNCTION1_CLASS = 91,
    GLOBAL_TYPE_ID_ETS_FUNCTION2_CLASS = 92,
    GLOBAL_TYPE_ID_ETS_FUNCTION3_CLASS = 93,
    GLOBAL_TYPE_ID_ETS_FUNCTION4_CLASS = 94,
    GLOBAL_TYPE_ID_ETS_FUNCTION5_CLASS = 95,
    GLOBAL_TYPE_ID_ETS_FUNCTION6_CLASS = 96,
    GLOBAL_TYPE_ID_ETS_FUNCTION7_CLASS = 97,
    GLOBAL_TYPE_ID_ETS_FUNCTION8_CLASS = 98,
    GLOBAL_TYPE_ID_ETS_FUNCTION9_CLASS = 99,
    GLOBAL_TYPE_ID_ETS_FUNCTION10_CLASS = 100,
    GLOBAL_TYPE_ID_ETS_FUNCTION11_CLASS = 101,
    GLOBAL_TYPE_ID_ETS_FUNCTION12_CLASS = 102,
    GLOBAL_TYPE_ID_ETS_FUNCTION13_CLASS = 103,
    GLOBAL_TYPE_ID_ETS_FUNCTION14_CLASS = 104,
    GLOBAL_TYPE_ID_ETS_FUNCTION15_CLASS = 105,
    GLOBAL_TYPE_ID_ETS_FUNCTION16_CLASS = 106,
    GLOBAL_TYPE_ID_ETS_FUNCTIONN_CLASS = 107,
    GLOBAL_TYPE_ID_ETS_LAMBDA0_CLASS = 108,
    GLOBAL_TYPE_ID_ETS_LAMBDA1_CLASS = 109,
    GLOBAL_TYPE_ID_ETS_LAMBDA2_CLASS = 110,
    GLOBAL_TYPE_ID_ETS_LAMBDA3_CLASS = 111,
    GLOBAL_TYPE_ID_ETS_LAMBDA4_CLASS = 112,
    GLOBAL_TYPE_ID_ETS_LAMBDA5_CLASS = 113,
    GLOBAL_TYPE_ID_ETS_LAMBDA6_CLASS = 114,
    GLOBAL_TYPE_ID_ETS_LAMBDA7_CLASS = 115,
    GLOBAL_TYPE_ID_ETS_LAMBDA8_CLASS = 116,
    GLOBAL_TYPE_ID_ETS_LAMBDA9_CLASS = 117,
    GLOBAL_TYPE_ID_ETS_LAMBDA10_CLASS = 118,
    GLOBAL_TYPE_ID_ETS_LAMBDA11_CLASS = 119,
    GLOBAL_TYPE_ID_ETS_LAMBDA12_CLASS = 120,
    GLOBAL_TYPE_ID_ETS_LAMBDA13_CLASS = 121,
    GLOBAL_TYPE_ID_ETS_LAMBDA14_CLASS = 122,
    GLOBAL_TYPE_ID_ETS_LAMBDA15_CLASS = 123,
    GLOBAL_TYPE_ID_ETS_LAMBDA16_CLASS = 124,
    GLOBAL_TYPE_ID_ETS_LAMBDAN_CLASS = 125,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR0_CLASS = 126,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR1_CLASS = 127,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR2_CLASS = 128,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR3_CLASS = 129,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR4_CLASS = 130,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR5_CLASS = 131,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR6_CLASS = 132,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR7_CLASS = 133,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR8_CLASS = 134,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR9_CLASS = 135,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR10_CLASS = 136,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR11_CLASS = 137,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR12_CLASS = 138,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR13_CLASS = 139,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR14_CLASS = 140,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR15_CLASS = 141,
    GLOBAL_TYPE_ID_ETS_FUNCTIONR16_CLASS = 142,
    GLOBAL_TYPE_ID_ETS_LAMBDAR0_CLASS = 143,
    GLOBAL_TYPE_ID_ETS_LAMBDAR1_CLASS = 144,
    GLOBAL_TYPE_ID_ETS_LAMBDAR2_CLASS = 145,
    GLOBAL_TYPE_ID_ETS_LAMBDAR3_CLASS = 146,
    GLOBAL_TYPE_ID_ETS_LAMBDAR4_CLASS = 147,
    GLOBAL_TYPE_ID_ETS_LAMBDAR5_CLASS = 148,
    GLOBAL_TYPE_ID_ETS_LAMBDAR6_CLASS = 149,
    GLOBAL_TYPE_ID_ETS_LAMBDAR7_CLASS = 150,
    GLOBAL_TYPE_ID_ETS_LAMBDAR8_CLASS = 151,
    GLOBAL_TYPE_ID_ETS_LAMBDAR9_CLASS = 152,
    GLOBAL_TYPE_ID_ETS_LAMBDAR10_CLASS = 153,
    GLOBAL_TYPE_ID_ETS_LAMBDAR11_CLASS = 154,
    GLOBAL_TYPE_ID_ETS_LAMBDAR12_CLASS = 155,
    GLOBAL_TYPE_ID_ETS_LAMBDAR13_CLASS = 156,
    GLOBAL_TYPE_ID_ETS_LAMBDAR14_CLASS = 157,
    GLOBAL_TYPE_ID_ETS_LAMBDAR15_CLASS = 158,
    GLOBAL_TYPE_ID_ETS_LAMBDAR16_CLASS = 159,
    GLOBAL_TYPE_ID_ETS_TUPLE0_CLASS = 160,
    GLOBAL_TYPE_ID_ETS_TUPLE1_CLASS = 161,
    GLOBAL_TYPE_ID_ETS_TUPLE2_CLASS = 162,
    GLOBAL_TYPE_ID_ETS_TUPLE3_CLASS = 163,
    GLOBAL_TYPE_ID_ETS_TUPLE4_CLASS = 164,
    GLOBAL_TYPE_ID_ETS_TUPLE5_CLASS = 165,
    GLOBAL_TYPE_ID_ETS_TUPLE6_CLASS = 166,
    GLOBAL_TYPE_ID_ETS_TUPLE7_CLASS = 167,
    GLOBAL_TYPE_ID_ETS_TUPLE8_CLASS = 168,
    GLOBAL_TYPE_ID_ETS_TUPLE9_CLASS = 169,
    GLOBAL_TYPE_ID_ETS_TUPLE10_CLASS = 170,
    GLOBAL_TYPE_ID_ETS_TUPLE11_CLASS = 171,
    GLOBAL_TYPE_ID_ETS_TUPLE12_CLASS = 172,
    GLOBAL_TYPE_ID_ETS_TUPLE13_CLASS = 173,
    GLOBAL_TYPE_ID_ETS_TUPLE14_CLASS = 174,
    GLOBAL_TYPE_ID_ETS_TUPLE15_CLASS = 175,
    GLOBAL_TYPE_ID_ETS_TUPLE16_CLASS = 176,
    GLOBAL_TYPE_ID_ETS_TUPLEN_CLASS = 177,
    GLOBAL_TYPE_ID_TYPE_ERROR = 178,
    GLOBAL_TYPE_ID_COUNT = 179
}
...
export enum Es2pandaEntityType {
    ENTITY_TYPE_CLASS_PROPERTY = 0,
    ENTITY_TYPE_METHOD_DEFINITION = 1,
