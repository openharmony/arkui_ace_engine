...
export enum Es2pandaAstNodeFlags {
    ...
    AST_NODE_FLAGS_TMP_CONVERT_PRIMITIVE_CAST_METHOD_CALL = 256
}
...
export enum Es2pandaProgramFlags {
    ...
    PROGRAM_FLAGS_AST_CONST_STRING_TO_CHAR_LOWERED = 16,
    PROGRAM_FLAGS_AST_CONSTANT_EXPRESSION_LOWERED = 32,
    PROGRAM_FLAGS_AST_STRING_CONSTANT_LOWERED = 64,
    PROGRAM_FLAGS_AST_IDENTIFIER_ANALYZED = 128,
    PROGRAM_FLAGS_AST_HAS_SCOPES_INITIALIZED = 256,
    PROGRAM_FLAGS_AST_HAS_OPTIONAL_PARAMETER_ANNOTATION = 512
}
