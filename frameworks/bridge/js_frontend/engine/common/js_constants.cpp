...
const char TRAIL_OPTIMIZED_SPRING_MOTION[] = "trailOptimizedSpringMotion";
const char TRAIL_OPTIMIZED_RESPONSIVE_SPRING_MOTION[] = "trailOptimizedResponsiveSpringMotion";
const char TRAIL_OPTIMIZED_INTERPOLATING_SPRING[] = "trailOptimizedInterpolatingSpring";
const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_SPRING_MOTION[] = "trail-optimized-spring-motion";
const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_RESPONSIVE_SPRING_MOTION[] =
    "trail-optimized-responsive-spring-motion";
const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_INTERPOLATING_SPRING[] =
    "trail-optimized-interpolating-spring";
