...
ACE_EXPORT extern const char TRAIL_OPTIMIZED_SPRING_MOTION[];
ACE_EXPORT extern const char TRAIL_OPTIMIZED_RESPONSIVE_SPRING_MOTION[];
ACE_EXPORT extern const char TRAIL_OPTIMIZED_INTERPOLATING_SPRING[];
ACE_EXPORT extern const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_SPRING_MOTION[];
ACE_EXPORT extern const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_RESPONSIVE_SPRING_MOTION[];
ACE_EXPORT extern const char DOM_ANIMATION_TIMING_FUNCTION_TRAIL_OPTIMIZED_INTERPOLATING_SPRING[];
