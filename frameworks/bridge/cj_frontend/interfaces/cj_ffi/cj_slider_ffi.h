...
CJ_EXPORT void FfiOHOSAceFrameworkSliderShowTips(bool isShow, const char* content, bool content_exist);
...
CJ_EXPORT void FfiOHOSAceFrameworkSliderSlideRange(float from, float to, bool from_Exist, bool to_Exist);
