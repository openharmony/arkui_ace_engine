...
TextBackgroundStyle ParseSpanTextBackgroundStyle(uint32_t color, double radiusDouble, int32_t unit)
{
...
TextBackgroundStyle ParseSpanTextBackgroundStyle(uint32_t color, CBorderRadiuses radiusValue)
{
    TextBackgroundStyle textBackgroundStyle;
    Color colorVal = Color(color);
