...
CJ_EXPORT void FFICJVectorRangeContentSetElement(VectorRangeContentHandle vec, int64_t index, CJRangeContent rangeContentOptions);
...
CJ_EXPORT void FfiOHOSAceFrameworkTextPickerDialogShow(VectorStringHandle vecContent, CJDialogShow value);
...
CJ_EXPORT void FfiOHOSAceFrameworkTextPickerCreate(CJTextArrayParam params);
...
CJ_EXPORT void FfiOHOSAceFrameworkTextPickerCreateMulti(CJTextArrayParamCascade param);
...
CJ_EXPORT void FfiOHOSAceFrameworkTextPickerCreate(VectorStringHandle vecContent, uint32_t selected, const char* value);
