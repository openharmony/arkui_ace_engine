...
{
    auto onSurfaceCreated = [&surfaceId](const std::string& outSurfaceId) { surfaceId = outSurfaceId.c_str(); };
...
{
    auto onSurfaceChanged = [&surfaceId](const std::string& outSurfaceId, const NG::RectF& /* rect */) {
        surfaceId = outSurfaceId.c_str();
    };
...
{
    auto onSurfaceDestroyed = [&surfaceId](const std::string& outSurfaceId) { surfaceId = outSurfaceId.c_str(); };
