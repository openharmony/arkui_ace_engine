...
extern "C" {
void FfiOHOSAceFrameworkTextCreate(const char* content, int64_t controllerId)
{
...
void FfiOHOSAceFrameworkTextSetDecoration(int32_t typeValue, uint32_t colorValue, int32_t styleValue)
{
