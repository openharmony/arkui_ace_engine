...
const nestedObsObjPropsPU = tsuite("Partial update: Nested Observed Object and Properties", () => {
  ...
  tcase("Two views having a property referring to a1: ClassA", () => {
    ...
    let p1b1: ObservedPropertyObjectAbstractPU<ClassB> = new ObservedPropertyObjectPU<ClassB>(new ClassB(new ClassA(47)), v1p1b1, "p1-b1");
    ...
    let p1a1: ObservedPropertyObjectAbstractPU<ClassA> =
      new SynchedPropertyNesedObjectPU<ClassA>(p1b1.get().a, v1p1a1, "a");
    ...
    let p2a1: ObservedPropertyObjectAbstractPU<ClassA> =
      new SynchedPropertyNesedObjectPU<ClassA>(p1b1.get().a, v2p2a1, "a");
