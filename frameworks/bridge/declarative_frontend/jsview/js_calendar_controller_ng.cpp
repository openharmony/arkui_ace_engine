...
void JSCalendarControllerNg::JSBind(BindingTarget globalObj)
{
    ...
    JSClass<JSCalendarControllerNg>::Bind(
        globalObj, JSCalendarControllerNg::Constructor, JSCalendarControllerNg::Destructor);
}
...
void JSCalendarControllerNg::BackToToday(const JSCallbackInfo& args)
{
    if (controller_ != nullptr) {
        // TODO: Implementation of BackToToday interface
    }
}
