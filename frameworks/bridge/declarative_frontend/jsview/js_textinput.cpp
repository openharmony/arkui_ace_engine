...
void JSTextInput::JSBind(BindingTarget globalObj)
{
    ...
    JSClass<JSTextInput>::StaticMethod("strokeJoinStyle", &JSTextField::SetStrokeJoinStyle);
    JSClass<JSTextInput>::StaticMethod("shaderStyle", &JSTextField::SetShaderStyle);
