...
using ParseJsLengthMetricsFunc = bool (*)(const JSRef<JSObject>&, CalcDimension&);
ParseJsLengthMetricsFunc ParseJsLengthMetrics = &JSViewAbstract::ParseJsLengthMetricsVp;
