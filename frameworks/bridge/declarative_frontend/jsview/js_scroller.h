...
// #include "core/components_ng/pattern/scroll_bar/proxy/scroll_proxy.h"
...
public:
    ...
    void SetScrollProxy(const RefPtr<ScrollProxy>& proxy)
    {
        scrollProxy_ = proxy;
    }

    const RefPtr<ScrollProxy>& GetScrollProxy()
    {
        return scrollProxy_;
    }
...
private:
    ...
    RefPtr<ScrollProxy> scrollProxy_;
