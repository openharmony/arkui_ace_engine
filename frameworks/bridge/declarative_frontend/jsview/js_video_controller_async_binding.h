...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_VIDEO_CONTROLLER_ASYNC_BINDING_H
#define FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_VIDEO_CONTROLLER_ASYNC_BINDING_H
...
class JSVideoControllerAsyncBinding : public JSVideoControllerAsync {
public:
    JSVideoControllerAsyncBinding() = default;
...
private:
    ACE_DISALLOW_COPY_AND_MOVE(JSVideoControllerAsyncBinding);
};

} // namespace OHOS::Ace::Framework

#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_VIDEO_CONTROLLER_ASYNC_BINDING_H
