...
class LazyArkTextInputComponent extends ArkComponent {
  static module: any | undefined = undefined;

  constructor(nativePtr: KNode, classType: ModifierType) {
    super(nativePtr, classType);
    if (LazyArkTextInputComponent.module === undefined) {
      LazyArkTextInputComponent.module = globalThis.requireNapi('arkui.components.arktextinput');
    }

    this.lazyComponent = LazyArkTextInputComponent.module!.createComponent(nativePtr, classType);
  }
  ...
  setText(value: any): this {
    this.lazyComponent.setText(value);
    return this;
  }

  setPlaceholder(value: any): this {
    this.lazyComponent.setPlaceholder(value);
    return this;
  }

  setController(value: any): this {
    this.lazyComponent.setController(value);
    return this;
  }
  ...
  enableAutoFillAnimation(value: any): this {
    this.lazyComponent.enableAutoFillAnimation(value);
    return this;
  }

  passwordRules(value: any): this {
    this.lazyComponent.passwordRules(value);
    return this;
  }
  ...
  onEditChanged(callback: any): this {
    this.lazyComponent.onEditChanged(callback);
    return this;
  }
  ...
  showPasswordIcon(value: any): this {
    this.lazyComponent.showPasswordIcon(value);
    return this;
  }

  showPassword(value: any): this {
    this.lazyComponent.showPassword(value);
    return this;
  }
  ...
  caretPosition(value: any): this {
    this.lazyComponent.caretPosition(value);
    return this;
  }
  ...
  passwordIcon(value: any): this {
    this.lazyComponent.passwordIcon(value);
    return this;
  }

  showError(value: any): this {
    this.lazyComponent.showError(value);
    return this;
  }

  showUnit(event: any): void {
    this.lazyComponent.showUnit(event);
  }

  showUnderline(value: any): this {
    this.lazyComponent.showUnderline(value);
    return this;
  }
  ...
  underlineColor(value: any): this {
    this.lazyComponent.underlineColor(value);
    return this;
  }
  ...
  onSecurityStateChange(callback: any): this {
    this.lazyComponent.onSecurityStateChange(callback);
    return this;
  }
...
class TextInputModifier extends LazyArkTextInputComponent implements AttributeModifier<TextInputAttribute> {
