...
const testViewState = tsuite("View State", () => {
  ...
  class Parent extends View {
    ...
    constructor(params: {
      ...
      super(/* parent */ undefined, localStorage);
    ...
    public initialRender() {
      // dump state
      console.debug(`${this.id__()}:${this.constructor.name}: initialRender: state is: forLink_: ${this.forLink_}, forProp_: ${this.forProp_}`);

      childView = new Child(parentView,
        {
    ...
    public rerender(): void {
      console.debug(`${this.id__()}:${this.constructor.name}: rerender: state is: forLink_: ${this.forLink_}, forProp_: ${this.forProp_} - unimplemented`);
    }

    public purgeVariableDependenciesOnElmtId(removedelementId: number): void {
      console.debug(`${this.id__()}:${this.constructor.name}: purgeVariableDependenciesOnElmtId - unimplemented!`);
    }


    public setOneWaySyncPropertiesUnchanged(): void {
      console.debug(`${this.id__()}:${this.constructor.name}: setOneWaySyncPropertiesUnchanged - unimplemented!`);
    }

    public setStateSourcePropertiesUnchanged(): void {
      console.debug(`${this.id__()}:${this.constructor.name}: setStateSourcePropertiesUnchanged - unimplemented!`);
    }

    public setTwoWaySyncPropertiesUnchanged(): void {
      console.debug(`${this.id__()}:${this.constructor.name}: setTwoWaySyncPropertiesUnchanged - unimplemented!`);
    }
  }
  ...
  class Child extends View
    ...
    public initialRender(): void {
      // dump state
      console.debug(`${this.id__()}:${this.constructor.name}: initialRender: state is: num_: ${this.num_}, link_: ${this.link_}, prop_: ${this.prop_}, reg_=${this.reg_}`);
    }

    public rerender(): void {
      // dump state
      console.debug(`${this.id__()}:${this.constructor.name}: rerender: state is: num_: ${this.num_}, link_: ${this.link_}, prop_: ${this.prop_}, reg_=${this.reg_}`);
    }
