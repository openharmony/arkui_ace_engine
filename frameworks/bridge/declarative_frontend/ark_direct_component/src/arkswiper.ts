...
function loadComponent(): ComponentObj | undefined {
  if (loadComponent.componentObj === undefined && globalThis.__ArkComponent__ !== undefined) {
    class ArkSwiperComponent extends globalThis.__ArkComponent__ implements SwiperAttribute {
...
globalThis.Swiper.attributeModifier = function (modifier: ArkComponent): void {
  attributeModifierFunc.call(this, modifier, (nativePtr: KNode) => {
    return createComponent(nativePtr, 'swiper');
...
class JSSwiper extends JSContainerBase {
  ...
  static indicatorInteractive(value: any): void {
    getUINativeModule().swiper.setIndicatorInteractive(true, value);
  }

  static autoPlay(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperAutoPlay(true, value, additional);
  }

  static duration(value: any): void {
    getUINativeModule().swiper.setSwiperDuration(true, value);
  }

  static index(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperIndex(true, value, additional);
  }

  static interval(value: any): void {
    getUINativeModule().swiper.setSwiperInterval(true, value);
  }

  static loop(value: any): void {
    getUINativeModule().swiper.setSwiperLoop(true, value);
  }

  static vertical(value: any): void {
    getUINativeModule().swiper.setSwiperVertical(true, value);
  }

  static indicator(value: any): void {
    getUINativeModule().swiper.setSwiperIndicator(true, value);
  }

  static displayMode(value: any): void {
    getUINativeModule().swiper.setSwiperDisplayMode(true, value);
  }

  static effectMode(value: any): void {
    getUINativeModule().swiper.setSwiperEffectMode(true, value);
  }

  static displayCount(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperDisplayCount(true, value, additional);
  }

  static itemSpace(value: any): void {
    getUINativeModule().swiper.setSwiperItemSpace(true, value);
  }

  static prevMargin(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperPrevMargin(true, value, additional);
  }

  static nextMargin(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperNextMargin(true, value, additional);
  }

  static cachedCount(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperCachedCount(true, value, additional);
  }

  static curve(value: any): void {
    getUINativeModule().swiper.setSwiperCurve(true, value);
  }

  static onChange(value: any): void {
    getUINativeModule().swiper.setSwiperOnChange(true, value);
  }

  static onUnselected(value: any): void {
    getUINativeModule().swiper.setSwiperOnUnselected(true, value);
  }

  static onAnimationStart(value: any): void {
    getUINativeModule().swiper.setSwiperOnAnimationStart(true, value);
  }

  static onAnimationEnd(value: any): void {
    getUINativeModule().swiper.setSwiperOnAnimationEnd(true, value);
  }

  static onGestureSwipe(value: any): void {
    getUINativeModule().swiper.setSwiperOnGestureSwipe(true, value);
  }

  static onClick(value: any): void {
    getUINativeModule().swiper.setSwiperOnClick(true, value);
  }

  static remoteMessage(value: any): void {
    getUINativeModule().swiper.setSwiperRemoteMessage(true, value);
  }

  static indicatorStyle(value: any): void {
    getUINativeModule().swiper.setSwiperIndicatorStyle(true, value);
    return this;
  }

  static enabled(value: any): void {
    getUINativeModule().swiper.setSwiperEnabled(true, value);
  }

  static disableSwipe(value: any): void {
    getUINativeModule().swiper.setSwiperDisableSwipe(true, value);
  }

  static height(value: any): void {
    getUINativeModule().swiper.setSwiperHeight(true, value);
  }

  static width(value: any): void {
    getUINativeModule().swiper.setSwiperWidth(true, value);
  }

  static size(value: any): void {
    getUINativeModule().swiper.setSwiperSize(true, value?.width, value?.height);
  }

  static displayArrow(value: any, additional: any): void {
    getUINativeModule().swiper.setSwiperDisplayArrow(true, value, additional);
  }

  static nestedScroll(value: any): void {
    getUINativeModule().swiper.setNestedScroll(true, value);
    return this;
  }

  static customContentTransition(value: any): void {
    getUINativeModule().swiper.setSwiperCustomContentTransition(true, value);
  }

  static onContentDidScroll(value: any): void {
    getUINativeModule().swiper.setSwiperOnContentDidScroll(true, value);
  }

  static pageFlipMode(value: any): void {
    getUINativeModule().swiper.setSwiperPageFlipMode(true, value);
  }

  static onContentWillScroll(value: any): void {
    getUINativeModule().swiper.setSwiperOnContentWillScroll(true, value);
  }

  static onSelected(value: any): void {
    getUINativeModule().swiper.setSwiperOnSelected(true, value);
  }

  static maintainVisibleContentPosition(value: any): void {
    getUINativeModule().swiper.setSwiperMaintainVisibleContentPosition(true, value);
  }

  static onScrollStateChanged(value: any): void {
    getUINativeModule().swiper.setSwiperOnScrollStateChanged(true, value);
  }
...
function exportComponent(): void {
  globalThis.ArkSwiperComponent = (loadComponent as any).componentObj?.component;
}

function exportView(): void {
  globalThis.Swiper = JSSwiper;
}

export default { loadComponent, createComponent, exportComponent, exportView, JSSwiper };
