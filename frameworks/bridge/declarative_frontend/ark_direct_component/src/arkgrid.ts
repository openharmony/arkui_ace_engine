    ...
    class ArkGridComponent extends ArkScrollable<GridAttribute> {
      ...
      initialize(value: Object[]): this {
        if (value.length === 1 && isObject(value[0])) {
          ...
          modifierWithKey(
              this._modifiersWithKeys, GridLayoutOptionsModifier.identity, GridLayoutOptionsModifier, undefined);
        }
        else if (value.length === 2 && isObject(value[0]) && isObject(value[1])) {
          modifierWithKey(this._modifiersWithKeys, GridScrollerModifier.identity, GridScrollerModifier, value[0]);
          modifierWithKey(
              this._modifiersWithKeys, GridLayoutOptionsModifier.identity, GridLayoutOptionsModifier, value[1]);
        }
        else {
      ...
      columnsTemplate(value: string | ItemFillPolicy): this {
        modifierWithKey(
            this._modifiersWithKeys, GridColumnsTemplateModifier.identity, GridColumnsTemplateModifier, value);
        return this;
      }
      ...
      scrollBarWidth(value: string | number | Resource): this {
        modifierWithKey(
            this._modifiersWithKeys, GridScrollBarWidthModifier.identity, GridScrollBarWidthModifier, value);
        return this;
      }
      scrollBarColor(value: string | number | Color): this {
        modifierWithKey(
            this._modifiersWithKeys, GridScrollBarColorModifier.identity, GridScrollBarColorModifier, value);
        return this;
      }
      ...
      onScrollBarUpdate(event: (index: number, offset: number) => ComputedBarAttribute): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnScrollBarUpdateModifier.identity, GridOnScrollBarUpdateModifier, event);
        return this;
      }
      ...
      multiSelectable(value: boolean): this {
        modifierWithKey(
            this._modifiersWithKeys, GridMultiSelectableModifier.identity, GridMultiSelectableModifier, value);
        return this;
      }
      ...
      layoutDirection(value: GridDirection): this {
        modifierWithKey(
            this._modifiersWithKeys, GridLayoutDirectionModifier.identity, GridLayoutDirectionModifier, value);
        return this;
      }
      supportAnimation(value: boolean): this {
        modifierWithKey(
            this._modifiersWithKeys, GridSupportAnimationModifier.identity, GridSupportAnimationModifier, value);
        return this;
      }
      onItemDragStart(event: (event: ItemDragInfo, itemIndex: number) => void | (() => any)): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnItemDragStartModifier.identity, GridOnItemDragStartModifier, event);
        return this;
      }
      onItemDragEnter(event: (event: ItemDragInfo) => void): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnItemDragEnterModifier.identity, GridOnItemDragEnterModifier, event);
        return this;
      }
      onItemDragMove(event: (event: ItemDragInfo, itemIndex: number, insertIndex: number) => void): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnItemDragMoveModifier.identity, GridOnItemDragMoveModifier, event);
        return this;
      }
      onItemDragLeave(event: (event: ItemDragInfo, itemIndex: number) => void): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnItemDragLeaveModifier.identity, GridOnItemDragLeaveModifier, event);
        return this;
      }
      ...
      onScrollFrameBegin(callback: (offset: number, state: ScrollState) => { offsetRemain: number; }): this {
        modifierWithKey(
            this._modifiersWithKeys, GridOnScrollFrameBeginModifier.identity, GridOnScrollFrameBeginModifier, callback);
        return this;
      }
      ...
      editModeOptions(options: EditModeOptions | undefined): this {
        modifierWithKey(
            this._modifiersWithKeys, GridEditModeOptionsModifier.identity, GridEditModeOptionsModifier, options);
        return this;
      }
      ...
      supportEmptyBranchInLazyLoading(value: any): this {
        modifierWithKey(
            this._modifiersWithKeys, GridSupportLazyLoadingEmptyBranchModifier.identity,
            GridSupportLazyLoadingEmptyBranchModifier, value);
        return this;
      }
    }

    loadComponent.componentObj = {'component': ArkGridComponent};
  }
  return loadComponent.componentObj;
}

class JSGrid extends JSContainerBase {
  static name: string = 'Grid'
  static create(scroller: any, options: any): void {
    getUINativeModule().grid.create(scroller, options);
  }
  static pop(): void {
    getUINativeModule().grid.pop();
  }
  static willUseProxy(): boolean {
    return getUINativeModule().grid.willUseProxy();
  }
  static columnsTemplate(value: any): void {
    getUINativeModule().grid.setColumnsTemplate(true, value);
  }
  static rowsTemplate(value: any): void {
    getUINativeModule().grid.setRowsTemplate(true, value);
  }
  static columnsGap(value: any): void {
    getUINativeModule().grid.setColumnsGap(true, value);
  }
  static rowsGap(value: any): void {
    getUINativeModule().grid.setRowsGap(true, value);
  }
  static scrollBar(value: any): void {
    getUINativeModule().grid.setJSScrollBar(true, value);
  }
  static scrollBarWidth(value: any): void {
    getUINativeModule().grid.setJSScrollBarWidth(true, value);
  }
  static scrollBarColor(value: any): void {
    getUINativeModule().grid.setScrollBarColor(true, value);
  }
  static clip(value: any): void {
    getUINativeModule().common.setClipWithEdge(true, value);
  }

  static onScrollBarUpdate(event: any): void {
    getUINativeModule().grid.setOnScrollBarUpdate(true, event);
  }
  static cachedCount(count: any, show: any): void {
    getUINativeModule().grid.setCachedCount(true, count, show ? show : false);
  }
  static editMode(value: any): void {
    getUINativeModule().grid.setEditMode(true, value);
  }
  static editModeOptions(value: any): void {
    getUINativeModule().grid.setEditModeOptions(true, value);
  }
  static enableEditMode(value: any, callback?: any): void {
    getUINativeModule().grid.setJSEnableEditMode(true, value, callback);
  }
  static multiSelectable(value: any): void {
    getUINativeModule().grid.setMultiSelectable(true, value);
  }
  static maxCount(value: any): void {
    getUINativeModule().grid.setMaxCount(true, value);
  }
  static minCount(value: any): void {
    getUINativeModule().grid.setMinCount(true, value);
  }
  static cellLength(value: any): void {
    getUINativeModule().grid.setCellLength(true, value);
  }
  static layoutDirection(value: any): void {
    getUINativeModule().grid.setLayoutDirection(true, value);
  }
  static dragAnimation(value: any): void {
    getUINativeModule().grid.setDragAnimation(true, value);
  }
  static edgeEffect(value: any, options: any): void {
    getUINativeModule().grid.setEdgeEffect(true, value, options);
  }
  static direction(value: any): void {
    getUINativeModule().grid.setDirection(true, value);
  }
  static supportAnimation(value: any): void {
    getUINativeModule().grid.setSupportAnimation(true, value);
  }
  static onItemDragEnter(event: any): void {
    getUINativeModule().grid.setOnItemDragEnter(true, event);
  }
  static onItemDragMove(event: any): void {
    getUINativeModule().grid.setOnItemDragMove(true, event);
  }
  static onItemDragLeave(event: any): void {
    getUINativeModule().grid.setOnItemDragLeave(true, event);
  }
  static onItemDragStart(event: any): void {
    getUINativeModule().grid.setOnItemDragStart(true, event);
  }
  static height(value: any): void {
    getUINativeModule().grid.setHeight(true, value);
  }
  static onItemDrop(event: any): void {
    getUINativeModule().grid.setOnItemDrop(true, event);
  }
  static nestedScroll(value: any): JSGrid {
    getUINativeModule().grid.setNestedScroll(true, value);
    return this;
  }
  static enableScrollInteraction(value: any): void {
    getUINativeModule().grid.setEnableScroll(true, value);
  }
  static friction(value: any): void {
    getUINativeModule().grid.setFriction(true, value);
  }
  static focusWrapMode(value: any): void {
    getUINativeModule().grid.setFocusWrapMode(true, value);
  }
  static alignItems(value: any): void {
    getUINativeModule().grid.setAlignItems(true, value);
  }
  static syncLoad(value: any): void {
    getUINativeModule().grid.setSyncLoad(true, value);
  }
  static supportEmptyBranchInLazyLoading(value: any): void {
    getUINativeModule().grid.setSupportLazyLoadingEmptyBranch(true, value);
  }

  static onScroll(event: any): JSGrid {
    getUINativeModule().grid.setOnScroll(true, event);
    return this;
  }
  static onReachStart(event: any): JSGrid {
    getUINativeModule().grid.setOnReachStart(true, event);
    return this;
  }
  static onReachEnd(event: any): JSGrid {
    getUINativeModule().grid.setOnReachEnd(true, event);
    return this;
  }
  static onScrollStart(event: any): JSGrid {
    getUINativeModule().grid.setOnScrollStart(true, event);
    return this;
  }
  static onScrollStop(event: any): JSGrid {
    getUINativeModule().grid.setOnScrollStop(true, event);
    return this;
  }
  static onScrollIndex(event: any): JSGrid {
    getUINativeModule().grid.setOnScrollIndex(true, event);
    return this;
  }
  static onScrollFrameBegin(event: any): void {
    getUINativeModule().grid.setOnScrollFrameBegin(true, event);
  }
  static onEditModeChange(event: any): void {
    getUINativeModule().grid.setOnEditModeChange(true, event);
  }
