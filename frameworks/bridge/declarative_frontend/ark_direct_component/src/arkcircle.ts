...
if (loadComponent.componentObj === undefined && globalThis.__ArkComponent__ !== undefined) {
    ...
    loadComponent.componentObj = {'component' : ArkCircleComponent };
  }
  return loadComponent.componentObj;
}

class JSCircle extends commonModule.CommonShape {
    constructor(value) {
        super();
...
function exportComponent(): void {
    globalThis.ArkCircleComponent = (loadComponent as any).componentObj?.component;
}

function exportView(): void {
    globalThis.Circle = JSCircle;
}
