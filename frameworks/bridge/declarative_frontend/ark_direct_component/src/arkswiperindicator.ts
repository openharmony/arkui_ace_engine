...
function loadComponent(): ComponentObj | undefined {
  if (loadComponent.componentObj === undefined && globalThis.__ArkComponent__ !== undefined) {
    ...
    class ArkSwiperIndicatorComponent extends globalThis.__ArkComponent__ implements SwiperIndicatorAttribute {
      constructor(nativePtr: KNode, classType?: ModifierType) {
        super(nativePtr, classType);
      }
    
      initialIndex(value: number): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentInitialIndexModifier.identity,
          IndicatorComponentInitialIndexModifier, value);
        return this;
      }
    
      count(value: number): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentCountModifier.identity,
          IndicatorComponentCountModifier, value);
        return this;
      }
    
      style(value: DotIndicator | DigitIndicator): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentStyleModifier.identity,
          IndicatorComponentStyleModifier, value);
        return this;
      }
    
      loop(value: boolean): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentLoopModifier.identity,
          IndicatorComponentLoopModifier, value);
        return this;
      }
    
      vertical(value: boolean): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentVerticalModifier.identity,
          IndicatorComponentVerticalModifier, value);
        return this;
      }
    
      onChange(value: Callback<number>): SwiperIndicatorAttribute {
        modifierWithKey(this._modifiersWithKeys, IndicatorComponentOnChangeModifier.identity,
          IndicatorComponentOnChangeModifier, value);
        return this;
      }
    }
    
        loadComponent.componentObj = { 'component': ArkSwiperIndicatorComponent };
  }
...
globalThis.IndicatorComponent.attributeModifier = function (modifier: ArkComponent): void {
  attributeModifierFunc.call(this, modifier, (nativePtr: KNode) => {
    return createComponent(nativePtr, 'swiperIndicator');
  }, (nativePtr: KNode, classType: ModifierType, modifierJS: ModifierJS) => {
    return new modifierJS.IndicatorComponentModifier(nativePtr, classType);
  });
};

class JSIndicator extends JSViewAbstract {
  static create(controller: any): void {
    getUINativeModule().indicatorComponent.create(controller);
  }

  static count(value: any): void {
    getUINativeModule().indicatorComponent.setCount(true, value);
  }

  static loop(value: any): void {
    getUINativeModule().indicatorComponent.setLoop(true, value);
  }

  static vertical(value: any): void {
    getUINativeModule().indicatorComponent.setVertical(true, value);
  }

  static style(value: any): void {
    getUINativeModule().indicatorComponent.setStyle(true, value);
  }

  static initialIndex(value: any): void {
    getUINativeModule().indicatorComponent.setInitialIndex(true, value);
  }

  static onChange(value: any): void {
    getUINativeModule().indicatorComponent.setOnChange(true, value);
  }
...
function exportComponent(): void {
  globalThis.ArkSwiperIndicatorComponent = (loadComponent as any).componentObj?.component;
}

function exportView(): void {
  globalThis.IndicatorComponent = JSIndicator;
}
