...
function loadComponent(): ComponentObj | undefined {
  if (loadComponent.componentObj === undefined && globalThis.__ArkComponent__ !== undefined) {
    ...
    loadComponent.componentObj = {'component' : ArkPolylineComponent };
  }
  return loadComponent.componentObj;
}

class JSPolyline extends commonModule.CommonShape {
    ...
    static points(value: any): void {
        ...
        getUINativeModule().polyline.setPoints(true, xPoint, yPoint);
    }
...
function exportComponent(): void {
    globalThis.ArkPolylineComponent = (loadComponent as any).componentObj?.component;
}

function exportView(): void {
    globalThis.Polyline = JSPolyline;
}
