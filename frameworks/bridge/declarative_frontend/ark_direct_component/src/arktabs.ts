...
function loadComponent(): ComponentObj | undefined {
  if (loadComponent.componentObj === undefined && globalThis.__ArkComponent__ !== undefined) {
    ...
    class ArkTabsComponent extends globalThis.__ArkComponent__ implements TabsAttribute {
      ...
      barFloatingStyle(value: barFloatingStyleOptions): TabsAttribute {
    ...
    class TabBarFloatingStyleModifier extends ModifierWithKey<barFloatingStyleOptions> {
      constructor(value: barFloatingStyleOptions) {
        super(value);
      }
      static identity: Symbol = Symbol('barFloatingStyle');
...
function getTabsComponent(): any {
  const elmtId = ViewStackProcessor.GetElmtIdToAccountFor();
  const nativeNode = getUINativeModule().getFrameNodeById(elmtId);
  return JSTabs.createOrGetNode(elmtId, () => {
    return createComponent(nativeNode, 'tabs');
  });
}
...
globalThis.Tabs.attributeModifier = function (modifier: ArkComponent): void {
  attributeModifierFunc.call(this, modifier, (nativePtr: KNode) => {
    return createComponent(nativePtr, 'tabs');
  }, (nativePtr: KNode, classType: ModifierType, modifierJS: ModifierJS) => {
    return new modifierJS.TabsModifier(nativePtr, classType);
  });
};

class JSTabs extends JSContainerBase {
  static create(value: any): void {
    getUINativeModule().tabs.create(value);
  }

  static pop(value: any): void {
    getUINativeModule().tabs.pop(value);
  }

  static vertical(value: any): void {
    getUINativeModule().tabs.setIsVertical(true, value);
  }

  static barPosition(value: any): void {
    getUINativeModule().tabs.setBarPosition(true, value);
  }

  static scrollable(value: any): void {
    getUINativeModule().tabs.setScrollable(true, value);
  }

  static barMode(value: any, additional: any): void {
    getUINativeModule().tabs.setTabBarMode(true, value, additional);
  }

  static barWidth(value: any): void {
    getUINativeModule().tabs.setTabBarWidth(true, value);
  }

  static barHeight(value: any, additional: any): void {
    getUINativeModule().tabs.setTabBarHeight(true, value, additional);
  }

  static animationCurve(value: any): void {
    getUINativeModule().tabs.setAnimationCurve(true, value);
  }

  static animationDuration(value: any): void {
    getUINativeModule().tabs.setAnimationDuration(true, value);
  }

  static animationMode(value: any): void {
    getUINativeModule().tabs.setAnimateMode(true, value);
  }

  static onChange(value: any): void {
    getUINativeModule().tabs.setTabsOnChange(true, value);
  }

  static onSelected(value: any): void {
    getUINativeModule().tabs.setTabsOnSelected(true, value);
  }

  static onTabBarClick(value: any): void {
    getUINativeModule().tabs.setTabsOnTabBarClick(true, value);
  }

  static onUnselected(value: any): void {
    getUINativeModule().tabs.setTabOnUnselected(true, value);
  }

  static onAnimationStart(value: any): void {
    getUINativeModule().tabs.setTabsOnAnimationStart(true, value);
  }

  static onAnimationEnd(value: any): void {
    getUINativeModule().tabs.setTabsOnAnimationEnd(true, value);
  }

  static onGestureSwipe(value: any): void {
    getUINativeModule().tabs.setTabsOnGestureSwipe(true, value);
  }

  static onContentDidScroll(value: any): void {
    getUINativeModule().tabs.setTabsOnContentDidScroll(true, value);
  }

  static onContentWillChange(value: any): void {
    getUINativeModule().tabs.setTabsOnContentWillChange(true, value);
  }

  static fadingEdge(value: any): void {
    getUINativeModule().tabs.setFadingEdge(true, value);
  }

  static divider(value: any): void {
    getUINativeModule().tabs.setDivider(true, value);
  }

  static barOverlap(value: any): void {
    getUINativeModule().tabs.setBarOverlap(true, value);
  }

  static barBackgroundColor(value: any): void {
  ...
  static barBackgroundEffect(value: any): void {
    getUINativeModule().tabs.setBarBackgroundEffect(true, value);
  }

  static barGridAlign(value: any): void {
    getUINativeModule().tabs.setBarGridAlign(true, value);
  }

  static clip(value: any): void {
    getUINativeModule().tabs.setTabClip(true, value);
  }

  static edgeEffect(value: any): void {
    getUINativeModule().tabs.setTabEdgeEffect(true, value);
  }

  static nestedScroll(value: any): void {
    getUINativeModule().tabs.setNestedScroll(true, value);
    return this;
  }

  static pageFlipMode(value: any): void {
    getUINativeModule().tabs.setTabPageFlipMode(true, value);
  }

  static width(value: any): void {
    getUINativeModule().tabs.setWidthAuto(true, value);
  }

  static height(value: any): void {
    getUINativeModule().tabs.setHeightAuto(true, value);
  }

  static cachedMaxCount(value: any, additional: any): void {
    getUINativeModule().tabs.setCachedMaxCount(true, value, additional);
  }

  static customContentTransition(value: any): void {
    getUINativeModule().tabs.setTabsCustomContentTransition(true, value);
  }

  static index(value: any): void {
    getUINativeModule().tabs.setTabsOptionsIndex(true, value);
  }
...
function exportComponent(): void {
  globalThis.ArkTabsComponent = (loadComponent as any).componentObj?.component;
}

function exportView(): void {
  globalThis.Tabs = JSTabs;
}
