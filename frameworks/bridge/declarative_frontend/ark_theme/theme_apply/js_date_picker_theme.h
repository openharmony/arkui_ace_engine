...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_THEME_JS_DATEPICKER_THEME_H
...
public:
    static bool ApplyTheme()
    {
        ...
        DatePickerModel::GetInstance()->SetSelectedTextStyle(themePicker, textStyle);
        ...
        DatePickerModel::GetInstance()->SetDisappearTextStyle(themePicker, textStyle);
        ...
        DatePickerModel::GetInstance()->SetNormalTextStyle(themePicker, textStyle);
...
#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_THEME_JS_DATEPICKER_THEME_H