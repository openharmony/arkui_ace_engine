...
public:
    static void ApplyTheme()
    {
        ...
        customModifier->getInstance()->SetTextColor(themeColors.value().FontPrimary());
        customModifier->getInstance()->SetPlaceholderColor(themeColors.value().FontSecondary());
        customModifier->getInstance()->SetSearchIconColor(themeColors.value().IconSecondary());
        customModifier->getInstance()->SetCaretColor(themeColors.value().Brand());
        customModifier->getInstance()->SetCancelIconColor(themeColors.value().IconSecondary());
        customModifier->getInstance()->SetSearchButtonFontColor(themeColors.value().FontEmphasize());
        ...
        customModifier->getInstance()->SetSelectedBackgroundColor(selectedColor);
