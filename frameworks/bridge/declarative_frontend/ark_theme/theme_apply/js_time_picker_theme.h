...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_THEME_JS_TIMEPICKER_THEME_H
#define FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_THEME_JS_TIMEPICKER_THEME_H
...
public:
    static bool ApplyTheme()
    {
        ...
        NG::TimePickerModelNG::SetSelectedTextStyle(targetNode, themePicker, textStyle);
        ...
        NG::TimePickerModelNG::SetDisappearTextStyle(targetNode, themePicker, textStyle);
        ...
        NG::TimePickerModelNG::SetNormalTextStyle(targetNode, themePicker, textStyle);
