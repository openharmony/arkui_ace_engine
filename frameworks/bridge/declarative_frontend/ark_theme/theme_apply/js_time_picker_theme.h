...
public:
    static bool ApplyTheme()
    {
        ...
        TimePickerModel::GetInstance()->SetSelectedTextStyle(themePicker, textStyle);
        ...
        TimePickerModel::GetInstance()->SetDisappearTextStyle(themePicker, textStyle);
        ...
        TimePickerModel::GetInstance()->SetNormalTextStyle(themePicker, textStyle);
