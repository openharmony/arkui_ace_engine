...
class ArkXComponentComponent implements CommonMethod<XComponentAttribute> {
  ...
  transition(value: TransitionOptions | TransitionEffect<keyof TransitionEffects, number | TransitionEdge | TranslateOptions | RotateOptions | ScaleOptions | { appear: TransitionEffect<keyof TransitionEffects, number | TransitionEdge | TranslateOptions | RotateOptions | ScaleOptions | any>; disappear: TransitionEffect<keyof TransitionEffects, number | TransitionEdge | TranslateOptions | RotateOptions | ScaleOptions | any>; }>): this {
    throw new Error("Method not implemented.");
  }
  ...
  useSizeType(value: { xs?: number | { span: number; offset: number; }; sm?: number | { span: number; offset: number; }; md?: number | { span: number; offset: number; }; lg?: number | { span: number; offset: number; }; }): this {
    throw new Error("Method not implemented.");
  }
  ...
  linearGradient(value: { angle?: string | number; direction?: GradientDirection; colors: any[]; repeating?: boolean; }): this {
    throw new Error("Method not implemented.");
  }
  sweepGradient(value: { center: any[]; start?: string | number; end?: string | number; rotation?: string | number; colors: any[]; repeating?: boolean; }): this {
    throw new Error("Method not implemented.");
  }
  radialGradient(value: { center: any[]; radius: string | number; colors: any[]; repeating?: boolean; }): this {
    throw new Error("Method not implemented.");
  }
