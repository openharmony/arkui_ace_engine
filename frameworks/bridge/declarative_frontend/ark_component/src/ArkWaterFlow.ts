...
globalThis.WaterFlow.onWillScroll = function (value: (xOffset: number, yOffset: number, scrollState: ScrollState, scrollSource: ScrollSource) => void | OffsetResult): void {
  let nodePtr = getUINativeModule().frameNode.getStackTopNode();
