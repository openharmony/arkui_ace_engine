...
class ArkContainerReaderComponent extends ArkComponent {
...
class ContainerReader extends JSContainerBase {
  static create(params, build) {
    getUINativeModule().loadNativeModule('ContainerReader');
    getUINativeModule().containerreader.create(params, build);
  }
  static breakpointConfig(config) {
    getUINativeModule().containerreader.breakpointConfig(config);
  }
  static attributeModifier(modifier) {
    attributeModifierFunc.call(this, modifier, (nativePtr) => {
        return new ArkContainerReaderComponent(nativePtr);
    }, (nativePtr, classType, modifierJS) => {
        return new modifierJS.ContainerReaderModifier(nativePtr, classType);
    });
  }
