...
public:
    ...
    static ArkUINativeModuleValue CreatePreviewMock(ArkUIRuntimeCallInfo* runtimeCallInfo);
...
private:
    ...
    static void RegisterPreviewMockAttributes(Local<panda::ObjectRef> object, EcmaVM* vm);
