...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_LAZY_WATER_FLOW_LAYOUT_BRIDGE_H
#define FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_LAZY_WATER_FLOW_LAYOUT_BRIDGE_H

#include "bridge/declarative_frontend/engine/jsi/nativeModule/arkts_native_api_bridge.h"

namespace OHOS::Ace::NG {
class LazyWaterFlowLayoutBridge {
public:
    static void RegisterLazyWaterFlowLayoutAttributes(Local<panda::ObjectRef> object, EcmaVM* vm);
...
public:
    static void RegisterLazyVWaterFlowLayoutAttributes(Local<panda::ObjectRef> object, EcmaVM* vm);
    ...
    static ArkUINativeModuleValue SetItemFillPolicy(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue ResetItemFillPolicy(ArkUIRuntimeCallInfo* runtimeCallInfo);
};
} // namespace OHOS::Ace::NG

#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_LAZY_WATER_FLOW_LAYOUT_BRIDGE_H
