...
public:
    ...
    static ArkUINativeModuleValue SetRenderType(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue GetRenderType(ArkUIRuntimeCallInfo* runtimeCallInfo);
