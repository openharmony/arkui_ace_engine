...
public:
    ...
    static ArkUINativeModuleValue SetScrollBarHeight(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue ResetScrollBarHeight(ArkUIRuntimeCallInfo* runtimeCallInfo);
