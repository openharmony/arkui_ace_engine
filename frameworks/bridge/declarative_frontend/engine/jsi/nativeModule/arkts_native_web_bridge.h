...
public:
    ...
    static ArkUINativeModuleValue SetSelectedDataDetectorConfig(ArkUIRuntimeCallInfo* runtimeCallInfo);
    static ArkUINativeModuleValue ResetSelectedDataDetectorConfig(ArkUIRuntimeCallInfo* runtimeCallInfo);
