...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_SYMBOL_GLYPH_BRIDGE_H
#define FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_SYMBOL_GLYPH_BRIDGE_H
...
public:
    ...
    static ArkUINativeModuleValue SetSymbolId(ArkUIRuntimeCallInfo* runtimeCallInfo);
...
#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_NATIVEMODULE_ARKTS_NATIVE_SYMBOL_GLYPH_BRIDGE_H
