...
| Static API | `<OH_ROOT>/interface/sdk-js/api/arkui/component/image.static.d.ets` | 静态 ArkTS Image 组件和属性声明，包含 `DrawableDescriptor` 数据源类型 |
...
| DrawableDescriptor API | `<OH_ROOT>/interface/sdk-js/api/@ohos.arkui.drawableDescriptor.d.ts`、`<OH_ROOT>/interface/sdk-js/api/@ohos.arkui.drawableDescriptor.static.d.ets` | Image 可接收的 DrawableDescriptor 数据源声明 |
