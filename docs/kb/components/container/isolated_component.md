...
| Accessibility Adapter | `frameworks/core/components_ng/pattern/ui_extension/accessibility_session_adapter_isolated_component.h` | Isolated 无障碍适配 |
...
与 UIExtensionComponent 共享 Session / Window、Ability Manager 和 Accessibility 依赖，参见 UIExtensionComponent KB 外部依赖入口。
