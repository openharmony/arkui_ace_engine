...
- [custom-component](../../frontend/state_management/custom-component.md) — 自定义组件机制（FuncID 07-03-01）
- [static-custom-component](../../frontend/state_management/static-custom-component.md) — 静态自定义组件状态相关（FuncID 07-03-07）
- [component-reuse-framework](../../architecture/component-reuse-framework.md) — 组件复用框架（FuncID 04-19-01）
- [transition-animation](../../capabilities/transition-animation.md) — 转场动画（FuncID 03-02-05）
- [geometry-transition](../../capabilities/geometry-transition.md) — 组件共享元素动画（FuncID 03-02-07）