...
- [ui-extension-component](../../components/container/ui-extension-component.md) — UIExtensionComponent，FuncID `05-12-03`
- [embedded-component](../../components/container/embedded-component.md) — EmbeddedComponent，FuncID `05-12-04`
- [ui-extension-component](../../components/container/ui-extension-component.md) — UIExtension 机制，FuncID `04-17-01`
- [window-mechanism](../../architecture/window-mechanism.md) — Pipeline 窗口显示/隐藏与状态分发，FuncID `03-05-01`