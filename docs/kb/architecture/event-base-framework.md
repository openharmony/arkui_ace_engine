...
- [触摸事件](../capabilities/touch-events.md)
- [按键事件](../capabilities/key-events.md)
- [事件分发和拦截](../capabilities/event-dispatch-intercept.md)
- [组件组合键](../capabilities/component-shortcuts.md)
- [鼠标事件](../capabilities/mouse-events.md)
- [手势能力](../capabilities/gesture-capability.md)