...
| 安全区导致约束或位置变化 | `docs/kb/capabilities/safe-area.md`；再回到 `test/unittest/core/layout/safe_area/` |
...
- 像素取整：[docs/kb/capabilities/pixel-rounding.md](../capabilities/pixel-rounding.md)
- [安全区域机制：[docs/kb/capabilities/safe-area.md](../capabilities/safe-area.md)](../capabilities/safe-area.md)
- 分割布局：[docs/kb/components/container/column-split.md](../components/container/column-split.md)、[docs/kb/components/container/row-split.md](../components/container/row-split.md)
- 相对布局：[docs/kb/components/container/relative-container.md](../components/container/relative-container.md)
- 动态布局：[docs/kb/components/container/dynamic-layout.md](../components/container/dynamic-layout.md)
