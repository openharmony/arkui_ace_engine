...
- [安全区域机制：`docs/kb/capabilities/safe-area.md`](../capabilities/safe-area.md)
- 分割布局：`docs/kb/components/container/column-split.md`、`docs/kb/components/container/row-split.md`
- 相对布局：`docs/kb/components/container/relative-container.md`
- 动态布局：`docs/kb/components/container/dynamic-layout.md`
