...
- [背景图片通用属性：[docs/kb/capabilities/background-image.md](background-image.md)](background-image.md)
- 样式属性：[docs/kb/capabilities/style-attributes.md](style-attributes.md)
- 图片加载：[docs/kb/capabilities/image-loading.md](image-loading.md)
- [DrawableDescriptor：[docs/kb/capabilities/drawable-descriptor.md](drawable-descriptor.md)](drawable-descriptor.md)
