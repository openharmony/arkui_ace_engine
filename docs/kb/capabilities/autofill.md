...
| TextFieldManager（触发管线 + MSDP，Feat-03/04） | `frameworks/core/common/text_field_manager_ng.h`、`frameworks/core/common/text_field_manager_ng.cpp` | `ParseMSDPAutoFillJsonValue` 等 + TextFieldInfo 结构 |
