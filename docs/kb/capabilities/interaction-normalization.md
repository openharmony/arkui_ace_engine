...
- [滚动公共能力：`docs/kb/capabilities/scroll-common-capability.md`。滚动容器的摩擦、惯性、回弹和嵌套滚动不属于本主题。](scroll-common-capability.md)
- [预览器平台适配：`docs/kb/architecture/preview-platform-adaptation.md`。用于定位 Previewer 与 OHOS 输入接入差异。](../architecture/preview-platform-adaptation.md)
