...
- 静态 V1 装饰器具体语义：`docs/kb/frontend/state_management/static-v1-decorators.md`
- 动态侧 V1 核心（对照参考）：`docs/kb/frontend/state_management/v1-core.md`
- 静态 V2 核心：`docs/kb/frontend/state_management/static-v2-core.md`
- 跨前端互操作：`docs/kb/frontend/state_management/static-interop-bridge.md`
- [静态存储体系：`docs/kb/frontend/state_management/static-storage.md`](static-storage.md)