...
- 静态 V2 装饰器具体语义：`docs/kb/frontend/state_management/static-v2-decorators.md`
- 静态 V2 数据对象（`@ObservedV2`/`@Trace` UIPlugin 转换）：`docs/kb/frontend/state_management/static-v2-decorators.md`（数据对象段）
- 动态侧 V2 核心（对照参考）：`docs/kb/frontend/state_management/v2-core.md`
