...
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_START_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_STEP_NAME = "step";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_STEP_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_LOOP_NAME = "loop";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_LOOP_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_FROM_START_NAME = "fromStart";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_FROM_START_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_DELAY_NAME = "delay";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_DELAY_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_FADEOUT_NAME = "fadeout";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_FADEOUT_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_MARQUEE_START_POLICY_NAME = "marqueeStartPolicy";
const auto ATTRIBUTE_MARQUEE_OPTIONS_I_MARQUEE_START_POLICY_DEFAULT_VALUE = "!NOT-DEFINED!";
