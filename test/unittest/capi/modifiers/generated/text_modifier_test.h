...
const auto ATTRIBUTE_FONT_WEIGHT_I_OPTIONS_NAME = "options";
...
const auto ATTRIBUTE_FONT_WEIGHT_I_WEIGHT_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_FONT_WEIGHT_I_OPTIONS_I_ENABLE_VARIABLE_FONT_WEIGHT_NAME = "enableVariableFontWeight";
const auto ATTRIBUTE_FONT_WEIGHT_I_OPTIONS_I_ENABLE_VARIABLE_FONT_WEIGHT_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_TEXT_ALIGN_NAME = "textAlign";
const auto ATTRIBUTE_TEXT_ALIGN_DEFAULT_VALUE = "!NOT-DEFINED!";
...
const auto ATTRIBUTE_BASELINE_OFFSET_DEFAULT_VALUE = "!NOT-DEFINED!";
