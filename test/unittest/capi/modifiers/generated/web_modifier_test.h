...
const auto ATTRIBUTE_ENABLE_FULLSCREEN_VIDEO_OVERLAY_NAME = "enableFullscreenVideoOverlay";
const auto ATTRIBUTE_ENABLE_FULLSCREEN_VIDEO_OVERLAY_DEFAULT_VALUE = "false";
