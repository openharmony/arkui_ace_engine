...
const auto ATTRIBUTE_VALUE_I_PLACEHOLDER_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_VALUE_I_TEXT_NAME = "text";
const auto ATTRIBUTE_VALUE_I_TEXT_DEFAULT_VALUE = "!NOT-DEFINED!";
...
const auto ATTRIBUTE_TEXT_INDENT_DEFAULT_VALUE = "0.00px";
...
const auto ATTRIBUTE_SHOW_UNDERLINE_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_TYPING_NAME = "typing";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_TYPING_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_NORMAL_NAME = "normal";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_NORMAL_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_ERROR_NAME = "error";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_ERROR_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_DISABLE_NAME = "disable";
const auto ATTRIBUTE_UNDERLINE_COLOR_I_DISABLE_DEFAULT_VALUE = "!NOT-DEFINED!";
...
const auto ATTRIBUTE_SHOW_COUNTER_I_VALUE_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_SHOW_COUNTER_I_OPTIONS_I_THRESHOLD_PERCENTAGE_NAME = "thresholdPercentage";
const auto ATTRIBUTE_SHOW_COUNTER_I_OPTIONS_I_THRESHOLD_PERCENTAGE_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_SHOW_COUNTER_I_OPTIONS_I_HIGHLIGHT_BORDER_NAME = "highlightBorder";
const auto ATTRIBUTE_SHOW_COUNTER_I_OPTIONS_I_HIGHLIGHT_BORDER_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_CANCEL_BUTTON_I_STYLE_NAME = "style";
const auto ATTRIBUTE_CANCEL_BUTTON_I_STYLE_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_SIZE_NAME = "size";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_SIZE_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_COLOR_NAME = "color";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_COLOR_DEFAULT_VALUE = "!NOT-DEFINED!";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_SRC_NAME = "src";
const auto ATTRIBUTE_CANCEL_BUTTON_I_ICON_I_SRC_DEFAULT_VALUE = "!NOT-DEFINED!";
