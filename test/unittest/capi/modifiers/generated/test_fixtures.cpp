...
std::vector<std::tuple<std::string, Ark_Number, std::string>> testFixtureWeekDaysValidValues = {
    { "0", Converter::ArkValue<Ark_Number>(0), "Week.Mon" },
    { "1", Converter::ArkValue<Ark_Number>(1), "Week.Tue" },
    { "2", Converter::ArkValue<Ark_Number>(2), "Week.Wed" },
    { "3", Converter::ArkValue<Ark_Number>(3), "Week.Tur" },
    { "4", Converter::ArkValue<Ark_Number>(4), "Week.Fri" },
    { "5", Converter::ArkValue<Ark_Number>(5), "Week.Sat" },
    { "6", Converter::ArkValue<Ark_Number>(6), "Week.Sun" },
};

std::vector<std::tuple<std::string, Ark_Number>> testFixtureWeekDaysInvalidValues = {
    { "-1", Converter::ArkValue<Ark_Number>(-1) },
    { "7", Converter::ArkValue<Ark_Number>(7) },
    { "8", Converter::ArkValue<Ark_Number>(8) },
};

// Fixture 'OffDayBits' for type 'Ark_Number'
std::vector<std::tuple<std::string, Ark_Number, std::string>> testFixtureOffDayBitsValidValues = {
    { "0x01", Converter::ArkValue<Ark_Number>(0x01), "0" },
    { "0x02", Converter::ArkValue<Ark_Number>(0x02), "1" },
    { "0x04", Converter::ArkValue<Ark_Number>(0x04), "2" },
    { "0x08", Converter::ArkValue<Ark_Number>(0x08), "3" },
    { "0x10", Converter::ArkValue<Ark_Number>(0x10), "4" },
    { "0x20", Converter::ArkValue<Ark_Number>(0x20), "5" },
    { "0x41", Converter::ArkValue<Ark_Number>(0x41), "0,6" },
    { "0x60", Converter::ArkValue<Ark_Number>(0x60), "5,6" },
    { "0x25", Converter::ArkValue<Ark_Number>(0x25), "0,2,6" },
    { "0xdead30", Converter::ArkValue<Ark_Number>(0xdead30), "4,5" },
};

std::vector<std::tuple<std::string, Ark_Number>> testFixtureOffDayBitsInvalidValues = {
    { "-1", Converter::ArkValue<Ark_Number>(-1) },
    { "0x80", Converter::ArkValue<Ark_Number>(0x80) },
};

// Fixture 'IntAxis' for type 'Ark_Axis'
std::vector<std::tuple<std::string, Ark_Axis, std::string>> testFixtureIntAxisValidValues = {
...
std::vector<std::tuple<std::string, Ark_Axis>> testFixtureIntAxisInvalidValues = {
