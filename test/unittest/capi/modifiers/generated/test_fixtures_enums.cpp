...
std::vector<std::tuple<std::string, Ark_DragPreviewMode, std::string>> testFixtureEnumDragPreviewModeValidValues = {
    ...
    { "ARK_DRAG_PREVIEW_MODE_ENABLE_TOUCH_POINT_CALCULATION_BASED_ON_FINAL_PREVIEW",
        ARK_DRAG_PREVIEW_MODE_ENABLE_TOUCH_POINT_CALCULATION_BASED_ON_FINAL_PREVIEW,
        "DragPreviewMode.ENABLE_TOUCH_POINT_CALCULATION_BASED_ON_FINAL_PREVIEW" },
};
...
std::vector<std::tuple<std::string, Ark_DraggingSizeChangeEffect, std::string>>
    testFixtureEnumDraggingSizeChangeEffectValidValues = {
        { "ARK_DRAGGING_SIZE_CHANGE_EFFECT_DEFAULT", ARK_DRAGGING_SIZE_CHANGE_EFFECT_DEFAULT,
            "DraggingSizeChangeEffect.DEFAULT" },
        { "ARK_DRAGGING_SIZE_CHANGE_EFFECT_SIZE_TRANSITION", ARK_DRAGGING_SIZE_CHANGE_EFFECT_SIZE_TRANSITION,
            "DraggingSizeChangeEffect.SIZE_TRANSITION" },
        { "ARK_DRAGGING_SIZE_CHANGE_EFFECT_SIZE_CONTENT_TRANSITION",
            ARK_DRAGGING_SIZE_CHANGE_EFFECT_SIZE_CONTENT_TRANSITION,
            "DraggingSizeChangeEffect.SIZE_CONTENT_TRANSITION" },
    };

std::vector<std::tuple<std::string, Ark_DraggingSizeChangeEffect>>
    testFixtureEnumDraggingSizeChangeEffectInvalidValues = {
        { "-1", static_cast<Ark_DraggingSizeChangeEffect>(-1) },
        { "INT_MAX", static_cast<Ark_DraggingSizeChangeEffect>(INT_MAX) },
    };
