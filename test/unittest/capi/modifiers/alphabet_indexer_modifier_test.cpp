...
const std::vector<OptLengthTestStep> POPUP_HORIZONTAL_OFFSET_TEST_PLAN = {
    ...
    { Converter::ArkValue<Opt_Length>(99.0_pct), "99.00%" },
    { Converter::ArkValue<Opt_Length>(13.0_vp), "13.00vp" },
    { Converter::ArkValue<Opt_Length>(-55.0_pct), ATTRIBUTE_POPUP_HORIZONTAL_SPACE_DEFAULT_VALUE },
    { Converter::ArkValue<Opt_Length>(55.0_pct), "55.00%" },
...
static const std::vector<PopupPositionTestStep> POPUP_POSITION_TEST_PLAN = {
    ...
    { Converter::ArkValue<Ark_Length>(99.0_pct), "99.00%" },
    { Converter::ArkValue<Ark_Length>(13.0_vp), "13.00vp" },
    { Converter::ArkValue<Ark_Length>(-55.0_pct), "-55.00%" },
    { Converter::ArkValue<Ark_Length>(55.0_pct), "55.00%" },
