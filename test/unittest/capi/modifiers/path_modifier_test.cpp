...
HWTEST_F(PathModifierTest, setPathOptionsTestSizeValidValues, TestSize.Level1)
{
    ...
    std::string resultStr;
    Opt_Type_PathInterface_setPathOptions_Arg0 realInputValue = {.tag = ARK_TAG_OBJECT, .value = {}};
    Type_PathInterface_setPathOptions_Arg0& inputValueOptions = realInputValue.value;
