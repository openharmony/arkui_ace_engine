...
const auto ATTRIBUTE_SIDE_LENGTH_DEFAULT_VALUE = "300.00vp";
const auto ATTRIBUTE_CIRCLE_RADIUS_NAME = "circleRadius";
const auto ATTRIBUTE_CIRCLE_RADIUS_DEFAULT_VALUE = "14.00vp";
...
const auto ATTRIBUTE_PATH_COLOR_DEFAULT_VALUE = "#FF0000FF";
