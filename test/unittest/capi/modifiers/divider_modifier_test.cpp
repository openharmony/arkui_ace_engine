...
const std::vector<OneColorStep> COLOR_TEST_PLAN = {
    ...
    { Converter::ArkUnion<Ark_ResourceColor, Ark_Number>(Converter::ArkValue<Ark_Number>(0.5f)), "#FF000000" },
    ...
    { CreateResourceUnion<Ark_ResourceColor>(NamedResourceId{"aa.bb.cc", Converter::ResourceType::COLOR}),
        "#FF000000" },
    { CreateResourceUnion<Ark_ResourceColor>(IntResourceId{1234, Converter::ResourceType::COLOR}), "#FF000000" },
