...
const std::vector<OneColorStep> COLOR_TEST_PLAN = {
    ...
    { Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(Converter::ArkValue<Ark_Number>(0x123456)), "#FF123456" },
    { Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(Converter::ArkValue<Ark_Number>(0.5f)), "#00000000" },
