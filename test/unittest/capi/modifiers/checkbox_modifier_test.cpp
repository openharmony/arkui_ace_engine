...
HWTEST_F(CheckboxModifierTest, setSelectTestValidValues, TestSize.Level1)
{
    ...
    for (auto&& value: selectSelectValidValues) {
        auto inputValueSelect = Converter::ArkUnion<Opt_Union_Boolean_Bindable_Boolean, Ark_Boolean>(std::get<1>(value));
...
static std::vector<std::tuple<std::string, Ark_ResourceColor, std::string>> selectedColorSelectedColorValidValues = {
    { "ARK_COLOR_BLUE", Converter::ArkUnion<Ark_ResourceColor, Ark_arkui_component_enums_Color>(ARK_ARKUI_COMPONENT_ENUMS_COLOR_BLUE), "#FF0000FF" },
    { "ARK_COLOR_RED", Converter::ArkUnion<Ark_ResourceColor, Ark_arkui_component_enums_Color>(ARK_ARKUI_COMPONENT_ENUMS_COLOR_RED), "#FFFF0000" },
};
