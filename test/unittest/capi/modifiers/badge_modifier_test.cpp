...
HWTEST_F(BadgeModifierTest, setBadgeOptions0TestValidValues, TestSize.Level1)
{
    ...
    inputValueOptions.style = {
        ...
        .borderColor =
            Converter::ArkValue<Opt_ResourceColor>(Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(0xFF0000FF)),
...
HWTEST_F(BadgeModifierTest, setBadgeOptions1TestValidValues, TestSize.Level1)
{
    ...
    inputValueOptions.style = {
        .color = Converter::ArkValue<Opt_ResourceColor>(Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(0xFF00FFFF)),
