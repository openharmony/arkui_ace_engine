...
const auto THEME_FONT_SIZE = Dimension(123, DimensionUnit::PX);
...
const auto DEFAULT_THEME_FONT_SIZE = "123.00px";
const auto DEFAULT_THEME_FONT_WEIGHT = "FontWeight.Regular";
...
const auto ATTRIBUTE_FONT_I_SIZE_DEFAULT_VALUE = DEFAULT_FONT_SIZE;
const auto ATTRIBUTE_FONT_I_WEIGHT_NAME = "weight";
const auto ATTRIBUTE_FONT_I_WEIGHT_DEFAULT_VALUE = DEFAULT_FONT_WEIGHT;
const auto ATTRIBUTE_FONT_I_FAMILY_NAME = "family";
const auto ATTRIBUTE_FONT_I_FAMILY_DEFAULT_VALUE = DEFAULT_FONT_FAMILY;
const auto ATTRIBUTE_FONT_I_STYLE_NAME = "style";
const auto ATTRIBUTE_FONT_I_STYLE_DEFAULT_VALUE = DEFAULT_FONT_STYLE;
...
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_SIZE_DEFAULT_VALUE = DEFAULT_FONT_SIZE;
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_WEIGHT_NAME = "weight";
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_WEIGHT_DEFAULT_VALUE = DEFAULT_FONT_WEIGHT;
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_FAMILY_NAME = "family";
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_FAMILY_DEFAULT_VALUE = DEFAULT_FONT_FAMILY;
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_STYLE_NAME = "style";
const auto ATTRIBUTE_SELECTED_OPTION_FONT_I_STYLE_DEFAULT_VALUE = DEFAULT_FONT_STYLE;
...
const auto ATTRIBUTE_OPTION_FONT_I_SIZE_DEFAULT_VALUE = DEFAULT_THEME_FONT_SIZE; // as set in theme
const auto ATTRIBUTE_OPTION_FONT_I_WEIGHT_NAME = "weight";
const auto ATTRIBUTE_OPTION_FONT_I_WEIGHT_DEFAULT_VALUE = "FontWeight.Regular";
const auto ATTRIBUTE_OPTION_FONT_I_FAMILY_NAME = "family";
const auto ATTRIBUTE_OPTION_FONT_I_FAMILY_DEFAULT_VALUE = DEFAULT_FONT_FAMILY;
const auto ATTRIBUTE_OPTION_FONT_I_STYLE_NAME = "style";
const auto ATTRIBUTE_OPTION_FONT_I_STYLE_DEFAULT_VALUE = DEFAULT_FONT_STYLE;
const auto ATTRIBUTE_OPTION_FONT_COLOR_NAME = "optionFontColor";
const auto ATTRIBUTE_OPTION_FONT_COLOR_DEFAULT_VALUE = THEME_FONT_COLOR.ToString();
const auto ATTRIBUTE_SPACE_NAME = "space";
const auto ATTRIBUTE_SPACE_DEFAULT_VALUE = "23.00px";
const auto ATTRIBUTE_ARROW_POSITION_NAME = "arrowPosition";
const auto ATTRIBUTE_ARROW_POSITION_DEFAULT_VALUE = "ArrowPosition.END";
const auto ATTRIBUTE_OPTION_WIDTH_NAME = "optionWidth";
const auto ATTRIBUTE_OPTION_WIDTH_DEFAULT_VALUE = "0.000000";
const auto ATTRIBUTE_OPTION_HEIGHT_NAME = "optionHeight";
const auto ATTRIBUTE_OPTION_HEIGHT_DEFAULT_VALUE = "0.000000";
const auto ATTRIBUTE_MENU_BACKGROUND_COLOR_NAME = "menuBackgroundColor";
const auto ATTRIBUTE_MENU_BACKGROUND_COLOR_DEFAULT_VALUE = Color::TRANSPARENT.ToString();
const auto ATTRIBUTE_MENU_BACKGROUND_BLUR_STYLE_NAME = "menuBackgroundBlurStyle";
const auto ATTRIBUTE_MENU_BACKGROUND_BLUR_STYLE_DEFAULT_VALUE = "BlurStyle.COMPONENT_ULTRA_THICK";
...
const auto ATTRIBUTE_MENU_ALIGN_I_ALIGN_TYPE_DEFAULT_VALUE = "MenuAlignType.Start";
const auto ATTRIBUTE_MENU_ALIGN_I_OFFSET_I_DX_NAME = "dx";
const auto ATTRIBUTE_MENU_ALIGN_I_OFFSET_I_DX_DEFAULT_VALUE = "0";
const auto ATTRIBUTE_MENU_ALIGN_I_OFFSET_I_DY_NAME = "dy";
const auto ATTRIBUTE_MENU_ALIGN_I_OFFSET_I_DY_DEFAULT_VALUE = "0";
...
public:
    static void SetUpTestCase()
    {
        ...
        themeStyle->SetAttr("menu_text_font_size", { .value = THEME_FONT_SIZE });
        themeStyle->SetAttr("bg_color_select_button", { .value = THEME_BACKGROUND_COLOR });
     
        SetupTheme<SelectTheme>();
        SetupTheme<IconTheme>();

        themeStyle = SetupThemeStyle("text_pattern");
        themeStyle->SetAttr("text_font_weight", { .value = static_cast<double>(FontWeight::REGULAR) });
