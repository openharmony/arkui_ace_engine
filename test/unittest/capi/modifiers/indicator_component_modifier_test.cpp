...
static const std::vector<std::pair<Ark_Number, std::string>> TEST_POSITIVE_INTEGER_PLAN {
    {ArkValue<Ark_Number>(1234), "1234"},
    {ArkValue<Ark_Number>(5.67f), "5"},
    {ArkValue<Ark_Number>(INT32_MIN), "0"},
    {ArkValue<Ark_Number>(-123434.435f), "0"},
};
} // namespace
...
HWTEST_F(IndicatorComponentModifierTests, setStyleTestDotLayoutValid, TestSize.Level1)
{
    ...
    auto arkParam = ArkUnion<Ark_Union_DotIndicator_DigitIndicator, Ark_DotIndicator>(arkDotIndicator);
...
HWTEST_F(IndicatorComponentModifierTests, setStyleTestDigitLayoutValid, TestSize.Level1)
{
    ...
    ASSERT_NE(modifier_->setStyle, nullptr);
    auto arkParam = ArkUnion<Ark_Union_DotIndicator_DigitIndicator, Ark_DigitIndicator>(arkDigitIndicator);
    modifier_->setStyle(node_, &arkParam);
    OnModifyDone();
