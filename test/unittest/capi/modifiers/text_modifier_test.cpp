...
/**
 * @tc.name: setTailIndentsTest001
 * @tc.desc: Test single value tailIndents
 * @tc.type: FUNC
 */
...
/**
 * @tc.name: setTailIndentsTest002
 * @tc.desc: Test array with mixed values including negative and percent
 * @tc.type: FUNC
 */
HWTEST_F(TextModifierTest, setTailIndentsTest002, TestSize.Level1)
{
    std::vector<Ark_LengthMetrics> metricsArray;
    metricsArray.push_back(Converter::ArkValue<Ark_LengthMetrics>(Dimension(50.0, DimensionUnit::VP)));
    metricsArray.push_back(Converter::ArkValue<Ark_LengthMetrics>(Dimension(-10.0, DimensionUnit::VP)));
