...
using Opt_Union_ResourceStr_Bindable_Bindable_Bindable = Opt_Union_ResourceStr_Bindable_ResourceStr_Bindable_Resource_Bindable_String;
using Ark_Union_ResourceStr_Bindable_Bindable_Bindable = Ark_Union_ResourceStr_Bindable_ResourceStr_Bindable_Resource_Bindable_String;
