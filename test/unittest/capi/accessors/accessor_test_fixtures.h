...
extern std::vector<std::tuple<std::string, Ark_Boolean, bool>> testFixtureBooleanValues;
extern std::vector<std::tuple<std::string, Ark_Int32, int32_t>> testFixtureInt32WithNegativeValues;
}
#endif