...
HWTEST_F(TabsControllerAccessorTest, preloadItemsTest, TestSize.Level1)
{
    ...
    accessor_->preloadItems(vmContext_, peer_, &validValue, &cont);
    ...
    accessor_->preloadItems(vmContext_, peer_, &invalidValue, &cont);
    accessor_->preloadItems(vmContext_, peer_, nullptr, &cont);
}
