...
HWTEST_F(PathShapeAccessorTest, fillTest, TestSize.Level1)
{
    ...
    static const std::vector<FillTestStep> FILL_TEST_PLAN = {
        ...
        // Ark_Number
        {Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(Converter::ArkValue<Ark_Float64>(0x11223344)),
            Color(0x11223344)},
        {Converter::ArkUnion<Ark_ResourceColor, Ark_Float64>(Converter::ArkValue<Ark_Float64>(0xAABBCCDD)),
            Color(0xAABBCCDD)},
        // Ark_String
