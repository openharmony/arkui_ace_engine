 ...
 * @tc.type: FUNC
 */
HWTEST_F(RotationGestureInterfaceAccessorTest, onActionCancelTest, TestSize.Level1)
{
    static std::optional<RotationEvent> rotationEvent = std::nullopt;
    auto onActionCancelFunc = [](const Ark_Int32 resourceId) {
        rotationEvent = {
            .resourceId = Converter::Convert<int32_t>(resourceId),
        };
    };
