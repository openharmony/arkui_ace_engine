...
HWTEST_F(ImageDataAccessorTest, CtorTest, TestSize.Level1)
{
    ...
    peer_ = reinterpret_cast<ImageDataPeer*>(accessor_->ctor(&arkWidth, &arkHeight, &bufferOpt, nullptr));
...
HWTEST_F(ImageDataAccessorTest, CtorInvalidValuesTest, TestSize.Level1)
{
    ...
    peer_ = reinterpret_cast<ImageDataPeer*>(accessor_->ctor(nullptr, &arkHeight, &bufferOpt, nullptr));
    EXPECT_EQ(peer_, nullptr);
    peer_ = reinterpret_cast<ImageDataPeer*>(accessor_->ctor(&arkWidth, nullptr, &bufferOpt, nullptr));
    EXPECT_EQ(peer_, nullptr);
    peer_ = reinterpret_cast<ImageDataPeer*>(accessor_->ctor(&arkWidth, &arkHeight, nullptr, nullptr));
