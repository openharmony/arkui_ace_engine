...
// test plan
std::vector<std::tuple<Ark_Float64, double>> ARK_NUMBER_TEST_PLAN = {
...
std::vector<std::tuple<Ark_Float64, double>> ARK_NUMBER_ALPHA_TEST_PLAN = {
    { Converter::ArkValue<Ark_Float64>(100.), 100 },
    { Converter::ArkValue<Ark_Float64>(0.), 0 },
...
HWTEST_F(CanvasRendererAccessorTest, setLineDashTest, TestSize.Level1)
{
    ...
    for (const auto& [actual, expected] : ARRAY_LINE_DASH_TEST_PLAN) {
        const auto segments = Converter::ArkValue<Array_F64>(actual, Converter::FC);
