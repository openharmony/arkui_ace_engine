 ...
 * @tc.type: FUNC
 */
HWTEST_F(AccessibilityHoverEventAccessorTest, accessibilityHoverEventAcrGetTypeTest, TestSize.Level1)
{
    ...
    for (auto& [actual, expected] : accessibilityHoverTypeTestPlan) {
        ...
        auto type = Converter::OptConvert<AccessibilityHoverAction>(result);
        ASSERT_NE(type.has_value(), false);
