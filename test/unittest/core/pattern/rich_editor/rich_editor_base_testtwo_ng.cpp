 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController008, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController009, TestSize.Level1)
{
    auto nodeId = ViewStackProcessor::GetInstance()->ClaimNodeId();
    richEditorNode_ = FrameNode::GetOrCreateFrameNode(
        V2::RICH_EDITOR_ETS_TAG, nodeId, []() { return AceType::MakeRefPtr<RichEditorPattern>(); });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController011, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController016, TestSize.Level1)
{
    /**
     * @tc.steps: step1. get richEditor controller
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorBaseTestTwoNg, RichEditorController020, TestSize.Level1)
{
    /**
