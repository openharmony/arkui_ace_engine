 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetChildByIndex001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetChildByIndex002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, CreateNodePaintMethod001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetSpanItemByIndex001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, BeforeAddImage001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, UnableStandardInput001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, UnableStandardInput002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ProvideabilityNameText, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetTextContentLength001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, CalcLineBeginPosition001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, CalcLineEndPosition, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, MoveTextRect001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, AdjustIndexSkipLineSeparator001, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, AdjustIndexSkipLineSeparator002, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, AdjustIndexSkipLineSeparator003, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, IsTextEditableForStylus001, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, IsTextEditableForStylus002, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, IsTextEditableForStylus003, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
    richEditorPattern->GetFocusHub()->focusType_ = FocusType::DISABLE;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetRightWordPosition002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetRightWordPosition003, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetRightWordPosition004, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetRightWordPosition005, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, GetLeftWordPosition002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, HandleOnEscape001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ClearContent001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ClearContent002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ConvertGlobalToTextOffset001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, AfterContentChange001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ReportAfterContentChangeEvent001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ReportAfterContentChangeEvent002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ReportAfterContentChangeEvent003, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetInputMethodStatus001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, RichEditorToJsonValue001, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, FixMoveDownChange001, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, IsLineSeparatorInLast001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLength001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    int32_t maxLength = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLength002, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLines001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLines002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLines003, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLinesHeight001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLinesHeight002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, SetMaxLinesHeight003, TestSize.Level1)
{
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ReportTextChange001, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RichEditorEditOneTestNg, ReportTextChange002, TestSize.Level1)
{
    ASSERT_NE(richEditorNode_, nullptr);
    auto richEditorPattern = richEditorNode_->GetPattern<RichEditorPattern>();
    ASSERT_NE(richEditorPattern, nullptr);
