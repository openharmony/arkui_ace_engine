...
HWTEST_F(TextPatternNg, TextPatternHandleAISpanHoverEvent001, TestSize.Level1)
{
    ...
    RefPtr<FrameNode> frameNodeRef = AceType::MakeRefPtr<FrameNode>(tag, nodeId, pattern, isRoot, isLayoutNode);
...
HWTEST_F(TextPatternNg, TextPatternHandleUrlTouchEvent001, TestSize.Level1)
{
    ...
    RefPtr<TextSelectOverlay> overlay = AceType::MakeRefPtr<TextSelectOverlay>(textBase);
