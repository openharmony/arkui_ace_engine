 ...
 * @tc.type: FUNC
 */
HWTEST_F(TextTestNgOne, SetTextSelectDetectConfig001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create textModelNG and frameNode.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TextTestNgOne, SetSelectUseSelectDetectConfigFollow001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create textModelNG and frameNode.
     */
...
HWTEST_F(TextTestNgOne, SetSelectUseSelectDetectConfigUserSet001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create textModelNG and frameNode.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TextTestNgOne, TextPattern013, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TextTestNgOne, TextPattern014, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create frameNode
     */
