 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuWrapperPatternTestNg009, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuWrapperPatternTestNg010, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, CustomMenuItemPattern002, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create menuItem.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, CustomMenuItemPattern003, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create menuItem.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuItemLayoutAlgorithm001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create menuItem.
     */
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg4200, TestSize.Level1)
{
    ...
    auto expectMenuOffset = OffsetF(OFFSET_FORTH, OFFSET_THIRD + TARGET_SIZE_HEIGHT + TARGET_SECURITY.ConvertToPx());
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg4300, TestSize.Level1)
{
    ...
    auto expectPreviewOffset =
        OffsetF(OFFSET_FORTH + TOP_POSITION_X, PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(SCALE_OFFSET, SCALE_OFFSET));
    auto expectMenuOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X,
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg4400, TestSize.Level1)
{
    ...
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    auto expectPreviewOffset = OffsetF(OFFSET_FORTH, OFFSET_FORTH);
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, TARGET_SIZE_HEIGHT));
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg4500, TestSize.Level1)
{
    ...
    pipelineContext->SetDisplayWindowRectInfo(Rect(0.0f, 0.0f, FULL_SCREEN_WIDTH, FULL_SCREEN_HEIGHT));
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    auto expectPreviewOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X,
        SCALE_MENU_HEIGHT + TARGET_SECURITY.ConvertToPx() + PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(SCALE_OFFSET, SCALE_OFFSET));
    auto expectMenuOffset = OffsetF(- TARGET_SIZE_WIDTH, - SCALE_MENU_HEIGHT);
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
    EXPECT_EQ(menuGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, SCALE_MENU_HEIGHT));
}
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg4700, TestSize.Level1)
{
    ...
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, OFFSET_THIRD));
    auto expectMenuOffset = OffsetF(- MENU_SIZE_WIDTH_SECOND, - TARGET_SIZE_HEIGHT);
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg5300, TestSize.Level1)
{
    ...
    pipelineContext->SetDisplayWindowRectInfo(Rect(0.0f, 0.0f, FULL_SCREEN_WIDTH, FULL_SCREEN_HEIGHT));
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    auto expectPreviewOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X, PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(SCALE_OFFSET, SCALE_PREVIEW_HEIGHT_THIRD));
    auto expectMenuOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X,
    ...
    menuAlgorithm->placement_ = Placement::TOP_LEFT;
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    expectPreviewOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X,
        PORTRAIT_TOP_SECURITY.ConvertToPx() + TARGET_SIZE_HEIGHT + TARGET_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(SCALE_OFFSET, SCALE_PREVIEW_HEIGHT_THIRD));
    expectMenuOffset = OffsetF(OFFSET_FORTH + TOP_POSITION_X, PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
    EXPECT_EQ(menuGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, TARGET_SIZE_HEIGHT));
}
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg5400, TestSize.Level1)
{
    ...
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    auto expectPreviewOffset = OffsetF(OFFSET_FORTH + OFFSET_FIFTH / 2, PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(OFFSET_FIFTH, SCALE_PREVIEW_HEIGHT_SECOND));
    auto expectMenuOffset = OffsetF(OFFSET_FORTH + OFFSET_FIFTH / 2,
    ...
    previewGeometryNode->SetFrameSize(SizeF(TARGET_SIZE_WIDTH, GREATER_WINDOW_PREVIEW_HEIGHT_SECOND));
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    expectPreviewOffset = OffsetF(OFFSET_FORTH + OFFSET_FIFTH / 2,
        PORTRAIT_TOP_SECURITY.ConvertToPx() + SCALE_MENU_HEIGHT_THIRD + TARGET_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(OFFSET_FIFTH, SCALE_PREVIEW_HEIGHT_SECOND));
    expectMenuOffset = OffsetF(OFFSET_FORTH + OFFSET_FIFTH / 2, PORTRAIT_TOP_SECURITY.ConvertToPx());
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
}
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg5500, TestSize.Level1)
{
    ...
    layoutProperty->UpdateMenuPlacement(Placement::TOP_LEFT);
    menuAlgorithm->Layout(AceType::RawPtr(menuNode));
    auto expectPreviewOffset = OffsetF(OFFSET_FORTH,
        PORTRAIT_TOP_SECURITY.ConvertToPx() + OFFSET_FORTH + TARGET_SECURITY.ConvertToPx());
    EXPECT_EQ(previewGeometryNode->GetFrameOffset(), expectPreviewOffset);
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, TARGET_SIZE_HEIGHT));
    auto expectMenuOffset = OffsetF(- TARGET_SIZE_WIDTH, - OFFSET_FORTH);
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
...
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg5600, TestSize.Level1)
{
    ...
    EXPECT_EQ(previewGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, TARGET_SIZE_HEIGHT));
    auto expectMenuOffset =
        OffsetF(OFFSET_FORTH, FULL_SCREEN_HEIGHT - PORTRAIT_BOTTOM_SECURITY.ConvertToPx() - OFFSET_FORTH);
    EXPECT_EQ(menuGeometryNode->GetFrameOffset(), expectMenuOffset);
    EXPECT_EQ(menuGeometryNode->GetFrameSize(), SizeF(TARGET_SIZE_WIDTH, OFFSET_FORTH));
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, SubMenuLayoutAlgorithmTestNg001, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg5900, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg6000, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create a menuWrapperNode and menuNode.
     * @tc.expected: menuWrapperNode and menuNode are not null.
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuItemPatternTestNg010, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuItemPatternTestNg011, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create a menuWrapperNode and menuNodes.
     * @tc.expected: menuWrapperNode and menuNode are not null.
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmInitTarget, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create menuLayoutAlgorithm and target is null
     * @tc.expected: menuLayoutAlgorithm is not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg029, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create MenuModelNG and MenuItemModelNG object and set FontStyle properties of MenuModelNG.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg030, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg031, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     * @tc.expected: wrapper pattern not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg032, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     * @tc.expected: wrapper pattern not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg033, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     * @tc.expected: wrapper pattern not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg034, TestSize.Level1)
{
    /**
     * @tc.steps: step1. create menu node, preview node and menuLayoutAlgorithm, then set the initial properties
     * @tc.expected: menu node, preview node and menuLayoutAlgorithm are not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg035, TestSize.Level1)
{
    ScreenSystemManager::GetInstance().dipScale_ = DIP_SCALE;
    ScreenSystemManager::GetInstance().screenWidth_ = FULL_SCREEN_WIDTH;
    auto menuWrapperNode = GetPreviewMenuWrapper();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg036, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     * @tc.expected: wrapper pattern not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuPatternTestNg037, TestSize.Level1)
{
    /**
     * @tc.steps: step1. Create wrapper and child menu
     * @tc.expected: wrapper pattern not null
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg042, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MenuTestNg, MenuLayoutAlgorithmTestNg043, TestSize.Level1)
{
    /**
     * @tc.steps: step1. device type is PHONE and orientation is LANDSCAPE, create menu node, preview node and
     * menuLayoutAlgorithm, then set the initial properties
