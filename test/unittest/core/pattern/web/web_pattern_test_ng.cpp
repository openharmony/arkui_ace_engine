...
/**
 * @tc.name: OnTransformRotateAndSkewEnabledUpdate_001
 * @tc.desc: OnTransformRotateAndSkewEnabledUpdate.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternTestNg, OnTransformRotateAndSkewEnabledUpdate_001, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
    ...
    webPattern->OnModifyDone();
    ASSERT_NE(webPattern->delegate_, nullptr);
    webPattern->OnTransformRotateAndSkewEnabledUpdate(true);
#endif
}

/**
 * @tc.name: OnTransformRotateAndSkewEnabledUpdate_002
 * @tc.desc: OnTransformRotateAndSkewEnabledUpdate.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternTestNg, OnTransformRotateAndSkewEnabledUpdate_002, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
    ...
    webPattern->OnModifyDone();
    ASSERT_NE(webPattern->delegate_, nullptr);
    webPattern->OnTransformRotateAndSkewEnabledUpdate(false);
#endif
}

/**
 * @tc.name: OnTransformRotateAndSkewEnabledUpdate_003
 * @tc.desc: OnTransformRotateAndSkewEnabledUpdate.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternTestNg, OnTransformRotateAndSkewEnabledUpdate_003, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
