 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebDataDetectorAdapterTest, SetSelectedDataDetectorConfig_001, TestSize.Level0)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto adapter = AceType::MakeRefPtr<WebDataDetectorAdapter>(AceType::WeakClaim(AceType::RawPtr(g_webPattern)), 0);
    adapter->aiSupportStatus_ = AISupportStatus::SUPPORTED;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebDataDetectorAdapterTest, GetSelectDataDetectorTypes_001, TestSize.Level0)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto adapter = AceType::MakeRefPtr<WebDataDetectorAdapter>(AceType::WeakClaim(AceType::RawPtr(g_webPattern)), 0);
    adapter->aiSupportStatus_ = AISupportStatus::SUPPORTED;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebDataDetectorAdapterTest, GetSelectDataDetectorTypes_002, TestSize.Level0)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto adapter = AceType::MakeRefPtr<WebDataDetectorAdapter>(AceType::WeakClaim(AceType::RawPtr(g_webPattern)), 0);
    adapter->aiSupportStatus_ = AISupportStatus::SUPPORTED;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebDataDetectorAdapterTest, FilterAndMapTypes_001, TestSize.Level0)
{
    std::string input1 = "";
