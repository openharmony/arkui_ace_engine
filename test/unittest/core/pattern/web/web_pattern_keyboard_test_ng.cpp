...
HWTEST_F(WebPatternKeyboardTestNg, FilterScrollEventHandlevVlocity001, TestSize.Level1)
{
    ...
    webPattern->isFlingReachEdge_.atEnd = false;
    ...
    webPattern->isParentReachEdge_ = false;
    webPattern->isFlingReachEdge_.atEnd = true;
...
/**
 * @tc.name: UpdateFlingReachEdgeState001
 * @tc.desc: UpdateFlingReachEdgeState.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternKeyboardTestNg, UpdateFlingReachEdgeState001, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
    ...
    webPattern->isFlingReachEdge_.atStart = true;
    webPattern->isFlingReachEdge_.atEnd = false;
    webPattern->UpdateFlingReachEdgeState(-10.0f, false);
...
/**
 * @tc.name: UpdateFlingReachEdgeState002
 * @tc.desc: UpdateFlingReachEdgeState.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternKeyboardTestNg, UpdateFlingReachEdgeState002, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
...
/**
 * @tc.name: UpdateFlingReachEdgeState003
 * @tc.desc: UpdateFlingReachEdgeState.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternKeyboardTestNg, UpdateFlingReachEdgeState003, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
    ...
    webPattern->isFlingReachEdge_.atStart = false;
    webPattern->isFlingReachEdge_.atEnd = false;
    webPattern->UpdateFlingReachEdgeState(-10.0f, true);
    EXPECT_FALSE(webPattern->isFlingReachEdge_.atStart);
    EXPECT_FALSE(webPattern->isFlingReachEdge_.atEnd);
#endif
}
...
/**
 * @tc.name: UpdateFlingReachEdgeState004
 * @tc.desc: UpdateFlingReachEdgeState.
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternKeyboardTestNg, UpdateFlingReachEdgeState004, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
