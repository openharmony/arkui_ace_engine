...
HWTEST_F(GridScrollLayoutTestNg, SpringAnimationTest010, TestSize.Level1)

{
    ...
    scrollable->HandleDragEnd(info);
    FlushUITasks();
    EXPECT_FLOAT_EQ(pattern_->info_.currentOffset_, -709.38562);
    ...
    FlushUITasks();
    EXPECT_FLOAT_EQ(pattern_->info_.currentOffset_, -269.69281);
...
HWTEST_F(GridScrollLayoutTestNg, SpringAnimationTest011, TestSize.Level1)
{
    ...
    scrollable->HandleDragEnd(info);
    FlushUITasks();
    EXPECT_FLOAT_EQ(pattern_->info_.currentOffset_, -729.38562);
    ...
    FlushUITasks();
    EXPECT_FLOAT_EQ(pattern_->info_.currentOffset_, 60.30719);
