 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, MarginIgnoreBlankTest001, TestSize.Level1)
{
    CreateWithItem(
        [](SwiperModelNG model) {
            model.SetDirection(Axis::HORIZONTAL);
        ...
        5);
    float result = pattern_->IgnoreBlankOffset(true);
    EXPECT_NE(result, 20);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, MarginIgnoreBlankTest002, TestSize.Level1)
{
    CreateWithItem(
        [](SwiperModelNG model) {
            model.SetDirection(Axis::HORIZONTAL);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, MarginIgnoreBlankTest003, TestSize.Level1)
{
    CreateWithItem(
        [](SwiperModelNG model) {
            model.SetDirection(Axis::HORIZONTAL);
