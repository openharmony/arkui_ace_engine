 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmMeasure001, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {});
    auto indicatorNode = GetChildFrameNode(frameNode_, 4);
    auto indicatorPattern = indicatorNode->GetPattern<SwiperIndicatorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmMeasure002, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout001, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout002, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {});
    auto indicatorNode = GetChildFrameNode(frameNode_, 4);
    auto indicatorPattern = indicatorNode->GetPattern<SwiperIndicatorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout003, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {});
    auto indicatorNode = GetChildFrameNode(frameNode_, 4);
    auto indicatorPattern = indicatorNode->GetPattern<SwiperIndicatorPattern>();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout004, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout005, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmLayout006, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SwiperLayoutTestNg, SwiperIndicatorLayoutAlgorithmGetValidEdgeLength001, TestSize.Level1)
{
    CreateWithItem([](SwiperModelNG model) {
        model.SetDirection(Axis::VERTICAL);
    });
