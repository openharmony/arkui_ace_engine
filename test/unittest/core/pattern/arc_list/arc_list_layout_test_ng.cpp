...
HWTEST_F(ArcListLayoutTestNg, Pattern010, TestSize.Level1)
{
    ...
    CreateListItems(TOTAL_ITEM_NUMBER);
    CreateDone(frameNode_);
    EXPECT_EQ(frameNode_->GetGeometryNode()->GetFrameSize().Width(), Infinity<float>() * ARC_LIST_ITER_SCALE);
...
HWTEST_F(ArcListLayoutTestNg, ChildrenMainSize005, TestSize.Level1)
{
    ...
    CreateListItems(8);
    CreateDone(frameNode_);
    EXPECT_TRUE(ScrollToIndex(1, false, ScrollAlign::CENTER, -50.f));
...
HWTEST_F(ArcListLayoutTestNg, ChildrenMainSize006, TestSize.Level1)
{
    ...
    CreateListItems(8);
    CreateDone(frameNode_);
    EXPECT_TRUE(ScrollToIndex(3, false, ScrollAlign::CENTER, 0));
    ...
    EXPECT_TRUE(ScrollToIndex(8, false, ScrollAlign::END, 225.f));
...
HWTEST_F(ArcListLayoutTestNg, GetNearScale001, TestSize.Level1)
{
    ...
    EXPECT_TRUE(NearEqual(ArcListLayoutAlgorithm::GetNearScale(-10.0), 1.077826));
}
...
HWTEST_F(ArcListLayoutTestNg, UpdatePosMap001, TestSize.Level1)
{
    ...
    EXPECT_EQ(posMap->GetTotalHeight(), 30.f);
}
