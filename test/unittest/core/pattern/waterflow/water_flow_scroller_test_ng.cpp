 ...
 * @tc.type: FUNC
 */
HWTEST_F(WaterFlowScrollerTestNg, OnWillScrollAndOnDidScroll001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WaterFlowScrollerTestNg, OnWillScrollAndOnDidScroll002, TestSize.Level1)
{
    bool isOnScrollCallBack = false;
    bool isOnWillScrollCallBack = false;
    bool isOnDidScrollCallBack = false;
