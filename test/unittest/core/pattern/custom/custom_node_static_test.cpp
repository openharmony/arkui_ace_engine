...
/**
 * @tc.name: CustomNodeFlushReloadTest001
 * @tc.desc: Test FlushReload with needRebuild=true
 * @tc.type: FUNC
 */
HWTEST_F(CustomNodeStaticTestNg, CustomNodeFlushReloadTest001, TestSize.Level1)
{
    auto customNode = CustomNode::CreateCustomNode(TEST_NODE_ID, "testCustom");
    ASSERT_NE(customNode, nullptr);

    auto res = false;
    customNode->SetCompleteReloadFunc([&res](int64_t deadline, bool& isTimeout) -> RefPtr<UINode> {
        res = true;
        return nullptr;
    });

    customNode->FlushReload(true);
    EXPECT_TRUE(res);
}

/**
 * @tc.name: CustomNodeFlushReloadTest002
 * @tc.desc: Test FlushReload with needRebuild=false
 * @tc.type: FUNC
 */
HWTEST_F(CustomNodeStaticTestNg, CustomNodeFlushReloadTest002, TestSize.Level1)
{
    auto customNode = CustomNode::CreateCustomNode(TEST_NODE_ID, "testCustom");
    ASSERT_NE(customNode, nullptr);
...
/**
 * @tc.name: CustomNodeFlushReloadTest003
 * @tc.desc: Test FlushReload default parameter (needRebuild=true)
 * @tc.type: FUNC
 */
HWTEST_F(CustomNodeStaticTestNg, CustomNodeFlushReloadTest003, TestSize.Level1)
{
    auto customNode = CustomNode::CreateCustomNode(TEST_NODE_ID, "testCustom");
    ASSERT_NE(customNode, nullptr);
