...
/**
 * @tc.name: CheckBoxPatternTest0131
 * @tc.desc: Test CheckBox InitOnKeyEvent.
 * @tc.type: FUNC
 */
HWTEST_F(CheckBoxTestNG, CheckBoxPatternTest0131, TestSize.Level1)
{
    CheckBoxModelNG checkBoxModelNG;
    checkBoxModelNG.Create(NAME, GROUP_NAME, TAG);
    auto frameNode = AceType::DynamicCast<FrameNode>(ViewStackProcessor::GetInstance()->Finish());
...
/**
 * @tc.name: CheckBoxPatternTest0132
 * @tc.desc: Test CheckBox theme.
 * @tc.type: FUNC
 */
HWTEST_F(CheckBoxTestNG, CheckBoxPatternTest0132, TestSize.Level1)
{
    /**
     * @tc.steps: create mock theme manager
     */
    auto themeManager = AceType::MakeRefPtr<MockThemeManager>();
    ...
    /**
     * @tc.steps: set checkbox theme
     */
    auto checkboxTheme = AceType::MakeRefPtr<CheckboxTheme>();
    EXPECT_CALL(*themeManager, GetTheme(_)).WillRepeatedly(Return(checkboxTheme));

    /**
     * @tc.steps: call Builder to trigger Build to return error themeValue
     */
    ...
    attributes.insert(std::pair<std::string, ResValueWrapper>(THEME_PATTERN_CHECKBOX, resValueWrapper));
    ...
    CheckboxTheme::Builder().Build(themeConstants);
    EXPECT_CALL(*themeManager, GetTheme(CheckboxTheme::TypeId())).WillRepeatedly(Return(checkboxTheme));
}
