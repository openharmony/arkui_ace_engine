 ...
 * @tc.desc: Increase the coverage of SheetView::GetTitlePaddingPos function.
 * @tc.type: FUNC
 */
HWTEST_F(SheetOthersTestNg, GetTitlePaddingPos001, TestSize.Level1)
{
    ...
    EXPECT_FALSE(applicationInfo.GreatOrEqualTargetAPIVersion(PlatformVersion::VERSION_THIRTEEN));
...
/**
 * @tc.name: GetTitlePaddingPos002
 * @tc.desc: Increase the coverage of SheetView::GetTitlePaddingPos function.
 * @tc.type: FUNC
 */
HWTEST_F(SheetOthersTestNg, GetTitlePaddingPos002, TestSize.Level1)
{
    PaddingProperty padding;
    auto callback = [](const std::string&) {};
    auto sheetNode = FrameNode::CreateFrameNode("Sheet", 101,
    ...
    layoutProperty->UpdateSheetStyle(sheetStyle);
    AceApplicationInfo& applicationInfo = AceApplicationInfo::GetInstance();
    applicationInfo.apiVersion_ = static_cast<int32_t>(PlatformVersion::VERSION_THIRTEEN);
    applicationInfo.isRightToLeft_ = false;

    EXPECT_TRUE(applicationInfo.GreatOrEqualTargetAPIVersion(PlatformVersion::VERSION_THIRTEEN));
...
/**
 * @tc.name: GetTitlePaddingPos003
 * @tc.desc: Increase the coverage of SheetView::GetTitlePaddingPos function.
 * @tc.type: FUNC
 */
HWTEST_F(SheetOthersTestNg, GetTitlePaddingPos003, TestSize.Level1)
{
    PaddingProperty padding;
    auto callback = [](const std::string&) {};
    auto sheetNode = FrameNode::CreateFrameNode("Sheet", 101,
