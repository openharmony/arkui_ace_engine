...
HWTEST_F(OverlayMaterialECTestNg, SetSheetBlurSnapshotFreezeNullSheetPage001, TestSize.Level1)
{
    ...
    overlayManager->SetSheetBlurSnapshotFreeze(nullNode, pattern, sheetStyle, false);
}

/**
 * @tc.name: SetSheetBlurSnapshotFreezeNullPattern001
 * @tc.desc: Test SetSheetBlurSnapshotFreeze with null nodePattern
 * @tc.type: FUNC
 */
HWTEST_F(OverlayMaterialECTestNg, SetSheetBlurSnapshotFreezeNullPattern001, TestSize.Level1)
{
    ...
    RefPtr<SheetPresentationPattern> nullPattern = nullptr;
    overlayManager->SetSheetBlurSnapshotFreeze(sheetPageNode, nullPattern, sheetStyle, false);
}
...
HWTEST_F(OverlayMaterialECTestNg, SetSheetBlurSnapshotFreezeNotUseEC001, TestSize.Level1)
{
    ...
    ASSERT_TRUE(sheetPattern);
    overlayManager->SetSheetBlurSnapshotFreeze(sheetPageNode, sheetPattern, sheetStyle, false);
}
...
HWTEST_F(OverlayMaterialECTestNg, SetSheetBlurSnapshotFreezePartialUpdateNoValue001, TestSize.Level1)
{
    ...
    auto rootPattern = AceType::MakeRefPtr<RootPattern>();
    auto rootNode = FrameNode::CreateFrameNode(V2::ROOT_ETS_TAG, 1, rootPattern);
    auto overlayManager = AceType::MakeRefPtr<OverlayManager>(rootNode);
    overlayManager->SetSheetBlurSnapshotFreeze(sheetPageNode, sheetPattern, partialStyle, true);
