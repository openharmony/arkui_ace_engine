...
struct Focus_Hierarchical_Page_TestCase {
    bool isDefaultFocus;
    ...
    bool isDependenceC;
    bool isDesiredNodes;
    Focus_Hierarchical_Page_TestCase(bool isDefaultFocus, bool isDefaultFocusAble, bool isCFirstFocus,
...
const std::vector<Focus_Hierarchical_Page_TestCase> FOCUS_HIERARCHICAL_PAGE_CASES = {
    // case1
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEC, true, false),
    // case2
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEC, false, false),
    // case3
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEE, true, false),
    // case4
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEE, false, false),
    // case5
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEC, true, false),
    // case6
    Focus_Hierarchical_Page_TestCase(true, true, true, false, FocusHierarchicalCase::NODEC, false, false),
...
void Focus_Hierarchical_Page_TestNG::SetUpTestSuite()
{
    MockPipelineContext::SetUp();
    GTEST_LOG_(INFO) << "Focus_Hierarchical_Page_TestNG SetUpTestCase";
}

void Focus_Hierarchical_Page_TestNG::TearDownTestSuite()
{
    MockPipelineContext::TearDown();
    GTEST_LOG_(INFO) << "Focus_Hierarchical_Page_TestNG TearDownTestCase";
}
...
HWTEST_F(Focus_Hierarchical_Page_TestNG, Focus_Hierarchical_Page_TestNG001, TestSize.Level1)
{
