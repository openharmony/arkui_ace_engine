...
/**
 * @tc.name: OH_ArkUI_PointerEvent_GetPressure
 * @tc.desc: Test OH_ArkUI_PointerEvent_GetPressure
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_PointerEvent_GetPressure, TestSize.Level1)
{
    ArkUI_UIInputEvent event;
    ...
    event.eventTypeId = C_KEY_EVENT_ID;
    ret = OH_ArkUI_PointerEvent_GetPressure(&event, 0);
    EXPECT_EQ(ret, 0.0f);

    event.eventTypeId = C_TOUCH_EVENT_ID;
    event.inputEvent = nullptr;
    ArkUITouchEvent touchEvent;
    ArkUITouchPoint pointes[3] = { 0, 1, 2 };
    pointes[2].pressure = 1.1f;
    ...
    event.inputEvent = nullptr;
    ArkUIMouseEvent mouseEvent;
    mouseEvent.actionTouchPoint.pressure = 2.2f;
    ret = OH_ArkUI_PointerEvent_GetPressure(&event, 0);
    event.inputEvent = &mouseEvent;
    ret = OH_ArkUI_PointerEvent_GetPressure(&event, 0);
    EXPECT_EQ(ret, 2.2f);
...
/**
 * @tc.name: OH_ArkUI_PointerEvent_GetTiltX
 * @tc.desc: Test OH_ArkUI_PointerEvent_GetTiltX
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_PointerEvent_GetTiltX, TestSize.Level1)
{
    ArkUI_UIInputEvent event;
    ...
    event.eventTypeId = C_KEY_EVENT_ID;
    ret = OH_ArkUI_PointerEvent_GetTiltX(&event, 0);
    EXPECT_EQ(ret, 0.0f);
...
/**
 * @tc.name: OH_ArkUI_PointerEvent_GetTiltY
 * @tc.desc: Test OH_ArkUI_PointerEvent_GetTiltY
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_PointerEvent_GetTiltY, TestSize.Level1)
{
    ArkUI_UIInputEvent event;
    ...
    event.eventTypeId = C_KEY_EVENT_ID;
    ret = OH_ArkUI_PointerEvent_GetTiltY(&event, 0);
    EXPECT_EQ(ret, 0.0f);
