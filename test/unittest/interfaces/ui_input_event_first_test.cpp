 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetCoastingAxisEvent, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, GetCoastingAxisEventTime001, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, GetCoastingAxisEventPhase001, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_CoastingAxisEvent_GetDeltaX, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_CoastingAxisEvent_GetDeltaY, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UIInputEventTest, OH_ArkUI_CoastingAxisEvent_SetPropagation, TestSize.Level1)
{
    /**
     * @tc.steps: step1.create ArkUI_NodeEvent, related function is called.
     */
