...
ArkUINodeHandle CreateLoadingProgress(ArkUI_Uint32 nodeId)
{
    auto frameNode = LoadingProgressModelNG::CreateFrameNode(static_cast<int32_t>(nodeId));
...
const ArkUILoadingProgressModifier* GetLoadingProgressModifier()
{
    static const ArkUILoadingProgressModifier modifier = {
        .createLoadingProgressFrameNode = CreateLoadingProgress,
    };
    return &modifier;
}
} // namespace NodeModifier
