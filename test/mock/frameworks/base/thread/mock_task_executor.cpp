...
// This file mirrors frameworks/base/thread/task_executor.cpp. Keep non-priority behavior synchronized with the
...
{
    // Priority adjustment is intentionally disabled to keep this mock deterministic.
    (void)priorityType;
