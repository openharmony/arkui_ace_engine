...
from src.keywords import event_procedure_keyword, keywords_dict
...
class EventScope(BaseBean):
    ...
    def __init__(self, input_str):
        ...
        if texts is None or len(texts) == 0:
            ...
            return
        finger_str = texts[0]
        self.finger = get_value_as_int(finger_str, event_procedure_keyword['finger'].key,
                                          event_procedure_keyword['finger'].value_separator_count, True)
    ...
    def parse_event_nodes(self, spliced_lines, start_index):
        start_keyword = event_procedure_keyword['frameNodeId'].key
        end_keywords = [event_procedure_keyword['frameNodeId'].key, keywords_dict['event tree']]
        current_index = 0
